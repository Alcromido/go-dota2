...
const file_dota_gcmessages_client_watch_proto_rawDesc = "" +
	"\n" +
	"\"dota_gcmessages_client_watch.proto\x12\bprotocol\x1a\x1cdota_gcmessages_common.proto\"\xa5\n" +
	"\n" +
	...
	"\x16custom_game_difficulty\x18  \x01(\rR\x14customGameDifficulty\x1a@\n" +
	"\x06Player\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12\x17\n" +
	"\ahero_id\x18\x02 \x01(\rR\x06heroId\"\xdd\x01\n" +
	...
	"\ahero_id\x18\x03 \x01(\rR\x06heroId\x12\x1d\n" +
	"\n" +
	...
	"\x0fteam_dire_score\x18\x05 \x01(\rR\rteamDireScoreB\rZ\v./;protocol"
