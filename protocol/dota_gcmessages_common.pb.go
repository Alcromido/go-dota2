...
func (CMsgDOTAProfileCard_EStatID) EnumDescriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{22, 0}
}
...
func (CMsgGCRerollPlayerChallengeResponse_EResult) EnumDescriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{25, 0}
}
...
func (CMsgDOTARealtimeGameStats_GraphDataEStat) EnumDescriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{27, 11, 0}
}
...
func (CMsgDOTARealtimeGameStats_GraphDataELocation) EnumDescriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{27, 11, 1}
}
...
func (CMsgInGamePrediction_ERawValueTypeT) EnumDescriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{33, 0}
}
...
func (CMsgInGamePrediction_EPredictionType) EnumDescriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{33, 1}
}
...
func (CMsgInGamePrediction_EResolutionTypeT) EnumDescriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{33, 2}
}
...
func (CMsgInGamePrediction_ERandomSelectionGroupT) EnumDescriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{33, 3}
}
...
func (CMsgDOTASeasonPredictions_Prediction_EPredictionType) EnumDescriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{34, 0, 0}
}
...
func (CMsgDOTASeasonPredictions_Prediction_EAnswerType) EnumDescriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{34, 0, 1}
}
...
func (CMsgDOTAMatch_Player_HeroDamageType) EnumDescriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{37, 0, 0}
}
...
// Default values for CMatchPlayerAbilityUpgrade fields.
const (
	Default_CMatchPlayerAbilityUpgrade_Ability = int32(-1)
)
...
// Default values for CMatchPlayerTimedCustomStat fields.
const (
	Default_CMatchPlayerTimedCustomStat_Stat = EDOTAMatchPlayerTimeCustomStat_k_EDOTA_MatchPlayerTimeCustomStat_HPRegenUnderT1Towers
)
...
// Default values for CMatchClip fields.
const (
	Default_CMatchClip_AbilityId = int32(-1)
)
...
// Default values for CMsgInGamePrediction fields.
const (
	Default_CMsgInGamePrediction_Type                 = CMsgInGamePrediction_Generic
	Default_CMsgInGamePrediction_Group                = CMsgInGamePrediction_EarlyGame
	Default_CMsgInGamePrediction_AnswerResolutionType = CMsgInGamePrediction_InvalidQuery
	Default_CMsgInGamePrediction_RawValueType         = CMsgInGamePrediction_Number
)
...
// Default values for CMsgServerToGCRequestPlayerRecentAccomplishmentsResponse fields.
const (
	Default_CMsgServerToGCRequestPlayerRecentAccomplishmentsResponse_Result = CMsgServerToGCRequestPlayerRecentAccomplishmentsResponse_k_eInternalError
)
...
// Default values for CMsgGameDataAbilityOrItem fields.
const (
	Default_CMsgGameDataAbilityOrItem_Id = int32(-1)
)
...
// Default values for CMsgStickerbookPage fields.
const (
	Default_CMsgStickerbookPage_EventId  = EEvent_EVENT_ID_NONE
	Default_CMsgStickerbookPage_PageType = EStickerbookPageType_STICKER_PAGE_GENERIC
)
...
func (*CMsgGCGetPlayerCardItemInfoResponse_PlayerCardInfo) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{19, 0}
}
...
func (*CMsgDOTAProfileCard_Slot_Trophy) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{22, 0, 0}
}
...
const (
	Default_CMsgDOTAProfileCard_Slot_Stat_StatId = CMsgDOTAProfileCard_k_eStat_Wins
)
...
func (*CMsgDOTAProfileCard_Slot_Stat) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{22, 0, 1}
}
...
func (*CMsgDOTAProfileCard_Slot_Item) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{22, 0, 2}
}
...
func (*CMsgDOTAProfileCard_Slot_Hero) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{22, 0, 3}
}
...
func (*CMsgDOTAProfileCard_Slot_Emoticon) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{22, 0, 4}
}
...
func (*CMsgDOTAProfileCard_Slot_Team) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{22, 0, 5}
}
...
// Default values for CMsgDOTARealtimeGameStats_ItemDetails fields.
const (
	Default_CMsgDOTARealtimeGameStats_ItemDetails_ItemAbilityId = int32(-1)
)
...
func (*CMsgDOTARealtimeGameStats_ItemDetails) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{27, 1}
}
...
// Default values for CMsgDOTARealtimeGameStats_AbilityDetails fields.
const (
	Default_CMsgDOTARealtimeGameStats_AbilityDetails_Id = int32(-1)
)
...
func (*CMsgDOTARealtimeGameStats_AbilityDetails) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{27, 2}
}
...
// Default values for CMsgDOTARealtimeGameStats_HeroToHeroStats fields.
const (
	Default_CMsgDOTARealtimeGameStats_HeroToHeroStats_Victimid = int32(-1)
)
...
func (*CMsgDOTARealtimeGameStats_HeroToHeroStats) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{27, 3}
}
...
func (*CMsgDOTARealtimeGameStats_AbilityList) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{27, 4}
}
...
// Default values for CMsgDOTARealtimeGameStats_PlayerDetails fields.
const (
	Default_CMsgDOTARealtimeGameStats_PlayerDetails_Playerid = int32(-1)
)
...
// Default values for CMsgDOTARealtimeGameStats_KillDetails fields.
const (
	Default_CMsgDOTARealtimeGameStats_KillDetails_PlayerId       = int32(-1)
	Default_CMsgDOTARealtimeGameStats_KillDetails_KillerPlayerId = int32(-1)
)
...
func (*CMsgDOTARealtimeGameStats_KillDetails) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{27, 7}
}
...
// Default values for CMsgDOTARealtimeGameStats_BroadcasterDetails fields.
const (
	Default_CMsgDOTARealtimeGameStats_BroadcasterDetails_PlayerId = int32(-1)
)
...
func (*CMsgDOTARealtimeGameStats_BroadcasterDetails) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{27, 8}
}
...
func (*CMsgDOTARealtimeGameStats_PickBanDetails) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{27, 9}
}
...
func (*CMsgDOTARealtimeGameStats_MatchDetails) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{27, 10}
}
...
// Default values for CMsgDOTARealtimeGameStatsTerse_PlayerDetails fields.
const (
	Default_CMsgDOTARealtimeGameStatsTerse_PlayerDetails_Playerid = int32(-1)
)
...
const (
	Default_CMsgDOTASeasonPredictions_Prediction_Type        = CMsgDOTASeasonPredictions_Prediction_Generic
	Default_CMsgDOTASeasonPredictions_Prediction_AnswerType  = CMsgDOTASeasonPredictions_Prediction_SingleInt
	Default_CMsgDOTASeasonPredictions_Prediction_Region      = ELeagueRegion_LEAGUE_REGION_UNSET
	Default_CMsgDOTASeasonPredictions_Prediction_RewardEvent = EEvent_EVENT_ID_NONE
)
...
func (*CMsgLeagueWatchedGames_League) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{36, 1}
}
...
// Default values for CMsgDOTAMatch_Player fields.
const (
	Default_CMsgDOTAMatch_Player_Item_0     = int32(-1)
	Default_CMsgDOTAMatch_Player_Item_1     = int32(-1)
	Default_CMsgDOTAMatch_Player_Item_2     = int32(-1)
	Default_CMsgDOTAMatch_Player_Item_3     = int32(-1)
	Default_CMsgDOTAMatch_Player_Item_4     = int32(-1)
	Default_CMsgDOTAMatch_Player_Item_5     = int32(-1)
	Default_CMsgDOTAMatch_Player_Item_6     = int32(-1)
	Default_CMsgDOTAMatch_Player_Item_7     = int32(-1)
	Default_CMsgDOTAMatch_Player_Item_8     = int32(-1)
	Default_CMsgDOTAMatch_Player_Item_9     = int32(-1)
	Default_CMsgDOTAMatch_Player_TeamNumber = DOTA_GC_TEAM_DOTA_GC_TEAM_GOOD_GUYS
)
...
func (*CMsgDOTAMatch_BroadcasterChannel) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{37, 2}
}
...
func (*CMsgDOTAMatch_Coach) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{37, 3}
}
...
func (*CMsgDOTAMatch_CustomGameData) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{37, 4}
}
...
func (*CMsgDOTAMatch_Player_HeroDamageReceived) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{37, 0, 1}
}
...
// Default values for CMsgDOTABotDebugInfo_Bot fields.
const (
	Default_CMsgDOTABotDebugInfo_Bot_PlayerOwnerId = int32(-1)
)
...
// Default values for CMsgDOTABotDebugInfo_Bot_Mode fields.
const (
	Default_CMsgDOTABotDebugInfo_Bot_Mode_TargetEntity = int32(-1)
)
...
func (*CMsgDOTABotDebugInfo_Bot_Mode) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{41, 0, 0}
}
...
func (*CMsgMatchTips_SingleTip) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{44, 0}
}
...
// Default values for CMsgDOTAMatchMinimal_Player fields.
const (
	Default_CMsgDOTAMatchMinimal_Player_TeamNumber = DOTA_GC_TEAM_DOTA_GC_TEAM_GOOD_GUYS
)
...
func (*CMsgDOTAMatchMinimal_Tourney) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{45, 1}
}
...
func (*CMsgPullTabsData_Jackpot) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_proto_rawDescGZIP(), []int{63, 1}
}
...
// Default values for CMsgGameDataItemAbilityList_ItemAbilityInfo fields.
const (
	Default_CMsgGameDataItemAbilityList_ItemAbilityInfo_Id = int32(-1)
)
...
const file_dota_gcmessages_common_proto_rawDesc = "" +
	"\n" +
	"\x1cdota_gcmessages_common.proto\x12\bprotocol\x1a\x13steammessages.proto\x1a\x16gcsdk_gcmessages.proto\x1a\x17dota_shared_enums.proto\"\xa8\x17\n" +
	...
	"\x1acurr_all_hero_challenge_id\x18C \x01(\rR\x16currAllHeroChallengeId\x12(\n" +
	...
	"\fqueue_points\x18r \x01(\rR\vqueuePoints\x12V\n" +
	"\x0erole_handicaps\x18s \x03(\v2/.protocol.CSODOTAGameAccountClient.RoleHandicapR\rroleHandicaps\x123\n" +
	"\x16event_mode_recent_time\x18x \x01(\rR\x13eventModeRecentTime\x124\n" +
	"\x16mmr_recalibration_time\x18y \x01(\rR\x14mmrRecalibrationTime\x1a>\n" +
	"\fRoleHandicap\x12\x12\n" +
	"\x04role\x18\x01 \x01(\rR\x04role\x12\x1a\n" +
	"\bhandicap\x18\x02 \x01(\x02R\bhandicap\"\xe7\x02\n" +
	"\x16CSODOTAGameAccountPlus\x12#\n" +
	"\n" +
	...
	"\x12steam_agreement_id\x18\b \x01(\x06R\x10steamAgreementId\"\xf0\x01\n" +
	"!CMsgLobbyFeaturedGamemodeProgress\x12W\n" +
	"\baccounts\x18\x01 \x03(\v2;.protocol.CMsgLobbyFeaturedGamemodeProgress.AccountProgressR\baccounts\x1ar\n" +
	...
	"\ttrophy_id\x18\t \x01(\rR\btrophyId\"Y\n" +
	"\x1dCMsgLobbyBattleCupVictoryList\x128\n" +
	"\awinners\x18\x01 \x03(\v2\x1e.protocol.CMsgBattleCupVictoryR\awinners\"9\n" +
	...
	"\x0ftournament_drop\x18\b \x01(\bR\x0etournamentDrop\"N\n" +
	"\x1aCMatchPlayerAbilityUpgrade\x12\x1c\n" +
	"\aability\x18\x01 \x01(\x05:\x02-1R\aability\x12\x12\n" +
	...
	"\ahero_id\x18\x03 \x01(\rR\x06heroId\"\xbe\x02\n" +
	"\n" +
	"CMatchClip\x12\x19\n" +
	...
	"\ahero_id\x18\x06 \x01(\rR\x06heroId\x12!\n" +
	"\n" +
	"ability_id\x18\a \x01(\x05:\x02-1R\tabilityId\x12\x1f\n" +
	...
	"\rall_for_event\x18\x03 \x01(\rR\vallForEvent\"\x97\x02\n" +
	"#CMsgGCGetPlayerCardItemInfoResponse\x12h\n" +
	"\x11player_card_infos\x18\x01 \x03(\v2<.protocol.CMsgGCGetPlayerCardItemInfoResponse.PlayerCardInfoR\x0fplayerCardInfos\x1a\x85\x01\n" +
	...
	"\x0epacked_bonuses\x18\x03 \x01(\x04R\rpackedBonuses\"\x83\x01\n" +
	"\x17CSODOTAMapLocationState\x12#\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rB\x04\x80\xa6\x1d\x01R\taccountId\x12%\n" +
	"\vlocation_id\x18\x02 \x01(\x05B\x04\x80\xa6\x1d\x01R\n" +
	"locationId\x12\x1c\n" +
	...
	"\x05slots\x18\x03 \x03(\v2\".protocol.CMsgDOTAProfileCard.SlotR\x05slots\x12!\n" +
	"\fbadge_points\x18\x04 \x01(\rR\vbadgePoints\x12!\n" +
	"\fevent_points\x18\x05 \x01(\rR\veventPoints\x12\x19\n" +
	"\bevent_id\x18\x06 \x01(\rR\aeventId\x12Y\n" +
	"\x19recent_battle_cup_victory\x18\a \x01(\v2\x1e.protocol.CMsgBattleCupVictoryR\x16recentBattleCupVictory\x12\x1b\n" +
	...
	"\x0elifetime_games\x18\x19 \x01(\rR\rlifetimeGames\x1a\xd5\x06\n" +
	"\x04Slot\x12\x17\n" +
	"\aslot_id\x18\x01 \x01(\rR\x06slotId\x12A\n" +
	"\x06trophy\x18\x02 \x01(\v2).protocol.CMsgDOTAProfileCard.Slot.TrophyR\x06trophy\x12;\n" +
	"\x04stat\x18\x03 \x01(\v2'.protocol.CMsgDOTAProfileCard.Slot.StatR\x04stat\x12;\n" +
	"\x04item\x18\x04 \x01(\v2'.protocol.CMsgDOTAProfileCard.Slot.ItemR\x04item\x12;\n" +
	"\x04hero\x18\x05 \x01(\v2'.protocol.CMsgDOTAProfileCard.Slot.HeroR\x04hero\x12G\n" +
	"\bemoticon\x18\x06 \x01(\v2+.protocol.CMsgDOTAProfileCard.Slot.EmoticonR\bemoticon\x12;\n" +
	"\x04team\x18\a \x01(\v2'.protocol.CMsgDOTAProfileCard.Slot.TeamR\x04team\x1aH\n" +
	"\x06Trophy\x12\x1b\n" +
	"\ttrophy_id\x18\x01 \x01(\rR\btrophyId\x12!\n" +
	"\ftrophy_score\x18\x02 \x01(\rR\vtrophyScore\x1as\n" +
	"\x04Stat\x12L\n" +
	"\astat_id\x18\x01 \x01(\x0e2%.protocol.CMsgDOTAProfileCard.EStatID:\fk_eStat_WinsR\x06statId\x12\x1d\n" +
	"\n" +
	...
	"\x10k_eStat_GamesMVP\x10\b\"\xbf\x04\n" +
	"\x16CSODOTAPlayerChallenge\x12#\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rB\x04\x80\xa6\x1d\x01R\taccountId\x12\x1f\n" +
	"\bevent_id\x18\x02 \x01(\rB\x04\x80\xa6\x1d\x01R\aeventId\x12\x1d\n" +
	"\aslot_id\x18\x03 \x01(\rB\x04\x80\xa6\x1d\x01R\x06slotId\x12\x1e\n" +
	...
	"instanceId\x12\x17\n" +
	"\ahero_id\x18\x11 \x01(\rR\x06heroId\x12\x1f\n" +
	"\vtemplate_id\x18\x12 \x01(\rR\n" +
	"templateId\"\x9b\x01\n" +
	"#CMsgClientToGCRerollPlayerChallenge\x12:\n" +
	"\bevent_id\x18\x01 \x01(\x0e2\x10.protocol.EEvent:\rEVENT_ID_NONER\aeventId\x12\x1f\n" +
	"\vsequence_id\x18\x03 \x01(\rR\n" +
	"sequenceId\x12\x17\n" +
	"\ahero_id\x18\x04 \x01(\rR\x06heroId\"\x81\x02\n" +
	"#CMsgGCRerollPlayerChallengeResponse\x12^\n" +
	"\x06result\x18\x01 \x01(\x0e25.protocol.CMsgGCRerollPlayerChallengeResponse.EResult:\x0feResult_SuccessR\x06result\"z\n" +
	"\aEResult\x12\x13\n" +
	...
	"\x0fgame_of_the_day\x18\x02 \x01(\x04R\fgameOfTheDay\"\xd2&\n" +
	"\x19CMsgDOTARealtimeGameStats\x12F\n" +
	"\x05match\x18\x01 \x01(\v20.protocol.CMsgDOTARealtimeGameStats.MatchDetailsR\x05match\x12E\n" +
	"\x05teams\x18\x02 \x03(\v2/.protocol.CMsgDOTARealtimeGameStats.TeamDetailsR\x05teams\x12Q\n" +
	"\tbuildings\x18\x03 \x03(\v23.protocol.CMsgDOTARealtimeGameStats.BuildingDetailsR\tbuildings\x12L\n" +
	"\n" +
	"graph_data\x18\x04 \x01(\v2-.protocol.CMsgDOTARealtimeGameStats.GraphDataR\tgraphData\x12\x1f\n" +
	"\vdelta_frame\x18\x05 \x01(\bR\n" +
	"deltaFrame\x1a\xf5\x02\n" +
	...
	"\tnet_worth\x18\t \x01(\rR\bnetWorth\x12K\n" +
	"\aplayers\x18\x06 \x03(\v21.protocol.CMsgDOTARealtimeGameStats.PlayerDetailsR\aplayers\x12\x1b\n" +
	"\tonly_team\x18\a \x01(\bR\bonlyTeam\x12\x16\n" +
	"\x06cheers\x18\b \x01(\rR\x06cheers\x12\"\n" +
	"\rteam_logo_url\x18\v \x01(\tR\vteamLogoUrl\x1a\x95\x01\n" +
	"\vItemDetails\x12*\n" +
	"\x0fitem_ability_id\x18\x01 \x01(\x05:\x02-1R\ritemAbilityId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x12\n" +
	"\x04time\x18\x03 \x01(\x05R\x04time\x12\x12\n" +
	"\x04sold\x18\x04 \x01(\bR\x04sold\x12\x1e\n" +
	"\n" +
	"stackcount\x18\x05 \x01(\rR\n" +
	"stackcount\x1a\x8d\x01\n" +
	"\x0eAbilityDetails\x12\x12\n" +
	...
	"\fcooldown_max\x18\x05 \x01(\x02R\vcooldownMax\x1aa\n" +
	"\x0fHeroToHeroStats\x12\x1e\n" +
	"\bvictimid\x18\x01 \x01(\x05:\x02-1R\bvictimid\x12\x14\n" +
	"\x05kills\x18\x02 \x01(\rR\x05kills\x12\x18\n" +
	"\aassists\x18\x03 \x01(\rR\aassists\x1a\x1d\n" +
	"\vAbilityList\x12\x0e\n" +
	"\x02id\x18\x01 \x03(\x05R\x02id\x1a\xda\x0e\n" +
	"\rPlayerDetails\x12\x1c\n" +
	"\taccountid\x18\x01 \x01(\rR\taccountid\x12\x1e\n" +
	"\bplayerid\x18\x02 \x01(\x05:\x02-1R\bplayerid\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x12\n" +
	"\x04team\x18\x04 \x01(\rR\x04team\x12\x16\n" +
	"\x06heroid\x18\x05 \x01(\rR\x06heroid\x12\"\n" +
	...
	"heroDamage\x12!\n" +
	"\ftower_damage\x18\x19 \x01(\rR\vtowerDamage\x12P\n" +
	"\tabilities\x18\x1a \x03(\v22.protocol.CMsgDOTARealtimeGameStats.AbilityDetailsR\tabilities\x12\x14\n" +
	...
	"hasBuyback\x12E\n" +
	"\x05items\x18+ \x03(\v2/.protocol.CMsgDOTARealtimeGameStats.ItemDetailsR\x05items\x12O\n" +
	"\n" +
	"stashitems\x18, \x03(\v2/.protocol.CMsgDOTARealtimeGameStats.ItemDetailsR\n" +
	"stashitems\x12[\n" +
	"\x10itemshoppinglist\x18- \x03(\v2/.protocol.CMsgDOTARealtimeGameStats.ItemDetailsR\x10itemshoppinglist\x12Q\n" +
	"\vlevelpoints\x18. \x03(\v2/.protocol.CMsgDOTARealtimeGameStats.AbilityListR\vlevelpoints\x12`\n" +
	"\x12hero_to_hero_stats\x18/ \x03(\v23.protocol.CMsgDOTARealtimeGameStats.HeroToHeroStatsR\x0fheroToHeroStats\x12!\n" +
	"\fhas_ultimate\x180 \x01(\bR\vhasUltimate\x12*\n" +
	"\x11has_ultimate_mana\x181 \x01(\bR\x0fhasUltimateMana\x1a\xb5\x01\n" +
	...
	"\tdestroyed\x18\t \x01(\bR\tdestroyed\x1a{\n" +
	"\vKillDetails\x12\x1f\n" +
	"\tplayer_id\x18\x01 \x01(\x05:\x02-1R\bplayerId\x12\x1d\n" +
	"\n" +
	"death_time\x18\x02 \x01(\x05R\tdeathTime\x12,\n" +
	"\x10killer_player_id\x18\x03 \x01(\x05:\x02-1R\x0ekillerPlayerId\x1a5\n" +
	"\x12BroadcasterDetails\x12\x1f\n" +
	"\tplayer_id\x18\x01 \x01(\x05:\x02-1R\bplayerId\x1a8\n" +
	"\x0ePickBanDetails\x12\x12\n" +
	"\x04hero\x18\x01 \x01(\rR\x04hero\x12\x12\n" +
	"\x04team\x18\x02 \x01(\rR\x04team\x1a\xe6\x06\n" +
	"\fMatchDetails\x12&\n" +
	...
	"teamidDire\x12H\n" +
	"\x05picks\x18\n" +
	" \x03(\v22.protocol.CMsgDOTARealtimeGameStats.PickBanDetailsR\x05picks\x12F\n" +
	"\x04bans\x18\v \x03(\v22.protocol.CMsgDOTARealtimeGameStats.PickBanDetailsR\x04bans\x12E\n" +
	"\x05kills\x18\f \x03(\v2/.protocol.CMsgDOTARealtimeGameStats.KillDetailsR\x05kills\x12Z\n" +
	"\fbroadcasters\x18\r \x03(\v26.protocol.CMsgDOTARealtimeGameStats.BroadcasterDetailsR\fbroadcasters\x12\x1b\n" +
	...
	"\x0fstart_timestamp\x18\x15 \x01(\rR\x0estartTimestamp\x1a\xd5\x04\n" +
	"\tGraphData\x12\x1d\n" +
	"\n" +
	...
	"graphTower\x12\x1b\n" +
	"\tgraph_rax\x18\x05 \x03(\x05R\bgraphRax\x12e\n" +
	"\x0eteam_loc_stats\x18\x06 \x03(\v2?.protocol.CMsgDOTARealtimeGameStats.GraphData.TeamLocationStatsR\fteamLocStats\x1a%\n" +
	"\rLocationStats\x12\x14\n" +
	"\x05stats\x18\x01 \x03(\x05R\x05stats\x1am\n" +
	"\x11TeamLocationStats\x12X\n" +
	"\tloc_stats\x18\x01 \x03(\v2;.protocol.CMsgDOTARealtimeGameStats.GraphData.LocationStatsR\blocStats\"[\n" +
	"\x05eStat\x12\x13\n" +
	...
	"\x05Other\x10\x05\"\xea\x0f\n" +
	"\x1eCMsgDOTARealtimeGameStatsTerse\x12K\n" +
	"\x05match\x18\x01 \x01(\v25.protocol.CMsgDOTARealtimeGameStatsTerse.MatchDetailsR\x05match\x12J\n" +
	"\x05teams\x18\x02 \x03(\v24.protocol.CMsgDOTARealtimeGameStatsTerse.TeamDetailsR\x05teams\x12V\n" +
	"\tbuildings\x18\x03 \x03(\v28.protocol.CMsgDOTARealtimeGameStatsTerse.BuildingDetailsR\tbuildings\x12Q\n" +
	"\n" +
	"graph_data\x18\x04 \x01(\v22.protocol.CMsgDOTARealtimeGameStatsTerse.GraphDataR\tgraphData\x12\x1f\n" +
	"\vdelta_frame\x18\x05 \x01(\bR\n" +
	"deltaFrame\x1a\xc5\x02\n" +
	"\vTeamDetails\x12\x1f\n" +
	"\vteam_number\x18\x01 \x01(\rR\n" +
	"teamNumber\x12\x17\n" +
	"\ateam_id\x18\x02 \x01(\rR\x06teamId\x12\x1b\n" +
	...
	"\rteam_logo_url\x18\t \x01(\tR\vteamLogoUrl\x12P\n" +
	"\aplayers\x18\x06 \x03(\v26.protocol.CMsgDOTARealtimeGameStatsTerse.PlayerDetailsR\aplayers\x1a\xc7\x03\n" +
	"\rPlayerDetails\x12\x1c\n" +
	"\taccountid\x18\x01 \x01(\rR\taccountid\x12\x1e\n" +
	"\bplayerid\x18\x02 \x01(\x05:\x02-1R\bplayerid\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x12\n" +
	"\x04team\x18\x04 \x01(\rR\x04team\x12\x16\n" +
	"\x06heroid\x18\x05 \x01(\rR\x06heroid\x12\x14\n" +
	...
	"\x05items\x18\x11 \x03(\x05R\x05items\x1a\xb5\x01\n" +
	"\x0fBuildingDetails\x12\x12\n" +
	...
	"\x0ePickBanDetails\x12\x12\n" +
	"\x04hero\x18\x01 \x01(\rR\x04hero\x12\x12\n" +
	"\x04team\x18\x02 \x01(\rR\x04team\x1a\xb2\x04\n" +
	"\fMatchDetails\x12&\n" +
	"\x0fserver_steam_id\x18\x01 \x01(\x06R\rserverSteamId\x12\x19\n" +
	"\bmatch_id\x18\x02 \x01(\x04R\amatchId\x12\x1c\n" +
	...
	"\n" +
	"game_state\x18\n" +
	" \x01(\rR\tgameState\x12M\n" +
	"\x05picks\x18\v \x03(\v27.protocol.CMsgDOTARealtimeGameStatsTerse.PickBanDetailsR\x05picks\x12K\n" +
	"\x04bans\x18\f \x03(\v27.protocol.CMsgDOTARealtimeGameStatsTerse.PickBanDetailsR\x04bans\x12\x1d\n" +
	"\n" +
	"lobby_type\x18\r \x01(\rR\tlobbyType\x12'\n" +
	"\x0fstart_timestamp\x18\x0e \x01(\rR\x0estartTimestamp\x1a*\n" +
	"\tGraphData\x12\x1d\n" +
	"\n" +
	"graph_gold\x18\x01 \x03(\x05R\tgraphGold\"\xd2\x01\n" +
	"\x1eCMsgDOTABroadcastTimelineEvent\x12]\n" +
	"\x05event\x18\x01 \x01(\x0e2!.protocol.EBroadcastTimelineEvent:$EBroadcastTimelineEvent_MatchStartedR\x05event\x12\x1c\n" +
	...
	"\rmax_raw_value\x18\x04 \x01(\rR\vmaxRawValue\"\x9d\n" +
	"\n" +
	"\x14CMsgInGamePrediction\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12K\n" +
	"\x04type\x18\x03 \x01(\x0e2..protocol.CMsgInGamePrediction.EPredictionType:\aGenericR\x04type\x12W\n" +
	"\x05group\x18\x04 \x01(\x0e26.protocol.CMsgInGamePrediction.ERandomSelectionGroup_t:\tEarlyGameR\x05group\x12\x1a\n" +
	"\bquestion\x18\x05 \x01(\tR\bquestion\x128\n" +
	"\achoices\x18\x06 \x03(\v2\x1e.protocol.CMsgPredictionChoiceR\achoices\x12'\n" +
	"\x0frequired_heroes\x18\a \x03(\tR\x0erequiredHeroes\x12\x1d\n" +
	"\n" +
	"query_name\x18\b \x01(\tR\tqueryName\x12P\n" +
	"\fquery_values\x18\t \x03(\v2-.protocol.CMsgInGamePrediction.QueryKeyValuesR\vqueryValues\x12t\n" +
	"\x16answer_resolution_type\x18\n" +
	" \x01(\x0e20.protocol.CMsgInGamePrediction.EResolutionType_t:\fInvalidQueryR\x14answerResolutionType\x12&\n" +
	"\x0fpoints_to_grant\x18\v \x01(\rR\rpointsToGrant\x12#\n" +
	"\rreward_action\x18\f \x01(\rR\frewardAction\x122\n" +
	"\x15debug_force_selection\x18\r \x01(\rR\x13debugForceSelection\x12\\\n" +
	"\x0eraw_value_type\x18\x0e \x01(\x0e2..protocol.CMsgInGamePrediction.ERawValueType_t:\x06NumberR\frawValueType\x1a:\n" +
	...
	"(in_game_prediction_voting_period_minutes\x18\x04 \x01(\rR#inGamePredictionVotingPeriodMinutes\x1a\xf4\t\n" +
	"\n" +
	"Prediction\x12[\n" +
	"\x04type\x18\x01 \x01(\x0e2>.protocol.CMsgDOTASeasonPredictions.Prediction.EPredictionType:\aGenericR\x04type\x12\x1a\n" +
	"\bquestion\x18\x02 \x01(\tR\bquestion\x128\n" +
	"\achoices\x18\x03 \x03(\v2\x1e.protocol.CMsgPredictionChoiceR\achoices\x12!\n" +
	...
	"\x06reward\x18\a \x01(\rR\x06reward\x12f\n" +
	"\vanswer_type\x18\b \x01(\x0e2:.protocol.CMsgDOTASeasonPredictions.Prediction.EAnswerType:\tSingleIntR\n" +
	"answerType\x12\x1b\n" +
	"\tanswer_id\x18\t \x01(\rR\banswerId\x12P\n" +
	"\aanswers\x18\n" +
	" \x03(\v26.protocol.CMsgDOTASeasonPredictions.Prediction.AnswersR\aanswers\x12\x1d\n" +
	"\n" +
	...
	"\x17use_answer_value_ranges\x18\x10 \x01(\bR\x14useAnswerValueRanges\x12D\n" +
	...
	"\freward_event\x18\x13 \x01(\x0e2\x10.protocol.EEvent:\rEVENT_ID_NONER\vrewardEvent\x1a&\n" +
	"\aAnswers\x12\x1b\n" +
	...
	"\bNoAnswer\x10\a\"\xeb\x01\n" +
	"\x18CMsgAvailablePredictions\x12_\n" +
	"\x11match_predictions\x18\x01 \x03(\v22.protocol.CMsgAvailablePredictions.MatchPredictionR\x10matchPredictions\x1an\n" +
	"\x0fMatchPrediction\x12\x19\n" +
	"\bmatch_id\x18\x01 \x01(\x04R\amatchId\x12@\n" +
	"\vpredictions\x18\x02 \x03(\v2\x1e.protocol.CMsgInGamePredictionR\vpredictions\"\xfa\x01\n" +
	"\x16CMsgLeagueWatchedGames\x12A\n" +
	"\aleagues\x18\x01 \x03(\v2'.protocol.CMsgLeagueWatchedGames.LeagueR\aleagues\x1a5\n" +
	"\x06Series\x12\x17\n" +
	"\anode_id\x18\x01 \x01(\rR\x06nodeId\x12\x12\n" +
	"\x04game\x18\x02 \x03(\rR\x04game\x1af\n" +
	"\x06League\x12\x1b\n" +
	"\tleague_id\x18\x01 \x01(\rR\bleagueId\x12?\n" +
	"\x06series\x18\x02 \x03(\v2'.protocol.CMsgLeagueWatchedGames.SeriesR\x06series\"\xef/\n" +
	"\rCMsgDOTAMatch\x12\x1a\n" +
	"\bduration\x18\x03 \x01(\rR\bduration\x12\x1c\n" +
	"\tstarttime\x18\x04 \x01(\aR\tstarttime\x128\n" +
	"\aplayers\x18\x05 \x03(\v2\x1e.protocol.CMsgDOTAMatch.PlayerR\aplayers\x12\x19\n" +
	...
	"\x12dire_team_complete\x18\x1c \x01(\rR\x10direTeamComplete\x12H\n" +
	"\tgame_mode\x18\x1f \x01(\x0e2\x17.protocol.DOTA_GameMode:\x12DOTA_GAMEMODE_NONER\bgameMode\x12>\n" +
	"\n" +
	"picks_bans\x18  \x03(\v2\x1f.protocol.CMatchHeroSelectEventR\tpicksBans\x12\"\n" +
	"\rmatch_seq_num\x18! \x01(\x04R\vmatchSeqNum\x12X\n" +
	"\freplay_state\x18\" \x01(\x0e2#.protocol.CMsgDOTAMatch.ReplayState:\x10REPLAY_AVAILABLER\vreplayState\x12(\n" +
	...
	"seriesType\x12]\n" +
	"\x14broadcaster_channels\x18+ \x03(\v2*.protocol.CMsgDOTAMatch.BroadcasterChannelR\x13broadcasterChannels\x12\x16\n" +
	"\x06engine\x18, \x01(\rR\x06engine\x12P\n" +
	"\x10custom_game_data\x18- \x01(\v2&.protocol.CMsgDOTAMatch.CustomGameDataR\x0ecustomGameData\x12\x1f\n" +
	...
	"\x0fdire_team_score\x181 \x01(\rR\rdireTeamScore\x12U\n" +
	"\rmatch_outcome\x182 \x01(\x0e2\x17.protocol.EMatchOutcome:\x17k_EMatchOutcome_UnknownR\fmatchOutcome\x12#\n" +
	...
	"\acoaches\x189 \x03(\v2\x1d.protocol.CMsgDOTAMatch.CoachR\acoaches\x1a\x8b\x1a\n" +
	"\x06Player\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12\x1f\n" +
	"\vplayer_slot\x18\x02 \x01(\rR\n" +
	"playerSlot\x12\x17\n" +
	"\ahero_id\x18\x03 \x01(\rR\x06heroId\x12\x19\n" +
	"\x06item_0\x18\x04 \x01(\x05:\x02-1R\x05item0\x12\x19\n" +
	"\x06item_1\x18\x05 \x01(\x05:\x02-1R\x05item1\x12\x19\n" +
	"\x06item_2\x18\x06 \x01(\x05:\x02-1R\x05item2\x12\x19\n" +
	"\x06item_3\x18\a \x01(\x05:\x02-1R\x05item3\x12\x19\n" +
	"\x06item_4\x18\b \x01(\x05:\x02-1R\x05item4\x12\x19\n" +
	"\x06item_5\x18\t \x01(\x05:\x02-1R\x05item5\x12\x19\n" +
	"\x06item_6\x18; \x01(\x05:\x02-1R\x05item6\x12\x19\n" +
	"\x06item_7\x18< \x01(\x05:\x02-1R\x05item7\x12\x19\n" +
	"\x06item_8\x18= \x01(\x05:\x02-1R\x05item8\x12\x19\n" +
	"\x06item_9\x18L \x01(\x05:\x02-1R\x05item9\x12<\n" +
	...
	"\x06misses\x18. \x01(\rR\x06misses\x12O\n" +
	"\x10ability_upgrades\x18/ \x03(\v2$.protocol.CMatchPlayerAbilityUpgradeR\x0fabilityUpgrades\x12e\n" +
	"\x1aadditional_units_inventory\x180 \x03(\v2'.protocol.CMatchAdditionalUnitInventoryR\x18additionalUnitsInventory\x12L\n" +
	"\x0fpermanent_buffs\x189 \x03(\v2#.protocol.CMatchPlayerPermanentBuffR\x0epermanentBuffs\x12\x19\n" +
	"\bpro_name\x18H \x01(\tR\aproName\x12\x1b\n" +
	"\treal_name\x18I \x01(\tR\brealName\x12W\n" +
	"\x10custom_game_data\x182 \x01(\v2-.protocol.CMsgDOTAMatch.Player.CustomGameDataR\x0ecustomGameData\x128\n" +
	...
	"\x1dhero_was_dota_plus_suggestion\x18E \x01(\bR\x19heroWasDotaPlusSuggestion\x12c\n" +
	"\x14hero_damage_received\x18C \x03(\v21.protocol.CMsgDOTAMatch.Player.HeroDamageReceivedR\x12heroDamageReceived\x12]\n" +
	"\x11hero_damage_dealt\x18O \x03(\v21.protocol.CMsgDOTAMatch.Player.HeroDamageReceivedR\x0fheroDamageDealt\x12!\n" +
	...
	"\x11outposts_captured\x18N \x01(\rR\x10outpostsCaptured\x12O\n" +
	"\vteam_number\x18P \x01(\x0e2\x16.protocol.DOTA_GC_TEAM:\x16DOTA_GC_TEAM_GOOD_GUYSR\n" +
	"teamNumber\x12\x1b\n" +
	"\tteam_slot\x18Q \x01(\rR\bteamSlot\x1aE\n" +
	"\x0eCustomGameData\x12\x1b\n" +
	"\tdota_team\x18\x01 \x01(\rR\bdotaTeam\x12\x16\n" +
	"\x06winner\x18\x02 \x01(\bR\x06winner\x1a\xc6\x01\n" +
	"\x12HeroDamageReceived\x12#\n" +
	"\rpre_reduction\x18\x01 \x01(\rR\fpreReduction\x12%\n" +
	"\x0epost_reduction\x18\x02 \x01(\rR\rpostReduction\x12d\n" +
	"\vdamage_type\x18\x03 \x01(\x0e2-.protocol.CMsgDOTAMatch.Player.HeroDamageType:\x14HERO_DAMAGE_PHYSICALR\n" +
	"damageType\"Y\n" +
	...
	"\x04name\x18\x02 \x01(\tR\x04name\x1a\xd4\x01\n" +
	"\x12BroadcasterChannel\x12!\n" +
	"\fcountry_code\x18\x01 \x01(\tR\vcountryCode\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12T\n" +
	"\x11broadcaster_infos\x18\x03 \x03(\v2'.protocol.CMsgDOTAMatch.BroadcasterInfoR\x10broadcasterInfos\x12#\n" +
	...
	"\n" +
	"\x14CMsgDOTABotDebugInfo\x126\n" +
	"\x04bots\x18\x01 \x03(\v2\".protocol.CMsgDOTABotDebugInfo.BotR\x04bots\x12/\n" +
	...
	"runeStatus\x1a\xe7\x05\n" +
	"\x03Bot\x12*\n" +
	"\x0fplayer_owner_id\x18\x01 \x01(\x05:\x02-1R\rplayerOwnerId\x12\x17\n" +
	"\ahero_id\x18\x02 \x01(\rR\x06heroId\x12\x1e\n" +
	"\n" +
	...
	" \x01(\x02R\rexecutionTime\x12=\n" +
	"\x05modes\x18\v \x03(\v2'.protocol.CMsgDOTABotDebugInfo.Bot.ModeR\x05modes\x12A\n" +
	"\x06action\x18\f \x01(\v2).protocol.CMsgDOTABotDebugInfo.Bot.ActionR\x06action\x1a\xb1\x01\n" +
	"\x04Mode\x12\x17\n" +
	"\amode_id\x18\x01 \x01(\rR\x06modeId\x12\x16\n" +
	"\x06desire\x18\x02 \x01(\x02R\x06desire\x12'\n" +
	"\rtarget_entity\x18\x03 \x01(\x05:\x02-1R\ftargetEntity\x12\x19\n" +
	...
	"winPercent\x12%\n" +
	"\x0elongest_streak\x18\x03 \x01(\rR\rlongestStreak\"\xb4\x03\n" +
	"\x13CMsgRecentMatchInfo\x12\x19\n" +
	"\bmatch_id\x18\x01 \x01(\x04R\amatchId\x12H\n" +
	"\tgame_mode\x18\x02 \x01(\x0e2\x17.protocol.DOTA_GameMode:\x12DOTA_GAMEMODE_NONER\bgameMode\x12\x14\n" +
	...
	"playerSlot\x12U\n" +
	"\rmatch_outcome\x18\b \x01(\x0e2\x17.protocol.EMatchOutcome:\x17k_EMatchOutcome_UnknownR\fmatchOutcome\x12\x1c\n" +
	...
	"teamNumber\"\x87\x02\n" +
	"\rCMsgMatchTips\x125\n" +
	"\x04tips\x18\x02 \x03(\v2!.protocol.CMsgMatchTips.SingleTipR\x04tips\x1a\xbe\x01\n" +
	"\tSingleTip\x12*\n" +
	...
	"\bevent_id\x18\x04 \x01(\x0e2\x10.protocol.EEvent:\rEVENT_ID_NONER\aeventId\"\xf4\v\n" +
	"\x14CMsgDOTAMatchMinimal\x12\x19\n" +
	"\bmatch_id\x18\x01 \x01(\x04R\amatchId\x12\x1d\n" +
	"\n" +
	"start_time\x18\x02 \x01(\aR\tstartTime\x12\x1a\n" +
	"\bduration\x18\x03 \x01(\rR\bduration\x12H\n" +
	"\tgame_mode\x18\x04 \x01(\x0e2\x17.protocol.DOTA_GameMode:\x12DOTA_GAMEMODE_NONER\bgameMode\x12?\n" +
	"\aplayers\x18\x06 \x03(\v2%.protocol.CMsgDOTAMatchMinimal.PlayerR\aplayers\x12@\n" +
	"\atourney\x18\a \x01(\v2&.protocol.CMsgDOTAMatchMinimal.TourneyR\atourney\x12U\n" +
	"\rmatch_outcome\x18\b \x01(\x0e2\x17.protocol.EMatchOutcome:\x17k_EMatchOutcome_UnknownR\fmatchOutcome\x12#\n" +
	"\rradiant_score\x18\t \x01(\rR\fradiantScore\x12\x1d\n" +
	"\n" +
	"dire_score\x18\n" +
	" \x01(\rR\tdireScore\x12\x1d\n" +
	"\n" +
	"lobby_type\x18\v \x01(\rR\tlobbyType\x1a\xc1\x02\n" +
	"\x06Player\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12\x17\n" +
	"\ahero_id\x18\x02 \x01(\rR\x06heroId\x12\x14\n" +
	"\x05kills\x18\x03 \x01(\rR\x05kills\x12\x16\n" +
	"\x06deaths\x18\x04 \x01(\rR\x06deaths\x12\x18\n" +
	...
	"\x05level\x18\t \x01(\rR\x05level\x12O\n" +
	"\vteam_number\x18\n" +
	" \x01(\x0e2\x16.protocol.DOTA_GC_TEAM:\x16DOTA_GC_TEAM_GOOD_GUYSR\n" +
	...
	"\x0fquantity_change\x18\x02 \x01(\x05R\x0equantityChange\"\xfa\x01\n" +
	"\x18CMsgMatchConsumableUsage\x12f\n" +
	"\x17player_consumables_used\x18\x01 \x03(\v2..protocol.CMsgMatchConsumableUsage.PlayerUsageR\x15playerConsumablesUsed\x1av\n" +
	"\vPlayerUsage\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12H\n" +
	"\x10consumables_used\x18\x02 \x03(\v2\x1d.protocol.CMsgConsumableUsageR\x0fconsumablesUsed\"\xed\x01\n" +
	"\x1aCMsgMatchEventActionGrants\x12V\n" +
	"\rplayer_grants\x18\x01 \x03(\v21.protocol.CMsgMatchEventActionGrants.PlayerGrantsR\fplayerGrants\x1aw\n" +
	"\fPlayerGrants\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12H\n" +
	"\x0factions_granted\x18\x03 \x03(\v2\x1f.protocol.CMsgPendingEventAwardR\x0eactionsGranted\"\x96\x01\n" +
	...
	"\x11disable_whitelist\x18\x03 \x01(\bR\x10disableWhitelist\"\xb2\x02\n" +
	"\x1eCMsgCustomGameWhitelistForEdit\x12d\n" +
	"\x11whitelist_entries\x18\x01 \x03(\v27.protocol.CMsgCustomGameWhitelistForEdit.WhitelistEntryR\x10whitelistEntries\x1a\xa9\x01\n" +
	"\x0eWhitelistEntry\x12$\n" +
	"\x0ecustom_game_id\x18\x01 \x01(\x04R\fcustomGameId\x12q\n" +
	"\x0fwhitelist_state\x18\x02 \x01(\x0e2#.protocol.ECustomGameWhitelistState:#CUSTOM_GAME_WHITELIST_STATE_UNKNOWNR\x0ewhitelistState\"\xe3\x01\n" +
	...
	"\ahero_id\x18\x05 \x01(\rR\x06heroId\x12\x14\n" +
	...
	"\vmatch_count\x18\x02 \x01(\rR\n" +
	"matchCount\"\xa9\x04\n" +
	"\x1fCMsgPlayerRecentAccomplishments\x12P\n" +
	"\x0frecent_outcomes\x18\x01 \x01(\v2'.protocol.CMsgPlayerRecentMatchOutcomesR\x0erecentOutcomes\x12B\n" +
	"\ftotal_record\x18\x02 \x01(\v2\x1f.protocol.CMsgPlayerMatchRecordR\vtotalRecord\x12+\n" +
	"\x11prediction_streak\x18\x03 \x01(\rR\x10predictionStreak\x124\n" +
	"\x16plus_prediction_streak\x18\x04 \x01(\rR\x14plusPredictionStreak\x12K\n" +
	"\x0frecent_commends\x18\x05 \x01(\v2\".protocol.CMsgPlayerRecentCommendsR\x0erecentCommends\x122\n" +
	"\x15first_match_timestamp\x18\x06 \x01(\rR\x13firstMatchTimestamp\x12B\n" +
	"\n" +
	"last_match\x18\a \x01(\v2#.protocol.CMsgPlayerRecentMatchInfoR\tlastMatch\x12H\n" +
	"\vrecent_mvps\x18\b \x01(\v2'.protocol.CMsgPlayerRecentMatchOutcomesR\n" +
	"recentMvps\"\xff\x01\n" +
	"#CMsgPlayerHeroRecentAccomplishments\x12P\n" +
	"\x0frecent_outcomes\x18\x01 \x01(\v2'.protocol.CMsgPlayerRecentMatchOutcomesR\x0erecentOutcomes\x12B\n" +
	"\ftotal_record\x18\x02 \x01(\v2\x1f.protocol.CMsgPlayerMatchRecordR\vtotalRecord\x12B\n" +
	"\n" +
	"last_match\x18\x03 \x01(\v2#.protocol.CMsgPlayerRecentMatchInfoR\tlastMatch\"\xdf\x01\n" +
	"\x19CMsgRecentAccomplishments\x12`\n" +
	"\x16player_accomplishments\x18\x01 \x01(\v2).protocol.CMsgPlayerRecentAccomplishmentsR\x15playerAccomplishments\x12`\n" +
	"\x14hero_accomplishments\x18\x02 \x01(\v2-.protocol.CMsgPlayerHeroRecentAccomplishmentsR\x13heroAccomplishments\"j\n" +
	"0CMsgServerToGCRequestPlayerRecentAccomplishments\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12\x17\n" +
	"\ahero_id\x18\x02 \x01(\rR\x06heroId\"\xe2\x02\n" +
	...
	"\x16num_additional_players\x18\x04 \x01(\rR\x14numAdditionalPlayers\"\xb0\x03\n" +
	"0CMsgGCtoGCAssociatedExploiterAccountInfoResponse\x12^\n" +
	"\baccounts\x18\x01 \x03(\v2B.protocol.CMsgGCtoGCAssociatedExploiterAccountInfoResponse.AccountR\baccounts\x1a\x9b\x02\n" +
	"\aAccount\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12,\n" +
	...
	"\x0ealready_banned\x18\a \x01(\bR\ralreadyBanned\"\x95\x03\n" +
	"\x10CMsgPullTabsData\x125\n" +
	"\x05slots\x18\x01 \x03(\v2\x1f.protocol.CMsgPullTabsData.SlotR\x05slots\x12>\n" +
	"\bjackpots\x18\x02 \x03(\v2\".protocol.CMsgPullTabsData.JackpotR\bjackpots\x12\x1d\n" +
	"\n" +
	...
	"\ahero_id\x18\x03 \x01(\rR\x06heroId\x12\x1b\n" +
	...
	"\ahero_id\x18\x03 \x01(\rR\x06heroId\"\xbc\x03\n" +
	"\x12CMsgUnderDraftData\x12G\n" +
	"\vbench_slots\x18\x01 \x03(\v2&.protocol.CMsgUnderDraftData.BenchSlotR\n" +
	"benchSlots\x12D\n" +
	"\n" +
	"shop_slots\x18\x02 \x03(\v2%.protocol.CMsgUnderDraftData.ShopSlotR\tshopSlots\x12\x12\n" +
	...
	"\x06active\x18\x03 \x01(\rR\x06active\"\xc3\x02\n" +
	"\x16CMsgDOTATriviaQuestion\x12\x1f\n" +
	"\vquestion_id\x18\x01 \x01(\rR\n" +
	"questionId\x12l\n" +
	"\bcategory\x18\x02 \x01(\x0e2%.protocol.EDOTATriviaQuestionCategory:)k_EDOTATriviaQuestionCategory_AbilityIconR\bcategory\x12\x1c\n" +
	...
	"\toperation\x18\x03 \x01(\rR\toperation\"\xa5\x02\n" +
	...
	"headingLoc\x12A\n" +
	"\abonuses\x18\x06 \x03(\v2'.protocol.CMsgGameDataSpecialValueBonusR\abonuses\x12!\n" +
	"\fvalues_shard\x18\a \x03(\x02R\vvaluesShard\x12%\n" +
	"\x0evalues_scepter\x18\b \x03(\x02R\rvaluesScepter\"\xb5\n" +
	"\n" +
	"\x19CMsgGameDataAbilityOrItem\x12\x12\n" +
	"\x02id\x18\x01 \x01(\x05:\x02-1R\x02id\x12\x12\n" +
	...
	"\fhealth_costs\x18& \x03(\rR\vhealthCosts\x12J\n" +
	"\x0especial_values\x18( \x03(\v2#.protocol.CMsgGameDataSpecialValuesR\rspecialValues\x12\x17\n" +
	...
	"\x1bability_is_granted_by_shard\x18? \x01(\bR\x17abilityIsGrantedByShard\x12\x1b\n" +
	...
	"\fitem_quality\x18U \x01(\rR\vitemQuality\"\xf9\b\n" +
	...
	"\n" +
	"mana_regen\x18& \x01(\x02R\tmanaRegen\x12A\n" +
	"\tabilities\x18( \x03(\v2#.protocol.CMsgGameDataAbilityOrItemR\tabilities\x12=\n" +
	"\atalents\x18) \x03(\v2#.protocol.CMsgGameDataAbilityOrItemR\atalents\"Z\n" +
	"\x15CMsgGameDataAbilities\x12A\n" +
	"\tabilities\x18\x01 \x03(\v2#.protocol.CMsgGameDataAbilityOrItemR\tabilities\"N\n" +
	"\x11CMsgGameDataItems\x129\n" +
	"\x05items\x18\x01 \x03(\v2#.protocol.CMsgGameDataAbilityOrItemR\x05items\"H\n" +
	"\x12CMsgGameDataHeroes\x122\n" +
	"\x06heroes\x18\x01 \x03(\v2\x1a.protocol.CMsgGameDataHeroR\x06heroes\"\x90\x02\n" +
	"\x14CMsgGameDataHeroList\x12?\n" +
	"\x06heroes\x18\x01 \x03(\v2'.protocol.CMsgGameDataHeroList.HeroInfoR\x06heroes\x1a\xb6\x01\n" +
	"\bHeroInfo\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x19\n" +
	...
	"\ritemabilities\x18\x01 \x03(\v25.protocol.CMsgGameDataItemAbilityList.ItemAbilityInfoR\ritemabilities\x1a\xaa\x01\n" +
	"\x0fItemAbilityInfo\x12\x12\n" +
	"\x02id\x18\x01 \x01(\x05:\x02-1R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x19\n" +
	"\bname_loc\x18\x03 \x01(\tR\anameLoc\x12(\n" +
	"\x10name_english_loc\x18\x04 \x01(\tR\x0enameEnglishLoc\x12*\n" +
	"\x11neutral_item_tier\x18\x05 \x01(\x05R\x0fneutralItemTier\"K\n" +
	"\x19CMsgLobbyAbilityDraftData\x12.\n" +
	"\x13shuffle_draft_order\x18\x01 \x01(\bR\x11shuffleDraftOrder\"\xa7\x02\n" +
	"\x18CSOEconItemDropRateBonus\x12#\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rB\x04\x80\xa6\x1d\x01R\taccountId\x12'\n" +
	"\x0fexpiration_date\x18\x02 \x01(\aR\x0eexpirationDate\x12\x1a\n" +
	"\x05bonus\x18\x03 \x01(\x02B\x04\x80\xa6\x1d\x01R\x05bonus\x12\x1f\n" +
	...
	"\fbooster_type\x18\b \x01(\rB\x04\x80\xa6\x1d\x01R\vboosterType\"\xad\x02\n" +
	...
	"\n" +
	"depth_bias\x18\n" +
	" \x01(\rR\tdepthBias\"\x96\x02\n" +
	"\x13CMsgStickerbookPage\x12\x19\n" +
	"\bpage_num\x18\x01 \x01(\rR\apageNum\x12:\n" +
	"\bevent_id\x18\x02 \x01(\x0e2\x10.protocol.EEvent:\rEVENT_ID_NONER\aeventId\x12\x17\n" +
	"\ateam_id\x18\x03 \x01(\rR\x06teamId\x12<\n" +
	"\bstickers\x18\x04 \x03(\v2 .protocol.CMsgStickerbookStickerR\bstickers\x12Q\n" +
	"\tpage_type\x18\x05 \x01(\x0e2\x1e.protocol.EStickerbookPageType:\x14STICKER_PAGE_GENERICR\bpageType\"I\n" +
	"$CMsgStickerbookTeamPageOrderSequence\x12!\n" +
	"\fpage_numbers\x18\x01 \x03(\rR\vpageNumbers\"\xdb\x01\n" +
	"\x0fCMsgStickerbook\x123\n" +
	"\x05pages\x18\x01 \x03(\v2\x1d.protocol.CMsgStickerbookPageR\x05pages\x12g\n" +
	"\x18team_page_order_sequence\x18\x02 \x01(\v2..protocol.CMsgStickerbookTeamPageOrderSequenceR\x15teamPageOrderSequence\x12*\n" +
	"\x11favorite_page_num\x18\x03 \x01(\rR\x0ffavoritePageNum\"\x8a\x01\n" +
	"\x0fCMsgStickerHero\x12\x17\n" +
	"\ahero_id\x18\x01 \x01(\rR\x06heroId\x12\x1e\n" +
	"\vitem_def_id\x18\x02 \x01(\rR\titemDefId\x12\x18\n" +
	"\aquality\x18\x03 \x01(\rR\aquality\x12$\n" +
	"\x0esource_item_id\x18\x04 \x01(\x04R\fsourceItemId\"F\n" +
	"\x11CMsgStickerHeroes\x121\n" +
	"\x06heroes\x18\x01 \x03(\v2\x19.protocol.CMsgStickerHeroR\x06heroes\"\x83\x01\n" +
	"\x11CMsgHeroRoleStats\x120\n" +
	"\x14lane_selection_flags\x18\x01 \x01(\rR\x12laneSelectionFlags\x12\x1f\n" +
	"\vmatch_count\x18\x02 \x01(\rR\n" +
	"matchCount\x12\x1b\n" +
	"\twin_count\x18\x03 \x01(\rR\bwinCount\"l\n" +
	"\x15CMsgHeroRoleHeroStats\x12\x17\n" +
	"\ahero_id\x18\x01 \x01(\rR\x06heroId\x12:\n" +
	"\n" +
	"role_stats\x18\x02 \x03(\v2\x1b.protocol.CMsgHeroRoleStatsR\troleStats\"t\n" +
	"\x15CMsgHeroRoleRankStats\x12\x1b\n" +
	"\trank_tier\x18\x01 \x01(\rR\brankTier\x12>\n" +
	"\n" +
	"hero_stats\x18\x02 \x03(\v2\x1f.protocol.CMsgHeroRoleHeroStatsR\theroStats\"\xa9\x01\n" +
	...
	"\n" +
	"rank_stats\x18\x03 \x03(\v2\x1f.protocol.CMsgHeroRoleRankStatsR\trankStats\"\xb3\x03\n" +
	...
	" \x01(\x04R\x11shieldRunesGained\"\xd0\x01\n" +
	"\x12CMsgGlobalMapStats\x128\n" +
	"\acurrent\x18\x01 \x01(\v2\x1e.protocol.CMsgMapStatsSnapshotR\acurrent\x12A\n" +
	"\fwindow_start\x18\x02 \x01(\v2\x1e.protocol.CMsgMapStatsSnapshotR\vwindowStart\x12=\n" +
	"\n" +
	...
	"\x12tracked_stat_value\x18\x02 \x01(\x05R\x10trackedStatValue*U\n" +
	...
	"\x13STICKER_PAGE_TALENT\x10\x02B\rZ\v./;protocol"
...
var file_dota_gcmessages_common_proto_enumTypes = make([]protoimpl.EnumInfo, 24)
var file_dota_gcmessages_common_proto_msgTypes = make([]protoimpl.MessageInfo, 153)
var file_dota_gcmessages_common_proto_goTypes = []any{
	...
	(CMsgDOTAProfileCard_EStatID)(0),                                        // 11: protocol.CMsgDOTAProfileCard.EStatID
	(CMsgGCRerollPlayerChallengeResponse_EResult)(0),                        // 12: protocol.CMsgGCRerollPlayerChallengeResponse.EResult
	(CMsgDOTARealtimeGameStats_GraphDataEStat)(0),                           // 13: protocol.CMsgDOTARealtimeGameStats.GraphData.eStat
	(CMsgDOTARealtimeGameStats_GraphDataELocation)(0),                       // 14: protocol.CMsgDOTARealtimeGameStats.GraphData.eLocation
	(CMsgInGamePrediction_ERawValueTypeT)(0),                                // 15: protocol.CMsgInGamePrediction.ERawValueType_t
	(CMsgInGamePrediction_EPredictionType)(0),                               // 16: protocol.CMsgInGamePrediction.EPredictionType
	(CMsgInGamePrediction_EResolutionTypeT)(0),                              // 17: protocol.CMsgInGamePrediction.EResolutionType_t
	(CMsgInGamePrediction_ERandomSelectionGroupT)(0),                        // 18: protocol.CMsgInGamePrediction.ERandomSelectionGroup_t
	(CMsgDOTASeasonPredictions_Prediction_EPredictionType)(0),               // 19: protocol.CMsgDOTASeasonPredictions.Prediction.EPredictionType
	(CMsgDOTASeasonPredictions_Prediction_EAnswerType)(0),                   // 20: protocol.CMsgDOTASeasonPredictions.Prediction.EAnswerType
	(CMsgDOTAMatch_ReplayState)(0),                                          // 21: protocol.CMsgDOTAMatch.ReplayState
	(CMsgDOTAMatch_Player_HeroDamageType)(0),                                // 22: protocol.CMsgDOTAMatch.Player.HeroDamageType
	(CMsgServerToGCRequestPlayerRecentAccomplishmentsResponse_EResponse)(0), // 23: protocol.CMsgServerToGCRequestPlayerRecentAccomplishmentsResponse.EResponse
	(*CSODOTAGameAccountClient)(nil),                                        // 24: protocol.CSODOTAGameAccountClient
	(*CSODOTAGameAccountPlus)(nil),                                          // 25: protocol.CSODOTAGameAccountPlus
	(*CMsgLobbyFeaturedGamemodeProgress)(nil),                               // 26: protocol.CMsgLobbyFeaturedGamemodeProgress
	(*CMsgBattleCupVictory)(nil),                                            // 27: protocol.CMsgBattleCupVictory
	(*CMsgLobbyBattleCupVictoryList)(nil),                                   // 28: protocol.CMsgLobbyBattleCupVictoryList
	(*CMsgDOTABroadcastNotification)(nil),                                   // 29: protocol.CMsgDOTABroadcastNotification
	(*CProtoItemHeroStatue)(nil),                                            // 30: protocol.CProtoItemHeroStatue
	(*CMatchPlayerAbilityUpgrade)(nil),                                      // 31: protocol.CMatchPlayerAbilityUpgrade
	(*CMatchPlayerTimedCustomStat)(nil),                                     // 32: protocol.CMatchPlayerTimedCustomStat
	(*CMatchPlayerTimedStats)(nil),                                          // 33: protocol.CMatchPlayerTimedStats
	(*CMatchTeamTimedStats)(nil),                                            // 34: protocol.CMatchTeamTimedStats
	(*CMatchAdditionalUnitInventory)(nil),                                   // 35: protocol.CMatchAdditionalUnitInventory
	(*CMatchPlayerPermanentBuff)(nil),                                       // 36: protocol.CMatchPlayerPermanentBuff
	(*CMatchHeroSelectEvent)(nil),                                           // 37: protocol.CMatchHeroSelectEvent
	(*CMatchClip)(nil),                                                      // 38: protocol.CMatchClip
	(*CPartySearchClientParty)(nil),                                         // 39: protocol.CPartySearchClientParty
	(*CMsgDOTAHasItemQuery)(nil),                                            // 40: protocol.CMsgDOTAHasItemQuery
	(*CMsgDOTAHasItemResponse)(nil),                                         // 41: protocol.CMsgDOTAHasItemResponse
	(*CMsgGCGetPlayerCardItemInfo)(nil),                                     // 42: protocol.CMsgGCGetPlayerCardItemInfo
	(*CMsgGCGetPlayerCardItemInfoResponse)(nil),                             // 43: protocol.CMsgGCGetPlayerCardItemInfoResponse
	(*CSODOTAMapLocationState)(nil),                                         // 44: protocol.CSODOTAMapLocationState
	(*CMsgLeagueAdminList)(nil),                                             // 45: protocol.CMsgLeagueAdminList
	(*CMsgDOTAProfileCard)(nil),                                             // 46: protocol.CMsgDOTAProfileCard
	(*CSODOTAPlayerChallenge)(nil),                                          // 47: protocol.CSODOTAPlayerChallenge
	(*CMsgClientToGCRerollPlayerChallenge)(nil),                             // 48: protocol.CMsgClientToGCRerollPlayerChallenge
	(*CMsgGCRerollPlayerChallengeResponse)(nil),                             // 49: protocol.CMsgGCRerollPlayerChallengeResponse
	(*CMsgGCTopCustomGamesList)(nil),                                        // 50: protocol.CMsgGCTopCustomGamesList
	(*CMsgDOTARealtimeGameStats)(nil),                                       // 51: protocol.CMsgDOTARealtimeGameStats
	(*CMsgDOTARealtimeGameStatsTerse)(nil),                                  // 52: protocol.CMsgDOTARealtimeGameStatsTerse
	(*CMsgDOTABroadcastTimelineEvent)(nil),                                  // 53: protocol.CMsgDOTABroadcastTimelineEvent
	(*CMsgGCToClientMatchGroupsVersion)(nil),                                // 54: protocol.CMsgGCToClientMatchGroupsVersion
	(*CMsgDOTASDOHeroStatsHistory)(nil),                                     // 55: protocol.CMsgDOTASDOHeroStatsHistory
	(*CMsgPredictionChoice)(nil),                                            // 56: protocol.CMsgPredictionChoice
	(*CMsgInGamePrediction)(nil),                                            // 57: protocol.CMsgInGamePrediction
	(*CMsgDOTASeasonPredictions)(nil),                                       // 58: protocol.CMsgDOTASeasonPredictions
	(*CMsgAvailablePredictions)(nil),                                        // 59: protocol.CMsgAvailablePredictions
	(*CMsgLeagueWatchedGames)(nil),                                          // 60: protocol.CMsgLeagueWatchedGames
	(*CMsgDOTAMatch)(nil),                                                   // 61: protocol.CMsgDOTAMatch
	(*CMsgPlayerCard)(nil),                                                  // 62: protocol.CMsgPlayerCard
	(*CMsgDOTAFantasyPlayerStats)(nil),                                      // 63: protocol.CMsgDOTAFantasyPlayerStats
	(*CMsgDOTAFantasyPlayerMatchStats)(nil),                                 // 64: protocol.CMsgDOTAFantasyPlayerMatchStats
	(*CMsgDOTABotDebugInfo)(nil),                                            // 65: protocol.CMsgDOTABotDebugInfo
	(*CMsgSuccessfulHero)(nil),                                              // 66: protocol.CMsgSuccessfulHero
	(*CMsgRecentMatchInfo)(nil),                                             // 67: protocol.CMsgRecentMatchInfo
	(*CMsgMatchTips)(nil),                                                   // 68: protocol.CMsgMatchTips
	(*CMsgDOTAMatchMinimal)(nil),                                            // 69: protocol.CMsgDOTAMatchMinimal
	(*CMsgConsumableUsage)(nil),                                             // 70: protocol.CMsgConsumableUsage
	(*CMsgMatchConsumableUsage)(nil),                                        // 71: protocol.CMsgMatchConsumableUsage
	(*CMsgMatchEventActionGrants)(nil),                                      // 72: protocol.CMsgMatchEventActionGrants
	(*CMsgCustomGameWhitelist)(nil),                                         // 73: protocol.CMsgCustomGameWhitelist
	(*CMsgCustomGameWhitelistForEdit)(nil),                                  // 74: protocol.CMsgCustomGameWhitelistForEdit
	(*CMsgPlayerRecentMatchInfo)(nil),                                       // 75: protocol.CMsgPlayerRecentMatchInfo
	(*CMsgPlayerMatchRecord)(nil),                                           // 76: protocol.CMsgPlayerMatchRecord
	(*CMsgPlayerRecentMatchOutcomes)(nil),                                   // 77: protocol.CMsgPlayerRecentMatchOutcomes
	(*CMsgPlayerRecentCommends)(nil),                                        // 78: protocol.CMsgPlayerRecentCommends
	(*CMsgPlayerRecentAccomplishments)(nil),                                 // 79: protocol.CMsgPlayerRecentAccomplishments
	(*CMsgPlayerHeroRecentAccomplishments)(nil),                             // 80: protocol.CMsgPlayerHeroRecentAccomplishments
	(*CMsgRecentAccomplishments)(nil),                                       // 81: protocol.CMsgRecentAccomplishments
	(*CMsgServerToGCRequestPlayerRecentAccomplishments)(nil),                // 82: protocol.CMsgServerToGCRequestPlayerRecentAccomplishments
	(*CMsgServerToGCRequestPlayerRecentAccomplishmentsResponse)(nil),        // 83: protocol.CMsgServerToGCRequestPlayerRecentAccomplishmentsResponse
	(*CMsgArcanaVoteMatchVotes)(nil),                                        // 84: protocol.CMsgArcanaVoteMatchVotes
	(*CMsgGCtoGCAssociatedExploiterAccountInfo)(nil),                        // 85: protocol.CMsgGCtoGCAssociatedExploiterAccountInfo
	(*CMsgGCtoGCAssociatedExploiterAccountInfoResponse)(nil),                // 86: protocol.CMsgGCtoGCAssociatedExploiterAccountInfoResponse
	(*CMsgPullTabsData)(nil),                                                // 87: protocol.CMsgPullTabsData
	(*CMsgUnderDraftData)(nil),                                              // 88: protocol.CMsgUnderDraftData
	(*CMsgPlayerTitleData)(nil),                                             // 89: protocol.CMsgPlayerTitleData
	(*CMsgDOTATriviaQuestion)(nil),                                          // 90: protocol.CMsgDOTATriviaQuestion
	(*CMsgDOTATriviaQuestionAnswersSummary)(nil),                            // 91: protocol.CMsgDOTATriviaQuestionAnswersSummary
	(*CMsgGameDataSpecialValueBonus)(nil),                                   // 92: protocol.CMsgGameDataSpecialValueBonus
	(*CMsgGameDataSpecialValues)(nil),                                       // 93: protocol.CMsgGameDataSpecialValues
	(*CMsgGameDataAbilityOrItem)(nil),                                       // 94: protocol.CMsgGameDataAbilityOrItem
	(*CMsgGameDataHero)(nil),                                                // 95: protocol.CMsgGameDataHero
	(*CMsgGameDataAbilities)(nil),                                           // 96: protocol.CMsgGameDataAbilities
	(*CMsgGameDataItems)(nil),                                               // 97: protocol.CMsgGameDataItems
	(*CMsgGameDataHeroes)(nil),                                              // 98: protocol.CMsgGameDataHeroes
	(*CMsgGameDataHeroList)(nil),                                            // 99: protocol.CMsgGameDataHeroList
	(*CMsgGameDataItemAbilityList)(nil),                                     // 100: protocol.CMsgGameDataItemAbilityList
	(*CMsgLobbyAbilityDraftData)(nil),                                       // 101: protocol.CMsgLobbyAbilityDraftData
	(*CSOEconItemDropRateBonus)(nil),                                        // 102: protocol.CSOEconItemDropRateBonus
	(*CSOEconItemTournamentPassport)(nil),                                   // 103: protocol.CSOEconItemTournamentPassport
	(*CMsgStickerbookSticker)(nil),                                          // 104: protocol.CMsgStickerbookSticker
	(*CMsgStickerbookPage)(nil),                                             // 105: protocol.CMsgStickerbookPage
	(*CMsgStickerbookTeamPageOrderSequence)(nil),                            // 106: protocol.CMsgStickerbookTeamPageOrderSequence
	(*CMsgStickerbook)(nil),                                                 // 107: protocol.CMsgStickerbook
	(*CMsgStickerHero)(nil),                                                 // 108: protocol.CMsgStickerHero
	(*CMsgStickerHeroes)(nil),                                               // 109: protocol.CMsgStickerHeroes
	(*CMsgHeroRoleStats)(nil),                                               // 110: protocol.CMsgHeroRoleStats
	(*CMsgHeroRoleHeroStats)(nil),                                           // 111: protocol.CMsgHeroRoleHeroStats
	(*CMsgHeroRoleRankStats)(nil),                                           // 112: protocol.CMsgHeroRoleRankStats
	(*CMsgHeroRoleAllRanksStats)(nil),                                       // 113: protocol.CMsgHeroRoleAllRanksStats
	(*CMsgMapStatsSnapshot)(nil),                                            // 114: protocol.CMsgMapStatsSnapshot
	(*CMsgGlobalMapStats)(nil),                                              // 115: protocol.CMsgGlobalMapStats
	(*CMsgTrackedStat)(nil),                                                 // 116: protocol.CMsgTrackedStat
	(*CSODOTAGameAccountClient_RoleHandicap)(nil),                           // 117: protocol.CSODOTAGameAccountClient.RoleHandicap
	(*CMsgLobbyFeaturedGamemodeProgress_AccountProgress)(nil),               // 118: protocol.CMsgLobbyFeaturedGamemodeProgress.AccountProgress
	(*CMsgGCGetPlayerCardItemInfoResponse_PlayerCardInfo)(nil),              // 119: protocol.CMsgGCGetPlayerCardItemInfoResponse.PlayerCardInfo
	(*CMsgDOTAProfileCard_Slot)(nil),                                        // 120: protocol.CMsgDOTAProfileCard.Slot
	(*CMsgDOTAProfileCard_Slot_Trophy)(nil),                                 // 121: protocol.CMsgDOTAProfileCard.Slot.Trophy
	(*CMsgDOTAProfileCard_Slot_Stat)(nil),                                   // 122: protocol.CMsgDOTAProfileCard.Slot.Stat
	(*CMsgDOTAProfileCard_Slot_Item)(nil),                                   // 123: protocol.CMsgDOTAProfileCard.Slot.Item
	(*CMsgDOTAProfileCard_Slot_Hero)(nil),                                   // 124: protocol.CMsgDOTAProfileCard.Slot.Hero
	(*CMsgDOTAProfileCard_Slot_Emoticon)(nil),                               // 125: protocol.CMsgDOTAProfileCard.Slot.Emoticon
	(*CMsgDOTAProfileCard_Slot_Team)(nil),                                   // 126: protocol.CMsgDOTAProfileCard.Slot.Team
	(*CMsgDOTARealtimeGameStats_TeamDetails)(nil),                           // 127: protocol.CMsgDOTARealtimeGameStats.TeamDetails
	(*CMsgDOTARealtimeGameStats_ItemDetails)(nil),                           // 128: protocol.CMsgDOTARealtimeGameStats.ItemDetails
	(*CMsgDOTARealtimeGameStats_AbilityDetails)(nil),                        // 129: protocol.CMsgDOTARealtimeGameStats.AbilityDetails
	(*CMsgDOTARealtimeGameStats_HeroToHeroStats)(nil),                       // 130: protocol.CMsgDOTARealtimeGameStats.HeroToHeroStats
	(*CMsgDOTARealtimeGameStats_AbilityList)(nil),                           // 131: protocol.CMsgDOTARealtimeGameStats.AbilityList
	(*CMsgDOTARealtimeGameStats_PlayerDetails)(nil),                         // 132: protocol.CMsgDOTARealtimeGameStats.PlayerDetails
	(*CMsgDOTARealtimeGameStats_BuildingDetails)(nil),                       // 133: protocol.CMsgDOTARealtimeGameStats.BuildingDetails
	(*CMsgDOTARealtimeGameStats_KillDetails)(nil),                           // 134: protocol.CMsgDOTARealtimeGameStats.KillDetails
	(*CMsgDOTARealtimeGameStats_BroadcasterDetails)(nil),                    // 135: protocol.CMsgDOTARealtimeGameStats.BroadcasterDetails
	(*CMsgDOTARealtimeGameStats_PickBanDetails)(nil),                        // 136: protocol.CMsgDOTARealtimeGameStats.PickBanDetails
	(*CMsgDOTARealtimeGameStats_MatchDetails)(nil),                          // 137: protocol.CMsgDOTARealtimeGameStats.MatchDetails
	(*CMsgDOTARealtimeGameStats_GraphData)(nil),                             // 138: protocol.CMsgDOTARealtimeGameStats.GraphData
	(*CMsgDOTARealtimeGameStats_GraphData_LocationStats)(nil),               // 139: protocol.CMsgDOTARealtimeGameStats.GraphData.LocationStats
	(*CMsgDOTARealtimeGameStats_GraphData_TeamLocationStats)(nil),           // 140: protocol.CMsgDOTARealtimeGameStats.GraphData.TeamLocationStats
	(*CMsgDOTARealtimeGameStatsTerse_TeamDetails)(nil),                      // 141: protocol.CMsgDOTARealtimeGameStatsTerse.TeamDetails
	(*CMsgDOTARealtimeGameStatsTerse_PlayerDetails)(nil),                    // 142: protocol.CMsgDOTARealtimeGameStatsTerse.PlayerDetails
	(*CMsgDOTARealtimeGameStatsTerse_BuildingDetails)(nil),                  // 143: protocol.CMsgDOTARealtimeGameStatsTerse.BuildingDetails
	(*CMsgDOTARealtimeGameStatsTerse_PickBanDetails)(nil),                   // 144: protocol.CMsgDOTARealtimeGameStatsTerse.PickBanDetails
	(*CMsgDOTARealtimeGameStatsTerse_MatchDetails)(nil),                     // 145: protocol.CMsgDOTARealtimeGameStatsTerse.MatchDetails
	(*CMsgDOTARealtimeGameStatsTerse_GraphData)(nil),                        // 146: protocol.CMsgDOTARealtimeGameStatsTerse.GraphData
	(*CMsgInGamePrediction_QueryKeyValues)(nil),                             // 147: protocol.CMsgInGamePrediction.QueryKeyValues
	(*CMsgDOTASeasonPredictions_Prediction)(nil),                            // 148: protocol.CMsgDOTASeasonPredictions.Prediction
	(*CMsgDOTASeasonPredictions_Prediction_Answers)(nil),                    // 149: protocol.CMsgDOTASeasonPredictions.Prediction.Answers
	(*CMsgAvailablePredictions_MatchPrediction)(nil),                        // 150: protocol.CMsgAvailablePredictions.MatchPrediction
	(*CMsgLeagueWatchedGames_Series)(nil),                                   // 151: protocol.CMsgLeagueWatchedGames.Series
	(*CMsgLeagueWatchedGames_League)(nil),                                   // 152: protocol.CMsgLeagueWatchedGames.League
	(*CMsgDOTAMatch_Player)(nil),                                            // 153: protocol.CMsgDOTAMatch.Player
	(*CMsgDOTAMatch_BroadcasterInfo)(nil),                                   // 154: protocol.CMsgDOTAMatch.BroadcasterInfo
	(*CMsgDOTAMatch_BroadcasterChannel)(nil),                                // 155: protocol.CMsgDOTAMatch.BroadcasterChannel
	(*CMsgDOTAMatch_Coach)(nil),                                             // 156: protocol.CMsgDOTAMatch.Coach
	(*CMsgDOTAMatch_CustomGameData)(nil),                                    // 157: protocol.CMsgDOTAMatch.CustomGameData
	(*CMsgDOTAMatch_Player_CustomGameData)(nil),                             // 158: protocol.CMsgDOTAMatch.Player.CustomGameData
	(*CMsgDOTAMatch_Player_HeroDamageReceived)(nil),                         // 159: protocol.CMsgDOTAMatch.Player.HeroDamageReceived
	(*CMsgPlayerCard_StatModifier)(nil),                                     // 160: protocol.CMsgPlayerCard.StatModifier
	(*CMsgDOTABotDebugInfo_Bot)(nil),                                        // 161: protocol.CMsgDOTABotDebugInfo.Bot
	(*CMsgDOTABotDebugInfo_Bot_Mode)(nil),                                   // 162: protocol.CMsgDOTABotDebugInfo.Bot.Mode
	(*CMsgDOTABotDebugInfo_Bot_Action)(nil),                                 // 163: protocol.CMsgDOTABotDebugInfo.Bot.Action
	(*CMsgMatchTips_SingleTip)(nil),                                         // 164: protocol.CMsgMatchTips.SingleTip
	(*CMsgDOTAMatchMinimal_Player)(nil),                                     // 165: protocol.CMsgDOTAMatchMinimal.Player
	(*CMsgDOTAMatchMinimal_Tourney)(nil),                                    // 166: protocol.CMsgDOTAMatchMinimal.Tourney
	(*CMsgMatchConsumableUsage_PlayerUsage)(nil),                            // 167: protocol.CMsgMatchConsumableUsage.PlayerUsage
	(*CMsgMatchEventActionGrants_PlayerGrants)(nil),                         // 168: protocol.CMsgMatchEventActionGrants.PlayerGrants
	(*CMsgCustomGameWhitelistForEdit_WhitelistEntry)(nil),                   // 169: protocol.CMsgCustomGameWhitelistForEdit.WhitelistEntry
	(*CMsgGCtoGCAssociatedExploiterAccountInfoResponse_Account)(nil),        // 170: protocol.CMsgGCtoGCAssociatedExploiterAccountInfoResponse.Account
	(*CMsgPullTabsData_Slot)(nil),                                           // 171: protocol.CMsgPullTabsData.Slot
	(*CMsgPullTabsData_Jackpot)(nil),                                        // 172: protocol.CMsgPullTabsData.Jackpot
	(*CMsgUnderDraftData_BenchSlot)(nil),                                    // 173: protocol.CMsgUnderDraftData.BenchSlot
	(*CMsgUnderDraftData_ShopSlot)(nil),                                     // 174: protocol.CMsgUnderDraftData.ShopSlot
	(*CMsgGameDataHeroList_HeroInfo)(nil),                                   // 175: protocol.CMsgGameDataHeroList.HeroInfo
	(*CMsgGameDataItemAbilityList_ItemAbilityInfo)(nil),                     // 176: protocol.CMsgGameDataItemAbilityList.ItemAbilityInfo
	(EEvent)(0),                   // 177: protocol.EEvent
	(DOTA_GameMode)(0),            // 178: protocol.DOTA_GameMode
	(EMatchOutcome)(0),            // 179: protocol.EMatchOutcome
	(ELeagueRegion)(0),            // 180: protocol.ELeagueRegion
	(ELeaguePhase)(0),             // 181: protocol.ELeaguePhase
	(DOTA_GC_TEAM)(0),             // 182: protocol.DOTA_GC_TEAM
	(*CMsgPendingEventAward)(nil), // 183: protocol.CMsgPendingEventAward
}
var file_dota_gcmessages_common_proto_depIdxs = []int32{
	117, // 0: protocol.CSODOTAGameAccountClient.role_handicaps:type_name -> protocol.CSODOTAGameAccountClient.RoleHandicap
	118, // 1: protocol.CMsgLobbyFeaturedGamemodeProgress.accounts:type_name -> protocol.CMsgLobbyFeaturedGamemodeProgress.AccountProgress
	27,  // 2: protocol.CMsgLobbyBattleCupVictoryList.winners:type_name -> protocol.CMsgBattleCupVictory
	2,   // 3: protocol.CMatchPlayerTimedCustomStat.stat:type_name -> protocol.EDOTAMatchPlayerTimeCustomStat
	32,  // 4: protocol.CMatchPlayerTimedStats.custom_stats:type_name -> protocol.CMatchPlayerTimedCustomStat
	119, // 5: protocol.CMsgGCGetPlayerCardItemInfoResponse.player_card_infos:type_name -> protocol.CMsgGCGetPlayerCardItemInfoResponse.PlayerCardInfo
	120, // 6: protocol.CMsgDOTAProfileCard.slots:type_name -> protocol.CMsgDOTAProfileCard.Slot
	27,  // 7: protocol.CMsgDOTAProfileCard.recent_battle_cup_victory:type_name -> protocol.CMsgBattleCupVictory
	177, // 8: protocol.CMsgClientToGCRerollPlayerChallenge.event_id:type_name -> protocol.EEvent
	12,  // 9: protocol.CMsgGCRerollPlayerChallengeResponse.result:type_name -> protocol.CMsgGCRerollPlayerChallengeResponse.EResult
	137, // 10: protocol.CMsgDOTARealtimeGameStats.match:type_name -> protocol.CMsgDOTARealtimeGameStats.MatchDetails
	127, // 11: protocol.CMsgDOTARealtimeGameStats.teams:type_name -> protocol.CMsgDOTARealtimeGameStats.TeamDetails
	133, // 12: protocol.CMsgDOTARealtimeGameStats.buildings:type_name -> protocol.CMsgDOTARealtimeGameStats.BuildingDetails
	138, // 13: protocol.CMsgDOTARealtimeGameStats.graph_data:type_name -> protocol.CMsgDOTARealtimeGameStats.GraphData
	145, // 14: protocol.CMsgDOTARealtimeGameStatsTerse.match:type_name -> protocol.CMsgDOTARealtimeGameStatsTerse.MatchDetails
	141, // 15: protocol.CMsgDOTARealtimeGameStatsTerse.teams:type_name -> protocol.CMsgDOTARealtimeGameStatsTerse.TeamDetails
	143, // 16: protocol.CMsgDOTARealtimeGameStatsTerse.buildings:type_name -> protocol.CMsgDOTARealtimeGameStatsTerse.BuildingDetails
	146, // 17: protocol.CMsgDOTARealtimeGameStatsTerse.graph_data:type_name -> protocol.CMsgDOTARealtimeGameStatsTerse.GraphData
	4,   // 18: protocol.CMsgDOTABroadcastTimelineEvent.event:type_name -> protocol.EBroadcastTimelineEvent
	16,  // 19: protocol.CMsgInGamePrediction.type:type_name -> protocol.CMsgInGamePrediction.EPredictionType
	18,  // 20: protocol.CMsgInGamePrediction.group:type_name -> protocol.CMsgInGamePrediction.ERandomSelectionGroup_t
	56,  // 21: protocol.CMsgInGamePrediction.choices:type_name -> protocol.CMsgPredictionChoice
	147, // 22: protocol.CMsgInGamePrediction.query_values:type_name -> protocol.CMsgInGamePrediction.QueryKeyValues
	17,  // 23: protocol.CMsgInGamePrediction.answer_resolution_type:type_name -> protocol.CMsgInGamePrediction.EResolutionType_t
	15,  // 24: protocol.CMsgInGamePrediction.raw_value_type:type_name -> protocol.CMsgInGamePrediction.ERawValueType_t
	148, // 25: protocol.CMsgDOTASeasonPredictions.predictions:type_name -> protocol.CMsgDOTASeasonPredictions.Prediction
	57,  // 26: protocol.CMsgDOTASeasonPredictions.in_game_predictions:type_name -> protocol.CMsgInGamePrediction
	150, // 27: protocol.CMsgAvailablePredictions.match_predictions:type_name -> protocol.CMsgAvailablePredictions.MatchPrediction
	152, // 28: protocol.CMsgLeagueWatchedGames.leagues:type_name -> protocol.CMsgLeagueWatchedGames.League
	153, // 29: protocol.CMsgDOTAMatch.players:type_name -> protocol.CMsgDOTAMatch.Player
	178, // 30: protocol.CMsgDOTAMatch.game_mode:type_name -> protocol.DOTA_GameMode
	37,  // 31: protocol.CMsgDOTAMatch.picks_bans:type_name -> protocol.CMatchHeroSelectEvent
	21,  // 32: protocol.CMsgDOTAMatch.replay_state:type_name -> protocol.CMsgDOTAMatch.ReplayState
	155, // 33: protocol.CMsgDOTAMatch.broadcaster_channels:type_name -> protocol.CMsgDOTAMatch.BroadcasterChannel
	157, // 34: protocol.CMsgDOTAMatch.custom_game_data:type_name -> protocol.CMsgDOTAMatch.CustomGameData
	179, // 35: protocol.CMsgDOTAMatch.match_outcome:type_name -> protocol.EMatchOutcome
	156, // 36: protocol.CMsgDOTAMatch.coaches:type_name -> protocol.CMsgDOTAMatch.Coach
	160, // 37: protocol.CMsgPlayerCard.stat_modifier:type_name -> protocol.CMsgPlayerCard.StatModifier
	63,  // 38: protocol.CMsgDOTAFantasyPlayerMatchStats.matches:type_name -> protocol.CMsgDOTAFantasyPlayerStats
	161, // 39: protocol.CMsgDOTABotDebugInfo.bots:type_name -> protocol.CMsgDOTABotDebugInfo.Bot
	178, // 40: protocol.CMsgRecentMatchInfo.game_mode:type_name -> protocol.DOTA_GameMode
	179, // 41: protocol.CMsgRecentMatchInfo.match_outcome:type_name -> protocol.EMatchOutcome
	164, // 42: protocol.CMsgMatchTips.tips:type_name -> protocol.CMsgMatchTips.SingleTip
	178, // 43: protocol.CMsgDOTAMatchMinimal.game_mode:type_name -> protocol.DOTA_GameMode
	165, // 44: protocol.CMsgDOTAMatchMinimal.players:type_name -> protocol.CMsgDOTAMatchMinimal.Player
	166, // 45: protocol.CMsgDOTAMatchMinimal.tourney:type_name -> protocol.CMsgDOTAMatchMinimal.Tourney
	179, // 46: protocol.CMsgDOTAMatchMinimal.match_outcome:type_name -> protocol.EMatchOutcome
	167, // 47: protocol.CMsgMatchConsumableUsage.player_consumables_used:type_name -> protocol.CMsgMatchConsumableUsage.PlayerUsage
	168, // 48: protocol.CMsgMatchEventActionGrants.player_grants:type_name -> protocol.CMsgMatchEventActionGrants.PlayerGrants
	169, // 49: protocol.CMsgCustomGameWhitelistForEdit.whitelist_entries:type_name -> protocol.CMsgCustomGameWhitelistForEdit.WhitelistEntry
	77,  // 50: protocol.CMsgPlayerRecentAccomplishments.recent_outcomes:type_name -> protocol.CMsgPlayerRecentMatchOutcomes
	76,  // 51: protocol.CMsgPlayerRecentAccomplishments.total_record:type_name -> protocol.CMsgPlayerMatchRecord
	78,  // 52: protocol.CMsgPlayerRecentAccomplishments.recent_commends:type_name -> protocol.CMsgPlayerRecentCommends
	75,  // 53: protocol.CMsgPlayerRecentAccomplishments.last_match:type_name -> protocol.CMsgPlayerRecentMatchInfo
	77,  // 54: protocol.CMsgPlayerRecentAccomplishments.recent_mvps:type_name -> protocol.CMsgPlayerRecentMatchOutcomes
	77,  // 55: protocol.CMsgPlayerHeroRecentAccomplishments.recent_outcomes:type_name -> protocol.CMsgPlayerRecentMatchOutcomes
	76,  // 56: protocol.CMsgPlayerHeroRecentAccomplishments.total_record:type_name -> protocol.CMsgPlayerMatchRecord
	75,  // 57: protocol.CMsgPlayerHeroRecentAccomplishments.last_match:type_name -> protocol.CMsgPlayerRecentMatchInfo
	79,  // 58: protocol.CMsgRecentAccomplishments.player_accomplishments:type_name -> protocol.CMsgPlayerRecentAccomplishments
	80,  // 59: protocol.CMsgRecentAccomplishments.hero_accomplishments:type_name -> protocol.CMsgPlayerHeroRecentAccomplishments
	23,  // 60: protocol.CMsgServerToGCRequestPlayerRecentAccomplishmentsResponse.result:type_name -> protocol.CMsgServerToGCRequestPlayerRecentAccomplishmentsResponse.EResponse
	81,  // 61: protocol.CMsgServerToGCRequestPlayerRecentAccomplishmentsResponse.player_accomplishments:type_name -> protocol.CMsgRecentAccomplishments
	170, // 62: protocol.CMsgGCtoGCAssociatedExploiterAccountInfoResponse.accounts:type_name -> protocol.CMsgGCtoGCAssociatedExploiterAccountInfoResponse.Account
	171, // 63: protocol.CMsgPullTabsData.slots:type_name -> protocol.CMsgPullTabsData.Slot
	172, // 64: protocol.CMsgPullTabsData.jackpots:type_name -> protocol.CMsgPullTabsData.Jackpot
	173, // 65: protocol.CMsgUnderDraftData.bench_slots:type_name -> protocol.CMsgUnderDraftData.BenchSlot
	174, // 66: protocol.CMsgUnderDraftData.shop_slots:type_name -> protocol.CMsgUnderDraftData.ShopSlot
	6,   // 67: protocol.CMsgDOTATriviaQuestion.category:type_name -> protocol.EDOTATriviaQuestionCategory
	92,  // 68: protocol.CMsgGameDataSpecialValues.bonuses:type_name -> protocol.CMsgGameDataSpecialValueBonus
	93,  // 69: protocol.CMsgGameDataAbilityOrItem.special_values:type_name -> protocol.CMsgGameDataSpecialValues
	94,  // 70: protocol.CMsgGameDataHero.abilities:type_name -> protocol.CMsgGameDataAbilityOrItem
	94,  // 71: protocol.CMsgGameDataHero.talents:type_name -> protocol.CMsgGameDataAbilityOrItem
	94,  // 72: protocol.CMsgGameDataAbilities.abilities:type_name -> protocol.CMsgGameDataAbilityOrItem
	94,  // 73: protocol.CMsgGameDataItems.items:type_name -> protocol.CMsgGameDataAbilityOrItem
	95,  // 74: protocol.CMsgGameDataHeroes.heroes:type_name -> protocol.CMsgGameDataHero
	175, // 75: protocol.CMsgGameDataHeroList.heroes:type_name -> protocol.CMsgGameDataHeroList.HeroInfo
	176, // 76: protocol.CMsgGameDataItemAbilityList.itemabilities:type_name -> protocol.CMsgGameDataItemAbilityList.ItemAbilityInfo
	177, // 77: protocol.CMsgStickerbookPage.event_id:type_name -> protocol.EEvent
	104, // 78: protocol.CMsgStickerbookPage.stickers:type_name -> protocol.CMsgStickerbookSticker
	10,  // 79: protocol.CMsgStickerbookPage.page_type:type_name -> protocol.EStickerbookPageType
	105, // 80: protocol.CMsgStickerbook.pages:type_name -> protocol.CMsgStickerbookPage
	106, // 81: protocol.CMsgStickerbook.team_page_order_sequence:type_name -> protocol.CMsgStickerbookTeamPageOrderSequence
	108, // 82: protocol.CMsgStickerHeroes.heroes:type_name -> protocol.CMsgStickerHero
	110, // 83: protocol.CMsgHeroRoleHeroStats.role_stats:type_name -> protocol.CMsgHeroRoleStats
	111, // 84: protocol.CMsgHeroRoleRankStats.hero_stats:type_name -> protocol.CMsgHeroRoleHeroStats
	112, // 85: protocol.CMsgHeroRoleAllRanksStats.rank_stats:type_name -> protocol.CMsgHeroRoleRankStats
	114, // 86: protocol.CMsgGlobalMapStats.current:type_name -> protocol.CMsgMapStatsSnapshot
	114, // 87: protocol.CMsgGlobalMapStats.window_start:type_name -> protocol.CMsgMapStatsSnapshot
	114, // 88: protocol.CMsgGlobalMapStats.window_end:type_name -> protocol.CMsgMapStatsSnapshot
	121, // 89: protocol.CMsgDOTAProfileCard.Slot.trophy:type_name -> protocol.CMsgDOTAProfileCard.Slot.Trophy
	122, // 90: protocol.CMsgDOTAProfileCard.Slot.stat:type_name -> protocol.CMsgDOTAProfileCard.Slot.Stat
	123, // 91: protocol.CMsgDOTAProfileCard.Slot.item:type_name -> protocol.CMsgDOTAProfileCard.Slot.Item
	124, // 92: protocol.CMsgDOTAProfileCard.Slot.hero:type_name -> protocol.CMsgDOTAProfileCard.Slot.Hero
	125, // 93: protocol.CMsgDOTAProfileCard.Slot.emoticon:type_name -> protocol.CMsgDOTAProfileCard.Slot.Emoticon
	126, // 94: protocol.CMsgDOTAProfileCard.Slot.team:type_name -> protocol.CMsgDOTAProfileCard.Slot.Team
	11,  // 95: protocol.CMsgDOTAProfileCard.Slot.Stat.stat_id:type_name -> protocol.CMsgDOTAProfileCard.EStatID
	132, // 96: protocol.CMsgDOTARealtimeGameStats.TeamDetails.players:type_name -> protocol.CMsgDOTARealtimeGameStats.PlayerDetails
	129, // 97: protocol.CMsgDOTARealtimeGameStats.PlayerDetails.abilities:type_name -> protocol.CMsgDOTARealtimeGameStats.AbilityDetails
	128, // 98: protocol.CMsgDOTARealtimeGameStats.PlayerDetails.items:type_name -> protocol.CMsgDOTARealtimeGameStats.ItemDetails
	128, // 99: protocol.CMsgDOTARealtimeGameStats.PlayerDetails.stashitems:type_name -> protocol.CMsgDOTARealtimeGameStats.ItemDetails
	128, // 100: protocol.CMsgDOTARealtimeGameStats.PlayerDetails.itemshoppinglist:type_name -> protocol.CMsgDOTARealtimeGameStats.ItemDetails
	131, // 101: protocol.CMsgDOTARealtimeGameStats.PlayerDetails.levelpoints:type_name -> protocol.CMsgDOTARealtimeGameStats.AbilityList
	130, // 102: protocol.CMsgDOTARealtimeGameStats.PlayerDetails.hero_to_hero_stats:type_name -> protocol.CMsgDOTARealtimeGameStats.HeroToHeroStats
	136, // 103: protocol.CMsgDOTARealtimeGameStats.MatchDetails.picks:type_name -> protocol.CMsgDOTARealtimeGameStats.PickBanDetails
	136, // 104: protocol.CMsgDOTARealtimeGameStats.MatchDetails.bans:type_name -> protocol.CMsgDOTARealtimeGameStats.PickBanDetails
	134, // 105: protocol.CMsgDOTARealtimeGameStats.MatchDetails.kills:type_name -> protocol.CMsgDOTARealtimeGameStats.KillDetails
	135, // 106: protocol.CMsgDOTARealtimeGameStats.MatchDetails.broadcasters:type_name -> protocol.CMsgDOTARealtimeGameStats.BroadcasterDetails
	140, // 107: protocol.CMsgDOTARealtimeGameStats.GraphData.team_loc_stats:type_name -> protocol.CMsgDOTARealtimeGameStats.GraphData.TeamLocationStats
	139, // 108: protocol.CMsgDOTARealtimeGameStats.GraphData.TeamLocationStats.loc_stats:type_name -> protocol.CMsgDOTARealtimeGameStats.GraphData.LocationStats
	142, // 109: protocol.CMsgDOTARealtimeGameStatsTerse.TeamDetails.players:type_name -> protocol.CMsgDOTARealtimeGameStatsTerse.PlayerDetails
	144, // 110: protocol.CMsgDOTARealtimeGameStatsTerse.MatchDetails.picks:type_name -> protocol.CMsgDOTARealtimeGameStatsTerse.PickBanDetails
	144, // 111: protocol.CMsgDOTARealtimeGameStatsTerse.MatchDetails.bans:type_name -> protocol.CMsgDOTARealtimeGameStatsTerse.PickBanDetails
	19,  // 112: protocol.CMsgDOTASeasonPredictions.Prediction.type:type_name -> protocol.CMsgDOTASeasonPredictions.Prediction.EPredictionType
	56,  // 113: protocol.CMsgDOTASeasonPredictions.Prediction.choices:type_name -> protocol.CMsgPredictionChoice
	20,  // 114: protocol.CMsgDOTASeasonPredictions.Prediction.answer_type:type_name -> protocol.CMsgDOTASeasonPredictions.Prediction.EAnswerType
	149, // 115: protocol.CMsgDOTASeasonPredictions.Prediction.answers:type_name -> protocol.CMsgDOTASeasonPredictions.Prediction.Answers
	180, // 116: protocol.CMsgDOTASeasonPredictions.Prediction.region:type_name -> protocol.ELeagueRegion
	181, // 117: protocol.CMsgDOTASeasonPredictions.Prediction.phases:type_name -> protocol.ELeaguePhase
	177, // 118: protocol.CMsgDOTASeasonPredictions.Prediction.reward_event:type_name -> protocol.EEvent
	57,  // 119: protocol.CMsgAvailablePredictions.MatchPrediction.predictions:type_name -> protocol.CMsgInGamePrediction
	151, // 120: protocol.CMsgLeagueWatchedGames.League.series:type_name -> protocol.CMsgLeagueWatchedGames.Series
	31,  // 121: protocol.CMsgDOTAMatch.Player.ability_upgrades:type_name -> protocol.CMatchPlayerAbilityUpgrade
	35,  // 122: protocol.CMsgDOTAMatch.Player.additional_units_inventory:type_name -> protocol.CMatchAdditionalUnitInventory
	36,  // 123: protocol.CMsgDOTAMatch.Player.permanent_buffs:type_name -> protocol.CMatchPlayerPermanentBuff
	158, // 124: protocol.CMsgDOTAMatch.Player.custom_game_data:type_name -> protocol.CMsgDOTAMatch.Player.CustomGameData
	159, // 125: protocol.CMsgDOTAMatch.Player.hero_damage_received:type_name -> protocol.CMsgDOTAMatch.Player.HeroDamageReceived
	159, // 126: protocol.CMsgDOTAMatch.Player.hero_damage_dealt:type_name -> protocol.CMsgDOTAMatch.Player.HeroDamageReceived
	182, // 127: protocol.CMsgDOTAMatch.Player.team_number:type_name -> protocol.DOTA_GC_TEAM
	154, // 128: protocol.CMsgDOTAMatch.BroadcasterChannel.broadcaster_infos:type_name -> protocol.CMsgDOTAMatch.BroadcasterInfo
	22,  // 129: protocol.CMsgDOTAMatch.Player.HeroDamageReceived.damage_type:type_name -> protocol.CMsgDOTAMatch.Player.HeroDamageType
	162, // 130: protocol.CMsgDOTABotDebugInfo.Bot.modes:type_name -> protocol.CMsgDOTABotDebugInfo.Bot.Mode
	163, // 131: protocol.CMsgDOTABotDebugInfo.Bot.action:type_name -> protocol.CMsgDOTABotDebugInfo.Bot.Action
	177, // 132: protocol.CMsgMatchTips.SingleTip.event_id:type_name -> protocol.EEvent
	182, // 133: protocol.CMsgDOTAMatchMinimal.Player.team_number:type_name -> protocol.DOTA_GC_TEAM
	70,  // 134: protocol.CMsgMatchConsumableUsage.PlayerUsage.consumables_used:type_name -> protocol.CMsgConsumableUsage
	183, // 135: protocol.CMsgMatchEventActionGrants.PlayerGrants.actions_granted:type_name -> protocol.CMsgPendingEventAward
	5,   // 136: protocol.CMsgCustomGameWhitelistForEdit.WhitelistEntry.whitelist_state:type_name -> protocol.ECustomGameWhitelistState
