...
func (x *CMsgSteamLearnServerInfo) GetEnableDataSubmission() bool {
	if x != nil && x.EnableDataSubmission != nil {
		return *x.EnableDataSubmission
	}
	return false
}

func (x *CMsgSteamLearnServerInfo) GetEnableInferencing() bool {
	if x != nil && x.EnableInferencing != nil {
		return *x.EnableInferencing
	}
	return false
}

func (x *CMsgSteamLearnServerInfo) GetHmacKeys() *CMsgSteamLearnHMACKeys {
	if x != nil {
		return x.HmacKeys
	}
	return nil
...
const file_gcsdk_gcmessages_proto_rawDesc = "" +
	"\n" +
	"\x16gcsdk_gcmessages.proto\x12\bprotocol\x1a\x13steammessages.proto\x1a,steammessages_steamlearn.steamworkssdk.proto\"\x85\x01\n" +
	...
	"\ris_compressed\x18\x04 \x01(\bR\fisCompressed\"\xbe\x01\n" +
	"\x18CMsgSteamLearnServerInfo\x124\n" +
	"\x16enable_data_submission\x18\x01 \x01(\bR\x14enableDataSubmission\x12-\n" +
	"\x12enable_inferencing\x18\x02 \x01(\bR\x11enableInferencing\x12=\n" +
	"\thmac_keys\x18\x03 \x01(\v2 .protocol.CMsgSteamLearnHMACKeysR\bhmacKeys\"[\n" +
	...
	"\bsdo_type\x18\x01 \x01(\x05R\asdoType\x12;\n" +
	"\brequests\x18\x02 \x03(\v2\x1f.protocol.CMsgSDOAssert.RequestR\brequests\x1aB\n" +
	"\aRequest\x12\x10\n" +
	...
	"\x02id\x18\x02 \x01(\x04R\x02id\"\xbf\x01\n" +
	"\x12CMsgSOSingleObject\x12\x17\n" +
	"\atype_id\x18\x02 \x01(\x05R\x06typeId\x12\x1f\n" +
	"\vobject_data\x18\x03 \x01(\fR\n" +
	"objectData\x12\x18\n" +
	"\aversion\x18\x04 \x01(\x06R\aversion\x126\n" +
	"\n" +
	"owner_soid\x18\x05 \x01(\v2\x17.protocol.CMsgSOIDOwnerR\townerSoid\x12\x1d\n" +
	"\n" +
	"service_id\x18\x06 \x01(\rR\tserviceId\"\xe1\x03\n" +
	"\x15CMsgSOMultipleObjects\x12W\n" +
	"\x10objects_modified\x18\x02 \x03(\v2,.protocol.CMsgSOMultipleObjects.SingleObjectR\x0fobjectsModified\x12\x18\n" +
	"\aversion\x18\x03 \x01(\x06R\aversion\x12Q\n" +
	"\robjects_added\x18\x04 \x03(\v2,.protocol.CMsgSOMultipleObjects.SingleObjectR\fobjectsAdded\x12U\n" +
	"\x0fobjects_removed\x18\x05 \x03(\v2,.protocol.CMsgSOMultipleObjects.SingleObjectR\x0eobjectsRemoved\x126\n" +
	"\n" +
	"owner_soid\x18\x06 \x01(\v2\x17.protocol.CMsgSOIDOwnerR\townerSoid\x12\x1d\n" +
	"\n" +
	"service_id\x18\a \x01(\rR\tserviceId\x1aT\n" +
	"\fSingleObject\x12\x17\n" +
	"\atype_id\x18\x01 \x01(\x05R\x06typeId\x12\x1f\n" +
	"\vobject_data\x18\x02 \x01(\fR\n" +
	"objectData:\n" +
	"\x80\xa6\x1d\x80\x02\x88\xa6\x1d\x80\b\"\xe4\x02\n" +
	"\x15CMsgSOCacheSubscribed\x12H\n" +
	"\aobjects\x18\x02 \x03(\v2..protocol.CMsgSOCacheSubscribed.SubscribedTypeR\aobjects\x12\x18\n" +
	"\aversion\x18\x03 \x01(\x06R\aversion\x126\n" +
	"\n" +
	"owner_soid\x18\x04 \x01(\v2\x17.protocol.CMsgSOIDOwnerR\townerSoid\x12\x1d\n" +
	"\n" +
	...
	"\aversion\x18\x01 \x01(\x06R\aversion\x126\n" +
	"\n" +
	"owner_soid\x18\x02 \x01(\v2\x17.protocol.CMsgSOIDOwnerR\townerSoid\x12\x1d\n" +
	"\n" +
	"service_id\x18\x03 \x01(\rR\tserviceId\x12!\n" +
	"\fservice_list\x18\x04 \x03(\rR\vserviceList\x12!\n" +
	"\fsync_version\x18\x05 \x01(\x06R\vsyncVersion\"Q\n" +
	"\x17CMsgSOCacheUnsubscribed\x126\n" +
	"\n" +
	"owner_soid\x18\x02 \x01(\v2\x17.protocol.CMsgSOIDOwnerR\townerSoid\"\xd5\x01\n" +
	"\x1cCMsgSOCacheSubscriptionCheck\x12\x18\n" +
	"\aversion\x18\x02 \x01(\x06R\aversion\x126\n" +
	"\n" +
	"owner_soid\x18\x03 \x01(\v2\x17.protocol.CMsgSOIDOwnerR\townerSoid\x12\x1d\n" +
	"\n" +
	"service_id\x18\x04 \x01(\rR\tserviceId\x12!\n" +
	"\fservice_list\x18\x05 \x03(\rR\vserviceList\x12!\n" +
	"\fsync_version\x18\x06 \x01(\x06R\vsyncVersion\"X\n" +
	"\x1eCMsgSOCacheSubscriptionRefresh\x126\n" +
	"\n" +
	"owner_soid\x18\x02 \x01(\v2\x17.protocol.CMsgSOIDOwnerR\townerSoid\".\n" +
	...
	"\tdir_index\x18\x01 \x01(\x05:\x02-1R\bdirIndex\"\x94\x02\n" +
	"\x13CGCToGCMsgMasterAck\x12\x1f\n" +
	"\tdir_index\x18\x01 \x01(\x05:\x02-1R\bdirIndex\x12!\n" +
	"\fmachine_name\x18\x03 \x01(\tR\vmachineName\x12!\n" +
	"\fprocess_name\x18\x04 \x01(\tR\vprocessName\x12C\n" +
	"\tdirectory\x18\x06 \x03(\v2%.protocol.CGCToGCMsgMasterAck.ProcessR\tdirectory\x1aQ\n" +
	"\aProcess\x12\x1f\n" +
	"\tdir_index\x18\x01 \x01(\x05:\x02-1R\bdirIndex\x12%\n" +
	...
	"\aeresult\x18\x01 \x01(\x05R\aeresult\"\xba\x01\n" +
	"\x1fCGCToGCMsgMasterStartupComplete\x12I\n" +
	"\agc_info\x18\x01 \x03(\v20.protocol.CGCToGCMsgMasterStartupComplete.GCInfoR\x06gcInfo\x1aL\n" +
	"\x06GCInfo\x12\x1f\n" +
	"\tdir_index\x18\x01 \x01(\x05:\x02-1R\bdirIndex\x12!\n" +
	...
	"netMessage\"\xbd\x01\n" +
	"\x1cCMsgGCUpdateSubGCSessionInfo\x12K\n" +
	"\aupdates\x18\x01 \x03(\v21.protocol.CMsgGCUpdateSubGCSessionInfo.CMsgUpdateR\aupdates\x1aP\n" +
	"\n" +
	"CMsgUpdate\x12\x18\n" +
	...
	"\asuccess\x18\x04 \x01(\bR\asuccess\"\xae\x01\n" +
	"\x16CMsgSOCacheHaveVersion\x12+\n" +
	"\x04soid\x18\x01 \x01(\v2\x17.protocol.CMsgSOIDOwnerR\x04soid\x12\x18\n" +
	"\aversion\x18\x02 \x01(\x06R\aversion\x12\x1d\n" +
	"\n" +
	"service_id\x18\x03 \x01(\rR\tserviceId\x12.\n" +
	"\x13cached_file_version\x18\x04 \x01(\rR\x11cachedFileVersion\"\xda\a\n" +
	"\x0fCMsgClientHello\x12\x18\n" +
	"\aversion\x18\x01 \x01(\rR\aversion\x12T\n" +
	"\x15socache_have_versions\x18\x02 \x03(\v2 .protocol.CMsgSOCacheHaveVersionR\x13socacheHaveVersions\x12.\n" +
	"\x13client_session_need\x18\x03 \x01(\rR\x11clientSessionNeed\x12S\n" +
	"\x0fclient_launcher\x18\x04 \x01(\x0e2\x1c.protocol.PartnerAccountType:\fPARTNER_NONER\x0eclientLauncher\x12\x1d\n" +
	"\n" +
	"secret_key\x18\x05 \x01(\tR\tsecretKey\x12'\n" +
	"\x0fclient_language\x18\x06 \x01(\rR\x0eclientLanguage\x12>\n" +
	"\x06engine\x18\a \x01(\x0e2\x17.protocol.ESourceEngine:\rk_ESE_Source1R\x06engine\x12/\n" +
	...
	"\rplatform_name\x18\x17 \x01(\tR\fplatformName\"\x84\b\n" +
	"\x11CMsgClientWelcome\x12\x18\n" +
	"\aversion\x18\x01 \x01(\rR\aversion\x12\x1b\n" +
	"\tgame_data\x18\x02 \x01(\fR\bgameData\x12_\n" +
	"\x1boutofdate_subscribed_caches\x18\x03 \x03(\v2\x1f.protocol.CMsgSOCacheSubscribedR\x19outofdateSubscribedCaches\x12d\n" +
	"\x1auptodate_subscribed_caches\x18\x04 \x03(\v2&.protocol.CMsgSOCacheSubscriptionCheckR\x18uptodateSubscribedCaches\x12@\n" +
	"\blocation\x18\x05 \x01(\v2$.protocol.CMsgClientWelcome.LocationR\blocation\x12\"\n" +
	"\rsave_game_key\x18\x06 \x01(\fR\vsaveGameKey\x125\n" +
	...
	"\x15is_banned_steam_china\x18\x11 \x01(\bR\x12isBannedSteamChina\x12P\n" +
	"\x17additional_welcome_msgs\x18\x12 \x01(\v2\x18.protocol.CExtraMsgBlockR\x15additionalWelcomeMsgs\x12Y\n" +
	"\x17steam_learn_server_info\x18\x14 \x01(\v2\".protocol.CMsgSteamLearnServerInfoR\x14steamLearnServerInfo\x1a^\n" +
	"\bLocation\x12\x1a\n" +
	"\blatitude\x18\x01 \x01(\x02R\blatitude\x12\x1c\n" +
	"\tlongitude\x18\x02 \x01(\x02R\tlongitude\x12\x18\n" +
	"\acountry\x18\x03 \x01(\tR\acountry\"\xcf\x02\n" +
	"\x14CMsgConnectionStatus\x12U\n" +
	"\x06status\x18\x01 \x01(\x0e2\x1c.protocol.GCConnectionStatus:\x1fGCConnectionStatus_HAVE_SESSIONR\x06status\x12.\n" +
	...
	" estimated_wait_seconds_remaining\x18\x06 \x01(\x05R\x1destimatedWaitSecondsRemaining\"\xdc\x02\n" +
	"\x1aCMsgGCToGCSOCacheSubscribe\x12\x1e\n" +
	"\n" +
	"subscriber\x18\x01 \x01(\x06R\n" +
	"subscriber\x12&\n" +
	"\x0fsubscribe_to_id\x18\x02 \x01(\x06R\rsubscribeToId\x12!\n" +
	"\fsync_version\x18\x03 \x01(\x06R\vsyncVersion\x12Z\n" +
	"\rhave_versions\x18\x04 \x03(\v25.protocol.CMsgGCToGCSOCacheSubscribe.CMsgHaveVersionsR\fhaveVersions\x12*\n" +
	...
	"\x10CMsgGCClientPing\"\xb8\x01\n" +
	"\x1fCMsgGCToGCForwardAccountDetails\x12\x18\n" +
	"\asteamid\x18\x01 \x01(\x06R\asteamid\x12Z\n" +
	"\x0faccount_details\x18\x02 \x01(\v21.protocol.CGCSystemMsg_GetAccountDetails_ResponseR\x0eaccountDetails\x12\x1f\n" +
	"\vage_seconds\x18\x03 \x01(\rR\n" +
	"ageSeconds\"\xa0\x01\n" +
	"\x1cCMsgGCToGCLoadSessionSOCache\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12a\n" +
	"\x17forward_account_details\x18\x02 \x01(\v2).protocol.CMsgGCToGCForwardAccountDetailsR\x15forwardAccountDetails\"&\n" +
	...
	"\x1cCMsgGCToClientRequestDropped\"\xc6\x03\n" +
	"*CWorkshop_PopulateItemDescriptions_Request\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12p\n" +
	"\tlanguages\x18\x02 \x03(\v2R.protocol.CWorkshop_PopulateItemDescriptions_Request.ItemDescriptionsLanguageBlockR\tlanguages\x1ab\n" +
	"\x15SingleItemDescription\x12\x1e\n" +
	"\n" +
	"gameitemid\x18\x01 \x01(\rR\n" +
	"gameitemid\x12)\n" +
	"\x10item_description\x18\x02 \x01(\tR\x0fitemDescription\x1a\xab\x01\n" +
	"\x1dItemDescriptionsLanguageBlock\x12\x1a\n" +
	"\blanguage\x18\x01 \x01(\tR\blanguage\x12n\n" +
	"\fdescriptions\x18\x02 \x03(\v2J.protocol.CWorkshop_PopulateItemDescriptions_Request.SingleItemDescriptionR\fdescriptions\"Y\n" +
	...
	"\fcontributors\x18\x01 \x03(\x06R\fcontributors\"\xb5\b\n" +
	"%CWorkshop_SetItemPaymentRules_Request\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12\x1e\n" +
	"\n" +
	"gameitemid\x18\x02 \x01(\rR\n" +
	"gameitemid\x12\x83\x01\n" +
	"\x19associated_workshop_files\x18\x03 \x03(\v2G.protocol.CWorkshop_SetItemPaymentRules_Request.WorkshopItemPaymentRuleR\x17associatedWorkshopFiles\x12q\n" +
	"\x10partner_accounts\x18\x04 \x03(\v2F.protocol.CWorkshop_SetItemPaymentRules_Request.PartnerItemPaymentRuleR\x0fpartnerAccounts\x12#\n" +
	"\rvalidate_only\x18\x05 \x01(\bR\fvalidateOnly\x12G\n" +
	" make_workshop_files_subscribable\x18\x06 \x01(\bR\x1dmakeWorkshopFilesSubscribable\x12\xa8\x01\n" +
	",associated_workshop_file_for_direct_payments\x18\a \x01(\v2I.protocol.CWorkshop_SetItemPaymentRules_Request.WorkshopDirectPaymentRuleR'associatedWorkshopFileForDirectPayments\x1a\xbd\x01\n" +
	...
	"\x16include_partner_events\x18\r \x01(\bR\x14includePartnerEvents\"\xb6\x01\n" +
	"(CCommunity_GetClanAnnouncements_Response\x12\x1a\n" +
	"\bmaxchars\x18\x01 \x01(\rR\bmaxchars\x12\x1d\n" +
	"\n" +
	"strip_html\x18\x02 \x01(\bR\tstripHtml\x12O\n" +
	"\rannouncements\x18\x03 \x03(\v2).protocol.CCommunity_ClanAnnouncementInfoR\rannouncements\"\x98\x01\n" +
	...
	"\n" +
	"frame_data\x18\x04 \x01(\fR\tframeData\"\x8e\x04\n" +
	"\x15CMsgSerializedSOCache\x12!\n" +
	"\ffile_version\x18\x01 \x01(\rR\vfileVersion\x12=\n" +
	"\x06caches\x18\x02 \x03(\v2%.protocol.CMsgSerializedSOCache.CacheR\x06caches\x125\n" +
	...
	"\n" +
	"service_id\x18\x03 \x01(\rR\tserviceId\x1a\x81\x02\n" +
	"\x05Cache\x12\x12\n" +
	"\x04type\x18\x01 \x01(\rR\x04type\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\x04R\x02id\x12I\n" +
	"\bversions\x18\x03 \x03(\v2-.protocol.CMsgSerializedSOCache.Cache.VersionR\bversions\x12J\n" +
	"\vtype_caches\x18\x04 \x03(\v2).protocol.CMsgSerializedSOCache.TypeCacheR\n" +
	"typeCaches\x1a=\n" +
	"\aVersion\x12\x18\n" +
	...
	"(CMsgGCToGCMasterSubscribeToCacheResponse\"x\n" +
	"%CMsgGCToGCMasterSubscribeToCacheAsync\x12O\n" +
	"\rsubscribe_msg\x18\x01 \x01(\v2*.protocol.CMsgGCToGCMasterSubscribeToCacheR\fsubscribeMsg\"\x9a\x01\n" +
	...
	"#GCConnectionStatus_STEAM_GOING_DOWN\x10\x06B\rZ\v./;protocol"
...
var file_gcsdk_gcmessages_proto_msgTypes = make([]protoimpl.MessageInfo, 73)
var file_gcsdk_gcmessages_proto_goTypes = []any{
	(ESourceEngine)(0),                                                               // 0: protocol.ESourceEngine
	(PartnerAccountType)(0),                                                          // 1: protocol.PartnerAccountType
	(GCConnectionStatus)(0),                                                          // 2: protocol.GCConnectionStatus
	(*CExtraMsgBlock)(nil),                                                           // 3: protocol.CExtraMsgBlock
	(*CMsgSteamLearnServerInfo)(nil),                                                 // 4: protocol.CMsgSteamLearnServerInfo
	(*CMsgGCAssertJobData)(nil),                                                      // 5: protocol.CMsgGCAssertJobData
	(*CMsgGCConCommand)(nil),                                                         // 6: protocol.CMsgGCConCommand
	(*CMsgSDOAssert)(nil),                                                            // 7: protocol.CMsgSDOAssert
	(*CMsgSOIDOwner)(nil),                                                            // 8: protocol.CMsgSOIDOwner
	(*CMsgSOSingleObject)(nil),                                                       // 9: protocol.CMsgSOSingleObject
	(*CMsgSOMultipleObjects)(nil),                                                    // 10: protocol.CMsgSOMultipleObjects
	(*CMsgSOCacheSubscribed)(nil),                                                    // 11: protocol.CMsgSOCacheSubscribed
	(*CMsgSOCacheSubscribedUpToDate)(nil),                                            // 12: protocol.CMsgSOCacheSubscribedUpToDate
	(*CMsgSOCacheUnsubscribed)(nil),                                                  // 13: protocol.CMsgSOCacheUnsubscribed
	(*CMsgSOCacheSubscriptionCheck)(nil),                                             // 14: protocol.CMsgSOCacheSubscriptionCheck
	(*CMsgSOCacheSubscriptionRefresh)(nil),                                           // 15: protocol.CMsgSOCacheSubscriptionRefresh
	(*CMsgSOCacheVersion)(nil),                                                       // 16: protocol.CMsgSOCacheVersion
	(*CMsgGCMultiplexMessage)(nil),                                                   // 17: protocol.CMsgGCMultiplexMessage
	(*CMsgGCToGCSubGCStarting)(nil),                                                  // 18: protocol.CMsgGCToGCSubGCStarting
	(*CGCToGCMsgMasterAck)(nil),                                                      // 19: protocol.CGCToGCMsgMasterAck
	(*CGCToGCMsgMasterAck_Response)(nil),                                             // 20: protocol.CGCToGCMsgMasterAck_Response
	(*CMsgGCToGCUniverseStartup)(nil),                                                // 21: protocol.CMsgGCToGCUniverseStartup
	(*CMsgGCToGCUniverseStartupResponse)(nil),                                        // 22: protocol.CMsgGCToGCUniverseStartupResponse
	(*CGCToGCMsgMasterStartupComplete)(nil),                                          // 23: protocol.CGCToGCMsgMasterStartupComplete
	(*CGCToGCMsgRouted)(nil),                                                         // 24: protocol.CGCToGCMsgRouted
	(*CGCToGCMsgRoutedReply)(nil),                                                    // 25: protocol.CGCToGCMsgRoutedReply
	(*CMsgGCUpdateSubGCSessionInfo)(nil),                                             // 26: protocol.CMsgGCUpdateSubGCSessionInfo
	(*CMsgGCRequestSubGCSessionInfo)(nil),                                            // 27: protocol.CMsgGCRequestSubGCSessionInfo
	(*CMsgGCRequestSubGCSessionInfoResponse)(nil),                                    // 28: protocol.CMsgGCRequestSubGCSessionInfoResponse
	(*CMsgSOCacheHaveVersion)(nil),                                                   // 29: protocol.CMsgSOCacheHaveVersion
	(*CMsgClientHello)(nil),                                                          // 30: protocol.CMsgClientHello
	(*CMsgClientWelcome)(nil),                                                        // 31: protocol.CMsgClientWelcome
	(*CMsgConnectionStatus)(nil),                                                     // 32: protocol.CMsgConnectionStatus
	(*CMsgGCToGCSOCacheSubscribe)(nil),                                               // 33: protocol.CMsgGCToGCSOCacheSubscribe
	(*CMsgGCToGCSOCacheUnsubscribe)(nil),                                             // 34: protocol.CMsgGCToGCSOCacheUnsubscribe
	(*CMsgGCClientPing)(nil),                                                         // 35: protocol.CMsgGCClientPing
	(*CMsgGCToGCForwardAccountDetails)(nil),                                          // 36: protocol.CMsgGCToGCForwardAccountDetails
	(*CMsgGCToGCLoadSessionSOCache)(nil),                                             // 37: protocol.CMsgGCToGCLoadSessionSOCache
	(*CMsgGCToGCLoadSessionSOCacheResponse)(nil),                                     // 38: protocol.CMsgGCToGCLoadSessionSOCacheResponse
	(*CMsgGCToGCUpdateSessionStats)(nil),                                             // 39: protocol.CMsgGCToGCUpdateSessionStats
	(*CMsgGCToClientRequestDropped)(nil),                                             // 40: protocol.CMsgGCToClientRequestDropped
	(*CWorkshop_PopulateItemDescriptions_Request)(nil),                               // 41: protocol.CWorkshop_PopulateItemDescriptions_Request
	(*CWorkshop_GetContributors_Request)(nil),                                        // 42: protocol.CWorkshop_GetContributors_Request
	(*CWorkshop_GetContributors_Response)(nil),                                       // 43: protocol.CWorkshop_GetContributors_Response
	(*CWorkshop_SetItemPaymentRules_Request)(nil),                                    // 44: protocol.CWorkshop_SetItemPaymentRules_Request
	(*CWorkshop_SetItemPaymentRules_Response)(nil),                                   // 45: protocol.CWorkshop_SetItemPaymentRules_Response
	(*CCommunity_ClanAnnouncementInfo)(nil),                                          // 46: protocol.CCommunity_ClanAnnouncementInfo
	(*CCommunity_GetClanAnnouncements_Request)(nil),                                  // 47: protocol.CCommunity_GetClanAnnouncements_Request
	(*CCommunity_GetClanAnnouncements_Response)(nil),                                 // 48: protocol.CCommunity_GetClanAnnouncements_Response
	(*CBroadcast_PostGameDataFrame_Request)(nil),                                     // 49: protocol.CBroadcast_PostGameDataFrame_Request
	(*CMsgSerializedSOCache)(nil),                                                    // 50: protocol.CMsgSerializedSOCache
	(*CMsgGCToClientPollConvarRequest)(nil),                                          // 51: protocol.CMsgGCToClientPollConvarRequest
	(*CMsgGCToClientPollConvarResponse)(nil),                                         // 52: protocol.CMsgGCToClientPollConvarResponse
	(*CGCMsgCompressedMsgToClient)(nil),                                              // 53: protocol.CGCMsgCompressedMsgToClient
	(*CMsgGCToGCMasterBroadcastMessage)(nil),                                         // 54: protocol.CMsgGCToGCMasterBroadcastMessage
	(*CMsgGCToGCMasterSubscribeToCache)(nil),                                         // 55: protocol.CMsgGCToGCMasterSubscribeToCache
	(*CMsgGCToGCMasterSubscribeToCacheResponse)(nil),                                 // 56: protocol.CMsgGCToGCMasterSubscribeToCacheResponse
	(*CMsgGCToGCMasterSubscribeToCacheAsync)(nil),                                    // 57: protocol.CMsgGCToGCMasterSubscribeToCacheAsync
	(*CMsgGCToGCMasterUnsubscribeFromCache)(nil),                                     // 58: protocol.CMsgGCToGCMasterUnsubscribeFromCache
	(*CMsgGCToGCMasterDestroyCache)(nil),                                             // 59: protocol.CMsgGCToGCMasterDestroyCache
	(*CMsgSDOAssert_Request)(nil),                                                    // 60: protocol.CMsgSDOAssert.Request
	(*CMsgSOMultipleObjects_SingleObject)(nil),                                       // 61: protocol.CMsgSOMultipleObjects.SingleObject
	(*CMsgSOCacheSubscribed_SubscribedType)(nil),                                     // 62: protocol.CMsgSOCacheSubscribed.SubscribedType
	(*CGCToGCMsgMasterAck_Process)(nil),                                              // 63: protocol.CGCToGCMsgMasterAck.Process
	(*CGCToGCMsgMasterStartupComplete_GCInfo)(nil),                                   // 64: protocol.CGCToGCMsgMasterStartupComplete.GCInfo
	(*CMsgGCUpdateSubGCSessionInfo_CMsgUpdate)(nil),                                  // 65: protocol.CMsgGCUpdateSubGCSessionInfo.CMsgUpdate
	(*CMsgClientWelcome_Location)(nil),                                               // 66: protocol.CMsgClientWelcome.Location
	(*CMsgGCToGCSOCacheSubscribe_CMsgHaveVersions)(nil),                              // 67: protocol.CMsgGCToGCSOCacheSubscribe.CMsgHaveVersions
	(*CWorkshop_PopulateItemDescriptions_Request_SingleItemDescription)(nil),         // 68: protocol.CWorkshop_PopulateItemDescriptions_Request.SingleItemDescription
	(*CWorkshop_PopulateItemDescriptions_Request_ItemDescriptionsLanguageBlock)(nil), // 69: protocol.CWorkshop_PopulateItemDescriptions_Request.ItemDescriptionsLanguageBlock
	(*CWorkshop_SetItemPaymentRules_Request_WorkshopItemPaymentRule)(nil),            // 70: protocol.CWorkshop_SetItemPaymentRules_Request.WorkshopItemPaymentRule
	(*CWorkshop_SetItemPaymentRules_Request_WorkshopDirectPaymentRule)(nil),          // 71: protocol.CWorkshop_SetItemPaymentRules_Request.WorkshopDirectPaymentRule
	(*CWorkshop_SetItemPaymentRules_Request_PartnerItemPaymentRule)(nil),             // 72: protocol.CWorkshop_SetItemPaymentRules_Request.PartnerItemPaymentRule
	(*CMsgSerializedSOCache_TypeCache)(nil),                                          // 73: protocol.CMsgSerializedSOCache.TypeCache
	(*CMsgSerializedSOCache_Cache)(nil),                                              // 74: protocol.CMsgSerializedSOCache.Cache
	(*CMsgSerializedSOCache_Cache_Version)(nil),                                      // 75: protocol.CMsgSerializedSOCache.Cache.Version
	(*CMsgSteamLearnHMACKeys)(nil),                                                   // 76: protocol.CMsgSteamLearnHMACKeys
	(*CGCSystemMsg_GetAccountDetails_Response)(nil),                                  // 77: protocol.CGCSystemMsg_GetAccountDetails_Response
}
var file_gcsdk_gcmessages_proto_depIdxs = []int32{
	76, // 0: protocol.CMsgSteamLearnServerInfo.hmac_keys:type_name -> protocol.CMsgSteamLearnHMACKeys
	60, // 1: protocol.CMsgSDOAssert.requests:type_name -> protocol.CMsgSDOAssert.Request
	8,  // 2: protocol.CMsgSOSingleObject.owner_soid:type_name -> protocol.CMsgSOIDOwner
	61, // 3: protocol.CMsgSOMultipleObjects.objects_modified:type_name -> protocol.CMsgSOMultipleObjects.SingleObject
	61, // 4: protocol.CMsgSOMultipleObjects.objects_added:type_name -> protocol.CMsgSOMultipleObjects.SingleObject
	61, // 5: protocol.CMsgSOMultipleObjects.objects_removed:type_name -> protocol.CMsgSOMultipleObjects.SingleObject
	8,  // 6: protocol.CMsgSOMultipleObjects.owner_soid:type_name -> protocol.CMsgSOIDOwner
	62, // 7: protocol.CMsgSOCacheSubscribed.objects:type_name -> protocol.CMsgSOCacheSubscribed.SubscribedType
	8,  // 8: protocol.CMsgSOCacheSubscribed.owner_soid:type_name -> protocol.CMsgSOIDOwner
	8,  // 9: protocol.CMsgSOCacheSubscribedUpToDate.owner_soid:type_name -> protocol.CMsgSOIDOwner
	8,  // 10: protocol.CMsgSOCacheUnsubscribed.owner_soid:type_name -> protocol.CMsgSOIDOwner
	8,  // 11: protocol.CMsgSOCacheSubscriptionCheck.owner_soid:type_name -> protocol.CMsgSOIDOwner
	8,  // 12: protocol.CMsgSOCacheSubscriptionRefresh.owner_soid:type_name -> protocol.CMsgSOIDOwner
	63, // 13: protocol.CGCToGCMsgMasterAck.directory:type_name -> protocol.CGCToGCMsgMasterAck.Process
	64, // 14: protocol.CGCToGCMsgMasterStartupComplete.gc_info:type_name -> protocol.CGCToGCMsgMasterStartupComplete.GCInfo
	65, // 15: protocol.CMsgGCUpdateSubGCSessionInfo.updates:type_name -> protocol.CMsgGCUpdateSubGCSessionInfo.CMsgUpdate
	8,  // 16: protocol.CMsgSOCacheHaveVersion.soid:type_name -> protocol.CMsgSOIDOwner
	29, // 17: protocol.CMsgClientHello.socache_have_versions:type_name -> protocol.CMsgSOCacheHaveVersion
	1,  // 18: protocol.CMsgClientHello.client_launcher:type_name -> protocol.PartnerAccountType
	0,  // 19: protocol.CMsgClientHello.engine:type_name -> protocol.ESourceEngine
	11, // 20: protocol.CMsgClientWelcome.outofdate_subscribed_caches:type_name -> protocol.CMsgSOCacheSubscribed
	14, // 21: protocol.CMsgClientWelcome.uptodate_subscribed_caches:type_name -> protocol.CMsgSOCacheSubscriptionCheck
	66, // 22: protocol.CMsgClientWelcome.location:type_name -> protocol.CMsgClientWelcome.Location
	3,  // 23: protocol.CMsgClientWelcome.additional_welcome_msgs:type_name -> protocol.CExtraMsgBlock
	4,  // 24: protocol.CMsgClientWelcome.steam_learn_server_info:type_name -> protocol.CMsgSteamLearnServerInfo
	2,  // 25: protocol.CMsgConnectionStatus.status:type_name -> protocol.GCConnectionStatus
	67, // 26: protocol.CMsgGCToGCSOCacheSubscribe.have_versions:type_name -> protocol.CMsgGCToGCSOCacheSubscribe.CMsgHaveVersions
	77, // 27: protocol.CMsgGCToGCForwardAccountDetails.account_details:type_name -> protocol.CGCSystemMsg_GetAccountDetails_Response
	36, // 28: protocol.CMsgGCToGCLoadSessionSOCache.forward_account_details:type_name -> protocol.CMsgGCToGCForwardAccountDetails
	69, // 29: protocol.CWorkshop_PopulateItemDescriptions_Request.languages:type_name -> protocol.CWorkshop_PopulateItemDescriptions_Request.ItemDescriptionsLanguageBlock
	70, // 30: protocol.CWorkshop_SetItemPaymentRules_Request.associated_workshop_files:type_name -> protocol.CWorkshop_SetItemPaymentRules_Request.WorkshopItemPaymentRule
	72, // 31: protocol.CWorkshop_SetItemPaymentRules_Request.partner_accounts:type_name -> protocol.CWorkshop_SetItemPaymentRules_Request.PartnerItemPaymentRule
	71, // 32: protocol.CWorkshop_SetItemPaymentRules_Request.associated_workshop_file_for_direct_payments:type_name -> protocol.CWorkshop_SetItemPaymentRules_Request.WorkshopDirectPaymentRule
	46, // 33: protocol.CCommunity_GetClanAnnouncements_Response.announcements:type_name -> protocol.CCommunity_ClanAnnouncementInfo
	74, // 34: protocol.CMsgSerializedSOCache.caches:type_name -> protocol.CMsgSerializedSOCache.Cache
	55, // 35: protocol.CMsgGCToGCMasterSubscribeToCacheAsync.subscribe_msg:type_name -> protocol.CMsgGCToGCMasterSubscribeToCache
	68, // 36: protocol.CWorkshop_PopulateItemDescriptions_Request.ItemDescriptionsLanguageBlock.descriptions:type_name -> protocol.CWorkshop_PopulateItemDescriptions_Request.SingleItemDescription
	75, // 37: protocol.CMsgSerializedSOCache.Cache.versions:type_name -> protocol.CMsgSerializedSOCache.Cache.Version
	73, // 38: protocol.CMsgSerializedSOCache.Cache.type_caches:type_name -> protocol.CMsgSerializedSOCache.TypeCache
