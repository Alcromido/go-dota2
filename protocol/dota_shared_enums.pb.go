...
const (
	...
	DOTACommLevelT_DOTA_COMM_LEVEL_CHAT           DOTACommLevelT = 3
	DOTACommLevelT_DOTA_COMM_LEVEL_TIPPING        DOTACommLevelT = 4
	DOTACommLevelT_DOTA_COMM_LEVEL_VOICE          DOTACommLevelT = 5
	DOTACommLevelT_DOTA_COMM_LEVEL_ALLIED_ABILITY DOTACommLevelT = 6
)
...
var (
	DOTACommLevelT_name = map[int32]string{
		...
		3: "DOTA_COMM_LEVEL_CHAT",
		4: "DOTA_COMM_LEVEL_TIPPING",
		5: "DOTA_COMM_LEVEL_VOICE",
		6: "DOTA_COMM_LEVEL_ALLIED_ABILITY",
	}
...
const file_dota_shared_enums_proto_rawDesc = "" +
	...
	"\x01y\x18\x02 \x01(\x02R\x01y\"\xcd\x19\n" +
	...
	"\fuses_charges\x18O \x01(\bR\vusesCharges\"\xb1\x02\n" +
	...
	"\x15DOTA_GC_TEAM_NEUTRALS\x10\x0e*\x83\v\n" +
	"\x06EEvent\x12\x11\n" +
	...
	"\x19EVENT_ID_10TH_ANNIVERSARY\x10.*\xbb\x02\n" +
	"\tERankType\x12\x17\n" +
	...
	"\x0fk_ERankType_Max\x10f*\xa8\x02\n" +
	...
	"\x14DOTA_LEAVER_DECLINED\x10\b*\x9e\x02\n" +
	...
	"'k_EChatSpecialPrivileges_SuperModerator\x10\x02*\xa2\x03\n" +
	...
	"\x1fDOTA_COMM_TYPE_NEWPLAYER_EXPERT\x10\r*\xda\x01\n" +
	"\x0fDOTACommLevel_t\x12\x18\n" +
	"\x14DOTA_COMM_LEVEL_NONE\x10\x00\x12\x1c\n" +
	"\x18DOTA_COMM_LEVEL_COOLDOWN\x10\x01\x12\x19\n" +
	"\x15DOTA_COMM_LEVEL_PINGS\x10\x02\x12\x18\n" +
	"\x14DOTA_COMM_LEVEL_CHAT\x10\x03\x12\x1b\n" +
	"\x17DOTA_COMM_LEVEL_TIPPING\x10\x04\x12\x19\n" +
	"\x15DOTA_COMM_LEVEL_VOICE\x10\x05\x12\"\n" +
	"\x1eDOTA_COMM_LEVEL_ALLIED_ABILITY\x10\x06*\xbd\x01\n" +
	...
	"\x0eLANE_TYPE_ROAM\x10\x05*\xd6\x04\n" +
	"\n" +
	"EBadgeType\x12\x18\n" +
	...
	"\x19k_EBadgeType_TI12_Special\x10\x11*\xd4\x01\n" +
	...
	"\x1dLEAGUE_AUDIT_ACTION_NODE_EDIT\x10\xd1\x01*\xe7\v\n" +
	...
	"\"DOTA_COMBATLOG_NEUTRAL_ITEM_EARNED\x10+*u\n" +
	...
	"%k_EOverwatchReportReason_AbilityAbuse\x10\x05B\rZ\v./;protocol"
...
var file_dota_shared_enums_proto_goTypes = []any{
	...
	(*CDOTAClientHardwareSpecs)(nil),                   // 51: protocol.CDOTAClientHardwareSpecs
	(*CDOTASaveGame)(nil),                              // 52: protocol.CDOTASaveGame
	(*CMsgDOTACombatLogEntry)(nil),                     // 53: protocol.CMsgDOTACombatLogEntry
	(*CMsgPendingEventAward)(nil),                      // 54: protocol.CMsgPendingEventAward
	(*CDOTASaveGame_Player)(nil),                       // 55: protocol.CDOTASaveGame.Player
	(*CDOTASaveGame_SaveInstance)(nil),                 // 56: protocol.CDOTASaveGame.SaveInstance
	(*CDOTASaveGame_SaveInstance_PlayerPositions)(nil), // 57: protocol.CDOTASaveGame.SaveInstance.PlayerPositions
}
var file_dota_shared_enums_proto_depIdxs = []int32{
	55, // 0: protocol.CDOTASaveGame.players:type_name -> protocol.CDOTASaveGame.Player
	56, // 1: protocol.CDOTASaveGame.save_instances:type_name -> protocol.CDOTASaveGame.SaveInstance
	...
	57, // 6: protocol.CDOTASaveGame.SaveInstance.player_positions:type_name -> protocol.CDOTASaveGame.SaveInstance.PlayerPositions
