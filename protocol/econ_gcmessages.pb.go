...
func (CMsgClientToGCGetLimitedItemPurchaseQuantityResponse_EResponse) EnumDescriptor() ([]byte, []int) {
	return file_econ_gcmessages_proto_rawDescGZIP(), []int{108, 0}
}
...
type CMsgClientToGCWrapAndDeliverGiftResponse struct {
	...
	TradeRestriction   *EGCMsgInitiateTradeResponse `protobuf:"varint,7,opt,name=trade_restriction,json=tradeRestriction,enum=protocol.EGCMsgInitiateTradeResponse,def=0" json:"trade_restriction,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type CMsgClientToGCGetGiftPermissionsResponse struct {
	...
	SenderPermission                  *EGCMsgInitiateTradeResponse                                 `protobuf:"varint,6,opt,name=sender_permission,json=senderPermission,enum=protocol.EGCMsgInitiateTradeResponse,def=0" json:"sender_permission,omitempty"`
...
type CMsgClientToGCUnpackBundleResponse struct {
	...
	Response               *CMsgClientToGCUnpackBundleResponse_EUnpackBundle `protobuf:"varint,2,opt,name=response,enum=protocol.CMsgClientToGCUnpackBundleResponse_EUnpackBundle,def=0" json:"response,omitempty"`
...
type CMsgClientToGCPackBundleResponse struct {
	state         protoimpl.MessageState                        `protogen:"open.v1"`
	ItemId        *uint64                                       `protobuf:"varint,1,opt,name=item_id,json=itemId" json:"item_id,omitempty"`
	Response      *CMsgClientToGCPackBundleResponse_EPackBundle `protobuf:"varint,2,opt,name=response,enum=protocol.CMsgClientToGCPackBundleResponse_EPackBundle,def=0" json:"response,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMsgClientToGCSetItemStyleResponse struct {
	state         protoimpl.MessageState                        `protogen:"open.v1"`
	Response      *CMsgClientToGCSetItemStyleResponse_ESetStyle `protobuf:"varint,1,opt,name=response,enum=protocol.CMsgClientToGCSetItemStyleResponse_ESetStyle,def=0" json:"response,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMsgClientToGCUnlockItemStyleResponse struct {
	state         protoimpl.MessageState                              `protogen:"open.v1"`
	Response      *CMsgClientToGCUnlockItemStyleResponse_EUnlockStyle `protobuf:"varint,1,opt,name=response,enum=protocol.CMsgClientToGCUnlockItemStyleResponse_EUnlockStyle,def=0" json:"response,omitempty"`
	ItemId        *uint64                                             `protobuf:"varint,2,opt,name=item_id,json=itemId" json:"item_id,omitempty"`
...
type CMsgClientToGCRemoveItemAttributeResponse struct {
	state         protoimpl.MessageState                                          `protogen:"open.v1"`
	Response      *CMsgClientToGCRemoveItemAttributeResponse_ERemoveItemAttribute `protobuf:"varint,1,opt,name=response,enum=protocol.CMsgClientToGCRemoveItemAttributeResponse_ERemoveItemAttribute,def=0" json:"response,omitempty"`
	ItemId        *uint64                                                         `protobuf:"varint,2,opt,name=item_id,json=itemId" json:"item_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type CMsgClientToGCCreateStaticRecipeResponse struct {
	state             protoimpl.MessageState                                       `protogen:"open.v1"`
	Response          *CMsgClientToGCCreateStaticRecipeResponse_EResponse          `protobuf:"varint,1,opt,name=response,enum=protocol.CMsgClientToGCCreateStaticRecipeResponse_EResponse,def=0" json:"response,omitempty"`
...
type CMsgClientToGCGetLimitedItemPurchaseQuantityResponse struct {
	state             protoimpl.MessageState                                          `protogen:"open.v1"`
	Result            *CMsgClientToGCGetLimitedItemPurchaseQuantityResponse_EResponse `protobuf:"varint,1,opt,name=result,enum=protocol.CMsgClientToGCGetLimitedItemPurchaseQuantityResponse_EResponse,def=0" json:"result,omitempty"`
...
func (x *CMsgGCToGCGrantAccountRolledItems_Item) GetQuality() uint32 {
...
func (*CMsgClientToGCGetGiftPermissionsResponse_FriendPermission) Descriptor() ([]byte, []int) {
	return file_econ_gcmessages_proto_rawDescGZIP(), []int{46, 0}
}
...
func (*CMsgClientToGCUnlockCrateResponse_Item) Descriptor() ([]byte, []int) {
	return file_econ_gcmessages_proto_rawDescGZIP(), []int{60, 0}
}
...
func (*CWorkshop_GetItemDailyRevenue_Response_CountryDailyRevenue) Descriptor() ([]byte, []int) {
	return file_econ_gcmessages_proto_rawDescGZIP(), []int{80, 0}
}
...
type CMsgClientToGCCreateStaticRecipeResponse_InputError struct {
	...
	Error         *CMsgClientToGCCreateStaticRecipeResponse_EResponse `protobuf:"varint,2,opt,name=error,enum=protocol.CMsgClientToGCCreateStaticRecipeResponse_EResponse,def=0" json:"error,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (*CMsgClientToGCCreateStaticRecipeResponse_InputError) Descriptor() ([]byte, []int) {
	return file_econ_gcmessages_proto_rawDescGZIP(), []int{87, 1}
}
...
func (*CMsgClientToGCCreateStaticRecipeResponse_AdditionalOutput) Descriptor() ([]byte, []int) {
	return file_econ_gcmessages_proto_rawDescGZIP(), []int{87, 2}
}
...
func (*CMsgGCToClientCurrencyPricePoints_Currency) Descriptor() ([]byte, []int) {
	return file_econ_gcmessages_proto_rawDescGZIP(), []int{99, 0}
}
...
const file_econ_gcmessages_proto_rawDesc = "" +
	"\n" +
	"\x15econ_gcmessages.proto\x12\bprotocol\x1a\x13steammessages.proto\x1a\x17econ_shared_enums.proto\x1a\x16gcsdk_gcmessages.proto\"b\n" +
	...
	"\bnew_slot\x18\x03 \x01(\rR\anewSlot\x12$\n" +
	"\vstyle_index\x18\x04 \x01(\r:\x03255R\n" +
	"styleIndex\"\xdc\x02\n" +
	"$CMsgEconPlayerStrangeCountAdjustment\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12\x82\x01\n" +
	"\x19strange_count_adjustments\x18\x02 \x03(\v2F.protocol.CMsgEconPlayerStrangeCountAdjustment.CStrangeCountAdjustmentR\x17strangeCountAdjustments\x12\x1d\n" +
	"\n" +
	...
	"\bcurrency\x18\x02 \x01(\rR\bcurrency\"\xf6\x01\n" +
	"#CMsgGCRequestStoreSalesDataResponse\x12R\n" +
	"\n" +
	"sale_price\x18\x01 \x03(\v23.protocol.CMsgGCRequestStoreSalesDataResponse.PriceR\tsalePrice\x12\x18\n" +
	...
	"accountids\"\xc1\x01\n" +
	"&CMsgLookupMultipleAccountNamesResponse\x12T\n" +
	"\baccounts\x18\x01 \x03(\v28.protocol.CMsgLookupMultipleAccountNamesResponse.AccountR\baccounts\x1aA\n" +
	"\aAccount\x12\x1c\n" +
	"\taccountid\x18\x01 \x01(\rR\taccountid\x12\x18\n" +
	"\apersona\x18\x02 \x01(\tR\apersona\"=\n" +
	"\x15CMsgRequestCrateItems\x12$\n" +
	"\x0ecrate_item_def\x18\x01 \x01(\rR\fcrateItemDef\"\xa8\x01\n" +
	"\x1dCMsgRequestCrateItemsResponse\x12\x1a\n" +
	"\bresponse\x18\x01 \x01(\rR\bresponse\x12\x1b\n" +
	"\titem_defs\x18\x02 \x03(\rR\bitemDefs\x12$\n" +
	"\x0epeek_item_defs\x18\x03 \x03(\rR\fpeekItemDefs\"(\n" +
	"\aEResult\x12\x0f\n" +
	...
	"\x12additional_seconds\x18\x03 \x01(\rR\x11additionalSeconds\"\x95\a\n" +
	"!CMsgGCToGCGrantAccountRolledItems\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12F\n" +
	"\x05items\x18\x02 \x03(\v20.protocol.CMsgGCToGCGrantAccountRolledItems.ItemR\x05items\x12!\n" +
	"\faudit_action\x18\x03 \x01(\rR\vauditAction\x12\x1d\n" +
	"\n" +
	"audit_data\x18\x04 \x01(\x04R\tauditData\x1a\xc6\x05\n" +
	"\x04Item\x12\x19\n" +
	...
	"\x06origin\x18\x04 \x01(\rR\x06origin\x12p\n" +
	"\x12dynamic_attributes\x18\x05 \x03(\v2A.protocol.CMsgGCToGCGrantAccountRolledItems.Item.DynamicAttributeR\x11dynamicAttributes\x12\x7f\n" +
	"\x18additional_audit_entries\x18\x06 \x03(\v2E.protocol.CMsgGCToGCGrantAccountRolledItems.Item.AdditionalAuditEntryR\x16additionalAuditEntries\x12'\n" +
	"\x0finventory_token\x18\a \x01(\rR\x0einventoryToken\x12\x18\n" +
	"\aquality\x18\b \x01(\rR\aquality\x1a\x8d\x01\n" +
	...
	"\taccountid\x18\x02 \x01(\rR\taccountid\"\x97\x02\n" +
	...
	"\x19itempack__ack_immediately\x18\x06 \x01(\bR\x16itempackAckImmediately\"~\n" +
	"\x11CMsgServerUseItem\x120\n" +
	"\x14initiator_account_id\x18\x01 \x01(\rR\x12initiatorAccountId\x127\n" +
	"\fuse_item_msg\x18\x02 \x01(\v2\x15.protocol.CMsgUseItemR\n" +
	"useItemMsg\"1\n" +
	...
	"\tdef_index\x18\x01 \x01(\rR\bdefIndex\"K\n" +
	"\x11CMsgGCAddGiftItem\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12\x17\n" +
	"\aitem_id\x18\x02 \x01(\x04R\x06itemId\"\x8b\x01\n" +
	" CMsgClientToGCWrapAndDeliverGift\x12\x17\n" +
	"\aitem_id\x18\x01 \x01(\x04R\x06itemId\x12+\n" +
	"\x12give_to_account_id\x18\x02 \x01(\rR\x0fgiveToAccountId\x12!\n" +
	"\fgift_message\x18\x03 \x01(\tR\vgiftMessage\"\xc4\x03\n" +
	"(CMsgClientToGCWrapAndDeliverGiftResponse\x12H\n" +
	"\bresponse\x18\x01 \x01(\x0e2\x18.protocol.EGCMsgResponse:\x12k_EGCMsgResponseOKR\bresponse\x12.\n" +
	...
	"giftingMax\x120\n" +
	"\x14gifting_window_hours\x18\x06 \x01(\rR\x12giftingWindowHours\x12z\n" +
	"\x11trade_restriction\x18\a \x01(\x0e2%.protocol.EGCMsgInitiateTradeResponse:&k_EGCMsgInitiateTradeResponse_AcceptedR\x10tradeRestriction\"3\n" +
	"\x18CMsgClientToGCUnwrapGift\x12\x17\n" +
	"\aitem_id\x18\x01 \x01(\x04R\x06itemId\"\"\n" +
	" CMsgClientToGCGetGiftPermissions\"\x96\x05\n" +
	"(CMsgClientToGCGetGiftPermissionsResponse\x12!\n" +
	"\fis_unlimited\x18\x01 \x01(\bR\visUnlimited\x12$\n" +
	"\x0ehas_two_factor\x18\x03 \x01(\bR\fhasTwoFactor\x12z\n" +
	"\x11sender_permission\x18\x06 \x01(\x0e2%.protocol.EGCMsgInitiateTradeResponse:&k_EGCMsgInitiateTradeResponse_AcceptedR\x10senderPermission\x12<\n" +
	"\x1afriendship_age_requirement\x18\a \x01(\rR\x18friendshipAgeRequirement\x12P\n" +
	"%friendship_age_requirement_two_factor\x18\b \x01(\rR!friendshipAgeRequirementTwoFactor\x12r\n" +
	"\x12friend_permissions\x18\t \x03(\v2C.protocol.CMsgClientToGCGetGiftPermissionsResponse.FriendPermissionR\x11friendPermissions\x1a\xa0\x01\n" +
	"\x10FriendPermission\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12m\n" +
	"\n" +
	"permission\x18\x02 \x01(\x0e2%.protocol.EGCMsgInitiateTradeResponse:&k_EGCMsgInitiateTradeResponse_AcceptedR\n" +
	"permission\"5\n" +
	"\x1aCMsgClientToGCUnpackBundle\x12\x17\n" +
	"\aitem_id\x18\x01 \x01(\x04R\x06itemId\"\xb9\x04\n" +
	"\"CMsgClientToGCUnpackBundleResponse\x12*\n" +
	"\x11unpacked_item_ids\x18\x01 \x03(\x04R\x0funpackedItemIds\x12p\n" +
	"\bresponse\x18\x02 \x01(\x0e2:.protocol.CMsgClientToGCUnpackBundleResponse.EUnpackBundle:\x18k_UnpackBundle_SucceededR\bresponse\x129\n" +
	...
	"\x15bundle_item_def_index\x18\x02 \x01(\rR\x12bundleItemDefIndex\"\x8d\x06\n" +
	" CMsgClientToGCPackBundleResponse\x12\x17\n" +
	"\aitem_id\x18\x01 \x01(\x04R\x06itemId\x12j\n" +
	"\bresponse\x18\x02 \x01(\x0e26.protocol.CMsgClientToGCPackBundleResponse.EPackBundle:\x16k_PackBundle_SucceededR\bresponse\"\xe3\x04\n" +
	...
	"\x18CMsgClientToGCEquipItems\x12=\n" +
	"\x06equips\x18\x01 \x03(\v2%.protocol.CMsgAdjustItemEquippedStateR\x06equips\"Q\n" +
	" CMsgClientToGCEquipItemsResponse\x12-\n" +
	"\x13so_cache_version_id\x18\x01 \x01(\x06R\x10soCacheVersionId\"[\n" +
	"\x1aCMsgClientToGCSetItemStyle\x12\x17\n" +
	"\aitem_id\x18\x01 \x01(\x04R\x06itemId\x12$\n" +
	"\vstyle_index\x18\x02 \x01(\r:\x03255R\n" +
	"styleIndex\"\xf1\x01\n" +
	"\"CMsgClientToGCSetItemStyleResponse\x12h\n" +
	"\bresponse\x18\x01 \x01(\x0e26.protocol.CMsgClientToGCSetItemStyleResponse.ESetStyle:\x14k_SetStyle_SucceededR\bresponse\"a\n" +
	"\tESetStyle\x12\x18\n" +
	"\x14k_SetStyle_Succeeded\x10\x00\x12\x15\n" +
	"\x11k_SetStyle_Failed\x10\x01\x12#\n" +
	"\x1fk_SetStyle_Failed_StyleIsLocked\x10\x02\"\x9b\x01\n" +
	"\x1dCMsgClientToGCUnlockItemStyle\x12$\n" +
	"\x0eitem_to_unlock\x18\x01 \x01(\x04R\fitemToUnlock\x12$\n" +
	"\vstyle_index\x18\x02 \x01(\r:\x03255R\n" +
	"styleIndex\x12.\n" +
	"\x13consumable_item_ids\x18\x03 \x03(\x04R\x11consumableItemIds\"\xe0\x05\n" +
	"%CMsgClientToGCUnlockItemStyleResponse\x12q\n" +
	"\bresponse\x18\x01 \x01(\x0e2<.protocol.CMsgClientToGCUnlockItemStyleResponse.EUnlockStyle:\x17k_UnlockStyle_SucceededR\bresponse\x12\x17\n" +
	"\aitem_id\x18\x02 \x01(\x04R\x06itemId\x12$\n" +
	"\vstyle_index\x18\x03 \x01(\r:\x03255R\n" +
	"styleIndex\x12&\n" +
	"\fstyle_prereq\x18\x04 \x01(\r:\x03255R\vstylePrereq\"\xdc\x03\n" +
	...
	"\vkey_item_id\x18\x02 \x01(\x04R\tkeyItemId\"\xfe\x01\n" +
	"!CMsgClientToGCUnlockCrateResponse\x12D\n" +
	"\x06result\x18\x01 \x01(\x0e2\x18.protocol.EGCMsgResponse:\x12k_EGCMsgResponseOKR\x06result\x12U\n" +
	"\rgranted_items\x18\x02 \x03(\v20.protocol.CMsgClientToGCUnlockCrateResponse.ItemR\fgrantedItems\x1a<\n" +
	"\x04Item\x12\x17\n" +
	"\aitem_id\x18\x01 \x01(\x04R\x06itemId\x12\x1b\n" +
	"\tdef_index\x18\x02 \x01(\rR\bdefIndex\"<\n" +
	"!CMsgClientToGCRemoveItemAttribute\x12\x17\n" +
	"\aitem_id\x18\x01 \x01(\x04R\x06itemId\"\xce\x03\n" +
	")CMsgClientToGCRemoveItemAttributeResponse\x12\x85\x01\n" +
	"\bresponse\x18\x01 \x01(\x0e2H.protocol.CMsgClientToGCRemoveItemAttributeResponse.ERemoveItemAttribute:\x1fk_RemoveItemAttribute_SucceededR\bresponse\x12\x17\n" +
	...
	"toolItemId\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\"\xcd\x02\n" +
	"\x1eCMsgClientToGCNameItemResponse\x12d\n" +
	"\bresponse\x18\x01 \x01(\x0e22.protocol.CMsgClientToGCNameItemResponse.ENameItem:\x14k_NameItem_SucceededR\bresponse\x12\x17\n" +
	...
	"\x12required_item_slot\x18\a \x01(\tR\x10requiredItemSlot\"L\n" +
	"\x16CProtoItemSocket_Empty\x122\n" +
	"\x06socket\x18\x01 \x01(\v2\x1a.protocol.CProtoItemSocketR\x06socket\"e\n" +
	"\x17CProtoItemSocket_Effect\x122\n" +
	"\x06socket\x18\x01 \x01(\v2\x1a.protocol.CProtoItemSocketR\x06socket\x12\x16\n" +
	"\x06effect\x18\x02 \x01(\rR\x06effect\"\x88\x01\n" +
	"\x16CProtoItemSocket_Color\x122\n" +
	"\x06socket\x18\x01 \x01(\v2\x1a.protocol.CProtoItemSocketR\x06socket\x12\x10\n" +
	"\x03red\x18\x02 \x01(\rR\x03red\x12\x14\n" +
	"\x05green\x18\x03 \x01(\rR\x05green\x12\x12\n" +
	"\x04blue\x18\x04 \x01(\rR\x04blue\"\x96\x01\n" +
	"\x18CProtoItemSocket_Strange\x122\n" +
	"\x06socket\x18\x01 \x01(\v2\x1a.protocol.CProtoItemSocketR\x06socket\x12!\n" +
	"\fstrange_type\x18\x02 \x01(\rR\vstrangeType\x12#\n" +
	"\rstrange_value\x18\x03 \x01(\rR\fstrangeValue\"\xda\x01\n" +
	"5CProtoItemSocket_Strange_DESERIALIZE_FROM_STRING_ONLY\x122\n" +
	"\x06socket\x18\x01 \x01(\v2\x1a.protocol.CProtoItemSocketR\x06socket\x12!\n" +
	"\fstrange_type\x18\x02 \x01(\rR\vstrangeType\x12#\n" +
	"\rstrange_value\x18\x03 \x01(\rR\fstrangeValue\x12%\n" +
	"\x0eability_effect\x18\x04 \x01(\rR\rabilityEffect\"\xd0\x01\n" +
	"\x1aCProtoItemSocket_Spectator\x122\n" +
	"\x06socket\x18\x01 \x01(\v2\x1a.protocol.CProtoItemSocketR\x06socket\x12!\n" +
	...
	"\ateam_id\x18\x05 \x01(\rR\x06teamId\"{\n" +
	"\x1eCProtoItemSocket_AssetModifier\x122\n" +
	"\x06socket\x18\x01 \x01(\v2\x1a.protocol.CProtoItemSocketR\x06socket\x12%\n" +
	"\x0easset_modifier\x18\x02 \x01(\rR\rassetModifier\"\xe4\x01\n" +
	";CProtoItemSocket_AssetModifier_DESERIALIZE_FROM_STRING_ONLY\x122\n" +
	"\x06socket\x18\x01 \x01(\v2\x1a.protocol.CProtoItemSocketR\x06socket\x12%\n" +
	"\x0easset_modifier\x18\x02 \x01(\rR\rassetModifier\x12#\n" +
	"\ranim_modifier\x18\x03 \x01(\rR\fanimModifier\x12%\n" +
	"\x0eability_effect\x18\x04 \x01(\rR\rabilityEffect\"\xba\x01\n" +
	"\x1aCProtoItemSocket_Autograph\x122\n" +
	"\x06socket\x18\x01 \x01(\v2\x1a.protocol.CProtoItemSocketR\x06socket\x12\x1c\n" +
	"\tautograph\x18\x02 \x01(\tR\tautograph\x12!\n" +
	"\fautograph_id\x18\x03 \x01(\rR\vautographId\x12'\n" +
	"\x0fautograph_score\x18\x04 \x01(\rR\x0eautographScore\"T\n" +
	"\x1eCProtoItemSocket_StaticVisuals\x122\n" +
	"\x06socket\x18\x01 \x01(\v2\x1a.protocol.CProtoItemSocketR\x06socket\")\n" +
	...
	"\bdate_end\x18\x04 \x01(\rR\adateEnd\"\x9d\x02\n" +
	"&CWorkshop_GetItemDailyRevenue_Response\x12m\n" +
	"\x0fcountry_revenue\x18\x01 \x03(\v2D.protocol.CWorkshop_GetItemDailyRevenue_Response.CountryDailyRevenueR\x0ecountryRevenue\x1a\x83\x01\n" +
	...
	"\bdate_end\x18\x03 \x01(\rR\adateEnd\"\xa3\x02\n" +
	")CWorkshop_GetPackageDailyRevenue_Response\x12p\n" +
	"\x0fcountry_revenue\x18\x01 \x03(\v2G.protocol.CWorkshop_GetPackageDailyRevenue_Response.CountryDailyRevenueR\x0ecountryRevenue\x1a\x83\x01\n" +
	"\x13CountryDailyRevenue\x12!\n" +
	"\fcountry_code\x18\x01 \x01(\tR\vcountryCode\x12\x12\n" +
	"\x04date\x18\x02 \x01(\rR\x04date\x12\x1f\n" +
	"\vrevenue_usd\x18\x03 \x01(\x03R\n" +
	...
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12!\n" +
	"\faccount_name\x18\x02 \x01(\tR\vaccountName\"\xcd\x01\n" +
	" CMsgClientToGCCreateStaticRecipe\x12E\n" +
	"\x05items\x18\x01 \x03(\v2/.protocol.CMsgClientToGCCreateStaticRecipe.ItemR\x05items\x12(\n" +
	"\x10recipe_def_index\x18\x02 \x01(\rR\x0erecipeDefIndex\x1a8\n" +
	"\x04Item\x12\x17\n" +
	"\aitem_id\x18\x01 \x01(\x04R\x06itemId\x12\x17\n" +
	"\aslot_id\x18\x02 \x01(\rR\x06slotId\"\xb5\a\n" +
	"(CMsgClientToGCCreateStaticRecipeResponse\x12k\n" +
	"\bresponse\x18\x01 \x01(\x0e2<.protocol.CMsgClientToGCCreateStaticRecipeResponse.EResponse:\x11eResponse_SuccessR\bresponse\x12`\n" +
	"\foutput_items\x18\x02 \x03(\v2=.protocol.CMsgClientToGCCreateStaticRecipeResponse.OutputItemR\voutputItems\x12`\n" +
	"\finput_errors\x18\x03 \x03(\v2=.protocol.CMsgClientToGCCreateStaticRecipeResponse.InputErrorR\vinputErrors\x12r\n" +
	"\x12additional_outputs\x18\x04 \x03(\v2C.protocol.CMsgClientToGCCreateStaticRecipeResponse.AdditionalOutputR\x11additionalOutputs\x1a[\n" +
	"\n" +
	"OutputItem\x12\x1b\n" +
	"\tdef_index\x18\x01 \x01(\rR\bdefIndex\x12\x17\n" +
	"\aitem_id\x18\x02 \x01(\x04R\x06itemId\x12\x17\n" +
	"\aslot_id\x18\x03 \x01(\rR\x06slotId\x1a\x8c\x01\n" +
	"\n" +
	"InputError\x12\x17\n" +
	"\aslot_id\x18\x01 \x01(\rR\x06slotId\x12e\n" +
	"\x05error\x18\x02 \x01(\x0e2<.protocol.CMsgClientToGCCreateStaticRecipeResponse.EResponse:\x11eResponse_SuccessR\x05error\x1aA\n" +
	...
	"\x16eResponse_MissingEvent\x10\x05\"\xd0\x05\n" +
	...
	"\x05items\x18\t \x03(\v2*.protocol.CMsgProcessTransactionOrder.ItemR\x05items\x1a\xe5\x02\n" +
	"\x04Item\x12$\n" +
	...
	"\x0eis_user_facing\x18\t \x01(\bR\fisUserFacing\"\xa0\x01\n" +
	"&CMsgGCToGCStoreProcessCDKeyTransaction\x12;\n" +
	"\x05order\x18\x01 \x01(\v2%.protocol.CMsgProcessTransactionOrderR\x05order\x12\x1f\n" +
	...
	"\x05order\x18\x01 \x01(\v2%.protocol.CMsgProcessTransactionOrderR\x05order\"D\n" +
	...
	"conCommand\x12#\n" +
	"\rreport_output\x18\x02 \x01(\bR\freportOutput\x12!\n" +
	"\n" +
	"sending_gc\x18\x03 \x01(\x05:\x02-1R\tsendingGc\x12)\n" +
	"\x10output_initiator\x18\x04 \x01(\tR\x0foutputInitiator\"\x91\x02\n" +
	"\x17CMsgGCToGCConsoleOutput\x12\x1c\n" +
	"\tinitiator\x18\x01 \x01(\tR\tinitiator\x12!\n" +
	"\n" +
	"sending_gc\x18\x02 \x01(\x05:\x02-1R\tsendingGc\x12@\n" +
	"\x04msgs\x18\x03 \x03(\v2,.protocol.CMsgGCToGCConsoleOutput.OutputLineR\x04msgs\x122\n" +
	"\x16is_last_for_source_job\x18\x04 \x01(\bR\x12isLastForSourceJob\x1a?\n" +
	"\n" +
	"OutputLine\x12\x12\n" +
	"\x04text\x18\x01 \x01(\tR\x04text\x12\x1d\n" +
	"\n" +
	"spew_level\x18\x02 \x01(\rR\tspewLevel\"\xc2\x01\n" +
	"\fCMsgItemAges\x12^\n" +
	"\x16max_item_id_timestamps\x18\x01 \x03(\v2).protocol.CMsgItemAges.MaxItemIDTimestampR\x13maxItemIdTimestamps\x1aR\n" +
	"\x12MaxItemIDTimestamp\x12\x1c\n" +
	"\ttimestamp\x18\x01 \x01(\rR\ttimestamp\x12\x1e\n" +
	"\vmax_item_id\x18\x02 \x01(\x04R\tmaxItemId\"\xff\x01\n" +
	"\x19CMsgGCToGCInternalTestMsg\x12!\n" +
	"\n" +
	"sending_gc\x18\x01 \x01(\x05:\x02-1R\tsendingGc\x12\x1b\n" +
	...
	"\fwhat_changed\x18\x05 \x01(\rR\vwhatChanged\"\xb5\x01\n" +
	...
	"\x0faccount_id_list\x18\x03 \x03(\rB\x02\x10\x01R\raccountIdList\x12&\n" +
	"\rsteam_id_list\x18\x04 \x03(\x06B\x02\x10\x01R\vsteamIdList\"\xf2\x01\n" +
	"!CMsgGCToClientCurrencyPricePoints\x12\x1f\n" +
	"\tprice_key\x18\x01 \x03(\x04B\x02\x10\x01R\bpriceKey\x12T\n" +
	"\n" +
	"currencies\x18\x02 \x03(\v24.protocol.CMsgGCToClientCurrencyPricePoints.CurrencyR\n" +
	"currencies\x1aV\n" +
	"\bCurrency\x12\x1f\n" +
	"\vcurrency_id\x18\x01 \x01(\rR\n" +
	"currencyId\x12)\n" +
	"\x0ecurrency_price\x18\x02 \x03(\x04B\x02\x10\x01R\rcurrencyPrice\"Q\n" +
	"\x12CMsgBannedWordList\x12\x18\n" +
	"\aversion\x18\x01 \x01(\rR\aversion\x12!\n" +
	"\fbanned_words\x18\x02 \x03(\tR\vbannedWords\"\xa9\x01\n" +
	"\"CMsgGCToGCFlushSteamInventoryCache\x12D\n" +
	"\x04keys\x18\x01 \x03(\v20.protocol.CMsgGCToGCFlushSteamInventoryCache.KeyR\x04keys\x1a=\n" +
	"\x03Key\x12\x18\n" +
	...
	"\x1fCMsgGCToGCGetInfuxIntervalStats\"\xdf\x01\n" +
	"'CMsgGCToGCGetInfuxIntervalStatsResponse\x12\x1d\n" +
	"\bstat_ids\x18\x01 \x03(\aB\x02\x10\x01R\astatIds\x12!\n" +
	"\n" +
	"stat_total\x18\x02 \x03(\x04B\x02\x10\x01R\tstatTotal\x12%\n" +
	"\fstat_samples\x18\x03 \x03(\rB\x02\x10\x01R\vstatSamples\x12\x1d\n" +
	"\bstat_max\x18\x04 \x03(\rB\x02\x10\x01R\astatMax\x12,\n" +
	...
	"\bitem_def\x18\x01 \x01(\rR\aitemDef\"\xef\x02\n" +
	"4CMsgClientToGCGetLimitedItemPurchaseQuantityResponse\x12r\n" +
	"\x06result\x18\x01 \x01(\x0e2H.protocol.CMsgClientToGCGetLimitedItemPurchaseQuantityResponse.EResponse:\x10k_eInternalErrorR\x06result\x12-\n" +
	...
	"\x14k_eItemDefNotLimited\x10\x06\"\x85\x01\n" +
	"\x1aCMsgGCToGCUpdateWelcomeMsg\x12\x16\n" +
	"\x06server\x18\x01 \x01(\bR\x06server\x121\n" +
	"\anew_msg\x18\x02 \x01(\v2\x18.protocol.CExtraMsgBlockR\x06newMsg\x12\x1c\n" +
	"\tbroadcast\x18\x03 \x01(\bR\tbroadcast*\xd9$\n" +
	"\n" +
	"EGCItemMsg\x12\x11\n" +
	...
	"&k_EMsgGCToGCGrantSelfMadeItemToAccount\x10\xfb\x13\x12\x18\n" +
	...
	"\x1bk_EMsgGCToGCBetaDeleteItems\x10\xb3\x14*\xb9\n" +
	"\n" +
	...
	"3k_EGCMsgInitiateTradeResponse_WalledFundsNotTrusted\x10\x18B\rZ\v./;protocol"
...
var file_econ_gcmessages_proto_enumTypes = make([]protoimpl.EnumInfo, 13)
var file_econ_gcmessages_proto_msgTypes = make([]protoimpl.MessageInfo, 129)
var file_econ_gcmessages_proto_goTypes = []any{
	(EGCItemMsg)(0),                                                       // 0: protocol.EGCItemMsg
	(EGCMsgInitiateTradeResponse)(0),                                      // 1: protocol.EGCMsgInitiateTradeResponse
	...
	(*CMsgApplyAutograph)(nil),                                            // 13: protocol.CMsgApplyAutograph
	(*CMsgAdjustItemEquippedState)(nil),                                   // 14: protocol.CMsgAdjustItemEquippedState
	(*CMsgEconPlayerStrangeCountAdjustment)(nil),                          // 15: protocol.CMsgEconPlayerStrangeCountAdjustment
	(*CMsgCraftingResponse)(nil),                                          // 16: protocol.CMsgCraftingResponse
	(*CMsgGCRequestStoreSalesData)(nil),                                   // 17: protocol.CMsgGCRequestStoreSalesData
	(*CMsgGCRequestStoreSalesDataResponse)(nil),                           // 18: protocol.CMsgGCRequestStoreSalesDataResponse
	(*CMsgGCRequestStoreSalesDataUpToDateResponse)(nil),                   // 19: protocol.CMsgGCRequestStoreSalesDataUpToDateResponse
	(*CMsgGCToGCPingRequest)(nil),                                         // 20: protocol.CMsgGCToGCPingRequest
	(*CMsgGCToGCPingResponse)(nil),                                        // 21: protocol.CMsgGCToGCPingResponse
	(*CMsgGCToGCGetUserSessionServer)(nil),                                // 22: protocol.CMsgGCToGCGetUserSessionServer
	(*CMsgGCToGCGetUserSessionServerResponse)(nil),                        // 23: protocol.CMsgGCToGCGetUserSessionServerResponse
	(*CMsgGCToGCGetUserServerMembers)(nil),                                // 24: protocol.CMsgGCToGCGetUserServerMembers
	(*CMsgGCToGCGetUserServerMembersResponse)(nil),                        // 25: protocol.CMsgGCToGCGetUserServerMembersResponse
	(*CMsgLookupMultipleAccountNames)(nil),                                // 26: protocol.CMsgLookupMultipleAccountNames
	(*CMsgLookupMultipleAccountNamesResponse)(nil),                        // 27: protocol.CMsgLookupMultipleAccountNamesResponse
	(*CMsgRequestCrateItems)(nil),                                         // 28: protocol.CMsgRequestCrateItems
	(*CMsgRequestCrateItemsResponse)(nil),                                 // 29: protocol.CMsgRequestCrateItemsResponse
	(*CMsgRequestCrateEscalationLevel)(nil),                               // 30: protocol.CMsgRequestCrateEscalationLevel
	(*CMsgRequestCrateEscalationLevelResponse)(nil),                       // 31: protocol.CMsgRequestCrateEscalationLevelResponse
	(*CMsgGCToGCCanUseDropRateBonus)(nil),                                 // 32: protocol.CMsgGCToGCCanUseDropRateBonus
	(*CMsgSQLAddDropRateBonus)(nil),                                       // 33: protocol.CMsgSQLAddDropRateBonus
	(*CMsgSQLUpgradeBattleBooster)(nil),                                   // 34: protocol.CMsgSQLUpgradeBattleBooster
	(*CMsgGCToGCRefreshSOCache)(nil),                                      // 35: protocol.CMsgGCToGCRefreshSOCache
	(*CMsgGCToGCAddSubscriptionTime)(nil),                                 // 36: protocol.CMsgGCToGCAddSubscriptionTime
	(*CMsgGCToGCGrantAccountRolledItems)(nil),                             // 37: protocol.CMsgGCToGCGrantAccountRolledItems
	(*CMsgGCToGCBetaDeleteItems)(nil),                                     // 38: protocol.CMsgGCToGCBetaDeleteItems
	(*CMsgGCToGCGrantSelfMadeItemToAccount)(nil),                          // 39: protocol.CMsgGCToGCGrantSelfMadeItemToAccount
	(*CMsgUseItem)(nil),                                                   // 40: protocol.CMsgUseItem
	(*CMsgServerUseItem)(nil),                                             // 41: protocol.CMsgServerUseItem
	(*CMsgUseMultipleItems)(nil),                                          // 42: protocol.CMsgUseMultipleItems
	(*CGCStoreRechargeRedirect_LineItem)(nil),                             // 43: protocol.CGCStoreRechargeRedirect_LineItem
	(*CMsgGCEconSQLWorkItemEmbeddedRollbackData)(nil),                     // 44: protocol.CMsgGCEconSQLWorkItemEmbeddedRollbackData
	(*CMsgCraftStatue)(nil),                                               // 45: protocol.CMsgCraftStatue
	(*CMsgRedeemCode)(nil),                                                // 46: protocol.CMsgRedeemCode
	(*CMsgRedeemCodeResponse)(nil),                                        // 47: protocol.CMsgRedeemCodeResponse
	(*CMsgDevNewItemRequest)(nil),                                         // 48: protocol.CMsgDevNewItemRequest
	(*CMsgDevNewItemRequestResponse)(nil),                                 // 49: protocol.CMsgDevNewItemRequestResponse
	(*CMsgDevUnlockAllItemStyles)(nil),                                    // 50: protocol.CMsgDevUnlockAllItemStyles
	(*CMsgDevUnlockAllItemStylesResponse)(nil),                            // 51: protocol.CMsgDevUnlockAllItemStylesResponse
	(*CMsgGCGetAccountSubscriptionItem)(nil),                              // 52: protocol.CMsgGCGetAccountSubscriptionItem
	(*CMsgGCGetAccountSubscriptionItemResponse)(nil),                      // 53: protocol.CMsgGCGetAccountSubscriptionItemResponse
	(*CMsgGCAddGiftItem)(nil),                                             // 54: protocol.CMsgGCAddGiftItem
	(*CMsgClientToGCWrapAndDeliverGift)(nil),                              // 55: protocol.CMsgClientToGCWrapAndDeliverGift
	(*CMsgClientToGCWrapAndDeliverGiftResponse)(nil),                      // 56: protocol.CMsgClientToGCWrapAndDeliverGiftResponse
	(*CMsgClientToGCUnwrapGift)(nil),                                      // 57: protocol.CMsgClientToGCUnwrapGift
	(*CMsgClientToGCGetGiftPermissions)(nil),                              // 58: protocol.CMsgClientToGCGetGiftPermissions
	(*CMsgClientToGCGetGiftPermissionsResponse)(nil),                      // 59: protocol.CMsgClientToGCGetGiftPermissionsResponse
	(*CMsgClientToGCUnpackBundle)(nil),                                    // 60: protocol.CMsgClientToGCUnpackBundle
	(*CMsgClientToGCUnpackBundleResponse)(nil),                            // 61: protocol.CMsgClientToGCUnpackBundleResponse
	(*CMsgClientToGCPackBundle)(nil),                                      // 62: protocol.CMsgClientToGCPackBundle
	(*CMsgClientToGCPackBundleResponse)(nil),                              // 63: protocol.CMsgClientToGCPackBundleResponse
	(*CMsgGCToClientStoreTransactionCompleted)(nil),                       // 64: protocol.CMsgGCToClientStoreTransactionCompleted
	(*CMsgClientToGCEquipItems)(nil),                                      // 65: protocol.CMsgClientToGCEquipItems
	(*CMsgClientToGCEquipItemsResponse)(nil),                              // 66: protocol.CMsgClientToGCEquipItemsResponse
	(*CMsgClientToGCSetItemStyle)(nil),                                    // 67: protocol.CMsgClientToGCSetItemStyle
	(*CMsgClientToGCSetItemStyleResponse)(nil),                            // 68: protocol.CMsgClientToGCSetItemStyleResponse
	(*CMsgClientToGCUnlockItemStyle)(nil),                                 // 69: protocol.CMsgClientToGCUnlockItemStyle
	(*CMsgClientToGCUnlockItemStyleResponse)(nil),                         // 70: protocol.CMsgClientToGCUnlockItemStyleResponse
	(*CMsgClientToGCSetItemInventoryCategory)(nil),                        // 71: protocol.CMsgClientToGCSetItemInventoryCategory
	(*CMsgClientToGCUnlockCrate)(nil),                                     // 72: protocol.CMsgClientToGCUnlockCrate
	(*CMsgClientToGCUnlockCrateResponse)(nil),                             // 73: protocol.CMsgClientToGCUnlockCrateResponse
	(*CMsgClientToGCRemoveItemAttribute)(nil),                             // 74: protocol.CMsgClientToGCRemoveItemAttribute
	(*CMsgClientToGCRemoveItemAttributeResponse)(nil),                     // 75: protocol.CMsgClientToGCRemoveItemAttributeResponse
	(*CMsgClientToGCNameItem)(nil),                                        // 76: protocol.CMsgClientToGCNameItem
	(*CMsgClientToGCNameItemResponse)(nil),                                // 77: protocol.CMsgClientToGCNameItemResponse
	(*CMsgGCSetItemPosition)(nil),                                         // 78: protocol.CMsgGCSetItemPosition
	(*CAttribute_ItemDynamicRecipeComponent)(nil),                         // 79: protocol.CAttribute_ItemDynamicRecipeComponent
	(*CProtoItemSocket)(nil),                                              // 80: protocol.CProtoItemSocket
	(*CProtoItemSocket_Empty)(nil),                                        // 81: protocol.CProtoItemSocket_Empty
	(*CProtoItemSocket_Effect)(nil),                                       // 82: protocol.CProtoItemSocket_Effect
	(*CProtoItemSocket_Color)(nil),                                        // 83: protocol.CProtoItemSocket_Color
	(*CProtoItemSocket_Strange)(nil),                                      // 84: protocol.CProtoItemSocket_Strange
	(*CProtoItemSocket_Strange_DESERIALIZE_FROM_STRING_ONLY)(nil),         // 85: protocol.CProtoItemSocket_Strange_DESERIALIZE_FROM_STRING_ONLY
	(*CProtoItemSocket_Spectator)(nil),                                    // 86: protocol.CProtoItemSocket_Spectator
	(*CProtoItemSocket_AssetModifier)(nil),                                // 87: protocol.CProtoItemSocket_AssetModifier
	(*CProtoItemSocket_AssetModifier_DESERIALIZE_FROM_STRING_ONLY)(nil),   // 88: protocol.CProtoItemSocket_AssetModifier_DESERIALIZE_FROM_STRING_ONLY
	(*CProtoItemSocket_Autograph)(nil),                                    // 89: protocol.CProtoItemSocket_Autograph
	(*CProtoItemSocket_StaticVisuals)(nil),                                // 90: protocol.CProtoItemSocket_StaticVisuals
	(*CAttribute_String)(nil),                                             // 91: protocol.CAttribute_String
	(*CWorkshop_GetItemDailyRevenue_Request)(nil),                         // 92: protocol.CWorkshop_GetItemDailyRevenue_Request
	(*CWorkshop_GetItemDailyRevenue_Response)(nil),                        // 93: protocol.CWorkshop_GetItemDailyRevenue_Response
	(*CWorkshop_GetPackageDailyRevenue_Request)(nil),                      // 94: protocol.CWorkshop_GetPackageDailyRevenue_Request
	(*CWorkshop_GetPackageDailyRevenue_Response)(nil),                     // 95: protocol.CWorkshop_GetPackageDailyRevenue_Response
	(*CMsgSQLGCToGCGrantBackpackSlots)(nil),                               // 96: protocol.CMsgSQLGCToGCGrantBackpackSlots
	(*CMsgClientToGCLookupAccountName)(nil),                               // 97: protocol.CMsgClientToGCLookupAccountName
	(*CMsgClientToGCLookupAccountNameResponse)(nil),                       // 98: protocol.CMsgClientToGCLookupAccountNameResponse
	(*CMsgClientToGCCreateStaticRecipe)(nil),                              // 99: protocol.CMsgClientToGCCreateStaticRecipe
	(*CMsgClientToGCCreateStaticRecipeResponse)(nil),                      // 100: protocol.CMsgClientToGCCreateStaticRecipeResponse
	(*CMsgProcessTransactionOrder)(nil),                                   // 101: protocol.CMsgProcessTransactionOrder
	(*CMsgGCToGCStoreProcessCDKeyTransaction)(nil),                        // 102: protocol.CMsgGCToGCStoreProcessCDKeyTransaction
	(*CMsgGCToGCStoreProcessCDKeyTransactionResponse)(nil),                // 103: protocol.CMsgGCToGCStoreProcessCDKeyTransactionResponse
	(*CMsgGCToGCStoreProcessSettlement)(nil),                              // 104: protocol.CMsgGCToGCStoreProcessSettlement
	(*CMsgGCToGCStoreProcessSettlementResponse)(nil),                      // 105: protocol.CMsgGCToGCStoreProcessSettlementResponse
	(*CMsgGCToGCBroadcastConsoleCommand)(nil),                             // 106: protocol.CMsgGCToGCBroadcastConsoleCommand
	(*CMsgGCToGCConsoleOutput)(nil),                                       // 107: protocol.CMsgGCToGCConsoleOutput
	(*CMsgItemAges)(nil),                                                  // 108: protocol.CMsgItemAges
	(*CMsgGCToGCInternalTestMsg)(nil),                                     // 109: protocol.CMsgGCToGCInternalTestMsg
	(*CMsgGCToGCClientServerVersionsUpdated)(nil),                         // 110: protocol.CMsgGCToGCClientServerVersionsUpdated
	(*CMsgGCToGCBroadcastMessageFromSub)(nil),                             // 111: protocol.CMsgGCToGCBroadcastMessageFromSub
	(*CMsgGCToClientCurrencyPricePoints)(nil),                             // 112: protocol.CMsgGCToClientCurrencyPricePoints
	(*CMsgBannedWordList)(nil),                                            // 113: protocol.CMsgBannedWordList
	(*CMsgGCToGCFlushSteamInventoryCache)(nil),                            // 114: protocol.CMsgGCToGCFlushSteamInventoryCache
	(*CMsgGCToGCUpdateSubscriptionItems)(nil),                             // 115: protocol.CMsgGCToGCUpdateSubscriptionItems
	(*CMsgGCToGCSelfPing)(nil),                                            // 116: protocol.CMsgGCToGCSelfPing
	(*CMsgGCToGCGetInfuxIntervalStats)(nil),                               // 117: protocol.CMsgGCToGCGetInfuxIntervalStats
	(*CMsgGCToGCGetInfuxIntervalStatsResponse)(nil),                       // 118: protocol.CMsgGCToGCGetInfuxIntervalStatsResponse
	(*CMsgGCToGCPurchaseSucceeded)(nil),                                   // 119: protocol.CMsgGCToGCPurchaseSucceeded
	(*CMsgClientToGCGetLimitedItemPurchaseQuantity)(nil),                  // 120: protocol.CMsgClientToGCGetLimitedItemPurchaseQuantity
	(*CMsgClientToGCGetLimitedItemPurchaseQuantityResponse)(nil),          // 121: protocol.CMsgClientToGCGetLimitedItemPurchaseQuantityResponse
	(*CMsgGCToGCUpdateWelcomeMsg)(nil),                                    // 122: protocol.CMsgGCToGCUpdateWelcomeMsg
	(*CMsgEconPlayerStrangeCountAdjustment_CStrangeCountAdjustment)(nil),  // 123: protocol.CMsgEconPlayerStrangeCountAdjustment.CStrangeCountAdjustment
	(*CMsgGCRequestStoreSalesDataResponse_Price)(nil),                     // 124: protocol.CMsgGCRequestStoreSalesDataResponse.Price
	(*CMsgLookupMultipleAccountNamesResponse_Account)(nil),                // 125: protocol.CMsgLookupMultipleAccountNamesResponse.Account
	(*CMsgGCToGCGrantAccountRolledItems_Item)(nil),                        // 126: protocol.CMsgGCToGCGrantAccountRolledItems.Item
	(*CMsgGCToGCGrantAccountRolledItems_Item_DynamicAttribute)(nil),       // 127: protocol.CMsgGCToGCGrantAccountRolledItems.Item.DynamicAttribute
	(*CMsgGCToGCGrantAccountRolledItems_Item_AdditionalAuditEntry)(nil),   // 128: protocol.CMsgGCToGCGrantAccountRolledItems.Item.AdditionalAuditEntry
	(*CMsgClientToGCGetGiftPermissionsResponse_FriendPermission)(nil),     // 129: protocol.CMsgClientToGCGetGiftPermissionsResponse.FriendPermission
	(*CMsgClientToGCUnlockCrateResponse_Item)(nil),                        // 130: protocol.CMsgClientToGCUnlockCrateResponse.Item
	(*CWorkshop_GetItemDailyRevenue_Response_CountryDailyRevenue)(nil),    // 131: protocol.CWorkshop_GetItemDailyRevenue_Response.CountryDailyRevenue
	(*CWorkshop_GetPackageDailyRevenue_Response_CountryDailyRevenue)(nil), // 132: protocol.CWorkshop_GetPackageDailyRevenue_Response.CountryDailyRevenue
	(*CMsgClientToGCCreateStaticRecipe_Item)(nil),                         // 133: protocol.CMsgClientToGCCreateStaticRecipe.Item
	(*CMsgClientToGCCreateStaticRecipeResponse_OutputItem)(nil),           // 134: protocol.CMsgClientToGCCreateStaticRecipeResponse.OutputItem
	(*CMsgClientToGCCreateStaticRecipeResponse_InputError)(nil),           // 135: protocol.CMsgClientToGCCreateStaticRecipeResponse.InputError
	(*CMsgClientToGCCreateStaticRecipeResponse_AdditionalOutput)(nil),     // 136: protocol.CMsgClientToGCCreateStaticRecipeResponse.AdditionalOutput
	(*CMsgProcessTransactionOrder_Item)(nil),                              // 137: protocol.CMsgProcessTransactionOrder.Item
	(*CMsgGCToGCConsoleOutput_OutputLine)(nil),                            // 138: protocol.CMsgGCToGCConsoleOutput.OutputLine
	(*CMsgItemAges_MaxItemIDTimestamp)(nil),                               // 139: protocol.CMsgItemAges.MaxItemIDTimestamp
	(*CMsgGCToClientCurrencyPricePoints_Currency)(nil),                    // 140: protocol.CMsgGCToClientCurrencyPricePoints.Currency
	(*CMsgGCToGCFlushSteamInventoryCache_Key)(nil),                        // 141: protocol.CMsgGCToGCFlushSteamInventoryCache.Key
	(EGCMsgResponse)(0),                                                   // 142: protocol.EGCMsgResponse
	(*CExtraMsgBlock)(nil),                                                // 143: protocol.CExtraMsgBlock
}
var file_econ_gcmessages_proto_depIdxs = []int32{
	123, // 0: protocol.CMsgEconPlayerStrangeCountAdjustment.strange_count_adjustments:type_name -> protocol.CMsgEconPlayerStrangeCountAdjustment.CStrangeCountAdjustment
	124, // 1: protocol.CMsgGCRequestStoreSalesDataResponse.sale_price:type_name -> protocol.CMsgGCRequestStoreSalesDataResponse.Price
	125, // 2: protocol.CMsgLookupMultipleAccountNamesResponse.accounts:type_name -> protocol.CMsgLookupMultipleAccountNamesResponse.Account
	126, // 3: protocol.CMsgGCToGCGrantAccountRolledItems.items:type_name -> protocol.CMsgGCToGCGrantAccountRolledItems.Item
	40,  // 4: protocol.CMsgServerUseItem.use_item_msg:type_name -> protocol.CMsgUseItem
	142, // 5: protocol.CMsgClientToGCWrapAndDeliverGiftResponse.response:type_name -> protocol.EGCMsgResponse
	1,   // 6: protocol.CMsgClientToGCWrapAndDeliverGiftResponse.trade_restriction:type_name -> protocol.EGCMsgInitiateTradeResponse
	1,   // 7: protocol.CMsgClientToGCGetGiftPermissionsResponse.sender_permission:type_name -> protocol.EGCMsgInitiateTradeResponse
	129, // 8: protocol.CMsgClientToGCGetGiftPermissionsResponse.friend_permissions:type_name -> protocol.CMsgClientToGCGetGiftPermissionsResponse.FriendPermission
	5,   // 9: protocol.CMsgClientToGCUnpackBundleResponse.response:type_name -> protocol.CMsgClientToGCUnpackBundleResponse.EUnpackBundle
	6,   // 10: protocol.CMsgClientToGCPackBundleResponse.response:type_name -> protocol.CMsgClientToGCPackBundleResponse.EPackBundle
	14,  // 11: protocol.CMsgClientToGCEquipItems.equips:type_name -> protocol.CMsgAdjustItemEquippedState
	7,   // 12: protocol.CMsgClientToGCSetItemStyleResponse.response:type_name -> protocol.CMsgClientToGCSetItemStyleResponse.ESetStyle
	8,   // 13: protocol.CMsgClientToGCUnlockItemStyleResponse.response:type_name -> protocol.CMsgClientToGCUnlockItemStyleResponse.EUnlockStyle
	142, // 14: protocol.CMsgClientToGCUnlockCrateResponse.result:type_name -> protocol.EGCMsgResponse
	130, // 15: protocol.CMsgClientToGCUnlockCrateResponse.granted_items:type_name -> protocol.CMsgClientToGCUnlockCrateResponse.Item
	9,   // 16: protocol.CMsgClientToGCRemoveItemAttributeResponse.response:type_name -> protocol.CMsgClientToGCRemoveItemAttributeResponse.ERemoveItemAttribute
	10,  // 17: protocol.CMsgClientToGCNameItemResponse.response:type_name -> protocol.CMsgClientToGCNameItemResponse.ENameItem
	80,  // 18: protocol.CProtoItemSocket_Empty.socket:type_name -> protocol.CProtoItemSocket
	80,  // 19: protocol.CProtoItemSocket_Effect.socket:type_name -> protocol.CProtoItemSocket
	80,  // 20: protocol.CProtoItemSocket_Color.socket:type_name -> protocol.CProtoItemSocket
	80,  // 21: protocol.CProtoItemSocket_Strange.socket:type_name -> protocol.CProtoItemSocket
	80,  // 22: protocol.CProtoItemSocket_Strange_DESERIALIZE_FROM_STRING_ONLY.socket:type_name -> protocol.CProtoItemSocket
	80,  // 23: protocol.CProtoItemSocket_Spectator.socket:type_name -> protocol.CProtoItemSocket
	80,  // 24: protocol.CProtoItemSocket_AssetModifier.socket:type_name -> protocol.CProtoItemSocket
	80,  // 25: protocol.CProtoItemSocket_AssetModifier_DESERIALIZE_FROM_STRING_ONLY.socket:type_name -> protocol.CProtoItemSocket
	80,  // 26: protocol.CProtoItemSocket_Autograph.socket:type_name -> protocol.CProtoItemSocket
	80,  // 27: protocol.CProtoItemSocket_StaticVisuals.socket:type_name -> protocol.CProtoItemSocket
	131, // 28: protocol.CWorkshop_GetItemDailyRevenue_Response.country_revenue:type_name -> protocol.CWorkshop_GetItemDailyRevenue_Response.CountryDailyRevenue
	132, // 29: protocol.CWorkshop_GetPackageDailyRevenue_Response.country_revenue:type_name -> protocol.CWorkshop_GetPackageDailyRevenue_Response.CountryDailyRevenue
	133, // 30: protocol.CMsgClientToGCCreateStaticRecipe.items:type_name -> protocol.CMsgClientToGCCreateStaticRecipe.Item
	11,  // 31: protocol.CMsgClientToGCCreateStaticRecipeResponse.response:type_name -> protocol.CMsgClientToGCCreateStaticRecipeResponse.EResponse
	134, // 32: protocol.CMsgClientToGCCreateStaticRecipeResponse.output_items:type_name -> protocol.CMsgClientToGCCreateStaticRecipeResponse.OutputItem
	135, // 33: protocol.CMsgClientToGCCreateStaticRecipeResponse.input_errors:type_name -> protocol.CMsgClientToGCCreateStaticRecipeResponse.InputError
	136, // 34: protocol.CMsgClientToGCCreateStaticRecipeResponse.additional_outputs:type_name -> protocol.CMsgClientToGCCreateStaticRecipeResponse.AdditionalOutput
	137, // 35: protocol.CMsgProcessTransactionOrder.items:type_name -> protocol.CMsgProcessTransactionOrder.Item
	101, // 36: protocol.CMsgGCToGCStoreProcessCDKeyTransaction.order:type_name -> protocol.CMsgProcessTransactionOrder
	101, // 37: protocol.CMsgGCToGCStoreProcessSettlement.order:type_name -> protocol.CMsgProcessTransactionOrder
	138, // 38: protocol.CMsgGCToGCConsoleOutput.msgs:type_name -> protocol.CMsgGCToGCConsoleOutput.OutputLine
	139, // 39: protocol.CMsgItemAges.max_item_id_timestamps:type_name -> protocol.CMsgItemAges.MaxItemIDTimestamp
	140, // 40: protocol.CMsgGCToClientCurrencyPricePoints.currencies:type_name -> protocol.CMsgGCToClientCurrencyPricePoints.Currency
	141, // 41: protocol.CMsgGCToGCFlushSteamInventoryCache.keys:type_name -> protocol.CMsgGCToGCFlushSteamInventoryCache.Key
	12,  // 42: protocol.CMsgClientToGCGetLimitedItemPurchaseQuantityResponse.result:type_name -> protocol.CMsgClientToGCGetLimitedItemPurchaseQuantityResponse.EResponse
	143, // 43: protocol.CMsgGCToGCUpdateWelcomeMsg.new_msg:type_name -> protocol.CExtraMsgBlock
	127, // 44: protocol.CMsgGCToGCGrantAccountRolledItems.Item.dynamic_attributes:type_name -> protocol.CMsgGCToGCGrantAccountRolledItems.Item.DynamicAttribute
	128, // 45: protocol.CMsgGCToGCGrantAccountRolledItems.Item.additional_audit_entries:type_name -> protocol.CMsgGCToGCGrantAccountRolledItems.Item.AdditionalAuditEntry
	1,   // 46: protocol.CMsgClientToGCGetGiftPermissionsResponse.FriendPermission.permission:type_name -> protocol.EGCMsgInitiateTradeResponse
	11,  // 47: protocol.CMsgClientToGCCreateStaticRecipeResponse.InputError.error:type_name -> protocol.CMsgClientToGCCreateStaticRecipeResponse.EResponse
