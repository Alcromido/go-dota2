...
const file_dota_gcmessages_client_team_proto_rawDesc = "" +
	...
	"\fmember_stats\x18! \x03(\v2&.protocol.CMsgDOTATeamInfo.MemberStatsR\vmemberStats\x12C\n" +
	"\n" +
	"team_stats\x18\" \x01(\v2$.protocol.CMsgDOTATeamInfo.TeamStatsR\tteamStats\x12E\n" +
	"\vdpc_results\x18# \x03(\v2$.protocol.CMsgDOTATeamInfo.DPCResultR\n" +
	"dpcResults\x12#\n" +
	...
	"\aavg_xpm\x18\t \x01(\x02R\x06avgXpm\x1a\x9e\x02\n" +
	"\vMemberStats\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12$\n" +
	"\x0ewins_with_team\x18\x02 \x01(\rR\fwinsWithTeam\x12(\n" +
	"\x10losses_with_team\x18\x03 \x01(\rR\x0elossesWithTeam\x12C\n" +
	"\n" +
	"top_heroes\x18\x04 \x03(\v2$.protocol.CMsgDOTATeamInfo.HeroStatsR\ttopHeroes\x12\x1b\n" +
	"\tavg_kills\x18\x05 \x01(\x02R\bavgKills\x12\x1d\n" +
	"\n" +
	"avg_deaths\x18\x06 \x01(\x02R\tavgDeaths\x12\x1f\n" +
	"\vavg_assists\x18\a \x01(\x02R\n" +
	"avgAssists\x1a\x8d\x02\n" +
	"\tTeamStats\x12I\n" +
	"\rplayed_heroes\x18\x01 \x03(\v2$.protocol.CMsgDOTATeamInfo.HeroStatsR\fplayedHeroes\x12\x18\n" +
	...
	"\ttimestamp\x18\x05 \x01(\rR\ttimestamp\x1a\xdb\x01\n" +
	"\x06Member\x12\x1d\n" +
	"\n" +
	...
	"\bpro_name\x18\x06 \x01(\tR\aproName\x12C\n" +
	"\x04role\x18\b \x01(\x0e2\x17.protocol.Fantasy_Roles:\x16FANTASY_ROLE_UNDEFINEDR\x04role\x12\x1b\n" +
	...
	"\n" +
	"account_id\x18\x03 \x01(\rR\taccountId\"b\n" +
	"\x11CMsgDOTATeamsInfo\x12\x1b\n" +
	"\tleague_id\x18\x01 \x01(\rR\bleagueId\x120\n" +
	"\x05teams\x18\x02 \x03(\v2\x1a.protocol.CMsgDOTATeamInfoR\x05teams\"H\n" +
	"\x14CMsgDOTATeamInfoList\x120\n" +
	"\x05teams\x18\x01 \x03(\v2\x1a.protocol.CMsgDOTATeamInfoR\x05teams\"}\n" +
	"\x15CMsgDOTATeamInfoCache\x12'\n" +
	"\x0fcache_timestamp\x18\x01 \x01(\rR\x0ecacheTimestamp\x12;\n" +
	"\tteam_list\x18\x02 \x01(\v2\x1e.protocol.CMsgDOTATeamInfoListR\bteamList\"\x1b\n" +
	...
	"pickupTeam\x12\"\n" +
	"\fabbreviation\x18\n" +
	" \x01(\tR\fabbreviation\"\xb0\x04\n" +
	"\x1aCMsgDOTACreateTeamResponse\x12L\n" +
	"\x06result\x18\x01 \x01(\x0e2+.protocol.CMsgDOTACreateTeamResponse.Result:\aINVALIDR\x06result\x12\x17\n" +
	...
	"\fabbreviation\x18\v \x01(\tR\fabbreviation\"\xfe\x01\n" +
	"\x1fCMsgDOTAEditTeamDetailsResponse\x12Q\n" +
	"\x06result\x18\x01 \x01(\x0e20.protocol.CMsgDOTAEditTeamDetailsResponse.Result:\aSUCCESSR\x06result\"\x87\x01\n" +
	"\x06Result\x12\v\n" +
	...
	"\ateam_id\x18\x02 \x01(\rR\x06teamId\"\xcc\x01\n" +
	"/CMsgDOTATeamInvite_GCImmediateResponseToInviter\x12H\n" +
	"\x06result\x18\x01 \x01(\x0e2\x1b.protocol.ETeamInviteResult:\x13TEAM_INVITE_SUCCESSR\x06result\x12!\n" +
	...
	"\x04logo\x18\x04 \x01(\x04R\x04logo\"r\n" +
	"&CMsgDOTATeamInvite_InviteeResponseToGC\x12H\n" +
	"\x06result\x18\x01 \x01(\x0e2\x1b.protocol.ETeamInviteResult:\x13TEAM_INVITE_SUCCESSR\x06result\"\x95\x01\n" +
	"&CMsgDOTATeamInvite_GCResponseToInviter\x12H\n" +
	"\x06result\x18\x01 \x01(\x0e2\x1b.protocol.ETeamInviteResult:\x13TEAM_INVITE_SUCCESSR\x06result\x12!\n" +
	"\finvitee_name\x18\x02 \x01(\tR\vinviteeName\"\x8f\x01\n" +
	"&CMsgDOTATeamInvite_GCResponseToInvitee\x12H\n" +
	"\x06result\x18\x01 \x01(\x0e2\x1b.protocol.ETeamInviteResult:\x13TEAM_INVITE_SUCCESSR\x06result\x12\x1b\n" +
	"\tteam_name\x18\x02 \x01(\tR\bteamName\"P\n" +
	"\x16CMsgDOTAKickTeamMember\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12\x17\n" +
	"\ateam_id\x18\x02 \x01(\rR\x06teamId\"\xa1\x02\n" +
	"\x1eCMsgDOTAKickTeamMemberResponse\x12P\n" +
	"\x06result\x18\x01 \x01(\x0e2/.protocol.CMsgDOTAKickTeamMemberResponse.Result:\aSUCCESSR\x06result\"\xac\x01\n" +
	"\x06Result\x12\v\n" +
	"\aSUCCESS\x10\x00\x12 \n" +
	...
	"\ateam_id\x18\x02 \x01(\rR\x06teamId\"\x9a\x02\n" +
	"!CMsgDOTATransferTeamAdminResponse\x12S\n" +
	"\x06result\x18\x01 \x01(\x0e22.protocol.CMsgDOTATransferTeamAdminResponse.Result:\aSUCCESSR\x06result\"\x9f\x01\n" +
	"\x06Result\x12\v\n" +
	"\aSUCCESS\x10\x00\x12 \n" +
	...
	"\ateam_id\x18\x01 \x01(\rR\x06teamId\"\xcf\x01\n" +
	"\x19CMsgDOTALeaveTeamResponse\x12K\n" +
	"\x06result\x18\x01 \x01(\x0e2*.protocol.CMsgDOTALeaveTeamResponse.Result:\aSUCCESSR\x06result\"e\n" +
	"\x06Result\x12\v\n" +
	...
	"\x1dTEAM_INVITE_ERROR_UNSPECIFIED\x10\rB\rZ\v./;protocol"
...
var file_dota_gcmessages_client_team_proto_goTypes = []any{
	(ETeamInviteResult)(0),                                  // 0: protocol.ETeamInviteResult
	(CMsgDOTACreateTeamResponse_Result)(0),                  // 1: protocol.CMsgDOTACreateTeamResponse.Result
	(CMsgDOTAEditTeamDetailsResponse_Result)(0),             // 2: protocol.CMsgDOTAEditTeamDetailsResponse.Result
	(CMsgDOTAKickTeamMemberResponse_Result)(0),              // 3: protocol.CMsgDOTAKickTeamMemberResponse.Result
	(CMsgDOTATransferTeamAdminResponse_Result)(0),           // 4: protocol.CMsgDOTATransferTeamAdminResponse.Result
	(CMsgDOTALeaveTeamResponse_Result)(0),                   // 5: protocol.CMsgDOTALeaveTeamResponse.Result
	(*CMsgDOTATeamInfo)(nil),                                // 6: protocol.CMsgDOTATeamInfo
	(*CMsgDOTATeamsInfo)(nil),                               // 7: protocol.CMsgDOTATeamsInfo
	(*CMsgDOTATeamInfoList)(nil),                            // 8: protocol.CMsgDOTATeamInfoList
	(*CMsgDOTATeamInfoCache)(nil),                           // 9: protocol.CMsgDOTATeamInfoCache
	(*CMsgDOTAMyTeamInfoRequest)(nil),                       // 10: protocol.CMsgDOTAMyTeamInfoRequest
	(*CMsgDOTACreateTeam)(nil),                              // 11: protocol.CMsgDOTACreateTeam
	(*CMsgDOTACreateTeamResponse)(nil),                      // 12: protocol.CMsgDOTACreateTeamResponse
	(*CMsgDOTAEditTeamDetails)(nil),                         // 13: protocol.CMsgDOTAEditTeamDetails
	(*CMsgDOTAEditTeamDetailsResponse)(nil),                 // 14: protocol.CMsgDOTAEditTeamDetailsResponse
	(*CMsgDOTATeamInvite_InviterToGC)(nil),                  // 15: protocol.CMsgDOTATeamInvite_InviterToGC
	(*CMsgDOTATeamInvite_GCImmediateResponseToInviter)(nil), // 16: protocol.CMsgDOTATeamInvite_GCImmediateResponseToInviter
	(*CMsgDOTATeamInvite_GCRequestToInvitee)(nil),           // 17: protocol.CMsgDOTATeamInvite_GCRequestToInvitee
	(*CMsgDOTATeamInvite_InviteeResponseToGC)(nil),          // 18: protocol.CMsgDOTATeamInvite_InviteeResponseToGC
	(*CMsgDOTATeamInvite_GCResponseToInviter)(nil),          // 19: protocol.CMsgDOTATeamInvite_GCResponseToInviter
	(*CMsgDOTATeamInvite_GCResponseToInvitee)(nil),          // 20: protocol.CMsgDOTATeamInvite_GCResponseToInvitee
	(*CMsgDOTAKickTeamMember)(nil),                          // 21: protocol.CMsgDOTAKickTeamMember
	(*CMsgDOTAKickTeamMemberResponse)(nil),                  // 22: protocol.CMsgDOTAKickTeamMemberResponse
	(*CMsgDOTATransferTeamAdmin)(nil),                       // 23: protocol.CMsgDOTATransferTeamAdmin
	(*CMsgDOTATransferTeamAdminResponse)(nil),               // 24: protocol.CMsgDOTATransferTeamAdminResponse
	(*CMsgDOTALeaveTeam)(nil),                               // 25: protocol.CMsgDOTALeaveTeam
	(*CMsgDOTALeaveTeamResponse)(nil),                       // 26: protocol.CMsgDOTALeaveTeamResponse
	(*CMsgDOTABetaParticipation)(nil),                       // 27: protocol.CMsgDOTABetaParticipation
	(*CMsgDOTATeamInfo_HeroStats)(nil),                      // 28: protocol.CMsgDOTATeamInfo.HeroStats
	(*CMsgDOTATeamInfo_MemberStats)(nil),                    // 29: protocol.CMsgDOTATeamInfo.MemberStats
	(*CMsgDOTATeamInfo_TeamStats)(nil),                      // 30: protocol.CMsgDOTATeamInfo.TeamStats
	(*CMsgDOTATeamInfo_DPCResult)(nil),                      // 31: protocol.CMsgDOTATeamInfo.DPCResult
	(*CMsgDOTATeamInfo_Member)(nil),                         // 32: protocol.CMsgDOTATeamInfo.Member
	(*CMsgDOTATeamInfo_AuditEntry)(nil),                     // 33: protocol.CMsgDOTATeamInfo.AuditEntry
	(ELeagueRegion)(0),                                      // 34: protocol.ELeagueRegion
	(Fantasy_Roles)(0),                                      // 35: protocol.Fantasy_Roles
}
var file_dota_gcmessages_client_team_proto_depIdxs = []int32{
	32, // 0: protocol.CMsgDOTATeamInfo.members:type_name -> protocol.CMsgDOTATeamInfo.Member
	33, // 1: protocol.CMsgDOTATeamInfo.audit_entries:type_name -> protocol.CMsgDOTATeamInfo.AuditEntry
	34, // 2: protocol.CMsgDOTATeamInfo.region:type_name -> protocol.ELeagueRegion
	29, // 3: protocol.CMsgDOTATeamInfo.member_stats:type_name -> protocol.CMsgDOTATeamInfo.MemberStats
	30, // 4: protocol.CMsgDOTATeamInfo.team_stats:type_name -> protocol.CMsgDOTATeamInfo.TeamStats
	31, // 5: protocol.CMsgDOTATeamInfo.dpc_results:type_name -> protocol.CMsgDOTATeamInfo.DPCResult
	6,  // 6: protocol.CMsgDOTATeamsInfo.teams:type_name -> protocol.CMsgDOTATeamInfo
	6,  // 7: protocol.CMsgDOTATeamInfoList.teams:type_name -> protocol.CMsgDOTATeamInfo
	8,  // 8: protocol.CMsgDOTATeamInfoCache.team_list:type_name -> protocol.CMsgDOTATeamInfoList
	1,  // 9: protocol.CMsgDOTACreateTeamResponse.result:type_name -> protocol.CMsgDOTACreateTeamResponse.Result
	2,  // 10: protocol.CMsgDOTAEditTeamDetailsResponse.result:type_name -> protocol.CMsgDOTAEditTeamDetailsResponse.Result
	0,  // 11: protocol.CMsgDOTATeamInvite_GCImmediateResponseToInviter.result:type_name -> protocol.ETeamInviteResult
	0,  // 12: protocol.CMsgDOTATeamInvite_InviteeResponseToGC.result:type_name -> protocol.ETeamInviteResult
	0,  // 13: protocol.CMsgDOTATeamInvite_GCResponseToInviter.result:type_name -> protocol.ETeamInviteResult
	0,  // 14: protocol.CMsgDOTATeamInvite_GCResponseToInvitee.result:type_name -> protocol.ETeamInviteResult
	3,  // 15: protocol.CMsgDOTAKickTeamMemberResponse.result:type_name -> protocol.CMsgDOTAKickTeamMemberResponse.Result
	4,  // 16: protocol.CMsgDOTATransferTeamAdminResponse.result:type_name -> protocol.CMsgDOTATransferTeamAdminResponse.Result
	5,  // 17: protocol.CMsgDOTALeaveTeamResponse.result:type_name -> protocol.CMsgDOTALeaveTeamResponse.Result
	28, // 18: protocol.CMsgDOTATeamInfo.MemberStats.top_heroes:type_name -> protocol.CMsgDOTATeamInfo.HeroStats
	28, // 19: protocol.CMsgDOTATeamInfo.TeamStats.played_heroes:type_name -> protocol.CMsgDOTATeamInfo.HeroStats
	35, // 20: protocol.CMsgDOTATeamInfo.Member.role:type_name -> protocol.Fantasy_Roles
