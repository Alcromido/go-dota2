...
const file_dota_client_enums_proto_rawDesc = "" +
	"\n" +
	"\x17dota_client_enums.proto\x12\bprotocol\x1a\x17dota_shared_enums.proto*^\n" +
	...
	"\x1bk_EPartyBeaconType_Joinable\x10\x01B\rZ\v./;protocol"
...
var file_dota_client_enums_proto_goTypes = []any{
	(ETournamentTemplate)(0),   // 0: protocol.ETournamentTemplate
	(ETournamentGameState)(0),  // 1: protocol.ETournamentGameState
	(ETournamentTeamState)(0),  // 2: protocol.ETournamentTeamState
	(ETournamentState)(0),      // 3: protocol.ETournamentState
	(ETournamentNodeState)(0),  // 4: protocol.ETournamentNodeState
	(EDOTAGroupMergeResult)(0), // 5: protocol.EDOTAGroupMergeResult
	(EPartyBeaconType)(0),      // 6: protocol.EPartyBeaconType
}
