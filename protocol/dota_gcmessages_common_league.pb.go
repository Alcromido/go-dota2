...
const file_dota_gcmessages_common_league_proto_rawDesc = "" +
	"\n" +
	"#dota_gcmessages_common_league.proto\x12\bprotocol\x1a\x17dota_shared_enums.proto\"\xbd\a\n" +
	...
	"\x12incoming_node_id_2\x18\a \x01(\rR\x0fincomingNodeId2\x12I\n" +
	"\tnode_type\x18\b \x01(\x0e2\x19.protocol.ELeagueNodeType:\x11INVALID_NODE_TYPER\bnodeType\x12%\n" +
	...
	"\tteam_id_2\x18\f \x01(\rR\ateamId2\x12C\n" +
	"\amatches\x18\r \x03(\v2).protocol.CMsgDOTALeagueNode.MatchDetailsR\amatches\x12\x1e\n" +
	...
	"\n" +
	"stream_ids\x18\x12 \x03(\rR\tstreamIds\x124\n" +
	"\x04vods\x18\x14 \x03(\v2 .protocol.CMsgDOTALeagueNode.VODR\x04vods\x1aQ\n" +
	...
	"\n" +
	"team_count\x18\a \x01(\rR\tteamCount\x12Z\n" +
	"\x0fnode_group_type\x18\b \x01(\x0e2\x1e.protocol.ELeagueNodeGroupType:\x12INVALID_GROUP_TYPER\rnodeGroupType\x12X\n" +
	"\x11default_node_type\x18\t \x01(\x0e2\x19.protocol.ELeagueNodeType:\x11INVALID_NODE_TYPER\x0fdefaultNodeType\x12\x14\n" +
	"\x05round\x18\n" +
	...
	"\x05phase\x18\x12 \x01(\x0e2\x16.protocol.ELeaguePhase:\x12LEAGUE_PHASE_UNSETR\x05phase\x12D\n" +
	"\x06region\x18\x13 \x01(\x0e2\x17.protocol.ELeagueRegion:\x13LEAGUE_REGION_UNSETR\x06region\x12\x1d\n" +
	"\n" +
	...
	"\x16elimination_dpc_points\x18\x1a \x01(\rR\x14eliminationDpcPoints\x12U\n" +
	...
	"\n" +
	"prize_pool\x18\x02 \x01(\v2\".protocol.CMsgDOTALeague.PrizePoolR\tprizePool\x126\n" +
	"\x06admins\x18\x03 \x03(\v2\x1e.protocol.CMsgDOTALeague.AdminR\x06admins\x129\n" +
	"\astreams\x18\x04 \x03(\v2\x1f.protocol.CMsgDOTALeague.StreamR\astreams\x12B\n" +
	"\vnode_groups\x18\x05 \x03(\v2!.protocol.CMsgDOTALeagueNodeGroupR\n" +
	"nodeGroups\x12F\n" +
	"\fseries_infos\x18\x06 \x03(\v2#.protocol.CMsgDOTALeague.SeriesInfoR\vseriesInfos\x12N\n" +
	"\x12registered_players\x18\a \x03(\v2\x1f.protocol.CMsgDOTALeague.PlayerR\x11registeredPlayers\x1a\xc9\x04\n" +
	"\x04Info\x12\x1b\n" +
	"\tleague_id\x18\x01 \x01(\rR\bleagueId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12<\n" +
	"\x04tier\x18\x03 \x01(\x0e2\x15.protocol.ELeagueTier:\x11LEAGUE_TIER_UNSETR\x04tier\x12D\n" +
	"\x06region\x18\x04 \x01(\x0e2\x17.protocol.ELeagueRegion:\x13LEAGUE_REGION_UNSETR\x06region\x12\x10\n" +
	...
	"\n" +
	"image_bits\x18\v \x01(\rR\timageBits\x12D\n" +
	"\x06status\x18\f \x01(\x0e2\x17.protocol.ELeagueStatus:\x13LEAGUE_STATUS_UNSETR\x06status\x120\n" +
	...
	"revenuePct\x123\n" +
	"\x16revenue_cents_per_sale\x18\x04 \x01(\rR\x13revenueCentsPerSale\x1a\xe0\x01\n" +
	"\tPrizePool\x12&\n" +
	"\x0fbase_prize_pool\x18\x01 \x01(\rR\rbasePrizePool\x12(\n" +
	"\x10total_prize_pool\x18\x02 \x01(\rR\x0etotalPrizePool\x12/\n" +
	"\x14prize_split_pct_x100\x18\x03 \x03(\rR\x11prizeSplitPctX100\x12P\n" +
	"\x10prize_pool_items\x18\x04 \x03(\v2&.protocol.CMsgDOTALeague.PrizePoolItemR\x0eprizePoolItems\x1a\xfa\x01\n" +
	"\x06Stream\x12\x1b\n" +
	"\tstream_id\x18\x01 \x01(\rR\bstreamId\x12\x1a\n" +
	"\blanguage\x18\x02 \x01(\rR\blanguage\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12k\n" +
	"\x12broadcast_provider\x18\x04 \x01(\x0e2\".protocol.ELeagueBroadcastProvider:\x18LEAGUE_BROADCAST_UNKNOWNR\x11broadcastProvider\x12\x1d\n" +
	"\n" +
	...
	"\ateam_id\x18\x03 \x01(\rR\x06teamId\"H\n" +
	"\x12CMsgDOTALeagueList\x122\n" +
	"\aleagues\x18\x01 \x03(\v2\x18.protocol.CMsgDOTALeagueR\aleagues\"\x8b\x03\n" +
	"\x12CMsgDOTALeagueInfo\x12\x1b\n" +
	"\tleague_id\x18\x01 \x01(\rR\bleagueId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12<\n" +
	"\x04tier\x18\x03 \x01(\x0e2\x15.protocol.ELeagueTier:\x11LEAGUE_TIER_UNSETR\x04tier\x12D\n" +
	"\x06region\x18\x04 \x01(\x0e2\x17.protocol.ELeagueRegion:\x13LEAGUE_REGION_UNSETR\x06region\x120\n" +
	...
	"\x06status\x18\t \x01(\rR\x06status\"L\n" +
	"\x16CMsgDOTALeagueInfoList\x122\n" +
	"\x05infos\x18\x01 \x03(\v2\x1c.protocol.CMsgDOTALeagueInfoR\x05infos\"\x89\x04\n" +
	"\x17CMsgDOTALeagueLiveGames\x12@\n" +
	"\x05games\x18\x01 \x03(\v2*.protocol.CMsgDOTALeagueLiveGames.LiveGameR\x05games\x1a\xab\x03\n" +
	"\bLiveGame\x12\x1b\n" +
	...
	"\bmatch_id\x18\r \x01(\x04R\amatchId\"\xcd\x01\n" +
	"\x16CMsgDOTALeagueMessages\x12D\n" +
	"\bmessages\x18\x01 \x03(\v2(.protocol.CMsgDOTALeagueMessages.MessageR\bmessages\x1am\n" +
	"\aMessage\x12*\n" +
	...
	"\tleague_id\x18\x01 \x01(\rR\bleagueId\"\x9b\x02\n" +
	"!CMsgDOTALeagueAvailableLobbyNodes\x12S\n" +
	"\n" +
	"node_infos\x18\x01 \x03(\v24.protocol.CMsgDOTALeagueAvailableLobbyNodes.NodeInfoR\tnodeInfos\x1a\xa0\x01\n" +
	"\bNodeInfo\x12\x17\n" +
	...
	"\tteam_id_2\x18\x05 \x01(\rR\ateamId2\"\xc4\x05\n" +
	"\x19CMsgDOTALeagueNodeResults\x12M\n" +
	"\fnode_results\x18\x01 \x03(\v2*.protocol.CMsgDOTALeagueNodeResults.ResultR\vnodeResults\x1a\xd7\x04\n" +
	"\x06Result\x12\x17\n" +
	...
	"\tmatch_ids\x18\x11 \x03(\x04R\bmatchIds\"\xf0\x03\n" +
	"\x18CMsgDOTADPCLeagueResults\x12C\n" +
	"\aresults\x18\x01 \x03(\v2).protocol.CMsgDOTADPCLeagueResults.ResultR\aresults\x12\x16\n" +
	"\x06points\x18\x02 \x03(\rR\x06points\x12\x18\n" +
	"\adollars\x18\x03 \x03(\rR\adollars\x1a\xdc\x02\n" +
	"\x06Result\x12\x1a\n" +
	"\bstanding\x18\x01 \x01(\rR\bstanding\x12\x17\n" +
	"\ateam_id\x18\x02 \x01(\rR\x06teamId\x12\x1b\n" +
	...
	"\x05phase\x18\t \x01(\x0e2\x16.protocol.ELeaguePhase:\x12LEAGUE_PHASE_UNSETR\x05phase\x12+\n" +
	"\x11team_abbreviation\x18\n" +
	" \x01(\tR\x10teamAbbreviation\"\xf1\x01\n" +
	"\x16CMsgDOTADPCTeamResults\x12A\n" +
	"\aresults\x18\x01 \x03(\v2'.protocol.CMsgDOTADPCTeamResults.ResultR\aresults\x1a\x93\x01\n" +
	"\x06Result\x12\x1b\n" +
	...
	"\ttimestamp\x18\x05 \x01(\rR\ttimestamp\"\xce\v\n" +
	"\x18CMsgDOTADPCSeasonResults\x12G\n" +
	"\aresults\x18\x01 \x03(\v2-.protocol.CMsgDOTADPCSeasonResults.TeamResultR\aresults\x12I\n" +
	"\tstandings\x18\x02 \x03(\v2+.protocol.CMsgDOTADPCSeasonResults.StandingR\tstandings\x12j\n" +
	"\x18major_wildcard_standings\x18\x03 \x03(\v20.protocol.CMsgDOTADPCSeasonResults.StandingEntryR\x16majorWildcardStandings\x12d\n" +
	"\x15major_group_standings\x18\x04 \x03(\v20.protocol.CMsgDOTADPCSeasonResults.StandingEntryR\x13majorGroupStandings\x12h\n" +
	"\x17major_playoff_standings\x18\x05 \x03(\v20.protocol.CMsgDOTADPCSeasonResults.StandingEntryR\x15majorPlayoffStandings\x1a\xdf\x01\n" +
	...
	"\n" +
	"audit_data\x18\a \x01(\rR\tauditData\x1a\xd6\x02\n" +
	"\n" +
	"TeamResult\x12\x17\n" +
	...
	"\x0etotal_earnings\x18\x06 \x01(\rR\rtotalEarnings\x12Z\n" +
	"\x0eleague_results\x18\a \x03(\v23.protocol.CMsgDOTADPCSeasonResults.TeamLeagueResultR\rleagueResults\x1a\xb9\x01\n" +
	...
	"\x11team_abbreviation\x18\x06 \x01(\tR\x10teamAbbreviation\x1a\xea\x01\n" +
	"\bStanding\x12D\n" +
	"\x06region\x18\x01 \x01(\x0e2\x17.protocol.ELeagueRegion:\x13LEAGUE_REGION_UNSETR\x06region\x12L\n" +
	"\bdivision\x18\x02 \x01(\x0e2\x19.protocol.ELeagueDivision:\x15LEAGUE_DIVISION_UNSETR\bdivision\x12J\n" +
	"\aentries\x18\x03 \x03(\v20.protocol.CMsgDOTADPCSeasonResults.StandingEntryR\aentries\"\x96\x01\n" +
	"\x1fCMsgDOTADPCSeasonSpoilerResults\x12*\n" +
	"\x11time_last_updated\x18\x01 \x01(\rR\x0ftimeLastUpdated\x12G\n" +
	"\rsaved_results\x18\x02 \x01(\v2\".protocol.CMsgDOTADPCSeasonResultsR\fsavedResults*\xd7\x01\n" +
	...
	"\vBEST_OF_TWO\x10\x04B\rZ\v./;protocol"
...
var file_dota_gcmessages_common_league_proto_goTypes = []any{
	(ELeagueNodeGroupType)(0),                          // 0: protocol.ELeagueNodeGroupType
	(ELeagueNodeType)(0),                               // 1: protocol.ELeagueNodeType
	(*CMsgDOTALeagueNode)(nil),                         // 2: protocol.CMsgDOTALeagueNode
	(*CMsgDOTALeagueNodeGroup)(nil),                    // 3: protocol.CMsgDOTALeagueNodeGroup
	(*CMsgDOTALeague)(nil),                             // 4: protocol.CMsgDOTALeague
	(*CMsgDOTALeagueList)(nil),                         // 5: protocol.CMsgDOTALeagueList
	(*CMsgDOTALeagueInfo)(nil),                         // 6: protocol.CMsgDOTALeagueInfo
	(*CMsgDOTALeagueInfoList)(nil),                     // 7: protocol.CMsgDOTALeagueInfoList
	(*CMsgDOTALeagueLiveGames)(nil),                    // 8: protocol.CMsgDOTALeagueLiveGames
	(*CMsgDOTALeagueMessages)(nil),                     // 9: protocol.CMsgDOTALeagueMessages
	(*CMsgDOTALeaguePrizePool)(nil),                    // 10: protocol.CMsgDOTALeaguePrizePool
	(*CMsgDOTALeagueInfoListAdminsRequest)(nil),        // 11: protocol.CMsgDOTALeagueInfoListAdminsRequest
	(*CMsgDOTALeagueAvailableLobbyNodesRequest)(nil),   // 12: protocol.CMsgDOTALeagueAvailableLobbyNodesRequest
	(*CMsgDOTALeagueAvailableLobbyNodes)(nil),          // 13: protocol.CMsgDOTALeagueAvailableLobbyNodes
	(*CMsgDOTALeagueNodeResults)(nil),                  // 14: protocol.CMsgDOTALeagueNodeResults
	(*CMsgDOTADPCLeagueResults)(nil),                   // 15: protocol.CMsgDOTADPCLeagueResults
	(*CMsgDOTADPCTeamResults)(nil),                     // 16: protocol.CMsgDOTADPCTeamResults
	(*CMsgDOTADPCSeasonResults)(nil),                   // 17: protocol.CMsgDOTADPCSeasonResults
	(*CMsgDOTADPCSeasonSpoilerResults)(nil),            // 18: protocol.CMsgDOTADPCSeasonSpoilerResults
	(*CMsgDOTALeagueNode_MatchDetails)(nil),            // 19: protocol.CMsgDOTALeagueNode.MatchDetails
	(*CMsgDOTALeagueNode_VOD)(nil),                     // 20: protocol.CMsgDOTALeagueNode.VOD
	(*CMsgDOTALeagueNodeGroup_TeamStanding)(nil),       // 21: protocol.CMsgDOTALeagueNodeGroup.TeamStanding
	(*CMsgDOTALeague_Info)(nil),                        // 22: protocol.CMsgDOTALeague.Info
	(*CMsgDOTALeague_Admin)(nil),                       // 23: protocol.CMsgDOTALeague.Admin
	(*CMsgDOTALeague_PrizePoolItem)(nil),               // 24: protocol.CMsgDOTALeague.PrizePoolItem
	(*CMsgDOTALeague_PrizePool)(nil),                   // 25: protocol.CMsgDOTALeague.PrizePool
	(*CMsgDOTALeague_Stream)(nil),                      // 26: protocol.CMsgDOTALeague.Stream
	(*CMsgDOTALeague_SeriesInfo)(nil),                  // 27: protocol.CMsgDOTALeague.SeriesInfo
	(*CMsgDOTALeague_Player)(nil),                      // 28: protocol.CMsgDOTALeague.Player
	(*CMsgDOTALeagueLiveGames_LiveGame)(nil),           // 29: protocol.CMsgDOTALeagueLiveGames.LiveGame
	(*CMsgDOTALeagueMessages_Message)(nil),             // 30: protocol.CMsgDOTALeagueMessages.Message
	(*CMsgDOTALeagueAvailableLobbyNodes_NodeInfo)(nil), // 31: protocol.CMsgDOTALeagueAvailableLobbyNodes.NodeInfo
	(*CMsgDOTALeagueNodeResults_Result)(nil),           // 32: protocol.CMsgDOTALeagueNodeResults.Result
	(*CMsgDOTADPCLeagueResults_Result)(nil),            // 33: protocol.CMsgDOTADPCLeagueResults.Result
	(*CMsgDOTADPCTeamResults_Result)(nil),              // 34: protocol.CMsgDOTADPCTeamResults.Result
	(*CMsgDOTADPCSeasonResults_TeamLeagueResult)(nil),  // 35: protocol.CMsgDOTADPCSeasonResults.TeamLeagueResult
	(*CMsgDOTADPCSeasonResults_TeamResult)(nil),        // 36: protocol.CMsgDOTADPCSeasonResults.TeamResult
	(*CMsgDOTADPCSeasonResults_StandingEntry)(nil),     // 37: protocol.CMsgDOTADPCSeasonResults.StandingEntry
	(*CMsgDOTADPCSeasonResults_Standing)(nil),          // 38: protocol.CMsgDOTADPCSeasonResults.Standing
	(ELeaguePhase)(0),                                  // 39: protocol.ELeaguePhase
	(ELeagueRegion)(0),                                 // 40: protocol.ELeagueRegion
	(ELeagueTier)(0),                                   // 41: protocol.ELeagueTier
	(ELeagueStatus)(0),                                 // 42: protocol.ELeagueStatus
	(ELeagueBroadcastProvider)(0),                      // 43: protocol.ELeagueBroadcastProvider
	(ELeagueDivision)(0),                               // 44: protocol.ELeagueDivision
}
var file_dota_gcmessages_common_league_proto_depIdxs = []int32{
	1,  // 0: protocol.CMsgDOTALeagueNode.node_type:type_name -> protocol.ELeagueNodeType
	19, // 1: protocol.CMsgDOTALeagueNode.matches:type_name -> protocol.CMsgDOTALeagueNode.MatchDetails
	20, // 2: protocol.CMsgDOTALeagueNode.vods:type_name -> protocol.CMsgDOTALeagueNode.VOD
	0,  // 3: protocol.CMsgDOTALeagueNodeGroup.node_group_type:type_name -> protocol.ELeagueNodeGroupType
	1,  // 4: protocol.CMsgDOTALeagueNodeGroup.default_node_type:type_name -> protocol.ELeagueNodeType
	39, // 5: protocol.CMsgDOTALeagueNodeGroup.phase:type_name -> protocol.ELeaguePhase
	40, // 6: protocol.CMsgDOTALeagueNodeGroup.region:type_name -> protocol.ELeagueRegion
	21, // 7: protocol.CMsgDOTALeagueNodeGroup.team_standings:type_name -> protocol.CMsgDOTALeagueNodeGroup.TeamStanding
	2,  // 8: protocol.CMsgDOTALeagueNodeGroup.nodes:type_name -> protocol.CMsgDOTALeagueNode
	3,  // 9: protocol.CMsgDOTALeagueNodeGroup.node_groups:type_name -> protocol.CMsgDOTALeagueNodeGroup
	22, // 10: protocol.CMsgDOTALeague.info:type_name -> protocol.CMsgDOTALeague.Info
	25, // 11: protocol.CMsgDOTALeague.prize_pool:type_name -> protocol.CMsgDOTALeague.PrizePool
	23, // 12: protocol.CMsgDOTALeague.admins:type_name -> protocol.CMsgDOTALeague.Admin
	26, // 13: protocol.CMsgDOTALeague.streams:type_name -> protocol.CMsgDOTALeague.Stream
	3,  // 14: protocol.CMsgDOTALeague.node_groups:type_name -> protocol.CMsgDOTALeagueNodeGroup
	27, // 15: protocol.CMsgDOTALeague.series_infos:type_name -> protocol.CMsgDOTALeague.SeriesInfo
	28, // 16: protocol.CMsgDOTALeague.registered_players:type_name -> protocol.CMsgDOTALeague.Player
	4,  // 17: protocol.CMsgDOTALeagueList.leagues:type_name -> protocol.CMsgDOTALeague
	41, // 18: protocol.CMsgDOTALeagueInfo.tier:type_name -> protocol.ELeagueTier
	40, // 19: protocol.CMsgDOTALeagueInfo.region:type_name -> protocol.ELeagueRegion
	6,  // 20: protocol.CMsgDOTALeagueInfoList.infos:type_name -> protocol.CMsgDOTALeagueInfo
	29, // 21: protocol.CMsgDOTALeagueLiveGames.games:type_name -> protocol.CMsgDOTALeagueLiveGames.LiveGame
	30, // 22: protocol.CMsgDOTALeagueMessages.messages:type_name -> protocol.CMsgDOTALeagueMessages.Message
	31, // 23: protocol.CMsgDOTALeagueAvailableLobbyNodes.node_infos:type_name -> protocol.CMsgDOTALeagueAvailableLobbyNodes.NodeInfo
	32, // 24: protocol.CMsgDOTALeagueNodeResults.node_results:type_name -> protocol.CMsgDOTALeagueNodeResults.Result
	33, // 25: protocol.CMsgDOTADPCLeagueResults.results:type_name -> protocol.CMsgDOTADPCLeagueResults.Result
	34, // 26: protocol.CMsgDOTADPCTeamResults.results:type_name -> protocol.CMsgDOTADPCTeamResults.Result
	36, // 27: protocol.CMsgDOTADPCSeasonResults.results:type_name -> protocol.CMsgDOTADPCSeasonResults.TeamResult
	38, // 28: protocol.CMsgDOTADPCSeasonResults.standings:type_name -> protocol.CMsgDOTADPCSeasonResults.Standing
	37, // 29: protocol.CMsgDOTADPCSeasonResults.major_wildcard_standings:type_name -> protocol.CMsgDOTADPCSeasonResults.StandingEntry
	37, // 30: protocol.CMsgDOTADPCSeasonResults.major_group_standings:type_name -> protocol.CMsgDOTADPCSeasonResults.StandingEntry
	37, // 31: protocol.CMsgDOTADPCSeasonResults.major_playoff_standings:type_name -> protocol.CMsgDOTADPCSeasonResults.StandingEntry
	17, // 32: protocol.CMsgDOTADPCSeasonSpoilerResults.saved_results:type_name -> protocol.CMsgDOTADPCSeasonResults
	41, // 33: protocol.CMsgDOTALeague.Info.tier:type_name -> protocol.ELeagueTier
	40, // 34: protocol.CMsgDOTALeague.Info.region:type_name -> protocol.ELeagueRegion
	42, // 35: protocol.CMsgDOTALeague.Info.status:type_name -> protocol.ELeagueStatus
	24, // 36: protocol.CMsgDOTALeague.PrizePool.prize_pool_items:type_name -> protocol.CMsgDOTALeague.PrizePoolItem
	43, // 37: protocol.CMsgDOTALeague.Stream.broadcast_provider:type_name -> protocol.ELeagueBroadcastProvider
	39, // 38: protocol.CMsgDOTADPCLeagueResults.Result.phase:type_name -> protocol.ELeaguePhase
	35, // 39: protocol.CMsgDOTADPCSeasonResults.TeamResult.league_results:type_name -> protocol.CMsgDOTADPCSeasonResults.TeamLeagueResult
	40, // 40: protocol.CMsgDOTADPCSeasonResults.Standing.region:type_name -> protocol.ELeagueRegion
	44, // 41: protocol.CMsgDOTADPCSeasonResults.Standing.division:type_name -> protocol.ELeagueDivision
	37, // 42: protocol.CMsgDOTADPCSeasonResults.Standing.entries:type_name -> protocol.CMsgDOTADPCSeasonResults.StandingEntry
