...
const file_dota_gcmessages_client_match_management_proto_rawDesc = "" +
	"\n" +
	"-dota_gcmessages_client_match_management.proto\x12\bprotocol\x1a\x13steammessages.proto\x1a\x17dota_shared_enums.proto\x1a\x17dota_client_enums.proto\x1a\x15base_gcmessages.proto\x1a\"dota_gcmessages_common_lobby.proto\"\x84\b\n" +
	"\x15CMsgStartFindingMatch\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12,\n" +
	"\vmatchgroups\x18\x02 \x01(\r:\n" +
	"4294967295R\vmatchgroups\x12%\n" +
	"\x0eclient_version\x18\x03 \x01(\rR\rclientVersion\x12)\n" +
	"\n" +
	"game_modes\x18\x04 \x01(\r:\n" +
	"4294967295R\tgameModes\x12E\n" +
	"\n" +
	"match_type\x18\x06 \x01(\x0e2\x13.protocol.MatchType:\x11MATCH_TYPE_CASUALR\tmatchType\x122\n" +
	"\x0ematchlanguages\x18\a \x01(\r:\n" +
	"4294967295R\x0ematchlanguages\x12\x17\n" +
	"\ateam_id\x18\b \x01(\rR\x06teamId\x12^\n" +
	"\x12game_language_enum\x18\n" +
	" \x01(\x0e2\x18.protocol.MatchLanguages:\x16MATCH_LANGUAGE_INVALIDR\x10gameLanguageEnum\x12,\n" +
	"\x12game_language_name\x18\v \x01(\tR\x10gameLanguageName\x129\n" +
	"\tping_data\x18\f \x01(\v2\x1c.protocol.CMsgClientPingDataR\bpingData\x12.\n" +
	...
	"\x15bot_script_index_mask\x18\x17 \x01(\rR\x12botScriptIndexMask\"\xe1\x02\n" +
	"\x1bCMsgStartFindingMatchResult\x127\n" +
	"\x16legacy_generic_eresult\x18\x01 \x01(\r:\x012R\x14legacyGenericEresult\x12^\n" +
	"\x06result\x18\x02 \x01(\x0e2\".protocol.EStartFindingMatchResult:\"k_EStartFindingMatchResult_InvalidR\x06result\x12\x1f\n" +
	...
	"\x0faccept_cooldown\x18\x01 \x01(\bR\x0eacceptCooldown\"\xa2\x02\n" +
	"\x17CMsgPartyBuilderOptions\x12)\n" +
	"\x10additional_slots\x18\x01 \x01(\rR\x0fadditionalSlots\x12E\n" +
	"\n" +
	"match_type\x18\x02 \x01(\x0e2\x13.protocol.MatchType:\x11MATCH_TYPE_CASUALR\tmatchType\x12 \n" +
	"\vmatchgroups\x18\x03 \x01(\rR\vmatchgroups\x12%\n" +
	"\x0eclient_version\x18\x04 \x01(\rR\rclientVersion\x12L\n" +
	"\blanguage\x18\x05 \x01(\x0e2\x18.protocol.MatchLanguages:\x16MATCH_LANGUAGE_INVALIDR\blanguage\"\xcf\x01\n" +
	"\vCMsgReadyUp\x12S\n" +
	"\x05state\x18\x01 \x01(\x0e2\x1d.protocol.DOTALobbyReadyState:\x1eDOTALobbyReadyState_UNDECLAREDR\x05state\x12 \n" +
	"\fready_up_key\x18\x02 \x01(\x06R\n" +
	"readyUpKey\x12I\n" +
	"\x0ehardware_specs\x18\x03 \x01(\v2\".protocol.CDOTAClientHardwareSpecsR\rhardwareSpecs\"t\n" +
	"\x11CMsgReadyUpStatus\x12\x19\n" +
	"\blobby_id\x18\x01 \x01(\x06R\alobbyId\x12!\n" +
	"\faccepted_ids\x18\x02 \x03(\rR\vacceptedIds\x12!\n" +
	"\fdeclined_ids\x18\x03 \x03(\rR\vdeclinedIds\"\x18\n" +
	"\x16CMsgAbandonCurrentGame\"E\n" +
	"\x15CMsgLobbyScenarioSave\x12\x18\n" +
	"\aversion\x18\x01 \x01(\x05R\aversion\x12\x12\n" +
	"\x04data\x18\x02 \x01(\fR\x04data\"\xd1\x12\n" +
	"\x1bCMsgPracticeLobbySetDetails\x12\x19\n" +
	"\blobby_id\x18\x01 \x01(\x04R\alobbyId\x12\x1b\n" +
	"\tgame_name\x18\x02 \x01(\tR\bgameName\x12>\n" +
	"\fteam_details\x18\x03 \x03(\v2\x1b.protocol.CLobbyTeamDetailsR\vteamDetails\x12#\n" +
	"\rserver_region\x18\x04 \x01(\rR\fserverRegion\x12\x1b\n" +
	"\tgame_mode\x18\x05 \x01(\rR\bgameMode\x12?\n" +
	"\acm_pick\x18\x06 \x01(\x0e2\x16.protocol.DOTA_CM_PICK:\x0eDOTA_CM_RANDOMR\x06cmPick\x12i\n" +
	"\x16bot_difficulty_radiant\x18\t \x01(\x0e2\x1b.protocol.DOTABotDifficulty:\x16BOT_DIFFICULTY_PASSIVER\x14botDifficultyRadiant\x12!\n" +
	"\fallow_cheats\x18\n" +
	" \x01(\bR\vallowCheats\x12$\n" +
	"\x0efill_with_bots\x18\v \x01(\bR\ffillWithBots\x12\x1d\n" +
	"\n" +
	"intro_mode\x18\f \x01(\bR\tintroMode\x12)\n" +
	...
	"\x12penalty_level_dire\x18\x12 \x01(\rR\x10penaltyLevelDire\x12 \n" +
	"\fload_game_id\x18\x13 \x01(\rR\n" +
	"loadGameId\x12\x1f\n" +
	"\vseries_type\x18\x14 \x01(\rR\n" +
	"seriesType\x12.\n" +
	"\x13radiant_series_wins\x18\x15 \x01(\rR\x11radiantSeriesWins\x12(\n" +
	"\x10dire_series_wins\x18\x16 \x01(\rR\x0edireSeriesWins\x12\x1f\n" +
	"\aallchat\x18\x17 \x01(\b:\x05falseR\aallchat\x12O\n" +
	"\rdota_tv_delay\x18\x18 \x01(\x0e2\x1a.protocol.LobbyDotaTVDelay:\x0fLobbyDotaTV_120R\vdotaTvDelay\x12\x10\n" +
	...
	"\x12custom_max_players\x18\x1f \x01(\rR\x10customMaxPlayers\x12Y\n" +
	"\n" +
	"visibility\x18! \x01(\x0e2\x1d.protocol.DOTALobbyVisibility:\x1aDOTALobbyVisibility_PublicR\n" +
	"visibility\x12&\n" +
	"\x0fcustom_game_crc\x18\" \x01(\x06R\rcustomGameCrc\x122\n" +
	"\x15custom_game_timestamp\x18% \x01(\aR\x13customGameTimestamp\x126\n" +
	"\x17previous_match_override\x18& \x01(\x04R\x15previousMatchOverride\x12e\n" +
	"\rpause_setting\x18* \x01(\x0e2\x1f.protocol.LobbyDotaPauseSetting:\x1fLobbyDotaPauseSetting_UnlimitedR\fpauseSetting\x12c\n" +
	"\x13bot_difficulty_dire\x18+ \x01(\x0e2\x1b.protocol.DOTABotDifficulty:\x16BOT_DIFFICULTY_PASSIVER\x11botDifficultyDire\x12\x1f\n" +
	"\vbot_radiant\x18, \x01(\x04R\n" +
	"botRadiant\x12\x19\n" +
	"\bbot_dire\x18- \x01(\x04R\abotDire\x12\x83\x01\n" +
	"\x18selection_priority_rules\x18. \x01(\x0e2$.protocol.DOTASelectionPriorityRules:#k_DOTASelectionPriorityRules_ManualR\x16selectionPriorityRules\x122\n" +
	...
	"\x12requested_hero_ids\x182 \x03(\rR\x10requestedHeroIds\x12D\n" +
	"\rscenario_save\x183 \x01(\v2\x1f.protocol.CMsgLobbyScenarioSaveR\fscenarioSave\x12\x86\x01\n" +
	"\x1eability_draft_specific_details\x184 \x01(\v2A.protocol.CMsgPracticeLobbySetDetails.AbilityDraftSpecificDetailsR\x1babilityDraftSpecificDetails\x12&\n" +
	"\x0fdo_player_draft\x185 \x01(\bR\rdoPlayerDraft\x1aM\n" +
	"\x1bAbilityDraftSpecificDetails\x12.\n" +
	"\x13shuffle_draft_order\x18\x01 \x01(\bR\x11shuffleDraftOrder\"\x82\x03\n" +
	"\x17CMsgPracticeLobbyCreate\x12\x1d\n" +
	"\n" +
	"search_key\x18\x01 \x01(\tR\tsearchKey\x12\x19\n" +
	"\bpass_key\x18\x05 \x01(\tR\apassKey\x12%\n" +
	"\x0eclient_version\x18\x06 \x01(\rR\rclientVersion\x12J\n" +
	"\rlobby_details\x18\a \x01(\v2%.protocol.CMsgPracticeLobbySetDetailsR\flobbyDetails\x12G\n" +
	"\tsave_game\x18\b \x01(\v2*.protocol.CMsgPracticeLobbyCreate.SaveGameR\bsaveGame\x1aq\n" +
	"\bSaveGame\x12\x12\n" +
	"\x04data\x18\x01 \x01(\fR\x04data\x12\x18\n" +
	"\aversion\x18\x02 \x01(\x05R\aversion\x12\x19\n" +
	"\bsteam_id\x18\x03 \x01(\x06R\asteamId\x12\x1c\n" +
	"\tsignature\x18\x04 \x01(\x06R\tsignature\"\xd2\x01\n" +
	"\x1cCMsgPracticeLobbySetTeamSlot\x12B\n" +
	...
	"\x0ebot_difficulty\x18\x03 \x01(\x0e2\x1b.protocol.DOTABotDifficulty:\x16BOT_DIFFICULTY_PASSIVER\rbotDifficulty\"_\n" +
	"\x19CMsgPracticeLobbySetCoach\x12B\n" +
	"\x04team\x18\x01 \x01(\x0e2\x16.protocol.DOTA_GC_TEAM:\x16DOTA_GC_TEAM_GOOD_GUYSR\x04team\"\xe4\x01\n" +
	...
	"\ateam_id\x18\x01 \x01(\rR\x06teamId\"\x94\x01\n" +
	"\x15CMsgPracticeLobbyList\x12\x19\n" +
	"\bpass_key\x18\x02 \x01(\tR\apassKey\x12\x16\n" +
	"\x06region\x18\x03 \x01(\rR\x06region\x12H\n" +
	"\tgame_mode\x18\x04 \x01(\x0e2\x17.protocol.DOTA_GameMode:\x12DOTA_GAMEMODE_NONER\bgameMode\"\xa0\x06\n" +
	"\"CMsgPracticeLobbyListResponseEntry\x12\x14\n" +
	"\x02id\x18\x01 \x01(\x04B\x04\x80\xa6\x1d\x01R\x02id\x12S\n" +
	"\amembers\x18\x05 \x03(\v29.protocol.CMsgPracticeLobbyListResponseEntry.CLobbyMemberR\amembers\x12*\n" +
	"\x11requires_pass_key\x18\x06 \x01(\bR\x0frequiresPassKey\x12*\n" +
	"\x11leader_account_id\x18\a \x01(\rR\x0fleaderAccountId\x12\x12\n" +
	"\x04name\x18\n" +
	" \x01(\tR\x04name\x12(\n" +
	"\x10custom_game_mode\x18\v \x01(\tR\x0ecustomGameMode\x12H\n" +
	"\tgame_mode\x18\f \x01(\x0e2\x17.protocol.DOTA_GameMode:\x12DOTA_GAMEMODE_NONER\bgameMode\x12%\n" +
	...
	"playerName\"g\n" +
	"\x1dCMsgPracticeLobbyListResponse\x12F\n" +
	"\alobbies\x18\x02 \x03(\v2,.protocol.CMsgPracticeLobbyListResponseEntryR\alobbies\"\x81\x01\n" +
	"\rCMsgLobbyList\x12&\n" +
	"\rserver_region\x18\x01 \x01(\r:\x010R\fserverRegion\x12H\n" +
	"\tgame_mode\x18\x02 \x01(\x0e2\x17.protocol.DOTA_GameMode:\x12DOTA_GAMEMODE_NONER\bgameMode\"_\n" +
	"\x15CMsgLobbyListResponse\x12F\n" +
	"\alobbies\x18\x01 \x03(\v2,.protocol.CMsgPracticeLobbyListResponseEntryR\alobbies\"\xd0\x01\n" +
	...
	"\x15custom_game_timestamp\x18\x05 \x01(\aR\x13customGameTimestamp\"p\n" +
	"\x1dCMsgPracticeLobbyJoinResponse\x12O\n" +
	"\x06result\x18\x01 \x01(\x0e2\x1d.protocol.DOTAJoinLobbyResult:\x18DOTA_JOIN_RESULT_SUCCESSR\x06result\">\n" +
	"\"CMsgFriendPracticeLobbyListRequest\x12\x18\n" +
	"\afriends\x18\x01 \x03(\rR\afriends\"m\n" +
	"#CMsgFriendPracticeLobbyListResponse\x12F\n" +
	"\alobbies\x18\x01 \x03(\v2,.protocol.CMsgPracticeLobbyListResponseEntryR\alobbies\"I\n" +
	...
	"lobbyCount\x12!\n" +
	"\fplayer_count\x18\x03 \x01(\rR\vplayerCount\"x\n" +
	"#CMsgJoinableCustomGameModesResponse\x12Q\n" +
	"\n" +
	"game_modes\x18\x01 \x03(\v22.protocol.CMsgJoinableCustomGameModesResponseEntryR\tgameModes\"m\n" +
	...
	"\x11penalties_enabled\x18\x11 \x01(\bR\x10penaltiesEnabled\"o\n" +
	"!CMsgJoinableCustomLobbiesResponse\x12J\n" +
	"\alobbies\x18\x01 \x03(\v20.protocol.CMsgJoinableCustomLobbiesResponseEntryR\alobbies\"\xa4\x04\n" +
	...
	"\x14create_lobby_details\x18\x04 \x01(\v2%.protocol.CMsgPracticeLobbySetDetailsR\x12createLobbyDetails\x12\"\n" +
	"\rallow_any_map\x18\x05 \x01(\bR\vallowAnyMap\x12c\n" +
	"\x13legacy_region_pings\x18\x06 \x03(\v23.protocol.CMsgQuickJoinCustomLobby.LegacyRegionPingR\x11legacyRegionPings\x129\n" +
	"\tping_data\x18\a \x01(\v2\x1c.protocol.CMsgClientPingDataR\bpingData\x1al\n" +
	...
	"regionCode\"s\n" +
	" CMsgQuickJoinCustomLobbyResponse\x12O\n" +
	"\x06result\x18\x01 \x01(\x0e2\x1d.protocol.DOTAJoinLobbyResult:\x18DOTA_JOIN_RESULT_SUCCESSR\x06result\"\xfc\x02\n" +
	"\x11CMsgBotGameCreate\x12\x1d\n" +
	"\n" +
	"search_key\x18\x01 \x01(\tR\tsearchKey\x12%\n" +
	"\x0eclient_version\x18\x02 \x01(\rR\rclientVersion\x12b\n" +
	"\x12difficulty_radiant\x18\x03 \x01(\x0e2\x1b.protocol.DOTABotDifficulty:\x16BOT_DIFFICULTY_PASSIVER\x11difficultyRadiant\x12B\n" +
	"\x04team\x18\x04 \x01(\x0e2\x16.protocol.DOTA_GC_TEAM:\x16DOTA_GC_TEAM_GOOD_GUYSR\x04team\x12\x1b\n" +
	"\tgame_mode\x18\x05 \x01(\rR\bgameMode\x12\\\n" +
	"\x0fdifficulty_dire\x18\x06 \x01(\x0e2\x1b.protocol.DOTABotDifficulty:\x16BOT_DIFFICULTY_PASSIVER\x0edifficultyDire\">\n" +
	...
	"\x17CMsgDOTAGroupMergeReply\x12S\n" +
	"\x06result\x18\x01 \x01(\x0e2\x1f.protocol.EDOTAGroupMergeResult:\x1ak_EDOTAGroupMergeResult_OKR\x06result\"\x94\x04\n" +
	...
	"seriesGame\x12O\n" +
	"\fradiant_team\x18\t \x01(\v2,.protocol.CMsgSpectatorLobbyGameDetails.TeamR\vradiantTeam\x12I\n" +
	"\tdire_team\x18\n" +
	" \x01(\v2,.protocol.CMsgSpectatorLobbyGameDetails.TeamR\bdireTeam\x1aY\n" +
	"\x04Team\x12\x17\n" +
	"\ateam_id\x18\x01 \x01(\rR\x06teamId\x12\x1b\n" +
	"\tteam_name\x18\x02 \x01(\tR\bteamName\x12\x1b\n" +
	"\tteam_logo\x18\x03 \x01(\x06R\bteamLogo\"\xbf\x01\n" +
	...
	"\bpass_key\x18\x03 \x01(\tR\apassKey\x12J\n" +
	"\fgame_details\x18\x04 \x01(\v2'.protocol.CMsgSpectatorLobbyGameDetailsR\vgameDetails\"\x83\x01\n" +
	"\x18CMsgCreateSpectatorLobby\x12%\n" +
	"\x0eclient_version\x18\x01 \x01(\rR\rclientVersion\x12@\n" +
	"\adetails\x18\x02 \x01(\v2&.protocol.CMsgSetSpectatorLobbyDetailsR\adetails\"\x18\n" +
	"\x16CMsgSpectatorLobbyList\"\x85\x03\n" +
	"\x1eCMsgSpectatorLobbyListResponse\x12Q\n" +
	"\alobbies\x18\x01 \x03(\v27.protocol.CMsgSpectatorLobbyListResponse.SpectatorLobbyR\alobbies\x1a\x8f\x02\n" +
	...
	"\fmember_count\x18\x05 \x01(\rR\vmemberCount\x12J\n" +
	"\fgame_details\x18\a \x01(\v2'.protocol.CMsgSpectatorLobbyGameDetailsR\vgameDetails\"R\n" +
	...
	"\x14lane_selection_flags\x18\x01 \x01(\rR\x12laneSelectionFlags\x124\n" +
	"\x16high_priority_disabled\x18\x02 \x01(\bR\x14highPriorityDisabled*\xf2\x10\n" +
	...
	"/k_EStartFindingMatchResult_RestrictedFromRanked\x10\x87\x01B\rZ\v./;protocol"
...
var file_dota_gcmessages_client_match_management_proto_goTypes = []any{
	(EStartFindingMatchResult)(0),                                   // 0: protocol.EStartFindingMatchResult
	(*CMsgStartFindingMatch)(nil),                                   // 1: protocol.CMsgStartFindingMatch
	(*CMsgStartFindingMatchResult)(nil),                             // 2: protocol.CMsgStartFindingMatchResult
	(*CMsgStopFindingMatch)(nil),                                    // 3: protocol.CMsgStopFindingMatch
	(*CMsgPartyBuilderOptions)(nil),                                 // 4: protocol.CMsgPartyBuilderOptions
	(*CMsgReadyUp)(nil),                                             // 5: protocol.CMsgReadyUp
	(*CMsgReadyUpStatus)(nil),                                       // 6: protocol.CMsgReadyUpStatus
	(*CMsgAbandonCurrentGame)(nil),                                  // 7: protocol.CMsgAbandonCurrentGame
	(*CMsgLobbyScenarioSave)(nil),                                   // 8: protocol.CMsgLobbyScenarioSave
	(*CMsgPracticeLobbySetDetails)(nil),                             // 9: protocol.CMsgPracticeLobbySetDetails
	(*CMsgPracticeLobbyCreate)(nil),                                 // 10: protocol.CMsgPracticeLobbyCreate
	(*CMsgPracticeLobbySetTeamSlot)(nil),                            // 11: protocol.CMsgPracticeLobbySetTeamSlot
	(*CMsgPracticeLobbySetCoach)(nil),                               // 12: protocol.CMsgPracticeLobbySetCoach
	(*CMsgPracticeLobbyJoinBroadcastChannel)(nil),                   // 13: protocol.CMsgPracticeLobbyJoinBroadcastChannel
	(*CMsgPracticeLobbyCloseBroadcastChannel)(nil),                  // 14: protocol.CMsgPracticeLobbyCloseBroadcastChannel
	(*CMsgPracticeLobbyToggleBroadcastChannelCameramanStatus)(nil),  // 15: protocol.CMsgPracticeLobbyToggleBroadcastChannelCameramanStatus
	(*CMsgPracticeLobbyKick)(nil),                                   // 16: protocol.CMsgPracticeLobbyKick
	(*CMsgPracticeLobbyKickFromTeam)(nil),                           // 17: protocol.CMsgPracticeLobbyKickFromTeam
	(*CMsgPracticeLobbyLeave)(nil),                                  // 18: protocol.CMsgPracticeLobbyLeave
	(*CMsgPracticeLobbyLaunch)(nil),                                 // 19: protocol.CMsgPracticeLobbyLaunch
	(*CMsgApplyTeamToPracticeLobby)(nil),                            // 20: protocol.CMsgApplyTeamToPracticeLobby
	(*CMsgPracticeLobbyList)(nil),                                   // 21: protocol.CMsgPracticeLobbyList
	(*CMsgPracticeLobbyListResponseEntry)(nil),                      // 22: protocol.CMsgPracticeLobbyListResponseEntry
	(*CMsgPracticeLobbyListResponse)(nil),                           // 23: protocol.CMsgPracticeLobbyListResponse
	(*CMsgLobbyList)(nil),                                           // 24: protocol.CMsgLobbyList
	(*CMsgLobbyListResponse)(nil),                                   // 25: protocol.CMsgLobbyListResponse
	(*CMsgPracticeLobbyJoin)(nil),                                   // 26: protocol.CMsgPracticeLobbyJoin
	(*CMsgPracticeLobbyJoinResponse)(nil),                           // 27: protocol.CMsgPracticeLobbyJoinResponse
	(*CMsgFriendPracticeLobbyListRequest)(nil),                      // 28: protocol.CMsgFriendPracticeLobbyListRequest
	(*CMsgFriendPracticeLobbyListResponse)(nil),                     // 29: protocol.CMsgFriendPracticeLobbyListResponse
	(*CMsgJoinableCustomGameModesRequest)(nil),                      // 30: protocol.CMsgJoinableCustomGameModesRequest
	(*CMsgJoinableCustomGameModesResponseEntry)(nil),                // 31: protocol.CMsgJoinableCustomGameModesResponseEntry
	(*CMsgJoinableCustomGameModesResponse)(nil),                     // 32: protocol.CMsgJoinableCustomGameModesResponse
	(*CMsgJoinableCustomLobbiesRequest)(nil),                        // 33: protocol.CMsgJoinableCustomLobbiesRequest
	(*CMsgJoinableCustomLobbiesResponseEntry)(nil),                  // 34: protocol.CMsgJoinableCustomLobbiesResponseEntry
	(*CMsgJoinableCustomLobbiesResponse)(nil),                       // 35: protocol.CMsgJoinableCustomLobbiesResponse
	(*CMsgQuickJoinCustomLobby)(nil),                                // 36: protocol.CMsgQuickJoinCustomLobby
	(*CMsgQuickJoinCustomLobbyResponse)(nil),                        // 37: protocol.CMsgQuickJoinCustomLobbyResponse
	(*CMsgBotGameCreate)(nil),                                       // 38: protocol.CMsgBotGameCreate
	(*CMsgDOTAPartyMemberSetCoach)(nil),                             // 39: protocol.CMsgDOTAPartyMemberSetCoach
	(*CMsgDOTASetGroupLeader)(nil),                                  // 40: protocol.CMsgDOTASetGroupLeader
	(*CMsgDOTACancelGroupInvites)(nil),                              // 41: protocol.CMsgDOTACancelGroupInvites
	(*CMsgDOTASetGroupOpenStatus)(nil),                              // 42: protocol.CMsgDOTASetGroupOpenStatus
	(*CMsgDOTAGroupMergeInvite)(nil),                                // 43: protocol.CMsgDOTAGroupMergeInvite
	(*CMsgDOTAGroupMergeResponse)(nil),                              // 44: protocol.CMsgDOTAGroupMergeResponse
	(*CMsgDOTAGroupMergeReply)(nil),                                 // 45: protocol.CMsgDOTAGroupMergeReply
	(*CMsgSpectatorLobbyGameDetails)(nil),                           // 46: protocol.CMsgSpectatorLobbyGameDetails
	(*CMsgSetSpectatorLobbyDetails)(nil),                            // 47: protocol.CMsgSetSpectatorLobbyDetails
	(*CMsgCreateSpectatorLobby)(nil),                                // 48: protocol.CMsgCreateSpectatorLobby
	(*CMsgSpectatorLobbyList)(nil),                                  // 49: protocol.CMsgSpectatorLobbyList
	(*CMsgSpectatorLobbyListResponse)(nil),                          // 50: protocol.CMsgSpectatorLobbyListResponse
	(*CMsgClientToGCRequestSteamDatagramTicket)(nil),                // 51: protocol.CMsgClientToGCRequestSteamDatagramTicket
	(*CMsgClientToGCRequestSteamDatagramTicketResponse)(nil),        // 52: protocol.CMsgClientToGCRequestSteamDatagramTicketResponse
	(*CMsgGCToClientSteamDatagramTicket)(nil),                       // 53: protocol.CMsgGCToClientSteamDatagramTicket
	(*CMsgGCToClientRequestLaneSelection)(nil),                      // 54: protocol.CMsgGCToClientRequestLaneSelection
	(*CMsgGCToClientRequestLaneSelectionResponse)(nil),              // 55: protocol.CMsgGCToClientRequestLaneSelectionResponse
	(*CMsgGCToClientRequestMMInfo)(nil),                             // 56: protocol.CMsgGCToClientRequestMMInfo
	(*CMsgClientToGCMMInfo)(nil),                                    // 57: protocol.CMsgClientToGCMMInfo
	(*CMsgPracticeLobbySetDetails_AbilityDraftSpecificDetails)(nil), // 58: protocol.CMsgPracticeLobbySetDetails.AbilityDraftSpecificDetails
	(*CMsgPracticeLobbyCreate_SaveGame)(nil),                        // 59: protocol.CMsgPracticeLobbyCreate.SaveGame
	(*CMsgPracticeLobbyListResponseEntry_CLobbyMember)(nil),         // 60: protocol.CMsgPracticeLobbyListResponseEntry.CLobbyMember
	(*CMsgQuickJoinCustomLobby_LegacyRegionPing)(nil),               // 61: protocol.CMsgQuickJoinCustomLobby.LegacyRegionPing
	(*CMsgSpectatorLobbyGameDetails_Team)(nil),                      // 62: protocol.CMsgSpectatorLobbyGameDetails.Team
	(*CMsgSpectatorLobbyListResponse_SpectatorLobby)(nil),           // 63: protocol.CMsgSpectatorLobbyListResponse.SpectatorLobby
	(MatchType)(0),                   // 64: protocol.MatchType
	(MatchLanguages)(0),              // 65: protocol.MatchLanguages
	(*CMsgClientPingData)(nil),       // 66: protocol.CMsgClientPingData
	(DOTALobbyReadyState)(0),         // 67: protocol.DOTALobbyReadyState
	(*CDOTAClientHardwareSpecs)(nil), // 68: protocol.CDOTAClientHardwareSpecs
	(*CLobbyTeamDetails)(nil),        // 69: protocol.CLobbyTeamDetails
	(DOTA_CM_PICK)(0),                // 70: protocol.DOTA_CM_PICK
	(DOTABotDifficulty)(0),           // 71: protocol.DOTABotDifficulty
	(LobbyDotaTVDelay)(0),            // 72: protocol.LobbyDotaTVDelay
	(DOTALobbyVisibility)(0),         // 73: protocol.DOTALobbyVisibility
	(LobbyDotaPauseSetting)(0),       // 74: protocol.LobbyDotaPauseSetting
	(DOTASelectionPriorityRules)(0),  // 75: protocol.DOTASelectionPriorityRules
	(DOTA_GC_TEAM)(0),                // 76: protocol.DOTA_GC_TEAM
	(DOTA_GameMode)(0),               // 77: protocol.DOTA_GameMode
	(DOTAJoinLobbyResult)(0),         // 78: protocol.DOTAJoinLobbyResult
	(EDOTAGroupMergeResult)(0),       // 79: protocol.EDOTAGroupMergeResult
}
var file_dota_gcmessages_client_match_management_proto_depIdxs = []int32{
	64, // 0: protocol.CMsgStartFindingMatch.match_type:type_name -> protocol.MatchType
	65, // 1: protocol.CMsgStartFindingMatch.game_language_enum:type_name -> protocol.MatchLanguages
	66, // 2: protocol.CMsgStartFindingMatch.ping_data:type_name -> protocol.CMsgClientPingData
	0,  // 3: protocol.CMsgStartFindingMatchResult.result:type_name -> protocol.EStartFindingMatchResult
	64, // 4: protocol.CMsgPartyBuilderOptions.match_type:type_name -> protocol.MatchType
	65, // 5: protocol.CMsgPartyBuilderOptions.language:type_name -> protocol.MatchLanguages
	67, // 6: protocol.CMsgReadyUp.state:type_name -> protocol.DOTALobbyReadyState
	68, // 7: protocol.CMsgReadyUp.hardware_specs:type_name -> protocol.CDOTAClientHardwareSpecs
	69, // 8: protocol.CMsgPracticeLobbySetDetails.team_details:type_name -> protocol.CLobbyTeamDetails
	70, // 9: protocol.CMsgPracticeLobbySetDetails.cm_pick:type_name -> protocol.DOTA_CM_PICK
	71, // 10: protocol.CMsgPracticeLobbySetDetails.bot_difficulty_radiant:type_name -> protocol.DOTABotDifficulty
	72, // 11: protocol.CMsgPracticeLobbySetDetails.dota_tv_delay:type_name -> protocol.LobbyDotaTVDelay
	73, // 12: protocol.CMsgPracticeLobbySetDetails.visibility:type_name -> protocol.DOTALobbyVisibility
	74, // 13: protocol.CMsgPracticeLobbySetDetails.pause_setting:type_name -> protocol.LobbyDotaPauseSetting
	71, // 14: protocol.CMsgPracticeLobbySetDetails.bot_difficulty_dire:type_name -> protocol.DOTABotDifficulty
	75, // 15: protocol.CMsgPracticeLobbySetDetails.selection_priority_rules:type_name -> protocol.DOTASelectionPriorityRules
	8,  // 16: protocol.CMsgPracticeLobbySetDetails.scenario_save:type_name -> protocol.CMsgLobbyScenarioSave
	58, // 17: protocol.CMsgPracticeLobbySetDetails.ability_draft_specific_details:type_name -> protocol.CMsgPracticeLobbySetDetails.AbilityDraftSpecificDetails
	9,  // 18: protocol.CMsgPracticeLobbyCreate.lobby_details:type_name -> protocol.CMsgPracticeLobbySetDetails
	59, // 19: protocol.CMsgPracticeLobbyCreate.save_game:type_name -> protocol.CMsgPracticeLobbyCreate.SaveGame
	76, // 20: protocol.CMsgPracticeLobbySetTeamSlot.team:type_name -> protocol.DOTA_GC_TEAM
	71, // 21: protocol.CMsgPracticeLobbySetTeamSlot.bot_difficulty:type_name -> protocol.DOTABotDifficulty
	76, // 22: protocol.CMsgPracticeLobbySetCoach.team:type_name -> protocol.DOTA_GC_TEAM
	77, // 23: protocol.CMsgPracticeLobbyList.game_mode:type_name -> protocol.DOTA_GameMode
	60, // 24: protocol.CMsgPracticeLobbyListResponseEntry.members:type_name -> protocol.CMsgPracticeLobbyListResponseEntry.CLobbyMember
	77, // 25: protocol.CMsgPracticeLobbyListResponseEntry.game_mode:type_name -> protocol.DOTA_GameMode
	22, // 26: protocol.CMsgPracticeLobbyListResponse.lobbies:type_name -> protocol.CMsgPracticeLobbyListResponseEntry
	77, // 27: protocol.CMsgLobbyList.game_mode:type_name -> protocol.DOTA_GameMode
	22, // 28: protocol.CMsgLobbyListResponse.lobbies:type_name -> protocol.CMsgPracticeLobbyListResponseEntry
	78, // 29: protocol.CMsgPracticeLobbyJoinResponse.result:type_name -> protocol.DOTAJoinLobbyResult
	22, // 30: protocol.CMsgFriendPracticeLobbyListResponse.lobbies:type_name -> protocol.CMsgPracticeLobbyListResponseEntry
	31, // 31: protocol.CMsgJoinableCustomGameModesResponse.game_modes:type_name -> protocol.CMsgJoinableCustomGameModesResponseEntry
	34, // 32: protocol.CMsgJoinableCustomLobbiesResponse.lobbies:type_name -> protocol.CMsgJoinableCustomLobbiesResponseEntry
	9,  // 33: protocol.CMsgQuickJoinCustomLobby.create_lobby_details:type_name -> protocol.CMsgPracticeLobbySetDetails
	61, // 34: protocol.CMsgQuickJoinCustomLobby.legacy_region_pings:type_name -> protocol.CMsgQuickJoinCustomLobby.LegacyRegionPing
	66, // 35: protocol.CMsgQuickJoinCustomLobby.ping_data:type_name -> protocol.CMsgClientPingData
	78, // 36: protocol.CMsgQuickJoinCustomLobbyResponse.result:type_name -> protocol.DOTAJoinLobbyResult
	71, // 37: protocol.CMsgBotGameCreate.difficulty_radiant:type_name -> protocol.DOTABotDifficulty
	76, // 38: protocol.CMsgBotGameCreate.team:type_name -> protocol.DOTA_GC_TEAM
	71, // 39: protocol.CMsgBotGameCreate.difficulty_dire:type_name -> protocol.DOTABotDifficulty
	79, // 40: protocol.CMsgDOTAGroupMergeReply.result:type_name -> protocol.EDOTAGroupMergeResult
	62, // 41: protocol.CMsgSpectatorLobbyGameDetails.radiant_team:type_name -> protocol.CMsgSpectatorLobbyGameDetails.Team
	62, // 42: protocol.CMsgSpectatorLobbyGameDetails.dire_team:type_name -> protocol.CMsgSpectatorLobbyGameDetails.Team
	46, // 43: protocol.CMsgSetSpectatorLobbyDetails.game_details:type_name -> protocol.CMsgSpectatorLobbyGameDetails
	47, // 44: protocol.CMsgCreateSpectatorLobby.details:type_name -> protocol.CMsgSetSpectatorLobbyDetails
	63, // 45: protocol.CMsgSpectatorLobbyListResponse.lobbies:type_name -> protocol.CMsgSpectatorLobbyListResponse.SpectatorLobby
	46, // 46: protocol.CMsgSpectatorLobbyListResponse.SpectatorLobby.game_details:type_name -> protocol.CMsgSpectatorLobbyGameDetails
