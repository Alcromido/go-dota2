...
const file_dota_gcmessages_client_battle_report_proto_rawDesc = "" +
	...
	"\bduration\x18\x03 \x01(\rR\bduration\"\xae\x0e\n" +
	"\x15CMsgBattleReport_Game\x12\x17\n" +
	"\ahero_id\x18\x01 \x01(\rR\x06heroId\x12\x14\n" +
	...
	"\x03xpm\x18\b \x01(\rR\x03xpm\x12C\n" +
	"\x04role\x18\t \x01(\x0e2\x1f.protocol.CMsgBattleReport_Role:\x0ek_eUnknownRoleR\x04role\x12E\n" +
	"\aoutcome\x18\n" +
	" \x01(\x0e2#.protocol.CMsgBattleReport_EOutcome:\x06k_eWinR\aoutcome\x12a\n" +
	"\flane_outcome\x18\v \x01(\x0e2'.protocol.CMsgBattleReport_ELaneOutcome:\x15k_eUnknownLaneOutcomeR\vlaneOutcome\x12\x16\n" +
	...
	"\x16time_purchased_scepter\x18, \x01(\x02R\x14timePurchasedScepter\x12\x18\n" +
	"\x05item0\x18- \x01(\x05:\x02-1R\x05item0\x12\x18\n" +
	"\x05item1\x18. \x01(\x05:\x02-1R\x05item1\x12\x18\n" +
	"\x05item2\x18/ \x01(\x05:\x02-1R\x05item2\x12\x18\n" +
	"\x05item3\x180 \x01(\x05:\x02-1R\x05item3\x12\x18\n" +
	"\x05item4\x181 \x01(\x05:\x02-1R\x05item4\x12\x18\n" +
	"\x05item5\x182 \x01(\x05:\x02-1R\x05item5\"R\n" +
	"\x19CMsgBattleReport_GameList\x125\n" +
	"\x05games\x18\x01 \x03(\v2\x1f.protocol.CMsgBattleReport_GameR\x05games\"\x97\a\n" +
	"\x10CMsgBattleReport\x125\n" +
	"\x05games\x18\x01 \x03(\v2\x1f.protocol.CMsgBattleReport_GameR\x05games\x12D\n" +
	"\n" +
	"highlights\x18\x03 \x01(\v2$.protocol.CMsgBattleReportHighlightsR\n" +
	...
	"confidence\x12\x17\n" +
	"\ahero_id\x18\a \x01(\rR\x06heroId\x12C\n" +
	"\x04role\x18\b \x01(\x0e2\x1f.protocol.CMsgBattleReport_Role:\x0ek_eUnknownRoleR\x04role\x124\n" +
	"\x16comparison_delta_value\x18\t \x01(\x02R\x14comparisonDeltaValue\x12]\n" +
	"\acontext\x18\n" +
	" \x01(\x0e2).protocol.CMsgBattleReport_CompareContext:\x18k_eCompareContextInvalidR\acontext\"\x91\x02\n" +
	...
	"\x10featured_hero_id\x18\x04 \x01(\rR\x0efeaturedHeroId\x12+\n" +
	"\x11featured_position\x18\x05 \x01(\rR\x10featuredPosition\x12!\n" +
	"\fgames_played\x18\x06 \x01(\rR\vgamesPlayed\x12!\n" +
	"\fmedal_counts\x18\a \x03(\rR\vmedalCounts\"h\n" +
	"\x18CMsgBattleReportInfoList\x12L\n" +
	"\x12battle_report_info\x18\x01 \x03(\v2\x1e.protocol.CMsgBattleReportInfoR\x10battleReportInfo\"b\n" +
	"\x1aCMsgBattleReportHighlights\x12D\n" +
	"\n" +
	"highlights\x18\x01 \x03(\v2$.protocol.CMsgBattleReport.HighlightR\n" +
	"highlights\"\x81\x17\n" +
	"\x1eCMsgBattleReportAggregateStats\x12Z\n" +
	"\x06result\x18\x01 \x03(\v2B.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregateR\x06result\x1a@\n" +
	"\x14CMsgBattleReportStat\x12\x12\n" +
	"\x04mean\x18\x01 \x01(\x02R\x04mean\x12\x14\n" +
	"\x05stdev\x18\x02 \x01(\x02R\x05stdev\x1a\xc0\x15\n" +
	...
	"\x0elane_win_count\x18\x05 \x01(\rR\flaneWinCount\x12S\n" +
	"\x05kills\x18\x06 \x01(\v2=.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStatR\x05kills\x12U\n" +
	"\x06deaths\x18\a \x01(\v2=.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStatR\x06deaths\x12W\n" +
	"\aassists\x18\b \x01(\v2=.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStatR\aassists\x12^\n" +
	"\vrank_change\x18\t \x01(\v2=.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStatR\n" +
	"rankChange\x12Z\n" +
	"\tlast_hits\x18\n" +
	" \x01(\v2=.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStatR\blastHits\x12U\n" +
	"\x06denies\x18\v \x01(\v2=.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStatR\x06denies\x12O\n" +
	"\x03gpm\x18\f \x01(\v2=.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStatR\x03gpm\x12O\n" +
	"\x03xpm\x18\r \x01(\v2=.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStatR\x03xpm\x12`\n" +
	"\fseconds_dead\x18\x0e \x01(\v2=.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStatR\vsecondsDead\x12`\n" +
	"\fbounty_runes\x18\x0f \x01(\v2=.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStatR\vbountyRunes\x12^\n" +
	"\vwater_runes\x18\x10 \x01(\v2=.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStatR\n" +
	"waterRunes\x12^\n" +
	"\vpower_runes\x18\x11 \x01(\v2=.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStatR\n" +
	"powerRunes\x12\x7f\n" +
	"\x1dtime_enemy_t1_tower_destroyed\x18\x12 \x01(\v2=.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStatR\x19timeEnemyT1TowerDestroyed\x12\x85\x01\n" +
	" time_friendly_t1_tower_destroyed\x18\x13 \x01(\v2=.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStatR\x1ctimeFriendlyT1TowerDestroyed\x12k\n" +
	"\x12enemy_roshan_kills\x18\x14 \x01(\v2=.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStatR\x10enemyRoshanKills\x12d\n" +
	"\x0eteleports_used\x18\x15 \x01(\v2=.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStatR\rteleportsUsed\x12W\n" +
	"\adewards\x18\x16 \x01(\v2=.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStatR\adewards\x12b\n" +
	"\rcamps_stacked\x18\x17 \x01(\v2=.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStatR\fcampsStacked\x12`\n" +
	"\fsupport_gold\x18\x18 \x01(\v2=.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStatR\vsupportGold\x12^\n" +
	"\vhero_damage\x18\x19 \x01(\v2=.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStatR\n" +
	"heroDamage\x12`\n" +
	"\fhero_healing\x18\x1a \x01(\v2=.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStatR\vheroHealing\x12`\n" +
	"\ftower_damage\x18\x1b \x01(\v2=.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStatR\vtowerDamage\x12j\n" +
	"\x11successful_smokes\x18\x1c \x01(\v2=.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStatR\x10successfulSmokes\x12b\n" +
	"\rstun_duration\x18\x1d \x01(\v2=.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStatR\fstunDuration\x12Y\n" +
	"\bduration\x18\x1e \x01(\v2=.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStatR\bduration\x12q\n" +
	"\x15friendly_roshan_kills\x18\x1f \x01(\v2=.protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStatR\x13friendlyRoshanKills\"(\n" +
	"&CMsgBattleReportAggregatedGeneralStats\"\x8f\x05\n" +
	"%CMsgClientToGCGetBattleReportResponse\x122\n" +
	"\x06report\x18\x01 \x01(\v2\x1a.protocol.CMsgBattleReportR\x06report\x12g\n" +
	"\bresponse\x18\x02 \x01(\x0e29.protocol.CMsgClientToGCGetBattleReportResponse.EResponse:\x10k_eInternalErrorR\bresponse\x12Q\n" +
	"\x0faggregate_stats\x18\x03 \x01(\v2(.protocol.CMsgBattleReportAggregateStatsR\x0eaggregateStats\x122\n" +
	"\x04info\x18\x04 \x01(\v2\x1e.protocol.CMsgBattleReportInfoR\x04info\"\xc1\x02\n" +
	"\tEResponse\x12\x14\n" +
	...
	"\x12\x1b\n" +
	"\x17k_eNotEnoughGamesPlayed\x10\v\"\xde\x02\n" +
	"+CMsgClientToGCGetBattleReportAggregateStats\x12y\n" +
	"\x0eaggregate_keys\x18\x01 \x03(\v2R.protocol.CMsgClientToGCGetBattleReportAggregateStats.CMsgBattleReportAggregateKeyR\raggregateKeys\x12\x1c\n" +
	"\ttimestamp\x18\x02 \x01(\rR\ttimestamp\x12\x1a\n" +
	"\bduration\x18\x03 \x01(\rR\bduration\x12\x12\n" +
	"\x04rank\x18\x04 \x01(\rR\x04rank\x1af\n" +
	"\x1cCMsgBattleReportAggregateKey\x12\x17\n" +
	"\ahero_id\x18\x01 \x01(\rR\x06heroId\x12-\n" +
	"\x12predicted_position\x18\x02 \x01(\rR\x11predictedPosition\"\xa3\x03\n" +
	"3CMsgClientToGCGetBattleReportAggregateStatsResponse\x12Q\n" +
	"\x0faggregate_stats\x18\x01 \x01(\v2(.protocol.CMsgBattleReportAggregateStatsR\x0eaggregateStats\x12u\n" +
	"\bresponse\x18\x02 \x01(\x0e2G.protocol.CMsgClientToGCGetBattleReportAggregateStatsResponse.EResponse:\x10k_eInternalErrorR\bresponse\"\xa1\x01\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\"\x81\x03\n" +
	")CMsgClientToGCGetBattleReportInfoResponse\x12Y\n" +
	"\x17battle_report_info_list\x18\x01 \x01(\v2\".protocol.CMsgBattleReportInfoListR\x14battleReportInfoList\x12k\n" +
	"\bresponse\x18\x02 \x01(\x0e2=.protocol.CMsgClientToGCGetBattleReportInfoResponse.EResponse:\x10k_eInternalErrorR\bresponse\"\x8b\x01\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"account_id\x18\x01 \x01(\rR\taccountId\x12\x1c\n" +
	"\ttimestamp\x18\x02 \x01(\rR\ttimestamp\x12\x1a\n" +
	"\bduration\x18\x03 \x01(\rR\bduration\"\xd5\x03\n" +
	"-CMsgClientToGCAcknowledgeBattleReportResponse\x12o\n" +
	"\bresponse\x18\x01 \x01(\x0e2A.protocol.CMsgClientToGCAcknowledgeBattleReportResponse.EResponse:\x10k_eInternalErrorR\bresponse\x12%\n" +
	...
	"account_id\x18\x01 \x01(\rR\taccountId\x12\x1c\n" +
	"\ttimestamp\x18\x02 \x01(\rR\ttimestamp\x12\x1a\n" +
	"\bduration\x18\x03 \x01(\rR\bduration\"\x81\x03\n" +
	"1CMsgClientToGCGetBattleReportMatchHistoryResponse\x12s\n" +
	"\bresponse\x18\x01 \x01(\x0e2E.protocol.CMsgClientToGCGetBattleReportMatchHistoryResponse.EResponse:\x10k_eInternalErrorR\bresponse\x129\n" +
	"\x05games\x18\x02 \x01(\v2#.protocol.CMsgBattleReport_GameListR\x05games\"\x9b\x01\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\x0ek_eGameWinrate\x10\x00\x1a\x0f\xc2>\fGame Winrate\x12#\n" +
	"\x0ek_eLaneWinrate\x10\x01\x1a\x0f\xc2>\fLane Winrate\x12$\n" +
	"\vk_eMMRDelta\x10\x02\x1a\x13\xc2>\x10Ranked MMR Delta\x122\n" +
	"\x12k_eNumHeroesPlayed\x10\x03\x1a\x1a\xc2>\x17Number of Heroes Played\x120\n" +
	"\x11k_eNumGamesPlayed\x10\x04\x1a\x19\xc2>\x16Number of Games Played\x12;\n" +
	"\x19k_eAveragePowerRunesTaken\x10\x05\x1a\x1c\xc2>\x19Average Power Runes Taken\x12=\n" +
	"\x1ak_eAverageBountyRunesTaken\x10\x06\x1a\x1d\xc2>\x1aAverage Bounty Runes Taken\x12?\n" +
	"\x18k_eTotalKillEnemyT1First\x10\a\x1a!\xc2>\x1eTotal Enemy T1 Destroyed First\x12.\n" +
	"\x13k_eTotalRoshanKills\x10\b\x1a\x15\xc2>\x12Total Roshan Kills\x12%\n" +
	"\x0fk_eTotalDewards\x10\t\x1a\x10\xc2>\rTotal Dewards\x120\n" +
	"\x14k_eTotalCampsStacked\x10\n" +
	"\x1a\x16\xc2>\x13Total Camps Stacked\x12&\n" +
	"\x0fk_eMaxWinstreak\x10\v\x1a\x11\xc2>\x0eMax Win Streak\x12)\n" +
	"\x11k_eAverageDewards\x10\f\x1a\x12\xc2>\x0fAverage Dewards\x12%\n" +
	"\x0fk_eAverageKills\x10\r\x1a\x10\xc2>\rAverage Kills\x12\x1d\n" +
	"\vk_eMaxKills\x10\x0e\x1a\f\xc2>\tMax Kills\x12)\n" +
	"\x11k_eAverageAssists\x10\x0f\x1a\x12\xc2>\x0fAverage Assists\x12!\n" +
	"\rk_eMaxAssists\x10\x10\x1a\x0e\xc2>\vMax Assists\x12'\n" +
	"\x10k_eAverageDeaths\x10\x11\x1a\x11\xc2>\x0eAverage Deaths\x12\x1f\n" +
	"\fk_eMinDeaths\x10\x12\x1a\r\xc2>\n" +
	"Min Deaths\x124\n" +
	"\x16k_eAverageCampsStacked\x10\x13\x1a\x18\xc2>\x15Average Camps Stacked\x12(\n" +
	"\x10k_eTotalLastHits\x10\x14\x1a\x12\xc2>\x0fTotal Last Hits\x12,\n" +
	"\x12k_eAverageLastHits\x10\x15\x1a\x14\xc2>\x11Average Last Hits\x12#\n" +
	"\x0ek_eTotalDenies\x10\x16\x1a\x0f\xc2>\fTotal Denies\x12'\n" +
	"\x10k_eAverageDenies\x10\x17\x1a\x11\xc2>\x0eAverage Denies\x12q\n" +
	...
	"\"k_ePercentGamesWithRoshanAdvantage\x10\x19\x1aI\xc2>FPct Games With Roshan Advantage (Player team killed Roshan more times)\x124\n" +
	"\x16k_eAverageStunDuration\x10\x1a\x1a\x18\xc2>\x15Average Stun Duration\x120\n" +
	"\x14k_eTotalStunDuration\x10\x1b\x1a\x16\xc2>\x13Total Stun Duration\x126\n" +
	"\x17k_eAverageTeleportsUsed\x10\x1c\x1a\x19\xc2>\x16Average Teleports Used\x122\n" +
	"\x15k_eTotalTeleportsUsed\x10\x1d\x1a\x17\xc2>\x14Total Teleports Used\x120\n" +
	"\x14k_eAverageHeroDamage\x10\x1e\x1a\x16\xc2>\x13Average Hero Damage\x12,\n" +
	"\x12k_eTotalHeroDamage\x10\x1f\x1a\x14\xc2>\x11Total Hero Damage\x122\n" +
	"\x15k_eAverageHeroHealing\x10 \x1a\x17\xc2>\x14Average Hero Healing\x12.\n" +
	"\x13k_eTotalHeroHealing\x10!\x1a\x15\xc2>\x12Total Hero Healing\x122\n" +
	"\x15k_eAverageTowerDamage\x10\"\x1a\x17\xc2>\x14Average Tower Damage\x12.\n" +
	"\x13k_eTotalTowerDamage\x10#\x1a\x15\xc2>\x12Total Tower Damage\x12(\n" +
	"\x10k_eMaxLossStreak\x10$\x1a\x12\xc2>\x0fMax Loss Streak\x124\n" +
	"\x16k_eAverageGameDuration\x10%\x1a\x18\xc2>\x15Average Game Duration\x12,\n" +
	"\x12k_eMaxGameDuration\x10&\x1a\x14\xc2>\x11Max Game Duration\x12,\n" +
	"\x12k_eMinGameDuration\x10'\x1a\x14\xc2>\x11Min Game Duration\x122\n" +
	"\x15k_eAverageWinDuration\x10(\x1a\x17\xc2>\x14Average Win Duration\x12*\n" +
	"\x11k_eMaxWinDuration\x10)\x1a\x13\xc2>\x10Max Win Duration\x12*\n" +
	"\x11k_eMinWinDuration\x10*\x1a\x13\xc2>\x10Min Win Duration\x124\n" +
	"\x16k_eAverageLossDuration\x10+\x1a\x18\xc2>\x15Average Loss Duration\x12,\n" +
	...
	"\rk_eMaxDewards\x100\x1a\x0e\xc2>\vMax Dewards\x12*\n" +
	"\x11k_eMaxRoshanKills\x101\x1a\x13\xc2>\x10Max Roshan Kills\x125\n" +
	"\x16k_eMaxBountyRunesTaken\x102\x1a\x19\xc2>\x16Max Bounty Runes Taken\x123\n" +
	"\x15k_eMaxPowerRunesTaken\x103\x1a\x18\xc2>\x15Max Power Runes Taken\x12\x1f\n" +
	"\fk_eMaxDeaths\x104\x1a\r\xc2>\n" +
	"Max Deaths\x12$\n" +
	"\x0ek_eMaxLastHits\x105\x1a\x10\xc2>\rMax Last Hits\x12\x1f\n" +
	"\fk_eMaxDenies\x106\x1a\r\xc2>\n" +
	"Max Denies\x12)\n" +
	"\x11k_eRadiantWinRate\x107\x1a\x12\xc2>\x0fRadiant Winrate\x12#\n" +
	"\x0ek_eDireWinRate\x108\x1a\x0f\xc2>\fDire Winrate\x12.\n" +
	"\x13k_eRadiantGameCount\x109\x1a\x15\xc2>\x12Radiant Game Count\x12(\n" +
	"\x10k_eDireGameCount\x10:\x1a\x12\xc2>\x0fDire Game Count\x12$\n" +
	"\fk_eMaxDamage\x10;\x1a\x12\xc2>\x0fMax Hero Damage\x12!\n" +
	"\rk_eMaxHealing\x10<\x1a\x0e\xc2>\vMax Healing\x12*\n" +
	"\x11k_eMaxTowerDamage\x10=\x1a\x13\xc2>\x10Max Tower Damage\x12!\n" +
	"\rk_eAverageGPM\x10>\x1a\x0e\xc2>\vAverage GPM\x12\x19\n" +
	"\tk_eMaxGPM\x10?\x1a\n" +
	"\xc2>\aMax GPM\x12!\n" +
	"\rk_eAverageXPM\x10@\x1a\x0e\xc2>\vAverage XPM\x12\x19\n" +
	"\tk_eMaxXPM\x10A\x1a\n" +
	"\xc2>\aMax XPM*\x87\x01\n" +
	"\"CMsgBattleReport_HighlightCategory\x12#\n" +
	"\x13k_eHighlightGeneral\x10\x00\x1a\n" +
	"\xc2>\aGeneral\x12\x1d\n" +
	"\x10k_eHighlightHero\x10\x01\x1a\a\xc2>\x04Hero\x12\x1d\n" +
	"\x10k_eHighlightRole\x10\x02\x1a\a\xc2>\x04Role*\xd3\x01\n" +
	"\x15CMsgBattleReport_Role\x12 \n" +
	"\x0ek_eUnknownRole\x10\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x1a\x03\xd0>\x01\x12\x1d\n" +
	"\vk_eSafelane\x10\x00\x1a\f\xc2>\tSafe Lane\x12\x1b\n" +
	"\n" +
	"k_eMidlane\x10\x01\x1a\v\xc2>\bMid Lane\x12\x1b\n" +
	"\n" +
	"k_eOfflane\x10\x02\x1a\v\xc2>\bOff Lane\x12\x1a\n" +
	"\n" +
	"k_eSupport\x10\x03\x1a\n" +
	"\xc2>\aSupport\x12#\n" +
	"\x0ek_eHardSupport\x10\x04\x1a\x0f\xc2>\fHard Support*\x86\x02\n" +
	...
	"\x10k_eAbsoluteValue\x10\x00\x1a\x10\xc2>\rOverall Value\x122\n" +
	"\x17k_ePlayersOfSimilarRank\x10\x01\x1a\x15\xc2>\x12Vs Rank Population\x12$\n" +
	"\rk_eAllPlayers\x10\x02\x1a\x11\xc2>\x0eVs All Players\x125\n" +
	"\x19k_ePlayersPersonalHistory\x10\x03\x1a\x16\xc2>\x13Vs Personal History*\xfb\x01\n" +
	"\x1eCMsgBattleReport_HighlightTier\x12-\n" +
	"\x13k_eHighlightTierLow\x10\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\x1a\v\xc2>\bTier Low\x12\x1d\n" +
	...
	"\x16k_eHighlightTierCustom\x10\x04\x1a\t\xc2>\x06Custom*\x8b\x01\n" +
	" CMsgBattleReport_HighlightRarity\x12!\n" +
	"\x12k_eHighlightCommon\x10\x00\x1a\t\xc2>\x06Common\x12%\n" +
	"\x14k_eHighlightUncommon\x10\x01\x1a\v\xc2>\bUncommon\x12\x1d\n" +
	"\x10k_eHighlightRare\x10\x02\x1a\a\xc2>\x04Rare*4\n" +
	...
	"\vk_eEvenLane\x10\x02B\rZ\v./;protocol"
...
var file_dota_gcmessages_client_battle_report_proto_goTypes = []any{
	...
	(CMsgBattleReport_CompareContext)(0),                                             // 3: protocol.CMsgBattleReport_CompareContext
	(CMsgBattleReport_HighlightTier)(0),                                              // 4: protocol.CMsgBattleReport_HighlightTier
	(CMsgBattleReport_HighlightRarity)(0),                                            // 5: protocol.CMsgBattleReport_HighlightRarity
	(CMsgBattleReport_EOutcome)(0),                                                   // 6: protocol.CMsgBattleReport_EOutcome
	(CMsgBattleReport_ELaneOutcome)(0),                                               // 7: protocol.CMsgBattleReport_ELaneOutcome
	(CMsgClientToGCGetBattleReportResponse_EResponse)(0),                             // 8: protocol.CMsgClientToGCGetBattleReportResponse.EResponse
	(CMsgClientToGCGetBattleReportAggregateStatsResponse_EResponse)(0),               // 9: protocol.CMsgClientToGCGetBattleReportAggregateStatsResponse.EResponse
	(CMsgClientToGCGetBattleReportInfoResponse_EResponse)(0),                         // 10: protocol.CMsgClientToGCGetBattleReportInfoResponse.EResponse
	(CMsgClientToGCAcknowledgeBattleReportResponse_EResponse)(0),                     // 11: protocol.CMsgClientToGCAcknowledgeBattleReportResponse.EResponse
	(CMsgClientToGCGetBattleReportMatchHistoryResponse_EResponse)(0),                 // 12: protocol.CMsgClientToGCGetBattleReportMatchHistoryResponse.EResponse
	(*CMsgClientToGCGetBattleReport)(nil),                                            // 13: protocol.CMsgClientToGCGetBattleReport
	(*CMsgBattleReport_Game)(nil),                                                    // 14: protocol.CMsgBattleReport_Game
	(*CMsgBattleReport_GameList)(nil),                                                // 15: protocol.CMsgBattleReport_GameList
	(*CMsgBattleReport)(nil),                                                         // 16: protocol.CMsgBattleReport
	(*CMsgBattleReportInfo)(nil),                                                     // 17: protocol.CMsgBattleReportInfo
	(*CMsgBattleReportInfoList)(nil),                                                 // 18: protocol.CMsgBattleReportInfoList
	(*CMsgBattleReportHighlights)(nil),                                               // 19: protocol.CMsgBattleReportHighlights
	(*CMsgBattleReportAggregateStats)(nil),                                           // 20: protocol.CMsgBattleReportAggregateStats
	(*CMsgBattleReportAggregatedGeneralStats)(nil),                                   // 21: protocol.CMsgBattleReportAggregatedGeneralStats
	(*CMsgClientToGCGetBattleReportResponse)(nil),                                    // 22: protocol.CMsgClientToGCGetBattleReportResponse
	(*CMsgClientToGCGetBattleReportAggregateStats)(nil),                              // 23: protocol.CMsgClientToGCGetBattleReportAggregateStats
	(*CMsgClientToGCGetBattleReportAggregateStatsResponse)(nil),                      // 24: protocol.CMsgClientToGCGetBattleReportAggregateStatsResponse
	(*CMsgClientToGCGetBattleReportInfo)(nil),                                        // 25: protocol.CMsgClientToGCGetBattleReportInfo
	(*CMsgClientToGCGetBattleReportInfoResponse)(nil),                                // 26: protocol.CMsgClientToGCGetBattleReportInfoResponse
	(*CMsgClientToGCAcknowledgeBattleReport)(nil),                                    // 27: protocol.CMsgClientToGCAcknowledgeBattleReport
	(*CMsgClientToGCAcknowledgeBattleReportResponse)(nil),                            // 28: protocol.CMsgClientToGCAcknowledgeBattleReportResponse
	(*CMsgClientToGCGetBattleReportMatchHistory)(nil),                                // 29: protocol.CMsgClientToGCGetBattleReportMatchHistory
	(*CMsgClientToGCGetBattleReportMatchHistoryResponse)(nil),                        // 30: protocol.CMsgClientToGCGetBattleReportMatchHistoryResponse
	(*CMsgBattleReport_HighlightGeneral)(nil),                                        // 31: protocol.CMsgBattleReport.HighlightGeneral
	(*CMsgBattleReport_Highlight)(nil),                                               // 32: protocol.CMsgBattleReport.Highlight
	(*CMsgBattleReportAggregateStats_CMsgBattleReportStat)(nil),                      // 33: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
...
var file_dota_gcmessages_client_battle_report_proto_depIdxs = []int32{
	...
	14, // 3: protocol.CMsgBattleReport_GameList.games:type_name -> protocol.CMsgBattleReport_Game
	14, // 4: protocol.CMsgBattleReport.games:type_name -> protocol.CMsgBattleReport_Game
	19, // 5: protocol.CMsgBattleReport.highlights:type_name -> protocol.CMsgBattleReportHighlights
	17, // 6: protocol.CMsgBattleReportInfoList.battle_report_info:type_name -> protocol.CMsgBattleReportInfo
	32, // 7: protocol.CMsgBattleReportHighlights.highlights:type_name -> protocol.CMsgBattleReport.Highlight
	34, // 8: protocol.CMsgBattleReportAggregateStats.result:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate
	16, // 9: protocol.CMsgClientToGCGetBattleReportResponse.report:type_name -> protocol.CMsgBattleReport
	8,  // 10: protocol.CMsgClientToGCGetBattleReportResponse.response:type_name -> protocol.CMsgClientToGCGetBattleReportResponse.EResponse
	20, // 11: protocol.CMsgClientToGCGetBattleReportResponse.aggregate_stats:type_name -> protocol.CMsgBattleReportAggregateStats
	17, // 12: protocol.CMsgClientToGCGetBattleReportResponse.info:type_name -> protocol.CMsgBattleReportInfo
	35, // 13: protocol.CMsgClientToGCGetBattleReportAggregateStats.aggregate_keys:type_name -> protocol.CMsgClientToGCGetBattleReportAggregateStats.CMsgBattleReportAggregateKey
	20, // 14: protocol.CMsgClientToGCGetBattleReportAggregateStatsResponse.aggregate_stats:type_name -> protocol.CMsgBattleReportAggregateStats
	9,  // 15: protocol.CMsgClientToGCGetBattleReportAggregateStatsResponse.response:type_name -> protocol.CMsgClientToGCGetBattleReportAggregateStatsResponse.EResponse
	18, // 16: protocol.CMsgClientToGCGetBattleReportInfoResponse.battle_report_info_list:type_name -> protocol.CMsgBattleReportInfoList
	10, // 17: protocol.CMsgClientToGCGetBattleReportInfoResponse.response:type_name -> protocol.CMsgClientToGCGetBattleReportInfoResponse.EResponse
	11, // 18: protocol.CMsgClientToGCAcknowledgeBattleReportResponse.response:type_name -> protocol.CMsgClientToGCAcknowledgeBattleReportResponse.EResponse
	12, // 19: protocol.CMsgClientToGCGetBattleReportMatchHistoryResponse.response:type_name -> protocol.CMsgClientToGCGetBattleReportMatchHistoryResponse.EResponse
	15, // 20: protocol.CMsgClientToGCGetBattleReportMatchHistoryResponse.games:type_name -> protocol.CMsgBattleReport_GameList
	1,  // 21: protocol.CMsgBattleReport.Highlight.category:type_name -> protocol.CMsgBattleReport_HighlightCategory
	4,  // 22: protocol.CMsgBattleReport.Highlight.tier:type_name -> protocol.CMsgBattleReport_HighlightTier
	5,  // 23: protocol.CMsgBattleReport.Highlight.rarity:type_name -> protocol.CMsgBattleReport_HighlightRarity
	2,  // 24: protocol.CMsgBattleReport.Highlight.role:type_name -> protocol.CMsgBattleReport_Role
	3,  // 25: protocol.CMsgBattleReport.Highlight.context:type_name -> protocol.CMsgBattleReport_CompareContext
	33, // 26: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate.kills:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
	33, // 27: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate.deaths:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
	33, // 28: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate.assists:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
	33, // 29: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate.rank_change:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
	33, // 30: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate.last_hits:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
	33, // 31: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate.denies:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
	33, // 32: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate.gpm:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
	33, // 33: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate.xpm:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
	33, // 34: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate.seconds_dead:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
	33, // 35: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate.bounty_runes:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
	33, // 36: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate.water_runes:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
	33, // 37: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate.power_runes:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
	33, // 38: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate.time_enemy_t1_tower_destroyed:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
	33, // 39: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate.time_friendly_t1_tower_destroyed:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
	33, // 40: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate.enemy_roshan_kills:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
	33, // 41: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate.teleports_used:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
	33, // 42: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate.dewards:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
	33, // 43: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate.camps_stacked:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
	33, // 44: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate.support_gold:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
	33, // 45: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate.hero_damage:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
	33, // 46: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate.hero_healing:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
	33, // 47: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate.tower_damage:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
	33, // 48: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate.successful_smokes:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
	33, // 49: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate.stun_duration:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
	33, // 50: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate.duration:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
	33, // 51: protocol.CMsgBattleReportAggregateStats.CMsgBattleReportAggregate.friendly_roshan_kills:type_name -> protocol.CMsgBattleReportAggregateStats.CMsgBattleReportStat
