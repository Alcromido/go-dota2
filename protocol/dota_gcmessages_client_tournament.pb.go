...
const file_dota_gcmessages_client_tournament_proto_rawDesc = "" +
	"\n" +
	"'dota_gcmessages_client_tournament.proto\x12\bprotocol\x1a\x17dota_client_enums.proto\"#\n" +
	"!CMsgRequestWeekendTourneySchedule\"\xe4\x02\n" +
	"\x1aCMsgWeekendTourneySchedule\x12K\n" +
	"\tdivisions\x18\x01 \x03(\v2-.protocol.CMsgWeekendTourneySchedule.DivisionR\tdivisions\x1a\xf8\x01\n" +
	"\bDivision\x12#\n" +
	...
	"\x17CMsgWeekendTourneyLeave\"\xe6\n" +
	"\n" +
	...
	"\vskill_level\x18\x04 \x01(\rR\n" +
	"skillLevel\x12j\n" +
	"\x13tournament_template\x18\x05 \x01(\x0e2\x1d.protocol.ETournamentTemplate:\x1ak_ETournamentTemplate_NoneR\x12tournamentTemplate\x12L\n" +
	"\x05state\x18\x06 \x01(\x0e2\x1a.protocol.ETournamentState:\x1ak_ETournamentState_UnknownR\x05state\x12\"\n" +
	"\rstate_seq_num\x18\n" +
	" \x01(\rR\vstateSeqNum\x12(\n" +
	"\x10season_trophy_id\x18\v \x01(\rR\x0eseasonTrophyId\x127\n" +
	"\x05teams\x18\a \x03(\v2!.protocol.CMsgDOTATournament.TeamR\x05teams\x127\n" +
	"\x05games\x18\b \x03(\v2!.protocol.CMsgDOTATournament.GameR\x05games\x127\n" +
	"\x05nodes\x18\t \x03(\v2!.protocol.CMsgDOTATournament.NodeR\x05nodes\x1a\xe4\x02\n" +
	"\x04Team\x12\x19\n" +
	"\bteam_gid\x18\x01 \x01(\x06R\ateamGid\x12\"\n" +
	"\rnode_or_state\x18\x02 \x01(\rR\vnodeOrState\x12\x1c\n" +
	"\aplayers\x18\x03 \x03(\rB\x02\x10\x01R\aplayers\x12%\n" +
	"\fplayer_buyin\x18\t \x03(\rB\x02\x10\x01R\vplayerBuyin\x120\n" +
	"\x12player_skill_level\x18\n" +
	" \x03(\rB\x02\x10\x01R\x10playerSkillLevel\x12(\n" +
	...
	"\vteam_a_good\x18\x04 \x01(\bR\tteamAGood\x12T\n" +
	"\x05state\x18\x05 \x01(\x0e2\x1e.protocol.ETournamentGameState:\x1ek_ETournamentGameState_UnknownR\x05state\x12\x1d\n" +
	"\n" +
	"start_time\x18\x06 \x01(\rR\tstartTime\x1a\xba\x01\n" +
	"\x04Node\x12\x17\n" +
	"\anode_id\x18\x01 \x01(\rR\x06nodeId\x12\x1c\n" +
	"\n" +
	"team_idx_a\x18\x02 \x01(\rR\bteamIdxA\x12\x1c\n" +
	"\n" +
	"team_idx_b\x18\x03 \x01(\rR\bteamIdxB\x12]\n" +
	"\n" +
	"node_state\x18\x04 \x01(\x0e2\x1e.protocol.ETournamentNodeState:\x1ek_ETournamentNodeState_UnknownR\tnodeState\"\x90\x06\n" +
	"\x1dCMsgDOTATournamentStateChange\x12*\n" +
	"\x11new_tournament_id\x18\x01 \x01(\rR\x0fnewTournamentId\x12I\n" +
	"\x05event\x18\x02 \x01(\x0e2\x1a.protocol.ETournamentEvent:\x17k_ETournamentEvent_NoneR\x05event\x12h\n" +
	"\x14new_tournament_state\x18\x03 \x01(\x0e2\x1a.protocol.ETournamentState:\x1ak_ETournamentState_UnknownR\x12newTournamentState\x12U\n" +
	"\fgame_changes\x18\x04 \x03(\v22.protocol.CMsgDOTATournamentStateChange.GameChangeR\vgameChanges\x12U\n" +
	"\fteam_changes\x18\x05 \x03(\v22.protocol.CMsgDOTATournamentStateChange.TeamChangeR\vteamChanges\x126\n" +
	"\x15merged_tournament_ids\x18\x06 \x03(\rB\x02\x10\x01R\x13mergedTournamentIds\x12\"\n" +
	"\rstate_seq_num\x18\a \x01(\rR\vstateSeqNum\x1a\x84\x01\n" +
	"\n" +
	"GameChange\x12\x19\n" +
	"\bmatch_id\x18\x01 \x01(\x04R\amatchId\x12[\n" +
	"\tnew_state\x18\x02 \x01(\x0e2\x1e.protocol.ETournamentGameState:\x1ek_ETournamentGameState_UnknownR\bnewState\x1a}\n" +
	"\n" +
	"TeamChange\x12\x19\n" +
	...
	"\x05score\x18\t \x01(\rR\x05score\"\xe9\x01\n" +
	"!CMsgDOTAWeekendTourneyPlayerStats\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12(\n" +
	"\x10season_trophy_id\x18\x02 \x01(\rR\x0eseasonTrophyId\x12X\n" +
	"\fskill_levels\x18\x03 \x03(\v25.protocol.CMsgDOTAWeekendTourneyPlayerSkillLevelStatsR\vskillLevels\x12!\n" +
	"\fcurrent_tier\x18\x04 \x01(\rR\vcurrentTier\"s\n" +
	"(CMsgDOTAWeekendTourneyPlayerStatsRequest\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12(\n" +
	"\x10season_trophy_id\x18\x02 \x01(\rR\x0eseasonTrophyId\"\xd9\x03\n" +
	"#CMsgDOTAWeekendTourneyPlayerHistory\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12Z\n" +
	"\vtournaments\x18\x03 \x03(\v28.protocol.CMsgDOTAWeekendTourneyPlayerHistory.TournamentR\vtournaments\x1a\xb6\x02\n" +
	"\n" +
	"Tournament\x12#\n" +
	...
	"\x10season_trophy_id\x18\t \x01(\rR\x0eseasonTrophyId\"\xc7\x04\n" +
	"*CMsgDOTAWeekendTourneyParticipationDetails\x12[\n" +
	"\tdivisions\x18\x01 \x03(\v2=.protocol.CMsgDOTAWeekendTourneyParticipationDetails.DivisionR\tdivisions\x1a\x97\x02\n" +
	"\x04Tier\x12\x12\n" +
	...
	"\x10players_streak_5\x18\b \x01(\rR\x0eplayersStreak5\x1a\xa1\x01\n" +
	"\bDivision\x12\x1f\n" +
	"\vdivision_id\x18\x01 \x01(\rR\n" +
	"divisionId\x12#\n" +
	"\rschedule_time\x18\x02 \x01(\rR\fscheduleTime\x12O\n" +
	"\x05tiers\x18\x03 \x03(\v29.protocol.CMsgDOTAWeekendTourneyParticipationDetails.TierR\x05tiers*\xb6\x04\n" +
	...
	"\x12?\n" +
	";k_ETournamentEvent_TeamParticipationTimedOut_GrantedVictory\x10\vB\rZ\v./;protocol"
