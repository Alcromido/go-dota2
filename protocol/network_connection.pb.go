...
const file_network_connection_proto_rawDesc = "" +
	"\n" +
	"\x18network_connection.proto\x12\bprotocol\x1a google/protobuf/descriptor.proto*\xceJ\n" +
	...
	"'NETWORK_DISCONNECT_KICKED_NOSTEAMTICKET\x10\xa1\x01\x1a*\xa2\xd4\x18&#Player_DisconnectReason_NoSteamTicket:]\n" +
	"\x18network_connection_token\x12!.google.protobuf.EnumValueOptions\x18Ċ\x03 \x01(\tR\x16networkConnectionTokenB\rZ\v./;protocol"
...
var file_network_connection_proto_goTypes = []any{
	(ENetworkDisconnectionReason)(0),      // 0: protocol.ENetworkDisconnectionReason
