...
func (CSODOTALobby_State) EnumDescriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_lobby_proto_rawDescGZIP(), []int{16, 0}
}
...
func (CSODOTALobby_LobbyType) EnumDescriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_lobby_proto_rawDescGZIP(), []int{16, 1}
}
...
func (x *CSODOTALobbyMember) GetCoachedAccountIds() []uint32 {
	if x != nil {
...
func (x *CSODOTALobbyMember) GetIsSteamChina() bool {
...
func (x *CSODOTALobby) GetRequestedHeroIds() []uint32 {
	if x != nil {
...
func (x *CSODOTALobby) GetExtraStartupMessages() []*CSODOTALobby_CExtraMsg {
	if x != nil {
...
func (*CMsgAdditionalLobbyStartupAccountData_ChatWheelMessageRange) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_lobby_proto_rawDescGZIP(), []int{20, 0}
}
...
func (*CMsgAdditionalLobbyStartupAccountData_PingWheelMessageRange) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_common_lobby_proto_rawDescGZIP(), []int{20, 1}
}
...
const file_dota_gcmessages_common_lobby_proto_rawDesc = "" +
	...
	"\x03max\x18\x03 \x01(\rR\x03max\"\xc7\x06\n" +
	"\x14CMsgLobbyEventPoints\x12\x19\n" +
	"\bevent_id\x18\x01 \x01(\rR\aeventId\x12S\n" +
	"\x0eaccount_points\x18\x02 \x03(\v2,.protocol.CMsgLobbyEventPoints.AccountPointsR\raccountPoints\x1a\xbe\x05\n" +
	...
	"\x04slot\x18\a \x01(\rR\x04slot\x12\x19\n" +
	"\bparty_id\x18\f \x01(\x04R\apartyId\x12\x1d\n" +
	"\n" +
	"meta_level\x18\r \x01(\rR\tmetaLevel\x12\x17\n" +
	"\ameta_xp\x18\x0e \x01(\rR\x06metaXp\x12&\n" +
	"\x0fmeta_xp_awarded\x18\x0f \x01(\rR\rmetaXpAwarded\x12S\n" +
	"\rleaver_status\x18\x10 \x01(\x0e2\x1c.protocol.DOTALeaverStatus_t:\x10DOTA_LEAVER_NONER\fleaverStatus\x12%\n" +
	"\x0eleaver_actions\x18\x1c \x01(\rR\rleaverActions\x12\x1b\n" +
	"\achannel\x18\x11 \x01(\r:\x016R\achannel\x12(\n" +
	"\x10disabled_hero_id\x18\x14 \x03(\rR\x0edisabledHeroId\x12&\n" +
	"\x0fenabled_hero_id\x18\x16 \x03(\rR\renabledHeroId\x12J\n" +
	"\n" +
	"coach_team\x18\x17 \x01(\x0e2\x16.protocol.DOTA_GC_TEAM:\x13DOTA_GC_TEAM_NOTEAMR\tcoachTeam\x12.\n" +
	"\x13coached_account_ids\x185 \x03(\rR\x11coachedAccountIds\x12!\n" +
	"\fcoach_rating\x18* \x01(\rR\vcoachRating\x12+\n" +
	"\x12pwrd_cyber_cafe_id\x18\x18 \x01(\rR\x0fpwrdCyberCafeId\x12/\n" +
	"\x14pwrd_cyber_cafe_name\x18\x19 \x01(\tR\x11pwrdCyberCafeName\x129\n" +
	"\x19disabled_random_hero_bits\x18) \x03(\aR\x16disabledRandomHeroBits\x12\x1f\n" +
	"\vrank_change\x18\x1d \x01(\x11R\n" +
	"rankChange\x12\x1c\n" +
	"\tcameraman\x18\x1e \x01(\bR\tcameraman\x125\n" +
	"\x17custom_game_product_ids\x18\x1f \x03(\rR\x14customGameProductIds\x12R\n" +
	"\x11search_match_type\x18! \x01(\x0e2\x13.protocol.MatchType:\x11MATCH_TYPE_CASUALR\x0fsearchMatchType\x120\n" +
	"\x14favorite_team_packed\x18# \x01(\x04R\x12favoriteTeamPacked\x12,\n" +
	"\x12is_plus_subscriber\x18$ \x01(\bR\x10isPlusSubscriber\x120\n" +
	"\x14lane_selection_flags\x18& \x01(\rR\x12laneSelectionFlags\x12(\n" +
	"\x10can_earn_rewards\x18' \x01(\bR\x0ecanEarnRewards\x12[\n" +
	"\x13live_spectator_team\x18( \x01(\x0e2\x16.protocol.DOTA_GC_TEAM:\x13DOTA_GC_TEAM_NOTEAMR\x11liveSpectatorTeam\x12)\n" +
	"\x11was_mvp_last_game\x18+ \x01(\bR\x0ewasMvpLastGame\x12F\n" +
	"\x0epending_awards\x18, \x03(\v2\x1f.protocol.CMsgPendingEventAwardR\rpendingAwards\x12Z\n" +
	"\x19pending_awards_on_victory\x18- \x03(\v2\x1f.protocol.CMsgPendingEventAwardR\x16pendingAwardsOnVictory\x12d\n" +
	"\x13rank_mmr_boost_type\x18. \x01(\x0e2\x1b.protocol.EDOTAMMRBoostType:\x18k_EDOTAMMRBoostType_NoneR\x10rankMmrBoostType\x124\n" +
	"\x16queue_point_adjustment\x18/ \x01(\x11R\x14queuePointAdjustment\x12\x1b\n" +
	"\trank_tier\x180 \x01(\x05R\brankTier\x12\x14\n" +
	"\x05title\x182 \x01(\rR\x05title\x12\x19\n" +
	"\bguild_id\x183 \x01(\rR\aguildId\x12+\n" +
	"\x11reports_available\x184 \x01(\rR\x10reportsAvailable\x12$\n" +
	"\x0eis_steam_china\x186 \x01(\bR\fisSteamChina\x129\n" +
	...
	"\x14eligible_account_ids\x18\b \x03(\rR\x12eligibleAccountIds\"\x95.\n" +
	...
	"\x0efill_with_bots\x18\x0e \x01(\bR\ffillWithBots\x12\x1d\n" +
	"\n" +
	"intro_mode\x18\x0f \x01(\bR\tintroMode\x12\x1b\n" +
	"\tgame_name\x18\x10 \x01(\tR\bgameName\x12>\n" +
	"\fteam_details\x18\x11 \x03(\v2\x1b.protocol.CLobbyTeamDetailsR\vteamDetails\x12'\n" +
	"\x0ftutorial_lesson\x18\x12 \x01(\rR\x0etutorialLesson\x12#\n" +
	...
	"\x16bot_difficulty_radiant\x18$ \x01(\x0e2\x1b.protocol.DOTABotDifficulty:\x13BOT_DIFFICULTY_HARDR\x14botDifficultyRadiant\x12T\n" +
	"\x14timed_reward_details\x18& \x03(\v2\".protocol.CLobbyTimedRewardDetailsR\x12timedRewardDetails\x12\x19\n" +
	...
	"\x12penalty_level_dire\x18, \x01(\r:\x010R\x10penaltyLevelDire\x12 \n" +
	"\fload_game_id\x18- \x01(\rR\n" +
	"loadGameId\x12\x1f\n" +
	"\vseries_type\x18. \x01(\rR\n" +
	"seriesType\x12.\n" +
	"\x13radiant_series_wins\x18/ \x01(\rR\x11radiantSeriesWins\x12(\n" +
	"\x10dire_series_wins\x180 \x01(\rR\x0edireSeriesWins\x12%\n" +
	"\x0eloot_generated\x181 \x01(\rR\rlootGenerated\x12!\n" +
	"\floot_awarded\x182 \x01(\rR\vlootAwarded\x12\x1f\n" +
	...
	"\x0eextra_messages\x18> \x03(\v2 .protocol.CSODOTALobby.CExtraMsgR\rextraMessages\x124\n" +
	"\tsave_game\x18? \x01(\v2\x17.protocol.CDOTASaveGameR\bsaveGame\x120\n" +
	...
	"\x1bemergency_disabled_hero_ids\x18i \x03(\rR\x18emergencyDisabledHeroIds\x125\n" +
	...
	"\fleague_phase\x18q \x01(\rR\vleaguePhase\x122\n" +
	"\x15record_detailed_stats\x18r \x01(\bR\x13recordDetailedStats\x12B\n" +
	...
	"\rguild_details\x18v \x03(\v2\x1c.protocol.CLobbyGuildDetailsR\fguildDetails\x12L\n" +
	"\x12lobby_event_points\x18w \x03(\v2\x1e.protocol.CMsgLobbyEventPointsR\x10lobbyEventPoints\x12,\n" +
	"\x12requested_hero_ids\x18| \x03(\rR\x10requestedHeroIds\x12Y\n" +
	...
	"\x15event_game_definition\x18\x81\x01 \x01(\tR\x13eventGameDefinition\x12W\n" +
	"\x16extra_startup_messages\x18\x82\x01 \x03(\v2 .protocol.CSODOTALobby.CExtraMsgR\x14extraStartupMessages\x1a7\n" +
	"\tCExtraMsg\x12\x0e\n" +
	...
	"\x11FEATURED_GAMEMODE\x10\x0f\"Y\n" +
	...
	"\x17is_last_match_in_series\x18\x03 \x01(\bR\x13isLastMatchInSeries\"e\n" +
	...
	"\x1eLobbyDotaPauseSetting_Disabled\x10\x02B\rZ\v./;protocol"
...
var file_dota_gcmessages_common_lobby_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_dota_gcmessages_common_lobby_proto_goTypes = []any{
	...
	(*CSODOTAServerLobby)(nil),                                          // 22: protocol.CSODOTAServerLobby
	(*CSODOTAStaticLobby)(nil),                                          // 23: protocol.CSODOTAStaticLobby
	(*CSODOTAServerStaticLobby)(nil),                                    // 24: protocol.CSODOTAServerStaticLobby
	(*CMsgAdditionalLobbyStartupAccountData)(nil),                       // 25: protocol.CMsgAdditionalLobbyStartupAccountData
	(*CMsgLobbyInitializationComplete)(nil),                             // 26: protocol.CMsgLobbyInitializationComplete
	(*CMsgLobbyPlaytestDetails)(nil),                                    // 27: protocol.CMsgLobbyPlaytestDetails
	(*CMsgLocalServerGuildData)(nil),                                    // 28: protocol.CMsgLocalServerGuildData
	(*CMsgLocalServerFakeLobbyData)(nil),                                // 29: protocol.CMsgLocalServerFakeLobbyData
	(*CMsgLobbyPlayerPlusSubscriptionData_HeroBadge)(nil),               // 30: protocol.CMsgLobbyPlayerPlusSubscriptionData.HeroBadge
	(*CMsgLobbyEventPoints_AccountPoints)(nil),                          // 31: protocol.CMsgLobbyEventPoints.AccountPoints
	(*CSODOTALobbyInvite_LobbyMember)(nil),                              // 32: protocol.CSODOTALobbyInvite.LobbyMember
	(*CSODOTALobby_CExtraMsg)(nil),                                      // 33: protocol.CSODOTALobby.CExtraMsg
	(*CMsgAdditionalLobbyStartupAccountData_ChatWheelMessageRange)(nil), // 34: protocol.CMsgAdditionalLobbyStartupAccountData.ChatWheelMessageRange
	(*CMsgAdditionalLobbyStartupAccountData_PingWheelMessageRange)(nil), // 35: protocol.CMsgAdditionalLobbyStartupAccountData.PingWheelMessageRange
	(DOTA_GC_TEAM)(0),                                                   // 36: protocol.DOTA_GC_TEAM
	(DOTALeaverStatusT)(0),                                              // 37: protocol.DOTALeaverStatus_t
	(MatchType)(0),                                                      // 38: protocol.MatchType
	...
	(DOTASelectionPriorityRules)(0),                                     // 48: protocol.DOTASelectionPriorityRules
	(DOTASelectionPriorityChoice)(0),                                    // 49: protocol.DOTASelectionPriorityChoice
	(*CExtraMsgBlock)(nil),                                              // 50: protocol.CExtraMsgBlock
}
var file_dota_gcmessages_common_lobby_proto_depIdxs = []int32{
	...
	30, // 1: protocol.CMsgLobbyPlayerPlusSubscriptionData.hero_badges:type_name -> protocol.CMsgLobbyPlayerPlusSubscriptionData.HeroBadge
	31, // 2: protocol.CMsgLobbyEventPoints.account_points:type_name -> protocol.CMsgLobbyEventPoints.AccountPoints
	32, // 3: protocol.CSODOTALobbyInvite.members:type_name -> protocol.CSODOTALobbyInvite.LobbyMember
	36, // 4: protocol.CSODOTALobbyMember.team:type_name -> protocol.DOTA_GC_TEAM
	37, // 5: protocol.CSODOTALobbyMember.leaver_status:type_name -> protocol.DOTALeaverStatus_t
	36, // 6: protocol.CSODOTALobbyMember.coach_team:type_name -> protocol.DOTA_GC_TEAM
	38, // 7: protocol.CSODOTALobbyMember.search_match_type:type_name -> protocol.MatchType
	36, // 8: protocol.CSODOTALobbyMember.live_spectator_team:type_name -> protocol.DOTA_GC_TEAM
	39, // 9: protocol.CSODOTALobbyMember.pending_awards:type_name -> protocol.CMsgPendingEventAward
	39, // 10: protocol.CSODOTALobbyMember.pending_awards_on_victory:type_name -> protocol.CMsgPendingEventAward
	40, // 11: protocol.CSODOTALobbyMember.rank_mmr_boost_type:type_name -> protocol.EDOTAMMRBoostType
	36, // 12: protocol.CLobbyGuildDetails.team_for_guild:type_name -> protocol.DOTA_GC_TEAM
	41, // 13: protocol.CLobbyGuildChallenge.event_id:type_name -> protocol.EEvent
	12, // 14: protocol.CSODOTALobby.all_members:type_name -> protocol.CSODOTALobbyMember
	3,  // 15: protocol.CSODOTALobby.state:type_name -> protocol.CSODOTALobby.State
	4,  // 16: protocol.CSODOTALobby.lobby_type:type_name -> protocol.CSODOTALobby.LobbyType
	16, // 17: protocol.CSODOTALobby.team_details:type_name -> protocol.CLobbyTeamDetails
	42, // 18: protocol.CSODOTALobby.game_state:type_name -> protocol.DOTA_GameState
	43, // 19: protocol.CSODOTALobby.cm_pick:type_name -> protocol.DOTA_CM_PICK
	44, // 20: protocol.CSODOTALobby.bot_difficulty_radiant:type_name -> protocol.DOTABotDifficulty
	18, // 21: protocol.CSODOTALobby.timed_reward_details:type_name -> protocol.CLobbyTimedRewardDetails
	1,  // 22: protocol.CSODOTALobby.dota_tv_delay:type_name -> protocol.LobbyDotaTVDelay
	19, // 23: protocol.CSODOTALobby.broadcast_channel_info:type_name -> protocol.CLobbyBroadcastChannelInfo
	33, // 24: protocol.CSODOTALobby.extra_messages:type_name -> protocol.CSODOTALobby.CExtraMsg
	45, // 25: protocol.CSODOTALobby.save_game:type_name -> protocol.CDOTASaveGame
	46, // 26: protocol.CSODOTALobby.match_outcome:type_name -> protocol.EMatchOutcome
	47, // 27: protocol.CSODOTALobby.visibility:type_name -> protocol.DOTALobbyVisibility
	2,  // 28: protocol.CSODOTALobby.pause_setting:type_name -> protocol.LobbyDotaPauseSetting
	44, // 29: protocol.CSODOTALobby.bot_difficulty_dire:type_name -> protocol.DOTABotDifficulty
	41, // 30: protocol.CSODOTALobby.event_progression_enabled:type_name -> protocol.EEvent
	48, // 31: protocol.CSODOTALobby.selection_priority_rules:type_name -> protocol.DOTASelectionPriorityRules
	49, // 32: protocol.CSODOTALobby.series_current_priority_team_choice:type_name -> protocol.DOTASelectionPriorityChoice
	49, // 33: protocol.CSODOTALobby.series_current_non_priority_team_choice:type_name -> protocol.DOTASelectionPriorityChoice
	41, // 34: protocol.CSODOTALobby.current_primary_event:type_name -> protocol.EEvent
	20, // 35: protocol.CSODOTALobby.guild_challenges:type_name -> protocol.CLobbyGuildChallenge
	17, // 36: protocol.CSODOTALobby.guild_details:type_name -> protocol.CLobbyGuildDetails
	9,  // 37: protocol.CSODOTALobby.lobby_event_points:type_name -> protocol.CMsgLobbyEventPoints
	5,  // 38: protocol.CSODOTALobby.coach_friend_requests:type_name -> protocol.CMsgLobbyCoachFriendRequest
	33, // 39: protocol.CSODOTALobby.extra_startup_messages:type_name -> protocol.CSODOTALobby.CExtraMsg
	13, // 40: protocol.CSODOTAServerLobby.all_members:type_name -> protocol.CSODOTAServerLobbyMember
	14, // 41: protocol.CSODOTAStaticLobby.all_members:type_name -> protocol.CSODOTAStaticLobbyMember
	15, // 42: protocol.CSODOTAServerStaticLobby.all_members:type_name -> protocol.CSODOTAServerStaticLobbyMember
	6,  // 43: protocol.CMsgAdditionalLobbyStartupAccountData.plus_data:type_name -> protocol.CMsgLobbyPlayerPlusSubscriptionData
	34, // 44: protocol.CMsgAdditionalLobbyStartupAccountData.unlocked_chat_wheel_message_ranges:type_name -> protocol.CMsgAdditionalLobbyStartupAccountData.ChatWheelMessageRange
	35, // 45: protocol.CMsgAdditionalLobbyStartupAccountData.unlocked_ping_wheel_message_ranges:type_name -> protocol.CMsgAdditionalLobbyStartupAccountData.PingWheelMessageRange
	41, // 46: protocol.CMsgLocalServerGuildData.event_id:type_name -> protocol.EEvent
	9,  // 47: protocol.CMsgLocalServerFakeLobbyData.event_points:type_name -> protocol.CMsgLobbyEventPoints
	28, // 48: protocol.CMsgLocalServerFakeLobbyData.guild_info:type_name -> protocol.CMsgLocalServerGuildData
	25, // 49: protocol.CMsgLocalServerFakeLobbyData.additional_data:type_name -> protocol.CMsgAdditionalLobbyStartupAccountData
	7,  // 50: protocol.CMsgLobbyEventPoints.AccountPoints.event_game_custom_actions:type_name -> protocol.CMsgEventActionData
	7,  // 51: protocol.CMsgLobbyEventPoints.AccountPoints.networked_event_actions:type_name -> protocol.CMsgEventActionData
	8,  // 52: protocol.CMsgLobbyEventPoints.AccountPoints.periodic_resources:type_name -> protocol.CMsgPeriodicResourceData
	50, // 53: protocol.CMsgLobbyEventPoints.AccountPoints.extra_event_messages:type_name -> protocol.CExtraMsgBlock
