...
const file_base_gcmessages_proto_rawDesc = "" +
	"\n" +
	"\x15base_gcmessages.proto\x12\bprotocol\x1a\x13steammessages.proto\x1a\x16gcsdk_gcmessages.proto\"\xe5\x01\n" +
	...
	"\x13source_reference_id\x18\x05 \x01(\x04R\x11sourceReferenceId\"\xb3\x01\n" +
	"\x17CMsgGCStorePurchaseInit\x12\x18\n" +
	"\acountry\x18\x01 \x01(\tR\acountry\x12\x1a\n" +
	"\blanguage\x18\x02 \x01(\x05R\blanguage\x12\x1a\n" +
	"\bcurrency\x18\x03 \x01(\x05R\bcurrency\x12F\n" +
	"\n" +
	"line_items\x18\x04 \x03(\v2'.protocol.CGCStorePurchaseInit_LineItemR\tlineItems\"P\n" +
	"\x1fCMsgGCStorePurchaseInitResponse\x12\x16\n" +
	"\x06result\x18\x01 \x01(\x05R\x06result\x12\x15\n" +
	"\x06txn_id\x18\x02 \x01(\x04R\x05txnId\"\xe9\x01\n" +
	"\x12CMsgClientPingData\x12#\n" +
	"\vrelay_codes\x18\x04 \x03(\aB\x02\x10\x01R\n" +
	"relayCodes\x12#\n" +
	"\vrelay_pings\x18\x05 \x03(\rB\x02\x10\x01R\n" +
	"relayPings\x12%\n" +
	"\fregion_codes\x18\b \x03(\rB\x02\x10\x01R\vregionCodes\x12%\n" +
	"\fregion_pings\x18\t \x03(\rB\x02\x10\x01R\vregionPings\x12;\n" +
	"\x1aregion_ping_failed_bitmask\x18\n" +
	" \x01(\rR\x17regionPingFailedBitmask\"\xc4\x01\n" +
	...
	"\bas_coach\x18\x04 \x01(\bR\aasCoach\x129\n" +
	"\tping_data\x18\x05 \x01(\v2\x1c.protocol.CMsgClientPingDataR\bpingData\"U\n" +
	...
	"\fuser_offline\x18\x03 \x01(\bR\vuserOffline\"\xae\x01\n" +
	"\x17CMsgPartyInviteResponse\x12\x19\n" +
	"\bparty_id\x18\x01 \x01(\x04R\apartyId\x12\x16\n" +
	"\x06accept\x18\x02 \x01(\bR\x06accept\x12%\n" +
	"\x0eclient_version\x18\x03 \x01(\rR\rclientVersion\x129\n" +
	"\tping_data\x18\b \x01(\v2\x1c.protocol.CMsgClientPingDataR\bpingData\"\xcf\x01\n" +
	...
	"\x0eCMsgLeaveParty\"\xd6\x01\n" +
	"\x1bCMsgCustomGameInstallStatus\x12^\n" +
	"\x06status\x18\x01 \x01(\x0e2\".protocol.ECustomGameInstallStatus:\"k_ECustomGameInstallStatus_UnknownR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12=\n" +
	"\x1blatest_timestamp_from_steam\x18\x03 \x01(\aR\x18latestTimestampFromSteam\"y\n" +
	"\x13CMsgServerAvailable\x12b\n" +
	"\x1acustom_game_install_status\x18\x01 \x01(\v2%.protocol.CMsgCustomGameInstallStatusR\x17customGameInstallStatus\"3\n" +
	"\x16CMsgLANServerAvailable\x12\x19\n" +
	"\blobby_id\x18\x01 \x01(\x06R\alobbyId\"\xd0\x03\n" +
	"\x18CSOEconGameAccountClient\x12=\n" +
	"\x19additional_backpack_slots\x18\x01 \x01(\r:\x010R\x17additionalBackpackSlots\x12*\n" +
	"\rtrial_account\x18\x02 \x01(\b:\x05falseR\ftrialAccount\x12=\n" +
	"\x18eligible_for_online_play\x18\x03 \x01(\b:\x04trueR\x15eligibleForOnlinePlay\x12I\n" +
	...
	"\x13duel_ban_expiration\x18\a \x01(\aR\x11duelBanExpiration\x125\n" +
	"\x13made_first_purchase\x18\t \x01(\b:\x05falseR\x11madeFirstPurchase\"i\n" +
	...
	"\vegg_item_id\x18\x02 \x01(\x04R\teggItemId\"q\n" +
	"\x14CSOEconItemAttribute\x12\"\n" +
	"\tdef_index\x18\x01 \x01(\r:\x0565535R\bdefIndex\x12\x14\n" +
	...
	"\bnew_slot\x18\x02 \x01(\rR\anewSlot\"\xfa\x03\n" +
	"\vCSOEconItem\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x04R\x02id\x12\x1d\n" +
	"\n" +
	"account_id\x18\x02 \x01(\rR\taccountId\x12\x1c\n" +
	"\tinventory\x18\x03 \x01(\rR\tinventory\x12\x1b\n" +
	"\tdef_index\x18\x04 \x01(\rR\bdefIndex\x12\x1d\n" +
	"\bquantity\x18\x05 \x01(\r:\x011R\bquantity\x12\x17\n" +
	"\x05level\x18\x06 \x01(\r:\x011R\x05level\x12\x1b\n" +
	"\aquality\x18\a \x01(\r:\x014R\aquality\x12\x17\n" +
	"\x05flags\x18\b \x01(\r:\x010R\x05flags\x12\x19\n" +
	"\x06origin\x18\t \x01(\r:\x010R\x06origin\x12<\n" +
	"\tattribute\x18\f \x03(\v2\x1e.protocol.CSOEconItemAttributeR\tattribute\x12:\n" +
	"\rinterior_item\x18\r \x01(\v2\x15.protocol.CSOEconItemR\finteriorItem\x12\x17\n" +
	"\x05style\x18\x0f \x01(\r:\x010R\x05style\x12\x1f\n" +
	"\voriginal_id\x18\x10 \x01(\x04R\n" +
	"originalId\x12D\n" +
	"\x0eequipped_state\x18\x12 \x03(\v2\x1d.protocol.CSOEconItemEquippedR\requippedState\",\n" +
	...
	"\x06origin\x18\x06 \x01(\rR\x06origin\"\xaf\x01\n" +
	"\x14CMsgSetItemPositions\x12R\n" +
	"\x0eitem_positions\x18\x01 \x03(\v2+.protocol.CMsgSetItemPositions.ItemPositionR\ritemPositions\x1aC\n" +
	...
	"\x1eCMsgGCToGCWebAPIAccountChanged\"\x82\x01\n" +
	"\x0fCMsgExtractGems\x12 \n" +
	"\ftool_item_id\x18\x01 \x01(\x04R\n" +
	"toolItemId\x12 \n" +
	"\fitem_item_id\x18\x02 \x01(\x04R\n" +
	"itemItemId\x12+\n" +
	"\x0eitem_socket_id\x18\x03 \x01(\r:\x0565535R\fitemSocketId\"\xef\x02\n" +
	"\x17CMsgExtractGemsResponse\x12\x17\n" +
	"\aitem_id\x18\x01 \x01(\x04R\x06itemId\x12c\n" +
	"\bresponse\x18\x02 \x01(\x0e2..protocol.CMsgExtractGemsResponse.EExtractGems:\x17k_ExtractGems_SucceededR\bresponse\"\xd5\x01\n" +
	...
	"\fitem_item_id\x18\x02 \x01(\x04R\n" +
	"itemItemId\x12\x18\n" +
	"\aunusual\x18\x03 \x01(\bR\aunusual\"\xe8\x02\n" +
	"\x15CMsgAddSocketResponse\x12\x17\n" +
	"\aitem_id\x18\x01 \x01(\x04R\x06itemId\x120\n" +
	"\x14updated_socket_index\x18\x02 \x03(\rR\x12updatedSocketIndex\x12]\n" +
	"\bresponse\x18\x03 \x01(\x0e2*.protocol.CMsgAddSocketResponse.EAddSocket:\x15k_AddSocket_SucceededR\bresponse\"\xa4\x01\n" +
	"\n" +
	"EAddSocket\x12\x19\n" +
	...
	"$k_AddSocket_Failed_FailedToAddSocket\x10\x03\"c\n" +
	"\x17CMsgAddItemToSocketData\x12\x1e\n" +
	"\vgem_item_id\x18\x01 \x01(\x04R\tgemItemId\x12(\n" +
	"\fsocket_index\x18\x02 \x01(\r:\x0565535R\vsocketIndex\"\x80\x01\n" +
	"\x13CMsgAddItemToSocket\x12 \n" +
	"\fitem_item_id\x18\x01 \x01(\x04R\n" +
	"itemItemId\x12G\n" +
	"\x0egems_to_socket\x18\x02 \x03(\v2!.protocol.CMsgAddItemToSocketDataR\fgemsToSocket\"\x92\x04\n" +
	"\x1bCMsgAddItemToSocketResponse\x12 \n" +
	"\fitem_item_id\x18\x01 \x01(\x04R\n" +
	"itemItemId\x120\n" +
	"\x14updated_socket_index\x18\x02 \x03(\rR\x12updatedSocketIndex\x12]\n" +
	"\bresponse\x18\x03 \x01(\x0e2-.protocol.CMsgAddItemToSocketResponse.EAddGem:\x12k_AddGem_SucceededR\bresponse\"\xbf\x02\n" +
	"\aEAddGem\x12\x16\n" +
	...
	",k_AddGem_Failed_SocketContainsUnremovableGem\x10\a\"f\n" +
	"\x18CMsgResetStrangeGemCount\x12 \n" +
	"\fitem_item_id\x18\x01 \x01(\x04R\n" +
	"itemItemId\x12(\n" +
	"\fsocket_index\x18\x02 \x01(\r:\x0565535R\vsocketIndex\"\xd1\x02\n" +
	" CMsgResetStrangeGemCountResponse\x12f\n" +
	"\bresponse\x18\x01 \x01(\x0e24.protocol.CMsgResetStrangeGemCountResponse.EResetGem:\x14k_ResetGem_SucceededR\bresponse\"\xc4\x01\n" +
	"\tEResetGem\x12\x18\n" +
	...
	"\n" +
	"group_code\x18\x02 \x01(\rR\tgroupCode\"_\n" +
	"\"CMsgGCToGCPerformManualOpCompleted\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x1f\n" +
	"\tsource_gc\x18\x02 \x01(\x05:\x02-1R\bsourceGc\"&\n" +
	"$CMsgGCToGCReloadServerRegionSettings\"e\n" +
	"\x1eCMsgGCAdditionalWelcomeMsgList\x12C\n" +
	"\x10welcome_messages\x18\x01 \x03(\v2\x18.protocol.CExtraMsgBlockR\x0fwelcomeMessages\"\x9a\x02\n" +
	"\x16CMsgApplyRemoteConVars\x12B\n" +
	"\bcon_vars\x18\x01 \x03(\v2'.protocol.CMsgApplyRemoteConVars.ConVarR\aconVars\x1a\xbb\x01\n" +
	"\x06ConVar\x12\x12\n" +
	...
	"versionMax\x12E\n" +
	"\bplatform\x18\x05 \x01(\x0e2\x15.protocol.EGCPlatform:\x12k_eGCPlatform_NoneR\bplatform\"V\n" +
	" CMsgGCToClientApplyRemoteConVars\x122\n" +
	"\x03msg\x18\x01 \x01(\v2 .protocol.CMsgApplyRemoteConVarsR\x03msg\"V\n" +
	" CMsgGCToServerApplyRemoteConVars\x122\n" +
	"\x03msg\x18\x01 \x01(\v2 .protocol.CMsgApplyRemoteConVarsR\x03msg\"\xa3\x02\n" +
	"\x1dCMsgClientToGCIntegrityStatus\x12\x16\n" +
	"\x06report\x18\x01 \x01(\tR\x06report\x12%\n" +
	"\x0esecure_allowed\x18\x02 \x01(\bR\rsecureAllowed\x12R\n" +
	"\vdiagnostics\x18\x03 \x03(\v20.protocol.CMsgClientToGCIntegrityStatus.keyvalueR\vdiagnostics\x1ao\n" +
	"\bkeyvalue\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\x12\x1a\n" +
	"\bextended\x18\x02 \x01(\rR\bextended\x12\x14\n" +
	"\x05value\x18\x03 \x01(\x04R\x05value\x12!\n" +
	"\fstring_value\x18\x04 \x01(\tR\vstringValue\"\xc5\x01\n" +
	"\x1eCMsgClientToGCAggregateMetrics\x12O\n" +
	"\ametrics\x18\x01 \x03(\v25.protocol.CMsgClientToGCAggregateMetrics.SingleMetricR\ametrics\x1aR\n" +
	...
	"\x14upload_rate_modifier\x18\x01 \x01(\x02R\x12uploadRateModifier*\x98\x06\n" +
	"\n" +
	"EGCBaseMsg\x12\x1a\n" +
	...
	")k_ECustomGameInstallStatus_FailedCanceled\x10kB\rZ\v./;protocol"
...
var file_base_gcmessages_proto_msgTypes = make([]protoimpl.MessageInfo, 60)
var file_base_gcmessages_proto_goTypes = []any{
	(EGCBaseMsg)(0),                                     // 0: protocol.EGCBaseMsg
	(ECustomGameInstallStatus)(0),                       // 1: protocol.ECustomGameInstallStatus
	(CMsgExtractGemsResponse_EExtractGems)(0),           // 2: protocol.CMsgExtractGemsResponse.EExtractGems
	(CMsgAddSocketResponse_EAddSocket)(0),               // 3: protocol.CMsgAddSocketResponse.EAddSocket
	(CMsgAddItemToSocketResponse_EAddGem)(0),            // 4: protocol.CMsgAddItemToSocketResponse.EAddGem
	(CMsgResetStrangeGemCountResponse_EResetGem)(0),     // 5: protocol.CMsgResetStrangeGemCountResponse.EResetGem
	(*CGCStorePurchaseInit_LineItem)(nil),               // 6: protocol.CGCStorePurchaseInit_LineItem
	(*CMsgGCStorePurchaseInit)(nil),                     // 7: protocol.CMsgGCStorePurchaseInit
	(*CMsgGCStorePurchaseInitResponse)(nil),             // 8: protocol.CMsgGCStorePurchaseInitResponse
	(*CMsgClientPingData)(nil),                          // 9: protocol.CMsgClientPingData
	(*CMsgInviteToParty)(nil),                           // 10: protocol.CMsgInviteToParty
	(*CMsgInviteToLobby)(nil),                           // 11: protocol.CMsgInviteToLobby
	(*CMsgInvitationCreated)(nil),                       // 12: protocol.CMsgInvitationCreated
	(*CMsgPartyInviteResponse)(nil),                     // 13: protocol.CMsgPartyInviteResponse
	(*CMsgLobbyInviteResponse)(nil),                     // 14: protocol.CMsgLobbyInviteResponse
	(*CMsgKickFromParty)(nil),                           // 15: protocol.CMsgKickFromParty
	(*CMsgLeaveParty)(nil),                              // 16: protocol.CMsgLeaveParty
	(*CMsgCustomGameInstallStatus)(nil),                 // 17: protocol.CMsgCustomGameInstallStatus
	(*CMsgServerAvailable)(nil),                         // 18: protocol.CMsgServerAvailable
	(*CMsgLANServerAvailable)(nil),                      // 19: protocol.CMsgLANServerAvailable
	(*CSOEconGameAccountClient)(nil),                    // 20: protocol.CSOEconGameAccountClient
	(*CMsgApplyStrangePart)(nil),                        // 21: protocol.CMsgApplyStrangePart
	(*CMsgApplyPennantUpgrade)(nil),                     // 22: protocol.CMsgApplyPennantUpgrade
	(*CMsgApplyEggEssence)(nil),                         // 23: protocol.CMsgApplyEggEssence
	(*CSOEconItemAttribute)(nil),                        // 24: protocol.CSOEconItemAttribute
	(*CSOEconItemEquipped)(nil),                         // 25: protocol.CSOEconItemEquipped
	(*CSOEconItem)(nil),                                 // 26: protocol.CSOEconItem
	(*CMsgSortItems)(nil),                               // 27: protocol.CMsgSortItems
	(*CMsgItemAcknowledged)(nil),                        // 28: protocol.CMsgItemAcknowledged
	(*CMsgSetItemPositions)(nil),                        // 29: protocol.CMsgSetItemPositions
	(*CMsgGCStorePurchaseCancel)(nil),                   // 30: protocol.CMsgGCStorePurchaseCancel
	(*CMsgGCStorePurchaseCancelResponse)(nil),           // 31: protocol.CMsgGCStorePurchaseCancelResponse
	(*CMsgGCStorePurchaseFinalize)(nil),                 // 32: protocol.CMsgGCStorePurchaseFinalize
	(*CMsgGCStorePurchaseFinalizeResponse)(nil),         // 33: protocol.CMsgGCStorePurchaseFinalizeResponse
	(*CMsgGCToGCBannedWordListUpdated)(nil),             // 34: protocol.CMsgGCToGCBannedWordListUpdated
	(*CMsgGCToGCDirtySDOCache)(nil),                     // 35: protocol.CMsgGCToGCDirtySDOCache
	(*CMsgSDONoMemcached)(nil),                          // 36: protocol.CMsgSDONoMemcached
	(*CMsgGCToGCUpdateSQLKeyValue)(nil),                 // 37: protocol.CMsgGCToGCUpdateSQLKeyValue
	(*CMsgGCServerVersionUpdated)(nil),                  // 38: protocol.CMsgGCServerVersionUpdated
	(*CMsgGCClientVersionUpdated)(nil),                  // 39: protocol.CMsgGCClientVersionUpdated
	(*CMsgGCToGCWebAPIAccountChanged)(nil),              // 40: protocol.CMsgGCToGCWebAPIAccountChanged
	(*CMsgExtractGems)(nil),                             // 41: protocol.CMsgExtractGems
	(*CMsgExtractGemsResponse)(nil),                     // 42: protocol.CMsgExtractGemsResponse
	(*CMsgAddSocket)(nil),                               // 43: protocol.CMsgAddSocket
	(*CMsgAddSocketResponse)(nil),                       // 44: protocol.CMsgAddSocketResponse
	(*CMsgAddItemToSocketData)(nil),                     // 45: protocol.CMsgAddItemToSocketData
	(*CMsgAddItemToSocket)(nil),                         // 46: protocol.CMsgAddItemToSocket
	(*CMsgAddItemToSocketResponse)(nil),                 // 47: protocol.CMsgAddItemToSocketResponse
	(*CMsgResetStrangeGemCount)(nil),                    // 48: protocol.CMsgResetStrangeGemCount
	(*CMsgResetStrangeGemCountResponse)(nil),            // 49: protocol.CMsgResetStrangeGemCountResponse
	(*CMsgGCToClientPollFileRequest)(nil),               // 50: protocol.CMsgGCToClientPollFileRequest
	(*CMsgGCToClientPollFileResponse)(nil),              // 51: protocol.CMsgGCToClientPollFileResponse
	(*CMsgGCToGCPerformManualOp)(nil),                   // 52: protocol.CMsgGCToGCPerformManualOp
	(*CMsgGCToGCPerformManualOpCompleted)(nil),          // 53: protocol.CMsgGCToGCPerformManualOpCompleted
	(*CMsgGCToGCReloadServerRegionSettings)(nil),        // 54: protocol.CMsgGCToGCReloadServerRegionSettings
	(*CMsgGCAdditionalWelcomeMsgList)(nil),              // 55: protocol.CMsgGCAdditionalWelcomeMsgList
	(*CMsgApplyRemoteConVars)(nil),                      // 56: protocol.CMsgApplyRemoteConVars
	(*CMsgGCToClientApplyRemoteConVars)(nil),            // 57: protocol.CMsgGCToClientApplyRemoteConVars
	(*CMsgGCToServerApplyRemoteConVars)(nil),            // 58: protocol.CMsgGCToServerApplyRemoteConVars
	(*CMsgClientToGCIntegrityStatus)(nil),               // 59: protocol.CMsgClientToGCIntegrityStatus
	(*CMsgClientToGCAggregateMetrics)(nil),              // 60: protocol.CMsgClientToGCAggregateMetrics
	(*CMsgGCToClientAggregateMetricsBackoff)(nil),       // 61: protocol.CMsgGCToClientAggregateMetricsBackoff
	(*CMsgSetItemPositions_ItemPosition)(nil),           // 62: protocol.CMsgSetItemPositions.ItemPosition
	(*CMsgApplyRemoteConVars_ConVar)(nil),               // 63: protocol.CMsgApplyRemoteConVars.ConVar
	(*CMsgClientToGCIntegrityStatusKeyvalue)(nil),       // 64: protocol.CMsgClientToGCIntegrityStatus.keyvalue
	(*CMsgClientToGCAggregateMetrics_SingleMetric)(nil), // 65: protocol.CMsgClientToGCAggregateMetrics.SingleMetric
	(*CExtraMsgBlock)(nil),                              // 66: protocol.CExtraMsgBlock
	(EGCPlatform)(0),                                    // 67: protocol.EGCPlatform
}
var file_base_gcmessages_proto_depIdxs = []int32{
	6,  // 0: protocol.CMsgGCStorePurchaseInit.line_items:type_name -> protocol.CGCStorePurchaseInit_LineItem
	9,  // 1: protocol.CMsgInviteToParty.ping_data:type_name -> protocol.CMsgClientPingData
	9,  // 2: protocol.CMsgPartyInviteResponse.ping_data:type_name -> protocol.CMsgClientPingData
	1,  // 3: protocol.CMsgCustomGameInstallStatus.status:type_name -> protocol.ECustomGameInstallStatus
	17, // 4: protocol.CMsgServerAvailable.custom_game_install_status:type_name -> protocol.CMsgCustomGameInstallStatus
	24, // 5: protocol.CSOEconItem.attribute:type_name -> protocol.CSOEconItemAttribute
	26, // 6: protocol.CSOEconItem.interior_item:type_name -> protocol.CSOEconItem
	25, // 7: protocol.CSOEconItem.equipped_state:type_name -> protocol.CSOEconItemEquipped
	62, // 8: protocol.CMsgSetItemPositions.item_positions:type_name -> protocol.CMsgSetItemPositions.ItemPosition
	2,  // 9: protocol.CMsgExtractGemsResponse.response:type_name -> protocol.CMsgExtractGemsResponse.EExtractGems
	3,  // 10: protocol.CMsgAddSocketResponse.response:type_name -> protocol.CMsgAddSocketResponse.EAddSocket
	45, // 11: protocol.CMsgAddItemToSocket.gems_to_socket:type_name -> protocol.CMsgAddItemToSocketData
	4,  // 12: protocol.CMsgAddItemToSocketResponse.response:type_name -> protocol.CMsgAddItemToSocketResponse.EAddGem
	5,  // 13: protocol.CMsgResetStrangeGemCountResponse.response:type_name -> protocol.CMsgResetStrangeGemCountResponse.EResetGem
	66, // 14: protocol.CMsgGCAdditionalWelcomeMsgList.welcome_messages:type_name -> protocol.CExtraMsgBlock
	63, // 15: protocol.CMsgApplyRemoteConVars.con_vars:type_name -> protocol.CMsgApplyRemoteConVars.ConVar
	56, // 16: protocol.CMsgGCToClientApplyRemoteConVars.msg:type_name -> protocol.CMsgApplyRemoteConVars
	56, // 17: protocol.CMsgGCToServerApplyRemoteConVars.msg:type_name -> protocol.CMsgApplyRemoteConVars
	64, // 18: protocol.CMsgClientToGCIntegrityStatus.diagnostics:type_name -> protocol.CMsgClientToGCIntegrityStatus.keyvalue
	65, // 19: protocol.CMsgClientToGCAggregateMetrics.metrics:type_name -> protocol.CMsgClientToGCAggregateMetrics.SingleMetric
	67, // 20: protocol.CMsgApplyRemoteConVars.ConVar.platform:type_name -> protocol.EGCPlatform
