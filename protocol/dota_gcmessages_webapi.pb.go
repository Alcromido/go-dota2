...
const file_dota_gcmessages_webapi_proto_rawDesc = "" +
	"\n" +
	"\x1cdota_gcmessages_webapi.proto\x12\bprotocol\x1a\x13steammessages.proto\x1a\x16gcsdk_gcmessages.proto\x1a\x17dota_shared_enums.proto\x1a\x1cdota_gcmessages_common.proto\x1a\x19dota_match_metadata.proto\"\xd9\x06\n" +
	"\x0fCMsgArcanaVotes\x129\n" +
	"\amatches\x18\x01 \x03(\v2\x1f.protocol.CMsgArcanaVotes.MatchR\amatches\x120\n" +
	...
	"\thero_id_0\x18\x02 \x01(\rR\aheroId0\x12\x1a\n" +
	"\thero_id_1\x18\x03 \x01(\rR\aheroId1\x12$\n" +
	...
	"\tIN_FUTURE\x10\x02\"\x86\a\n" +
	"\x0fCMsgDOTADPCFeed\x12=\n" +
	"\belements\x18\x01 \x03(\v2!.protocol.CMsgDOTADPCFeed.ElementR\belements\x1a\xa5\x03\n" +
	"\aElement\x12R\n" +
	"\x04type\x18\x01 \x01(\x0e2*.protocol.CMsgDOTADPCFeed.EFeedElementType:\x12FEED_SERIES_RESULTR\x04type\x12\x1c\n" +
	...
	"\x12is_plus_subscriber\x18\x01 \x01(\bR\x10isPlusSubscriber\"\xc2\a\n" +
	"\x0fCMsgDraftTrivia\x12&\n" +
	"\x0fhas_valid_match\x18\x01 \x01(\bR\rhasValidMatch\x12V\n" +
	"\x0fmatch_hero_info\x18\x02 \x01(\v2..protocol.CMsgDraftTrivia.DraftTriviaMatchInfoR\rmatchHeroInfo\x12&\n" +
	...
	"\x1bcurrent_match_voted_radiant\x18\x06 \x01(\bR\x18currentMatchVotedRadiant\x12Q\n" +
	"\x0fprevious_result\x18\a \x01(\v2(.protocol.CMsgDraftTrivia.PreviousResultR\x0epreviousResult\x12%\n" +
	...
	"\x04role\x18\x02 \x01(\rR\x04role\x1a\xbc\x01\n" +
	"\x14DraftTriviaMatchInfo\x12T\n" +
	"\x0eradiant_heroes\x18\x01 \x03(\v2-.protocol.CMsgDraftTrivia.DraftTriviaHeroInfoR\rradiantHeroes\x12N\n" +
	"\vdire_heroes\x18\x02 \x03(\v2-.protocol.CMsgDraftTrivia.DraftTriviaHeroInfoR\n" +
	"direHeroes\x1a\x94\x02\n" +
	"\x0ePreviousResult\x12'\n" +
	"\x0fvoted_correctly\x18\x01 \x01(\bR\x0evotedCorrectly\x12#\n" +
	"\rvoted_radiant\x18\x02 \x01(\bR\fvotedRadiant\x12V\n" +
	"\x0fmatch_hero_info\x18\x03 \x01(\v2..protocol.CMsgDraftTrivia.DraftTriviaMatchInfoR\rmatchHeroInfo\x12&\n" +
	"\x0fmatch_rank_tier\x18\x04 \x01(\rR\rmatchRankTier\x12\x19\n" +
	"\bend_time\x18\x05 \x01(\rR\aendTime\x12\x19\n" +
	"\bmatch_id\x18\x06 \x01(\x04R\amatchId\"\x9d\x02\n" +
	"\x1dCMsgTeamFanContentAssetStatus\x12a\n" +
	"\n" +
	"asset_type\x18\x01 \x01(\x0e2\".protocol.ETeamFanContentAssetType:\x1ek_eFanContentAssetType_LogoPNGR\tassetType\x12\x1f\n" +
	"\vasset_index\x18\x02 \x01(\rR\n" +
	"assetIndex\x12f\n" +
	"\fasset_status\x18\x03 \x01(\x0e2$.protocol.ETeamFanContentAssetStatus:\x1dk_eFanContentAssetStatus_NoneR\vassetStatus\x12\x10\n" +
	"\x03crc\x18\x04 \x01(\rR\x03crc\"\xb5\x01\n" +
	"%CMsgTeamFanContentAssetStatusResponse\x12[\n" +
	"\x06result\x18\x01 \x01(\x0e27.protocol.CMsgTeamFanContentAssetStatusResponse.EResult:\n" +
	"k_eSuccessR\x06result\"/\n" +
	"\aEResult\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x00\x12\x14\n" +
	"\x10k_eInternalError\x10\x01\"\xc4\x06\n" +
	"\x18CMsgTeamFanContentStatus\x12W\n" +
	"\x10team_status_list\x18\x01 \x03(\v2-.protocol.CMsgTeamFanContentStatus.TeamStatusR\x0eteamStatusList\x1a\xce\x05\n" +
	"\n" +
	"TeamStatus\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x17\n" +
	"\ateam_id\x18\x02 \x01(\rR\x06teamId\x12\x19\n" +
	"\blogo_url\x18\x03 \x01(\tR\alogoUrl\x12X\n" +
	"\x06status\x18\x04 \x01(\x0e2\x1f.protocol.ETeamFanContentStatus:\x1fTEAM_FAN_CONTENT_STATUS_INVALIDR\x06status\x12\x1c\n" +
	...
	"\x11comment_timestamp\x18\x0f \x01(\rR\x10commentTimestamp\x12J\n" +
	"\fasset_status\x18\x10 \x03(\v2'.protocol.CMsgTeamFanContentAssetStatusR\vassetStatus\x12'\n" +
	"\x0femail_timestamp\x18\x11 \x01(\rR\x0eemailTimestamp\x12\x1d\n" +
	"\n" +
	"email_tier\x18\x12 \x01(\rR\temailTier\x12\x1c\n" +
	"\tlanguages\x18\x13 \x01(\tR\tlanguages\"\xcc\x03\n" +
	"!CMsgTeamFanContentAutographStatus\x12_\n" +
	"\x0fteam_autographs\x18\x01 \x03(\v26.protocol.CMsgTeamFanContentAutographStatus.TeamStatusR\x0eteamAutographs\x1a}\n" +
	...
	"\x04file\x18\x04 \x01(\tR\x04file\x1a\xc6\x01\n" +
	"\n" +
	"TeamStatus\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x17\n" +
	...
	"autographs\x12.\n" +
	"\x13workshop_account_id\x18\x04 \x01(\rR\x11workshopAccountId\"\x8b\x11\n" +
	"\fCMsgDPCEvent\x12H\n" +
	"\x05event\x18\x01 \x01(\x0e2#.protocol.CMsgDPCEvent.ELeagueEvent:\rEVENT_INVALIDR\x05event\x12O\n" +
	"\n" +
	"event_type\x18\x02 \x01(\x0e2'.protocol.CMsgDPCEvent.ELeagueEventType:\aUNKNOWNR\teventType\x127\n" +
	"\aleagues\x18\x03 \x03(\v2\x1d.protocol.CMsgDPCEvent.LeagueR\aleagues\x12/\n" +
	...
	"\x04tour\x18\n" +
	" \x01(\x0e2\x1c.protocol.CMsgDPCEvent.ETour:\tTOUR_NONER\x04tour\x12.\n" +
	...
	"!timestamp_content_review_deadline\x18\x10 \x01(\rR\x1etimestampContentReviewDeadline\x1a~\n" +
	"\tPhaseInfo\x12M\n" +
	"\x05phase\x18\x01 \x01(\x0e2(.protocol.CMsgDPCEvent.ELeagueEventPhase:\rPHASE_INVALIDR\x05phase\x12\"\n" +
	"\rnode_group_id\x18\x02 \x01(\rR\vnodeGroupId\x1a\xf3\x01\n" +
	"\x06League\x12D\n" +
	...
	"\x06phases\x18\x04 \x03(\v2 .protocol.CMsgDPCEvent.PhaseInfoR\x06phases\"\xd3\x04\n" +
	...
	"\x12INTERNATIONAL_2023\x10\x15\"\xc9\x01\n" +
	...
	"\x06events\x18\x01 \x03(\v2\x16.protocol.CMsgDPCEventR\x06events\"\xb3\x06\n" +
	"\x19CMsgDOTAFantasyCardLineup\x12D\n" +
	"\aperiods\x18\x01 \x03(\v2*.protocol.CMsgDOTAFantasyCardLineup.PeriodR\aperiods\x1aK\n" +
	"\tCardBonus\x12\x1d\n" +
	"\n" +
	"bonus_stat\x18\x01 \x01(\rR\tbonusStat\x12\x1f\n" +
	"\vbonus_value\x18\x02 \x01(\rR\n" +
	"bonusValue\x1a\xb3\x02\n" +
	"\x04Card\x12*\n" +
	...
	"\x04role\x18\x05 \x01(\rR\x04role\x12G\n" +
	"\abonuses\x18\x06 \x03(\v2-.protocol.CMsgDOTAFantasyCardLineup.CardBonusR\abonuses\x12\x14\n" +
	"\x05score\x18\a \x01(\x02R\x05score\x12\x1c\n" +
	"\tfinalized\x18\b \x01(\bR\tfinalized\x12\x17\n" +
	"\aitem_id\x18\t \x01(\x04R\x06itemId\x1a{\n" +
	"\x06League\x12\x1b\n" +
	"\tleague_id\x18\x01 \x01(\rR\bleagueId\x12>\n" +
	"\x05cards\x18\x02 \x03(\v2(.protocol.CMsgDOTAFantasyCardLineup.CardR\x05cards\x12\x14\n" +
	"\x05score\x18\x03 \x01(\x02R\x05score\x1a\xcf\x01\n" +
	"\x06Period\x121\n" +
	"\x0efantasy_period\x18\x01 \x01(\r:\n" +
	"4294967295R\rfantasyPeriod\x12'\n" +
	"\x0ftimestamp_start\x18\x02 \x01(\rR\x0etimestampStart\x12#\n" +
	"\rtimestamp_end\x18\x03 \x01(\rR\ftimestampEnd\x12D\n" +
	"\aleagues\x18\x04 \x03(\v2*.protocol.CMsgDOTAFantasyCardLineup.LeagueR\aleagues\"\xa4\x03\n" +
	"\x17CMsgDOTAFantasyCardList\x12<\n" +
	"\x05cards\x18\x01 \x03(\v2&.protocol.CMsgDOTAFantasyCardList.CardR\x05cards\x1aK\n" +
	"\tCardBonus\x12\x1d\n" +
	"\n" +
	"bonus_stat\x18\x01 \x01(\rR\tbonusStat\x12\x1f\n" +
	"\vbonus_value\x18\x02 \x01(\rR\n" +
	"bonusValue\x1a\xfd\x01\n" +
	"\x04Card\x12*\n" +
	"\x11player_account_id\x18\x01 \x01(\rR\x0fplayerAccountId\x12\x1f\n" +
	"\vplayer_name\x18\x02 \x01(\tR\n" +
	"playerName\x12\x17\n" +
	"\ateam_id\x18\x03 \x01(\rR\x06teamId\x12\x1b\n" +
	"\tteam_name\x18\x04 \x01(\tR\bteamName\x12\x12\n" +
	"\x04role\x18\x05 \x01(\rR\x04role\x12E\n" +
	"\abonuses\x18\x06 \x03(\v2+.protocol.CMsgDOTAFantasyCardList.CardBonusR\abonuses\x12\x17\n" +
	"\aitem_id\x18\b \x01(\x04R\x06itemId\"\x8b\x03\n" +
	"(CMsgChatToxicityToxicPlayerMatchesReport\x12T\n" +
	"\x04rows\x18\x01 \x03(\v2@.protocol.CMsgChatToxicityToxicPlayerMatchesReport.IndividualRowR\x04rows\x1a\x88\x02\n" +
	"\rIndividualRow\x12*\n" +
	...
	"\amessage\x18\a \x01(\tR\amessage\"\x9a\x03\n" +
	"\x1bCMsgGetTeamAuditInformation\x12\x17\n" +
	"\ateam_id\x18\x01 \x01(\rR\x06teamId\x12\x1b\n" +
	"\tteam_name\x18\x02 \x01(\tR\bteamName\x12F\n" +
	"\aactions\x18\x03 \x03(\v2,.protocol.CMsgGetTeamAuditInformation.ActionR\aactions\x12!\n" +
	...
	"playerName\x12(\n" +
	"\x10player_real_name\x18\x06 \x01(\tR\x0eplayerRealName\"{\n" +
	"\x10CMsgDOTADPCMatch\x12-\n" +
	"\x05match\x18\x01 \x01(\v2\x17.protocol.CMsgDOTAMatchR\x05match\x128\n" +
	"\bmetadata\x18\x02 \x01(\v2\x1c.protocol.CDOTAMatchMetadataR\bmetadata*\x88\x01\n" +
	...
	"!k_eFanContentAssetStatus_Rejected\x10\x02B\rZ\v./;protocol"
...
var file_dota_gcmessages_webapi_proto_goTypes = []any{
	...
	(ETeamFanContentAssetStatus)(0),                                // 2: protocol.ETeamFanContentAssetStatus
	(CMsgArcanaVotes_VotingState)(0),                               // 3: protocol.CMsgArcanaVotes.VotingState
	(CMsgDOTADPCFeed_EFeedElementType)(0),                          // 4: protocol.CMsgDOTADPCFeed.EFeedElementType
	(CMsgTeamFanContentAssetStatusResponse_EResult)(0),             // 5: protocol.CMsgTeamFanContentAssetStatusResponse.EResult
	(CMsgDPCEvent_ELeagueEvent)(0),                                 // 6: protocol.CMsgDPCEvent.ELeagueEvent
	(CMsgDPCEvent_ELeagueEventPhase)(0),                            // 7: protocol.CMsgDPCEvent.ELeagueEventPhase
	(CMsgDPCEvent_ELeagueEventType)(0),                             // 8: protocol.CMsgDPCEvent.ELeagueEventType
	(CMsgDPCEvent_ETour)(0),                                        // 9: protocol.CMsgDPCEvent.ETour
	(*CMsgArcanaVotes)(nil),                                        // 10: protocol.CMsgArcanaVotes
	(*CMsgDOTADPCFeed)(nil),                                        // 11: protocol.CMsgDOTADPCFeed
	(*CMsgDOTADPCUserInfo)(nil),                                    // 12: protocol.CMsgDOTADPCUserInfo
	(*CMsgDraftTrivia)(nil),                                        // 13: protocol.CMsgDraftTrivia
	(*CMsgTeamFanContentAssetStatus)(nil),                          // 14: protocol.CMsgTeamFanContentAssetStatus
	(*CMsgTeamFanContentAssetStatusResponse)(nil),                  // 15: protocol.CMsgTeamFanContentAssetStatusResponse
	(*CMsgTeamFanContentStatus)(nil),                               // 16: protocol.CMsgTeamFanContentStatus
	(*CMsgTeamFanContentAutographStatus)(nil),                      // 17: protocol.CMsgTeamFanContentAutographStatus
	(*CMsgDPCEvent)(nil),                                           // 18: protocol.CMsgDPCEvent
	(*CMsgDPCEventList)(nil),                                       // 19: protocol.CMsgDPCEventList
	(*CMsgDOTAFantasyCardLineup)(nil),                              // 20: protocol.CMsgDOTAFantasyCardLineup
	(*CMsgDOTAFantasyCardList)(nil),                                // 21: protocol.CMsgDOTAFantasyCardList
	(*CMsgChatToxicityToxicPlayerMatchesReport)(nil),               // 22: protocol.CMsgChatToxicityToxicPlayerMatchesReport
	(*CMsgChatToxicityReport)(nil),                                 // 23: protocol.CMsgChatToxicityReport
	(*CMsgGetTeamAuditInformation)(nil),                            // 24: protocol.CMsgGetTeamAuditInformation
	(*CMsgDOTADPCMatch)(nil),                                       // 25: protocol.CMsgDOTADPCMatch
	(*CMsgArcanaVotes_Match)(nil),                                  // 26: protocol.CMsgArcanaVotes.Match
	(*CMsgDOTADPCFeed_Element)(nil),                                // 27: protocol.CMsgDOTADPCFeed.Element
	(*CMsgDraftTrivia_DraftTriviaHeroInfo)(nil),                    // 28: protocol.CMsgDraftTrivia.DraftTriviaHeroInfo
	(*CMsgDraftTrivia_DraftTriviaMatchInfo)(nil),                   // 29: protocol.CMsgDraftTrivia.DraftTriviaMatchInfo
	(*CMsgDraftTrivia_PreviousResult)(nil),                         // 30: protocol.CMsgDraftTrivia.PreviousResult
	(*CMsgTeamFanContentStatus_TeamStatus)(nil),                    // 31: protocol.CMsgTeamFanContentStatus.TeamStatus
	(*CMsgTeamFanContentAutographStatus_AutographStatus)(nil),      // 32: protocol.CMsgTeamFanContentAutographStatus.AutographStatus
	(*CMsgTeamFanContentAutographStatus_TeamStatus)(nil),           // 33: protocol.CMsgTeamFanContentAutographStatus.TeamStatus
	(*CMsgDPCEvent_PhaseInfo)(nil),                                 // 34: protocol.CMsgDPCEvent.PhaseInfo
	(*CMsgDPCEvent_League)(nil),                                    // 35: protocol.CMsgDPCEvent.League
	(*CMsgDOTAFantasyCardLineup_CardBonus)(nil),                    // 36: protocol.CMsgDOTAFantasyCardLineup.CardBonus
	(*CMsgDOTAFantasyCardLineup_Card)(nil),                         // 37: protocol.CMsgDOTAFantasyCardLineup.Card
	(*CMsgDOTAFantasyCardLineup_League)(nil),                       // 38: protocol.CMsgDOTAFantasyCardLineup.League
	(*CMsgDOTAFantasyCardLineup_Period)(nil),                       // 39: protocol.CMsgDOTAFantasyCardLineup.Period
	(*CMsgDOTAFantasyCardList_CardBonus)(nil),                      // 40: protocol.CMsgDOTAFantasyCardList.CardBonus
	(*CMsgDOTAFantasyCardList_Card)(nil),                           // 41: protocol.CMsgDOTAFantasyCardList.Card
	(*CMsgChatToxicityToxicPlayerMatchesReport_IndividualRow)(nil), // 42: protocol.CMsgChatToxicityToxicPlayerMatchesReport.IndividualRow
	(*CMsgGetTeamAuditInformation_Action)(nil),                     // 43: protocol.CMsgGetTeamAuditInformation.Action
	(*CMsgDOTAMatch)(nil),                                          // 44: protocol.CMsgDOTAMatch
	(*CDOTAMatchMetadata)(nil),                                     // 45: protocol.CDOTAMatchMetadata
	(ELeagueRegion)(0),                                             // 46: protocol.ELeagueRegion
	(ELeagueDivision)(0),                                           // 47: protocol.ELeagueDivision
}
var file_dota_gcmessages_webapi_proto_depIdxs = []int32{
	26, // 0: protocol.CMsgArcanaVotes.matches:type_name -> protocol.CMsgArcanaVotes.Match
	27, // 1: protocol.CMsgDOTADPCFeed.elements:type_name -> protocol.CMsgDOTADPCFeed.Element
	29, // 2: protocol.CMsgDraftTrivia.match_hero_info:type_name -> protocol.CMsgDraftTrivia.DraftTriviaMatchInfo
	30, // 3: protocol.CMsgDraftTrivia.previous_result:type_name -> protocol.CMsgDraftTrivia.PreviousResult
	...
	5,  // 6: protocol.CMsgTeamFanContentAssetStatusResponse.result:type_name -> protocol.CMsgTeamFanContentAssetStatusResponse.EResult
	31, // 7: protocol.CMsgTeamFanContentStatus.team_status_list:type_name -> protocol.CMsgTeamFanContentStatus.TeamStatus
	33, // 8: protocol.CMsgTeamFanContentAutographStatus.team_autographs:type_name -> protocol.CMsgTeamFanContentAutographStatus.TeamStatus
	6,  // 9: protocol.CMsgDPCEvent.event:type_name -> protocol.CMsgDPCEvent.ELeagueEvent
	8,  // 10: protocol.CMsgDPCEvent.event_type:type_name -> protocol.CMsgDPCEvent.ELeagueEventType
	35, // 11: protocol.CMsgDPCEvent.leagues:type_name -> protocol.CMsgDPCEvent.League
	9,  // 12: protocol.CMsgDPCEvent.tour:type_name -> protocol.CMsgDPCEvent.ETour
	18, // 13: protocol.CMsgDPCEventList.events:type_name -> protocol.CMsgDPCEvent
	39, // 14: protocol.CMsgDOTAFantasyCardLineup.periods:type_name -> protocol.CMsgDOTAFantasyCardLineup.Period
	41, // 15: protocol.CMsgDOTAFantasyCardList.cards:type_name -> protocol.CMsgDOTAFantasyCardList.Card
	42, // 16: protocol.CMsgChatToxicityToxicPlayerMatchesReport.rows:type_name -> protocol.CMsgChatToxicityToxicPlayerMatchesReport.IndividualRow
	43, // 17: protocol.CMsgGetTeamAuditInformation.actions:type_name -> protocol.CMsgGetTeamAuditInformation.Action
	44, // 18: protocol.CMsgDOTADPCMatch.match:type_name -> protocol.CMsgDOTAMatch
	45, // 19: protocol.CMsgDOTADPCMatch.metadata:type_name -> protocol.CDOTAMatchMetadata
	4,  // 20: protocol.CMsgDOTADPCFeed.Element.type:type_name -> protocol.CMsgDOTADPCFeed.EFeedElementType
	28, // 21: protocol.CMsgDraftTrivia.DraftTriviaMatchInfo.radiant_heroes:type_name -> protocol.CMsgDraftTrivia.DraftTriviaHeroInfo
	28, // 22: protocol.CMsgDraftTrivia.DraftTriviaMatchInfo.dire_heroes:type_name -> protocol.CMsgDraftTrivia.DraftTriviaHeroInfo
	29, // 23: protocol.CMsgDraftTrivia.PreviousResult.match_hero_info:type_name -> protocol.CMsgDraftTrivia.DraftTriviaMatchInfo
	0,  // 24: protocol.CMsgTeamFanContentStatus.TeamStatus.status:type_name -> protocol.ETeamFanContentStatus
	14, // 25: protocol.CMsgTeamFanContentStatus.TeamStatus.asset_status:type_name -> protocol.CMsgTeamFanContentAssetStatus
	32, // 26: protocol.CMsgTeamFanContentAutographStatus.TeamStatus.autographs:type_name -> protocol.CMsgTeamFanContentAutographStatus.AutographStatus
	7,  // 27: protocol.CMsgDPCEvent.PhaseInfo.phase:type_name -> protocol.CMsgDPCEvent.ELeagueEventPhase
	46, // 28: protocol.CMsgDPCEvent.League.region:type_name -> protocol.ELeagueRegion
	47, // 29: protocol.CMsgDPCEvent.League.division:type_name -> protocol.ELeagueDivision
	34, // 30: protocol.CMsgDPCEvent.League.phases:type_name -> protocol.CMsgDPCEvent.PhaseInfo
	36, // 31: protocol.CMsgDOTAFantasyCardLineup.Card.bonuses:type_name -> protocol.CMsgDOTAFantasyCardLineup.CardBonus
	37, // 32: protocol.CMsgDOTAFantasyCardLineup.League.cards:type_name -> protocol.CMsgDOTAFantasyCardLineup.Card
	38, // 33: protocol.CMsgDOTAFantasyCardLineup.Period.leagues:type_name -> protocol.CMsgDOTAFantasyCardLineup.League
	40, // 34: protocol.CMsgDOTAFantasyCardList.Card.bonuses:type_name -> protocol.CMsgDOTAFantasyCardList.CardBonus
