...
const file_steammessages_proto_rawDesc = "" +
	"\n" +
	"\x13steammessages.proto\x12\bprotocol\x1a google/protobuf/descriptor.proto\"\x83\x04\n" +
	...
	"\rerror_message\x18\x0e \x01(\tR\ferrorMessage\x12W\n" +
	"\n" +
	"gc_msg_src\x18\xc8\x01 \x01(\x0e2\x1a.protocol.GCProtoBufMsgSrc:\x1cGCProtoBufMsgSrc_UnspecifiedR\bgcMsgSrc\x122\n" +
	"\x13gc_dir_index_source\x18\xc9\x01 \x01(\x05:\x02-1R\x10gcDirIndexSource:\n" +
	"\x80\xa6\x1d\x80\x02\x88\xa6\x1d\x80\b\"\\\n" +
	"\x1eCGCSystemMsg_GetAccountDetails\x12\x18\n" +
	"\asteamid\x18\x01 \x01(\x06R\asteamid\x12\x14\n" +
	"\x05appid\x18\x02 \x01(\rR\x05appid:\n" +
	"\x80\xa6\x1d\x80\x01\x88\xa6\x1d\x80\x04\"\xf5\f\n" +
	...
	"\x15is_banned_steam_china\x18' \x01(\bR\x12isBannedSteamChina:\n" +
	...
	"\x1fGCProtoBufMsgSrc_SpoofedSteamID\x10\x05:C\n" +
	...
	"\x12msgpool_hard_limit\x12\x1f.google.protobuf.MessageOptions\x18\xe1\xd4\x03 \x01(\x05:\x03384R\x10msgpoolHardLimitB\rZ\v./;protocol"
...
var file_steammessages_proto_goTypes = []any{
	(EGCPlatform)(0),                                // 0: protocol.EGCPlatform
	(GCProtoBufMsgSrc)(0),                           // 1: protocol.GCProtoBufMsgSrc
	(*CMsgProtoBufHeader)(nil),                      // 2: protocol.CMsgProtoBufHeader
	(*CGCSystemMsg_GetAccountDetails)(nil),          // 3: protocol.CGCSystemMsg_GetAccountDetails
	(*CGCSystemMsg_GetAccountDetails_Response)(nil), // 4: protocol.CGCSystemMsg_GetAccountDetails_Response
	(*CIPLocationInfo)(nil),                         // 5: protocol.CIPLocationInfo
	(*CGCMsgGetIPLocationResponse)(nil),             // 6: protocol.CGCMsgGetIPLocationResponse
	(*descriptorpb.FieldOptions)(nil),               // 7: google.protobuf.FieldOptions
	(*descriptorpb.MessageOptions)(nil),             // 8: google.protobuf.MessageOptions
}
var file_steammessages_proto_depIdxs = []int32{
	1, // 0: protocol.CMsgProtoBufHeader.gc_msg_src:type_name -> protocol.GCProtoBufMsgSrc
	5, // 1: protocol.CGCMsgGetIPLocationResponse.infos:type_name -> protocol.CIPLocationInfo
	7, // 2: protocol.key_field:extendee -> google.protobuf.FieldOptions
	8, // 3: protocol.msgpool_soft_limit:extendee -> google.protobuf.MessageOptions
	8, // 4: protocol.msgpool_hard_limit:extendee -> google.protobuf.MessageOptions
