...
const file_dota_gcmessages_msgid_proto_rawDesc = "" +
	"\n" +
	"\x1bdota_gcmessages_msgid.proto\x12\bprotocol*\x83\xaa\x02\n" +
	"\n" +
	"EDOTAGCMsg\x12\x15\n" +
	...
	"$k_EMsgGC_GameServerGetLoadGameResult\x10\xf97\x12\x1c\n" +
	...
	"%k_EMsgGCToGCGetEventOwnershipResponse\x10\xb4?\x123\n" +
	...
	"&k_EMsgClientToGCMVPVoteTimeoutResponse\x10\x9eA\x12\x1c\n" +
	...
	"(k_EMsgGCToServerSetSteamLearnKeysChanged\x10\xacE\x12 \n" +
	...
	"(k_EMsgGCToServerSetSteamLearnInferencing\x10\xb5E\x12(\n" +
	...
	"!k_EMsgLobbyRoadToTIMatchQuestData\x10\xebEB\rZ\v./;protocol"
...
var file_dota_gcmessages_msgid_proto_goTypes = []any{
	(EDOTAGCMsg)(0), // 0: protocol.EDOTAGCMsg
}
