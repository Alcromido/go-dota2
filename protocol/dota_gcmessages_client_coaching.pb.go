...
const file_dota_gcmessages_client_coaching_proto_rawDesc = "" +
	"\n" +
	"%dota_gcmessages_client_coaching.proto\x12\bprotocol\x1a\x17dota_shared_enums.proto\x1a\"dota_gcmessages_common_lobby.proto\"\xd2\x02\n" +
	"\x14CMsgPlayerCoachMatch\x12\x19\n" +
	"\bmatch_id\x18\x01 \x01(\x04R\amatchId\x12U\n" +
	"\rmatch_outcome\x18\x02 \x01(\x0e2\x17.protocol.EMatchOutcome:\x17k_EMatchOutcome_UnknownR\fmatchOutcome\x12!\n" +
	"\fcoached_team\x18\x03 \x01(\rR\vcoachedTeam\x12\x1d\n" +
	"\n" +
	"start_time\x18\x04 \x01(\aR\tstartTime\x12\x1a\n" +
	"\bduration\x18\x05 \x01(\rR\bduration\x12I\n" +
	"\x10teammate_ratings\x18\x06 \x03(\x0e2\x1e.protocol.ECoachTeammateRatingR\x0fteammateRatings\x12\x1f\n" +
	"\vcoach_flags\x18\a \x01(\rR\n" +
	"coachFlags\"\xd5\x01\n" +
	" CMsgPrivateCoachingSessionMember\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12!\n" +
	"\fmember_flags\x18\x02 \x01(\rR\vmemberFlags\x12o\n" +
	"\x15member_session_rating\x18\x03 \x01(\x0e2\x1e.protocol.ECoachTeammateRating:\x1bk_ECoachTeammateRating_NoneR\x13memberSessionRating\"\xd8\x04\n" +
	...
	"\x12requested_language\x18\x03 \x01(\rR\x11requestedLanguage\x12\x84\x01\n" +
	"\x16coaching_session_state\x18\x04 \x01(\x0e2&.protocol.EPrivateCoachingSessionState:&k_ePrivateCoachingSessionState_InvalidR\x14coachingSessionState\x12S\n" +
	"\x0fsession_members\x18\x05 \x03(\v2*.protocol.CMsgPrivateCoachingSessionMemberR\x0esessionMembers\x12(\n" +
	...
	"\x16requester_games_played\x18\x02 \x01(\rR\x14requesterGamesPlayed\"\xda\x01\n" +
	"#CMsgAvailablePrivateCoachingSession\x12O\n" +
	"\x10coaching_session\x18\x01 \x01(\v2$.protocol.CMsgPrivateCoachingSessionR\x0fcoachingSession\x12b\n" +
	"\x17coaching_session_status\x18\x02 \x01(\v2*.protocol.CMsgPrivateCoachingSessionStatusR\x15coachingSessionStatus\"\x98\x01\n" +
	"'CMsgAvailablePrivateCoachingSessionList\x12m\n" +
	"\x1bavailable_coaching_sessions\x18\x01 \x03(\v2-.protocol.CMsgAvailablePrivateCoachingSessionR\x19availableCoachingSessions\"b\n" +
	"*CMsgAvailablePrivateCoachingSessionSummary\x124\n" +
	"\x16coaching_session_count\x18\x01 \x01(\rR\x14coachingSessionCount\")\n" +
	"'CMsgClientToGCRequestPlayerCoachMatches\"\xb9\x02\n" +
	"/CMsgClientToGCRequestPlayerCoachMatchesResponse\x12m\n" +
	"\x06result\x18\x01 \x01(\x0e2C.protocol.CMsgClientToGCRequestPlayerCoachMatchesResponse.EResponse:\x10k_eInternalErrorR\x06result\x12C\n" +
	"\rcoach_matches\x18\x02 \x03(\v2\x1e.protocol.CMsgPlayerCoachMatchR\fcoachMatches\"R\n" +
	"\tEResponse\x12\x14\n" +
	...
	"\bmatch_id\x18\x01 \x01(\x04R\amatchId\"\xb1\x02\n" +
	"-CMsgClientToGCRequestPlayerCoachMatchResponse\x12k\n" +
	"\x06result\x18\x01 \x01(\x0e2A.protocol.CMsgClientToGCRequestPlayerCoachMatchResponse.EResponse:\x10k_eInternalErrorR\x06result\x12?\n" +
	"\vcoach_match\x18\x02 \x01(\v2\x1e.protocol.CMsgPlayerCoachMatchR\n" +
	"coachMatch\"R\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	...
	"\n" +
	"k_eTooBusy\x10\x02\x12\x0f\n" +
	"\vk_eDisabled\x10\x03\"\xdb\x01\n" +
	"'CMsgClientToGCSubmitCoachTeammateRating\x12\x19\n" +
	"\bmatch_id\x18\x01 \x01(\x04R\amatchId\x12(\n" +
	"\x10coach_account_id\x18\x02 \x01(\rR\x0ecoachAccountId\x12S\n" +
	"\x06rating\x18\x03 \x01(\x0e2\x1e.protocol.ECoachTeammateRating:\x1bk_ECoachTeammateRating_NoneR\x06rating\x12\x16\n" +
	"\x06reason\x18\x04 \x01(\tR\x06reason\"\xc2\x03\n" +
	"/CMsgClientToGCSubmitCoachTeammateRatingResponse\x12m\n" +
	"\x06result\x18\x01 \x01(\x0e2C.protocol.CMsgClientToGCSubmitCoachTeammateRatingResponse.EResponse:\x10k_eInternalErrorR\x06result\"\x9f\x02\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\x12\x17\n" +
	"\x13k_eMatchNotEligible\x10\v\"l\n" +
	")CMsgGCToClientCoachTeammateRatingsChanged\x12?\n" +
	"\vcoach_match\x18\x01 \x01(\v2\x1e.protocol.CMsgPlayerCoachMatchR\n" +
	"coachMatch\"I\n" +
	"+CMsgClientToGCRequestPrivateCoachingSession\x12\x1a\n" +
	"\blanguage\x18\x01 \x01(\rR\blanguage\"\xb2\x04\n" +
	"3CMsgClientToGCRequestPrivateCoachingSessionResponse\x12q\n" +
	"\x06result\x18\x01 \x01(\x0e2G.protocol.CMsgClientToGCRequestPrivateCoachingSessionResponse.EResponse:\x10k_eInternalErrorR\x06result\x12O\n" +
	"\x10coaching_session\x18\x02 \x01(\v2$.protocol.CMsgPrivateCoachingSessionR\x0fcoachingSession\"\xb6\x02\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\x13coaching_session_id\x18\x01 \x01(\x04R\x11coachingSessionId\"\x84\x06\n" +
	"2CMsgClientToGCAcceptPrivateCoachingSessionResponse\x12p\n" +
	"\x06result\x18\x01 \x01(\x0e2F.protocol.CMsgClientToGCAcceptPrivateCoachingSessionResponse.EResponse:\x10k_eInternalErrorR\x06result\x12O\n" +
	"\x10coaching_session\x18\x02 \x01(\v2$.protocol.CMsgPrivateCoachingSessionR\x0fcoachingSession\"\x8a\x04\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	")CMsgClientToGCLeavePrivateCoachingSession\"\xaf\x02\n" +
	"1CMsgClientToGCLeavePrivateCoachingSessionResponse\x12o\n" +
	"\x06result\x18\x01 \x01(\x0e2E.protocol.CMsgClientToGCLeavePrivateCoachingSessionResponse.EResponse:\x10k_eInternalErrorR\x06result\"\x88\x01\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	".CMsgClientToGCGetCurrentPrivateCoachingSession\"\xe1\x02\n" +
	"6CMsgClientToGCGetCurrentPrivateCoachingSessionResponse\x12t\n" +
	"\x06result\x18\x01 \x01(\x0e2J.protocol.CMsgClientToGCGetCurrentPrivateCoachingSessionResponse.EResponse:\x10k_eInternalErrorR\x06result\x12M\n" +
	"\x0fcurrent_session\x18\x02 \x01(\v2$.protocol.CMsgPrivateCoachingSessionR\x0ecurrentSession\"b\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\n" +
	"k_eTimeout\x10\x04\"~\n" +
	"+CMsgGCToClientPrivateCoachingSessionUpdated\x12O\n" +
	"\x10coaching_session\x18\x01 \x01(\v2$.protocol.CMsgPrivateCoachingSessionR\x0fcoachingSession\"\xc6\x01\n" +
	"0CMsgClientToGCSubmitPrivateCoachingSessionRating\x12.\n" +
	"\x13coaching_session_id\x18\x01 \x01(\x04R\x11coachingSessionId\x12b\n" +
	"\x0esession_rating\x18\x02 \x01(\x0e2\x1e.protocol.ECoachTeammateRating:\x1bk_ECoachTeammateRating_NoneR\rsessionRating\"\xad\x03\n" +
	"8CMsgClientToGCSubmitPrivateCoachingSessionRatingResponse\x12v\n" +
	"\x06result\x18\x01 \x01(\x0e2L.protocol.CMsgClientToGCSubmitPrivateCoachingSessionRatingResponse.EResponse:\x10k_eInternalErrorR\x06result\"\xf8\x01\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\blanguage\x18\x01 \x01(\rR\blanguage\"\x83\x03\n" +
	"9CMsgClientToGCGetAvailablePrivateCoachingSessionsResponse\x12w\n" +
	"\x06result\x18\x01 \x01(\x0e2M.protocol.CMsgClientToGCGetAvailablePrivateCoachingSessionsResponse.EResponse:\x10k_eInternalErrorR\x06result\x12i\n" +
	"\x17available_sessions_list\x18\x02 \x01(\v21.protocol.CMsgAvailablePrivateCoachingSessionListR\x15availableSessionsList\"b\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\n" +
	"k_eTimeout\x10\x04\":\n" +
	"8CMsgClientToGCGetAvailablePrivateCoachingSessionsSummary\"\x96\x03\n" +
	"@CMsgClientToGCGetAvailablePrivateCoachingSessionsSummaryResponse\x12~\n" +
	"\x06result\x18\x01 \x01(\x0e2T.protocol.CMsgClientToGCGetAvailablePrivateCoachingSessionsSummaryResponse.EResponse:\x10k_eInternalErrorR\x06result\x12n\n" +
	"\x18coaching_session_summary\x18\x02 \x01(\v24.protocol.CMsgAvailablePrivateCoachingSessionSummaryR\x16coachingSessionSummary\"b\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\n" +
	"k_eTimeout\x10\x04\"/\n" +
	"-CMsgClientToGCJoinPrivateCoachingSessionLobby\"\xda\x04\n" +
	"5CMsgClientToGCJoinPrivateCoachingSessionLobbyResponse\x12s\n" +
	"\x06result\x18\x01 \x01(\x0e2I.protocol.CMsgClientToGCJoinPrivateCoachingSessionLobbyResponse.EResponse:\x10k_eInternalErrorR\x06result\"\xab\x03\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\x11target_account_id\x18\x01 \x01(\rR\x0ftargetAccountId\"\xcf\x04\n" +
	"!CMsgClientToGCCoachFriendResponse\x12_\n" +
	"\x06result\x18\x01 \x01(\x0e25.protocol.CMsgClientToGCCoachFriendResponse.EResponse:\x10k_eInternalErrorR\x06result\"\xc8\x03\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\x12k_eRequestRejected\x10\x13\"\xc0\x01\n" +
	")CMsgClientToGCRespondToCoachFriendRequest\x12(\n" +
	"\x10coach_account_id\x18\x01 \x01(\rR\x0ecoachAccountId\x12i\n" +
	"\bresponse\x18\x02 \x01(\x0e2'.protocol.ELobbyMemberCoachRequestState:$k_eLobbyMemberCoachRequestState_NoneR\bresponse\"\xc7\x03\n" +
	"1CMsgClientToGCRespondToCoachFriendRequestResponse\x12o\n" +
	"\x06result\x18\x01 \x01(\x0e2E.protocol.CMsgClientToGCRespondToCoachFriendRequestResponse.EResponse:\x10k_eInternalErrorR\x06result\"\xa0\x02\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"$k_EPlayerCoachMatchFlag_PrivateCoach\x10\x02B\rZ\v./;protocol"
