...
func (CMsgClientToGCShowcaseGetUserDataResponse_EResponse) EnumDescriptor() ([]byte, []int) {
	return file_dota_gcmessages_client_showcase_proto_rawDescGZIP(), []int{17, 0}
}
...
func (CMsgClientToGCShowcaseSetUserDataResponse_EResponse) EnumDescriptor() ([]byte, []int) {
	return file_dota_gcmessages_client_showcase_proto_rawDescGZIP(), []int{19, 0}
}
...
func (CMsgClientToGCShowcaseSubmitReportResponse_EResponse) EnumDescriptor() ([]byte, []int) {
	return file_dota_gcmessages_client_showcase_proto_rawDescGZIP(), []int{21, 0}
}
...
func (CMsgClientToGCShowcaseAdminGetReportsRollupListResponse_EResponse) EnumDescriptor() ([]byte, []int) {
	return file_dota_gcmessages_client_showcase_proto_rawDescGZIP(), []int{27, 0}
}
...
func (CMsgClientToGCShowcaseAdminGetReportsRollupResponse_EResponse) EnumDescriptor() ([]byte, []int) {
	return file_dota_gcmessages_client_showcase_proto_rawDescGZIP(), []int{29, 0}
}
...
func (CMsgClientToGCShowcaseAdminGetUserDetailsResponse_EResponse) EnumDescriptor() ([]byte, []int) {
	return file_dota_gcmessages_client_showcase_proto_rawDescGZIP(), []int{34, 0}
}
...
func (CMsgClientToGCShowcaseAdminResetResponse_EResponse) EnumDescriptor() ([]byte, []int) {
	return file_dota_gcmessages_client_showcase_proto_rawDescGZIP(), []int{36, 0}
}
...
func (CMsgClientToGCShowcaseAdminLockAccountResponse_EResponse) EnumDescriptor() ([]byte, []int) {
	return file_dota_gcmessages_client_showcase_proto_rawDescGZIP(), []int{38, 0}
}
...
func (CMsgClientToGCShowcaseAdminConvictResponse_EResponse) EnumDescriptor() ([]byte, []int) {
	return file_dota_gcmessages_client_showcase_proto_rawDescGZIP(), []int{40, 0}
}
...
func (CMsgClientToGCShowcaseAdminExonerateResponse_EResponse) EnumDescriptor() ([]byte, []int) {
	return file_dota_gcmessages_client_showcase_proto_rawDescGZIP(), []int{42, 0}
}
...
func (x *CMsgShowcaseItemData) GetTrophy() *CMsgShowcaseItem_Trophy {
	if x != nil {
		if x, ok := x.Item.(*CMsgShowcaseItemData_Trophy); ok {
			return x.Trophy
		}
	}
	return nil
...
func (x *CMsgShowcaseItemData) GetEmoticon() *CMsgShowcaseItem_Emoticon {
	if x != nil {
		if x, ok := x.Item.(*CMsgShowcaseItemData_Emoticon); ok {
			return x.Emoticon
		}
	}
	return nil
...
func (x *CMsgShowcaseItemData) GetStat() *CMsgShowcaseItem_Stat {
	if x != nil {
		if x, ok := x.Item.(*CMsgShowcaseItemData_Stat); ok {
			return x.Stat
		}
	}
	return nil
...
func (*CMsgShowcaseItem_Trophy_Data) Descriptor() ([]byte, []int) {
	return file_dota_gcmessages_client_showcase_proto_rawDescGZIP(), []int{1, 0}
}
...
const file_dota_gcmessages_client_showcase_proto_rawDesc = "" +
	"\n" +
	"%dota_gcmessages_client_showcase.proto\x12\bprotocol\x1a\x13steammessages.proto\x1a\x17dota_shared_enums.proto\x1a\x1cdota_gcmessages_common.proto\x1a\x1cdota_gcmessages_webapi.proto\x1a\x16gcsdk_gcmessages.proto\x1a\x15base_gcmessages.proto\x1a\x15econ_gcmessages.proto\x1a\x1cdota_gcmessages_client.proto\x1a\x15valveextensions.proto\"\xb1\x01\n" +
	"\x1dCMsgShowcaseEconItemReference\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x04R\x02id\x12\x1f\n" +
	"\voriginal_id\x18\x02 \x01(\x04R\n" +
	"originalId\x12)\n" +
	"\x10definition_index\x18\x03 \x01(\rR\x0fdefinitionIndex\x124\n" +
	"\x14equipment_slot_index\x18\x04 \x01(\x05:\x02-1R\x12equipmentSlotIndex\"\x9d\x01\n" +
	"\x17CMsgShowcaseItem_Trophy\x12:\n" +
	"\x04data\x18\x01 \x01(\v2&.protocol.CMsgShowcaseItem_Trophy.DataR\x04data\x12\x1b\n" +
	"\ttrophy_id\x18\x02 \x01(\rR\btrophyId\x1a)\n" +
	"\x04Data\x12!\n" +
	"\ftrophy_score\x18\x01 \x01(\rR\vtrophyScore\"\xd0\x01\n" +
	"\x19CMsgShowcaseItem_EconItem\x12<\n" +
	"\x04data\x18\x01 \x01(\v2(.protocol.CMsgShowcaseItem_EconItem.DataR\x04data\x129\n" +
	"\x03ref\x18\x02 \x01(\v2'.protocol.CMsgShowcaseEconItemReferenceR\x03ref\x1a:\n" +
	"\x04Data\x122\n" +
	"\tecon_item\x18\x01 \x01(\v2\x15.protocol.CSOEconItemR\beconItem\"\xcf\x02\n" +
	"\x15CMsgShowcaseItem_Hero\x128\n" +
	"\x04data\x18\x01 \x01(\v2$.protocol.CMsgShowcaseItem_Hero.DataR\x04data\x12\x17\n" +
	"\ahero_id\x18\x02 \x01(\rR\x06heroId\x12M\n" +
	"\x0eecon_item_refs\x18\x03 \x03(\v2'.protocol.CMsgShowcaseEconItemReferenceR\feconItemRefs\x12\x1a\n" +
	"\brotation\x18\x04 \x01(\rR\brotation\x12\x14\n" +
	"\x05flags\x18\x05 \x01(\rR\x05flags\x1ab\n" +
	"\x04Data\x124\n" +
	"\n" +
	"econ_items\x18\x01 \x03(\v2\x15.protocol.CSOEconItemR\teconItems\x12$\n" +
	"\x0eactual_hero_id\x18\x02 \x01(\rR\factualHeroId\"z\n" +
	"\x19CMsgShowcaseItem_HeroIcon\x12<\n" +
	"\x04data\x18\x01 \x01(\v2(.protocol.CMsgShowcaseItem_HeroIcon.DataR\x04data\x12\x17\n" +
	"\ahero_id\x18\x02 \x01(\rR\x06heroId\x1a\x06\n" +
	"\x04Data\"\xb3\x04\n" +
	"\x1cCMsgShowcaseItem_PlayerMatch\x12?\n" +
	"\x04data\x18\x01 \x01(\v2+.protocol.CMsgShowcaseItem_PlayerMatch.DataR\x04data\x12\x19\n" +
	"\bmatch_id\x18\x02 \x01(\x04R\amatchId\x12\x1f\n" +
	"\vplayer_slot\x18\x03 \x01(\rR\n" +
	"playerSlot\x1a\xc8\x02\n" +
	"\x04Data\x12\x17\n" +
	"\ahero_id\x18\x01 \x01(\rR\x06heroId\x12\x1c\n" +
	...
	"\aoutcome\x18\x05 \x01(\x0e25.protocol.CMsgShowcaseItem_PlayerMatch.EPlayerOutcome:\n" +
	"k_eInvalidR\aoutcome\x12\x14\n" +
	...
	"\fk_eNotScored\x10\x03\"\xa2\x01\n" +
	"\x1aCMsgShowcaseItem_ChatWheel\x12=\n" +
	"\x04data\x18\x01 \x01(\v2).protocol.CMsgShowcaseItem_ChatWheel.DataR\x04data\x12=\n" +
	"\x15chat_wheel_message_id\x18\x02 \x01(\r:\n" +
	"4294967295R\x12chatWheelMessageId\x1a\x06\n" +
	"\x04Data\"\x82\x01\n" +
	"\x19CMsgShowcaseItem_Emoticon\x12<\n" +
	"\x04data\x18\x01 \x01(\v2(.protocol.CMsgShowcaseItem_Emoticon.DataR\x04data\x12\x1f\n" +
	"\vemoticon_id\x18\x02 \x01(\rR\n" +
	"emoticonId\x1a\x06\n" +
	"\x04Data\"g\n" +
	"\x1cCMsgShowcaseItem_SpiderGraph\x12?\n" +
	"\x04data\x18\x01 \x01(\v2+.protocol.CMsgShowcaseItem_SpiderGraph.DataR\x04data\x1a\x06\n" +
	"\x04Data\"a\n" +
	"\x19CMsgShowcaseItem_UserFeed\x12<\n" +
	"\x04data\x18\x01 \x01(\v2(.protocol.CMsgShowcaseItem_UserFeed.DataR\x04data\x1a\x06\n" +
	"\x04Data\"\xc6\x01\n" +
	"\x15CMsgShowcaseItem_Stat\x128\n" +
	"\x04data\x18\x01 \x01(\v2$.protocol.CMsgShowcaseItem_Stat.DataR\x04data\x12L\n" +
	"\astat_id\x18\x02 \x01(\x0e2%.protocol.CMsgDOTAProfileCard.EStatID:\fk_eStat_WinsR\x06statId\x1a%\n" +
	"\x04Data\x12\x1d\n" +
	"\n" +
	"stat_score\x18\x01 \x01(\rR\tstatScore\"\xbb\x02\n" +
	"\x16CMsgShowcaseBackground\x129\n" +
	"\x04data\x18\x01 \x01(\v2%.protocol.CMsgShowcaseBackground.DataR\x04data\x12U\n" +
	"\x12loading_screen_ref\x18\x02 \x01(\v2'.protocol.CMsgShowcaseEconItemReferenceR\x10loadingScreenRef\x12\x10\n" +
	"\x03dim\x18\x03 \x01(\rR\x03dim\x12\x12\n" +
	"\x04blur\x18\x04 \x01(\rR\x04blur\x12#\n" +
	"\rbackground_id\x18\x05 \x01(\rR\fbackgroundId\x1aD\n" +
	"\x04Data\x12<\n" +
	"\x0eloading_screen\x18\x01 \x01(\v2\x15.protocol.CSOEconItemR\rloadingScreen\"\x8c\b\n" +
	"\x14CMsgShowcaseItemData\x12;\n" +
	"\x06trophy\x18\x01 \x01(\v2!.protocol.CMsgShowcaseItem_TrophyH\x00R\x06trophy\x12K\n" +
	"\x0eecon_item_icon\x18\x02 \x01(\v2#.protocol.CMsgShowcaseItem_EconItemH\x00R\feconItemIcon\x12?\n" +
	"\asticker\x18\x03 \x01(\v2#.protocol.CMsgShowcaseItem_EconItemH\x00R\asticker\x12@\n" +
	"\n" +
	"hero_model\x18\x04 \x01(\v2\x1f.protocol.CMsgShowcaseItem_HeroH\x00R\theroModel\x12K\n" +
	"\fplayer_match\x18\x05 \x01(\v2&.protocol.CMsgShowcaseItem_PlayerMatchH\x00R\vplayerMatch\x12E\n" +
	"\n" +
	"chat_wheel\x18\x06 \x01(\v2$.protocol.CMsgShowcaseItem_ChatWheelH\x00R\tchatWheel\x12<\n" +
	"\x05spray\x18\a \x01(\v2$.protocol.CMsgShowcaseItem_ChatWheelH\x00R\x05spray\x12A\n" +
	"\bemoticon\x18\b \x01(\v2#.protocol.CMsgShowcaseItem_EmoticonH\x00R\bemoticon\x12?\n" +
	"\acourier\x18\n" +
	" \x01(\v2#.protocol.CMsgShowcaseItem_EconItemH\x00R\acourier\x129\n" +
	"\x04ward\x18\v \x01(\v2#.protocol.CMsgShowcaseItem_EconItemH\x00R\x04ward\x12B\n" +
	"\thero_icon\x18\f \x01(\v2#.protocol.CMsgShowcaseItem_HeroIconH\x00R\bheroIcon\x12K\n" +
	"\fspider_graph\x18\r \x01(\v2&.protocol.CMsgShowcaseItem_SpiderGraphH\x00R\vspiderGraph\x12B\n" +
	"\tuser_feed\x18\x0e \x01(\v2#.protocol.CMsgShowcaseItem_UserFeedH\x00R\buserFeed\x125\n" +
	"\x04stat\x18\x0f \x01(\v2\x1f.protocol.CMsgShowcaseItem_StatH\x00R\x04stat\x12B\n" +
	"\n" +
	"background\x18d \x01(\v2 .protocol.CMsgShowcaseBackgroundH\x00R\n" +
	"backgroundB\x06\n" +
	"\x04item\"\xb8\x01\n" +
	...
	"\brotation\x18\x06 \x01(\rR\brotation\"\xa5\x02\n" +
	"\x10CMsgShowcaseItem\x12(\n" +
	"\x10showcase_item_id\x18\x01 \x01(\rR\x0eshowcaseItemId\x12G\n" +
	"\ritem_position\x18\x02 \x01(\v2\".protocol.CMsgShowcaseItemPositionR\fitemPosition\x12;\n" +
	"\titem_data\x18\x03 \x01(\v2\x1e.protocol.CMsgShowcaseItemDataR\bitemData\x12K\n" +
	"\x05state\x18\x04 \x01(\x0e2\x1c.protocol.EShowcaseItemState:\x17k_eShowcaseItemState_OkR\x05state\x12\x14\n" +
	"\x05flags\x18\x05 \x01(\rR\x05flags\"\x8d\x01\n" +
	"\fCMsgShowcase\x12A\n" +
	"\x0eshowcase_items\x18\x01 \x03(\v2\x1a.protocol.CMsgShowcaseItemR\rshowcaseItems\x12:\n" +
	"\n" +
	"background\x18\x03 \x01(\v2\x1a.protocol.CMsgShowcaseItemR\n" +
	"background\"\x99\x01\n" +
	"!CMsgClientToGCShowcaseGetUserData\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12U\n" +
	"\rshowcase_type\x18\x02 \x01(\x0e2\x17.protocol.EShowcaseType:\x17k_eShowcaseType_InvalidR\fshowcaseType\"\xc8\x02\n" +
	")CMsgClientToGCShowcaseGetUserDataResponse\x12k\n" +
	"\bresponse\x18\x01 \x01(\x0e2=.protocol.CMsgClientToGCShowcaseGetUserDataResponse.EResponse:\x10k_eInternalErrorR\bresponse\x122\n" +
	"\bshowcase\x18\x02 \x01(\v2\x16.protocol.CMsgShowcaseR\bshowcase\"z\n" +
	"\tEResponse\x12\x14\n" +
	...
	"\x12k_eUnknownShowcase\x10\x05\"\xd5\x01\n" +
	"!CMsgClientToGCShowcaseSetUserData\x12U\n" +
	"\rshowcase_type\x18\x01 \x01(\x0e2\x17.protocol.EShowcaseType:\x17k_eShowcaseType_InvalidR\fshowcaseType\x122\n" +
	"\bshowcase\x18\x02 \x01(\v2\x16.protocol.CMsgShowcaseR\bshowcase\x12%\n" +
	"\x0eformat_version\x18\x03 \x01(\rR\rformatVersion\"\xdc\x03\n" +
	")CMsgClientToGCShowcaseSetUserDataResponse\x12k\n" +
	"\bresponse\x18\x01 \x01(\x0e2=.protocol.CMsgClientToGCShowcaseSetUserDataResponse.EResponse:\x10k_eInternalErrorR\bresponse\x12E\n" +
	"\x12validated_showcase\x18\x02 \x01(\v2\x16.protocol.CMsgShowcaseR\x11validatedShowcase\x124\n" +
	...
	"\x1bk_eCommunicationScoreTooLow\x10\b\"\xce\x01\n" +
	"\"CMsgClientToGCShowcaseSubmitReport\x12*\n" +
	"\x11target_account_id\x18\x01 \x01(\rR\x0ftargetAccountId\x12U\n" +
	"\rshowcase_type\x18\x02 \x01(\x0e2\x17.protocol.EShowcaseType:\x17k_eShowcaseType_InvalidR\fshowcaseType\x12%\n" +
	"\x0ereport_comment\x18\x03 \x01(\tR\rreportComment\"\x96\x02\n" +
	"*CMsgClientToGCShowcaseSubmitReportResponse\x12l\n" +
	"\bresponse\x18\x01 \x01(\x0e2>.protocol.CMsgClientToGCShowcaseSubmitReportResponse.EResponse:\x10k_eInternalErrorR\bresponse\"z\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\rend_timestamp\x18\x03 \x01(\rR\fendTimestamp\"b\n" +
	"\x1dCMsgShowcaseReportsRollupList\x12A\n" +
	"\arollups\x18\x01 \x03(\v2'.protocol.CMsgShowcaseReportsRollupInfoR\arollups\"\xb9\x01\n" +
	"\x1eCMsgShowcaseReportsRollupEntry\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12U\n" +
	"\rshowcase_type\x18\x02 \x01(\x0e2\x17.protocol.EShowcaseType:\x17k_eShowcaseType_InvalidR\fshowcaseType\x12!\n" +
	"\freport_count\x18\x03 \x01(\rR\vreportCount\"\xb6\x01\n" +
	"\x19CMsgShowcaseReportsRollup\x12H\n" +
	"\vrollup_info\x18\x01 \x01(\v2'.protocol.CMsgShowcaseReportsRollupInfoR\n" +
	"rollupInfo\x12O\n" +
	"\x0erollup_entries\x18\x02 \x03(\v2(.protocol.CMsgShowcaseReportsRollupEntryR\rrollupEntries\"1\n" +
	"/CMsgClientToGCShowcaseAdminGetReportsRollupList\"\xf7\x02\n" +
	"7CMsgClientToGCShowcaseAdminGetReportsRollupListResponse\x12y\n" +
	"\bresponse\x18\x01 \x01(\x0e2K.protocol.CMsgClientToGCShowcaseAdminGetReportsRollupListResponse.EResponse:\x10k_eInternalErrorR\bresponse\x12H\n" +
	"\vrollup_list\x18\x02 \x01(\v2'.protocol.CMsgShowcaseReportsRollupListR\n" +
	"rollupList\"w\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	...
	"\trollup_id\x18\x01 \x01(\rR\brollupId\"\xf4\x02\n" +
	"3CMsgClientToGCShowcaseAdminGetReportsRollupResponse\x12u\n" +
	"\bresponse\x18\x01 \x01(\x0e2G.protocol.CMsgClientToGCShowcaseAdminGetReportsRollupResponse.EResponse:\x10k_eInternalErrorR\bresponse\x12;\n" +
	"\x06rollup\x18\x02 \x01(\v2#.protocol.CMsgShowcaseReportsRollupR\x06rollup\"\x88\x01\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\vk_eNotFound\x10\x06\"\x8f\x02\n" +
	"\x16CMsgShowcaseAuditEntry\x12U\n" +
	"\rshowcase_type\x18\x01 \x01(\x0e2\x17.protocol.EShowcaseType:\x17k_eShowcaseType_InvalidR\fshowcaseType\x12a\n" +
	"\faudit_action\x18\x02 \x01(\x0e2\x1e.protocol.EShowcaseAuditAction:\x1ek_eShowcaseAuditAction_InvalidR\vauditAction\x12\x1d\n" +
	"\n" +
	"audit_data\x18\x03 \x01(\x04R\tauditData\x12\x1c\n" +
	"\ttimestamp\x18\x04 \x01(\rR\ttimestamp\"\xed\x01\n" +
	"\x12CMsgShowcaseReport\x12.\n" +
	"\x13reporter_account_id\x18\x01 \x01(\rR\x11reporterAccountId\x12U\n" +
	"\rshowcase_type\x18\x02 \x01(\x0e2\x17.protocol.EShowcaseType:\x17k_eShowcaseType_InvalidR\fshowcaseType\x12)\n" +
	"\x10report_timestamp\x18\x03 \x01(\rR\x0freportTimestamp\x12%\n" +
	"\x0ereport_comment\x18\x04 \x01(\tR\rreportComment\"\xd3\x01\n" +
	"\x1cCMsgShowcaseAdminUserDetails\x124\n" +
	"\x16locked_until_timestamp\x18\x01 \x01(\rR\x14lockedUntilTimestamp\x12E\n" +
	"\raudit_entries\x18\x02 \x03(\v2 .protocol.CMsgShowcaseAuditEntryR\fauditEntries\x126\n" +
	"\areports\x18\x03 \x03(\v2\x1c.protocol.CMsgShowcaseReportR\areports\"J\n" +
	")CMsgClientToGCShowcaseAdminGetUserDetails\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\"\xec\x02\n" +
	"1CMsgClientToGCShowcaseAdminGetUserDetailsResponse\x12s\n" +
	"\bresponse\x18\x01 \x01(\x0e2E.protocol.CMsgClientToGCShowcaseAdminGetUserDetailsResponse.EResponse:\x10k_eInternalErrorR\bresponse\x12I\n" +
	"\fuser_details\x18\x02 \x01(\v2&.protocol.CMsgShowcaseAdminUserDetailsR\vuserDetails\"w\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\n" +
	"k_eTimeout\x10\x04\x12\x13\n" +
	"\x0fk_eNoPermission\x10\x05\"\xa5\x01\n" +
	" CMsgClientToGCShowcaseAdminReset\x12*\n" +
	"\x11target_account_id\x18\x01 \x01(\rR\x0ftargetAccountId\x12U\n" +
	"\rshowcase_type\x18\x02 \x01(\x0e2\x17.protocol.EShowcaseType:\x17k_eShowcaseType_InvalidR\fshowcaseType\"\x8f\x02\n" +
	"(CMsgClientToGCShowcaseAdminResetResponse\x12j\n" +
	"\bresponse\x18\x01 \x01(\x0e2<.protocol.CMsgClientToGCShowcaseAdminResetResponse.EResponse:\x10k_eInternalErrorR\bresponse\"w\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\x16locked_until_timestamp\x18\x02 \x01(\rR\x14lockedUntilTimestamp\"\x9b\x02\n" +
	".CMsgClientToGCShowcaseAdminLockAccountResponse\x12p\n" +
	"\bresponse\x18\x01 \x01(\x0e2B.protocol.CMsgClientToGCShowcaseAdminLockAccountResponse.EResponse:\x10k_eInternalErrorR\bresponse\"w\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\n" +
	"k_eTimeout\x10\x04\x12\x13\n" +
	"\x0fk_eNoPermission\x10\x05\"\xa7\x01\n" +
	"\"CMsgClientToGCShowcaseAdminConvict\x12*\n" +
	"\x11target_account_id\x18\x01 \x01(\rR\x0ftargetAccountId\x12U\n" +
	"\rshowcase_type\x18\x02 \x01(\x0e2\x17.protocol.EShowcaseType:\x17k_eShowcaseType_InvalidR\fshowcaseType\"\xad\x02\n" +
	"*CMsgClientToGCShowcaseAdminConvictResponse\x12l\n" +
	"\bresponse\x18\x01 \x01(\x0e2>.protocol.CMsgClientToGCShowcaseAdminConvictResponse.EResponse:\x10k_eInternalErrorR\bresponse\"\x90\x01\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\x13k_eAlreadyConvicted\x10\x06\"\xa9\x01\n" +
	"$CMsgClientToGCShowcaseAdminExonerate\x12*\n" +
	"\x11target_account_id\x18\x01 \x01(\rR\x0ftargetAccountId\x12U\n" +
	"\rshowcase_type\x18\x02 \x01(\x0e2\x17.protocol.EShowcaseType:\x17k_eShowcaseType_InvalidR\fshowcaseType\"\xb2\x02\n" +
	",CMsgClientToGCShowcaseAdminExonerateResponse\x12n\n" +
	"\bresponse\x18\x01 \x01(\x0e2@.protocol.CMsgClientToGCShowcaseAdminExonerateResponse.EResponse:\x10k_eInternalErrorR\bresponse\"\x91\x01\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\x1ck_eShowcaseItemState_Failure\x10\x05*\xb3\x02\n" +
	...
	"-k_eShowcaseAuditAction_AdminShowcaseConvicted\x10\x05*[\n" +
	"\x11EShowcaseItemFlag\x12\x1c\n" +
	"\x18k_eShowcaseItemFlag_None\x10\x00\x12(\n" +
	"$k_eShowcaseItemFlag_FlipHorizontally\x10\x01*\x96\x01\n" +
	...
	"*k_eShowcaseItemFlag_Hero_UseCurrentLoadout\x10\x02B\rZ\v./;protocol"
...
var file_dota_gcmessages_client_showcase_proto_enumTypes = make([]protoimpl.EnumInfo, 16)
var file_dota_gcmessages_client_showcase_proto_msgTypes = make([]protoimpl.MessageInfo, 54)
var file_dota_gcmessages_client_showcase_proto_goTypes = []any{
	(EShowcaseType)(0),                                                     // 0: protocol.EShowcaseType
	(EShowcaseItemState)(0),                                                // 1: protocol.EShowcaseItemState
	(EShowcaseAuditAction)(0),                                              // 2: protocol.EShowcaseAuditAction
	(EShowcaseItemFlag)(0),                                                 // 3: protocol.EShowcaseItemFlag
	(EShowcaseItemFlag_Hero)(0),                                            // 4: protocol.EShowcaseItemFlag_Hero
	(CMsgShowcaseItem_PlayerMatch_EPlayerOutcome)(0),                       // 5: protocol.CMsgShowcaseItem_PlayerMatch.EPlayerOutcome
	(CMsgClientToGCShowcaseGetUserDataResponse_EResponse)(0),               // 6: protocol.CMsgClientToGCShowcaseGetUserDataResponse.EResponse
	(CMsgClientToGCShowcaseSetUserDataResponse_EResponse)(0),               // 7: protocol.CMsgClientToGCShowcaseSetUserDataResponse.EResponse
	(CMsgClientToGCShowcaseSubmitReportResponse_EResponse)(0),              // 8: protocol.CMsgClientToGCShowcaseSubmitReportResponse.EResponse
	(CMsgClientToGCShowcaseAdminGetReportsRollupListResponse_EResponse)(0), // 9: protocol.CMsgClientToGCShowcaseAdminGetReportsRollupListResponse.EResponse
	(CMsgClientToGCShowcaseAdminGetReportsRollupResponse_EResponse)(0),     // 10: protocol.CMsgClientToGCShowcaseAdminGetReportsRollupResponse.EResponse
	(CMsgClientToGCShowcaseAdminGetUserDetailsResponse_EResponse)(0),       // 11: protocol.CMsgClientToGCShowcaseAdminGetUserDetailsResponse.EResponse
	(CMsgClientToGCShowcaseAdminResetResponse_EResponse)(0),                // 12: protocol.CMsgClientToGCShowcaseAdminResetResponse.EResponse
	(CMsgClientToGCShowcaseAdminLockAccountResponse_EResponse)(0),          // 13: protocol.CMsgClientToGCShowcaseAdminLockAccountResponse.EResponse
	(CMsgClientToGCShowcaseAdminConvictResponse_EResponse)(0),              // 14: protocol.CMsgClientToGCShowcaseAdminConvictResponse.EResponse
	(CMsgClientToGCShowcaseAdminExonerateResponse_EResponse)(0),            // 15: protocol.CMsgClientToGCShowcaseAdminExonerateResponse.EResponse
	(*CMsgShowcaseEconItemReference)(nil),                                  // 16: protocol.CMsgShowcaseEconItemReference
	(*CMsgShowcaseItem_Trophy)(nil),                                        // 17: protocol.CMsgShowcaseItem_Trophy
	(*CMsgShowcaseItem_EconItem)(nil),                                      // 18: protocol.CMsgShowcaseItem_EconItem
	(*CMsgShowcaseItem_Hero)(nil),                                          // 19: protocol.CMsgShowcaseItem_Hero
	(*CMsgShowcaseItem_HeroIcon)(nil),                                      // 20: protocol.CMsgShowcaseItem_HeroIcon
	(*CMsgShowcaseItem_PlayerMatch)(nil),                                   // 21: protocol.CMsgShowcaseItem_PlayerMatch
	(*CMsgShowcaseItem_ChatWheel)(nil),                                     // 22: protocol.CMsgShowcaseItem_ChatWheel
	(*CMsgShowcaseItem_Emoticon)(nil),                                      // 23: protocol.CMsgShowcaseItem_Emoticon
	(*CMsgShowcaseItem_SpiderGraph)(nil),                                   // 24: protocol.CMsgShowcaseItem_SpiderGraph
	(*CMsgShowcaseItem_UserFeed)(nil),                                      // 25: protocol.CMsgShowcaseItem_UserFeed
	(*CMsgShowcaseItem_Stat)(nil),                                          // 26: protocol.CMsgShowcaseItem_Stat
	(*CMsgShowcaseBackground)(nil),                                         // 27: protocol.CMsgShowcaseBackground
	(*CMsgShowcaseItemData)(nil),                                           // 28: protocol.CMsgShowcaseItemData
	(*CMsgShowcaseItemPosition)(nil),                                       // 29: protocol.CMsgShowcaseItemPosition
	(*CMsgShowcaseItem)(nil),                                               // 30: protocol.CMsgShowcaseItem
	(*CMsgShowcase)(nil),                                                   // 31: protocol.CMsgShowcase
	(*CMsgClientToGCShowcaseGetUserData)(nil),                              // 32: protocol.CMsgClientToGCShowcaseGetUserData
	(*CMsgClientToGCShowcaseGetUserDataResponse)(nil),                      // 33: protocol.CMsgClientToGCShowcaseGetUserDataResponse
	(*CMsgClientToGCShowcaseSetUserData)(nil),                              // 34: protocol.CMsgClientToGCShowcaseSetUserData
	(*CMsgClientToGCShowcaseSetUserDataResponse)(nil),                      // 35: protocol.CMsgClientToGCShowcaseSetUserDataResponse
	(*CMsgClientToGCShowcaseSubmitReport)(nil),                             // 36: protocol.CMsgClientToGCShowcaseSubmitReport
	(*CMsgClientToGCShowcaseSubmitReportResponse)(nil),                     // 37: protocol.CMsgClientToGCShowcaseSubmitReportResponse
	(*CMsgShowcaseReportsRollupInfo)(nil),                                  // 38: protocol.CMsgShowcaseReportsRollupInfo
	(*CMsgShowcaseReportsRollupList)(nil),                                  // 39: protocol.CMsgShowcaseReportsRollupList
	(*CMsgShowcaseReportsRollupEntry)(nil),                                 // 40: protocol.CMsgShowcaseReportsRollupEntry
	(*CMsgShowcaseReportsRollup)(nil),                                      // 41: protocol.CMsgShowcaseReportsRollup
	(*CMsgClientToGCShowcaseAdminGetReportsRollupList)(nil),                // 42: protocol.CMsgClientToGCShowcaseAdminGetReportsRollupList
	(*CMsgClientToGCShowcaseAdminGetReportsRollupListResponse)(nil),        // 43: protocol.CMsgClientToGCShowcaseAdminGetReportsRollupListResponse
	(*CMsgClientToGCShowcaseAdminGetReportsRollup)(nil),                    // 44: protocol.CMsgClientToGCShowcaseAdminGetReportsRollup
	(*CMsgClientToGCShowcaseAdminGetReportsRollupResponse)(nil),            // 45: protocol.CMsgClientToGCShowcaseAdminGetReportsRollupResponse
	(*CMsgShowcaseAuditEntry)(nil),                                         // 46: protocol.CMsgShowcaseAuditEntry
	(*CMsgShowcaseReport)(nil),                                             // 47: protocol.CMsgShowcaseReport
	(*CMsgShowcaseAdminUserDetails)(nil),                                   // 48: protocol.CMsgShowcaseAdminUserDetails
	(*CMsgClientToGCShowcaseAdminGetUserDetails)(nil),                      // 49: protocol.CMsgClientToGCShowcaseAdminGetUserDetails
	(*CMsgClientToGCShowcaseAdminGetUserDetailsResponse)(nil),              // 50: protocol.CMsgClientToGCShowcaseAdminGetUserDetailsResponse
	(*CMsgClientToGCShowcaseAdminReset)(nil),                               // 51: protocol.CMsgClientToGCShowcaseAdminReset
	(*CMsgClientToGCShowcaseAdminResetResponse)(nil),                       // 52: protocol.CMsgClientToGCShowcaseAdminResetResponse
	(*CMsgClientToGCShowcaseAdminLockAccount)(nil),                         // 53: protocol.CMsgClientToGCShowcaseAdminLockAccount
	(*CMsgClientToGCShowcaseAdminLockAccountResponse)(nil),                 // 54: protocol.CMsgClientToGCShowcaseAdminLockAccountResponse
	(*CMsgClientToGCShowcaseAdminConvict)(nil),                             // 55: protocol.CMsgClientToGCShowcaseAdminConvict
	(*CMsgClientToGCShowcaseAdminConvictResponse)(nil),                     // 56: protocol.CMsgClientToGCShowcaseAdminConvictResponse
	(*CMsgClientToGCShowcaseAdminExonerate)(nil),                           // 57: protocol.CMsgClientToGCShowcaseAdminExonerate
	(*CMsgClientToGCShowcaseAdminExonerateResponse)(nil),                   // 58: protocol.CMsgClientToGCShowcaseAdminExonerateResponse
	(*CMsgShowcaseItem_Trophy_Data)(nil),                                   // 59: protocol.CMsgShowcaseItem_Trophy.Data
	(*CMsgShowcaseItem_EconItem_Data)(nil),                                 // 60: protocol.CMsgShowcaseItem_EconItem.Data
	(*CMsgShowcaseItem_Hero_Data)(nil),                                     // 61: protocol.CMsgShowcaseItem_Hero.Data
	(*CMsgShowcaseItem_HeroIcon_Data)(nil),                                 // 62: protocol.CMsgShowcaseItem_HeroIcon.Data
	(*CMsgShowcaseItem_PlayerMatch_Data)(nil),                              // 63: protocol.CMsgShowcaseItem_PlayerMatch.Data
	(*CMsgShowcaseItem_ChatWheel_Data)(nil),                                // 64: protocol.CMsgShowcaseItem_ChatWheel.Data
	(*CMsgShowcaseItem_Emoticon_Data)(nil),                                 // 65: protocol.CMsgShowcaseItem_Emoticon.Data
	(*CMsgShowcaseItem_SpiderGraph_Data)(nil),                              // 66: protocol.CMsgShowcaseItem_SpiderGraph.Data
	(*CMsgShowcaseItem_UserFeed_Data)(nil),                                 // 67: protocol.CMsgShowcaseItem_UserFeed.Data
	(*CMsgShowcaseItem_Stat_Data)(nil),                                     // 68: protocol.CMsgShowcaseItem_Stat.Data
	(*CMsgShowcaseBackground_Data)(nil),                                    // 69: protocol.CMsgShowcaseBackground.Data
	(CMsgDOTAProfileCard_EStatID)(0),                                       // 70: protocol.CMsgDOTAProfileCard.EStatID
	(*CSOEconItem)(nil),                                                    // 71: protocol.CSOEconItem
	(DOTA_GameMode)(0),                                                     // 72: protocol.DOTA_GameMode
}
var file_dota_gcmessages_client_showcase_proto_depIdxs = []int32{
	59, // 0: protocol.CMsgShowcaseItem_Trophy.data:type_name -> protocol.CMsgShowcaseItem_Trophy.Data
	60, // 1: protocol.CMsgShowcaseItem_EconItem.data:type_name -> protocol.CMsgShowcaseItem_EconItem.Data
	16, // 2: protocol.CMsgShowcaseItem_EconItem.ref:type_name -> protocol.CMsgShowcaseEconItemReference
	61, // 3: protocol.CMsgShowcaseItem_Hero.data:type_name -> protocol.CMsgShowcaseItem_Hero.Data
	16, // 4: protocol.CMsgShowcaseItem_Hero.econ_item_refs:type_name -> protocol.CMsgShowcaseEconItemReference
	62, // 5: protocol.CMsgShowcaseItem_HeroIcon.data:type_name -> protocol.CMsgShowcaseItem_HeroIcon.Data
	63, // 6: protocol.CMsgShowcaseItem_PlayerMatch.data:type_name -> protocol.CMsgShowcaseItem_PlayerMatch.Data
	64, // 7: protocol.CMsgShowcaseItem_ChatWheel.data:type_name -> protocol.CMsgShowcaseItem_ChatWheel.Data
	65, // 8: protocol.CMsgShowcaseItem_Emoticon.data:type_name -> protocol.CMsgShowcaseItem_Emoticon.Data
	66, // 9: protocol.CMsgShowcaseItem_SpiderGraph.data:type_name -> protocol.CMsgShowcaseItem_SpiderGraph.Data
	67, // 10: protocol.CMsgShowcaseItem_UserFeed.data:type_name -> protocol.CMsgShowcaseItem_UserFeed.Data
	68, // 11: protocol.CMsgShowcaseItem_Stat.data:type_name -> protocol.CMsgShowcaseItem_Stat.Data
	70, // 12: protocol.CMsgShowcaseItem_Stat.stat_id:type_name -> protocol.CMsgDOTAProfileCard.EStatID
	69, // 13: protocol.CMsgShowcaseBackground.data:type_name -> protocol.CMsgShowcaseBackground.Data
	16, // 14: protocol.CMsgShowcaseBackground.loading_screen_ref:type_name -> protocol.CMsgShowcaseEconItemReference
	17, // 15: protocol.CMsgShowcaseItemData.trophy:type_name -> protocol.CMsgShowcaseItem_Trophy
	18, // 16: protocol.CMsgShowcaseItemData.econ_item_icon:type_name -> protocol.CMsgShowcaseItem_EconItem
	18, // 17: protocol.CMsgShowcaseItemData.sticker:type_name -> protocol.CMsgShowcaseItem_EconItem
	19, // 18: protocol.CMsgShowcaseItemData.hero_model:type_name -> protocol.CMsgShowcaseItem_Hero
	21, // 19: protocol.CMsgShowcaseItemData.player_match:type_name -> protocol.CMsgShowcaseItem_PlayerMatch
	22, // 20: protocol.CMsgShowcaseItemData.chat_wheel:type_name -> protocol.CMsgShowcaseItem_ChatWheel
	22, // 21: protocol.CMsgShowcaseItemData.spray:type_name -> protocol.CMsgShowcaseItem_ChatWheel
	23, // 22: protocol.CMsgShowcaseItemData.emoticon:type_name -> protocol.CMsgShowcaseItem_Emoticon
	18, // 23: protocol.CMsgShowcaseItemData.courier:type_name -> protocol.CMsgShowcaseItem_EconItem
	18, // 24: protocol.CMsgShowcaseItemData.ward:type_name -> protocol.CMsgShowcaseItem_EconItem
	20, // 25: protocol.CMsgShowcaseItemData.hero_icon:type_name -> protocol.CMsgShowcaseItem_HeroIcon
	24, // 26: protocol.CMsgShowcaseItemData.spider_graph:type_name -> protocol.CMsgShowcaseItem_SpiderGraph
	25, // 27: protocol.CMsgShowcaseItemData.user_feed:type_name -> protocol.CMsgShowcaseItem_UserFeed
	26, // 28: protocol.CMsgShowcaseItemData.stat:type_name -> protocol.CMsgShowcaseItem_Stat
	27, // 29: protocol.CMsgShowcaseItemData.background:type_name -> protocol.CMsgShowcaseBackground
	29, // 30: protocol.CMsgShowcaseItem.item_position:type_name -> protocol.CMsgShowcaseItemPosition
	28, // 31: protocol.CMsgShowcaseItem.item_data:type_name -> protocol.CMsgShowcaseItemData
	1,  // 32: protocol.CMsgShowcaseItem.state:type_name -> protocol.EShowcaseItemState
	30, // 33: protocol.CMsgShowcase.showcase_items:type_name -> protocol.CMsgShowcaseItem
	30, // 34: protocol.CMsgShowcase.background:type_name -> protocol.CMsgShowcaseItem
	0,  // 35: protocol.CMsgClientToGCShowcaseGetUserData.showcase_type:type_name -> protocol.EShowcaseType
	6,  // 36: protocol.CMsgClientToGCShowcaseGetUserDataResponse.response:type_name -> protocol.CMsgClientToGCShowcaseGetUserDataResponse.EResponse
	31, // 37: protocol.CMsgClientToGCShowcaseGetUserDataResponse.showcase:type_name -> protocol.CMsgShowcase
	0,  // 38: protocol.CMsgClientToGCShowcaseSetUserData.showcase_type:type_name -> protocol.EShowcaseType
	31, // 39: protocol.CMsgClientToGCShowcaseSetUserData.showcase:type_name -> protocol.CMsgShowcase
	7,  // 40: protocol.CMsgClientToGCShowcaseSetUserDataResponse.response:type_name -> protocol.CMsgClientToGCShowcaseSetUserDataResponse.EResponse
	31, // 41: protocol.CMsgClientToGCShowcaseSetUserDataResponse.validated_showcase:type_name -> protocol.CMsgShowcase
	0,  // 42: protocol.CMsgClientToGCShowcaseSubmitReport.showcase_type:type_name -> protocol.EShowcaseType
	8,  // 43: protocol.CMsgClientToGCShowcaseSubmitReportResponse.response:type_name -> protocol.CMsgClientToGCShowcaseSubmitReportResponse.EResponse
	38, // 44: protocol.CMsgShowcaseReportsRollupList.rollups:type_name -> protocol.CMsgShowcaseReportsRollupInfo
	0,  // 45: protocol.CMsgShowcaseReportsRollupEntry.showcase_type:type_name -> protocol.EShowcaseType
	38, // 46: protocol.CMsgShowcaseReportsRollup.rollup_info:type_name -> protocol.CMsgShowcaseReportsRollupInfo
	40, // 47: protocol.CMsgShowcaseReportsRollup.rollup_entries:type_name -> protocol.CMsgShowcaseReportsRollupEntry
	9,  // 48: protocol.CMsgClientToGCShowcaseAdminGetReportsRollupListResponse.response:type_name -> protocol.CMsgClientToGCShowcaseAdminGetReportsRollupListResponse.EResponse
	39, // 49: protocol.CMsgClientToGCShowcaseAdminGetReportsRollupListResponse.rollup_list:type_name -> protocol.CMsgShowcaseReportsRollupList
	10, // 50: protocol.CMsgClientToGCShowcaseAdminGetReportsRollupResponse.response:type_name -> protocol.CMsgClientToGCShowcaseAdminGetReportsRollupResponse.EResponse
	41, // 51: protocol.CMsgClientToGCShowcaseAdminGetReportsRollupResponse.rollup:type_name -> protocol.CMsgShowcaseReportsRollup
	0,  // 52: protocol.CMsgShowcaseAuditEntry.showcase_type:type_name -> protocol.EShowcaseType
	2,  // 53: protocol.CMsgShowcaseAuditEntry.audit_action:type_name -> protocol.EShowcaseAuditAction
	0,  // 54: protocol.CMsgShowcaseReport.showcase_type:type_name -> protocol.EShowcaseType
	46, // 55: protocol.CMsgShowcaseAdminUserDetails.audit_entries:type_name -> protocol.CMsgShowcaseAuditEntry
	47, // 56: protocol.CMsgShowcaseAdminUserDetails.reports:type_name -> protocol.CMsgShowcaseReport
	11, // 57: protocol.CMsgClientToGCShowcaseAdminGetUserDetailsResponse.response:type_name -> protocol.CMsgClientToGCShowcaseAdminGetUserDetailsResponse.EResponse
	48, // 58: protocol.CMsgClientToGCShowcaseAdminGetUserDetailsResponse.user_details:type_name -> protocol.CMsgShowcaseAdminUserDetails
	0,  // 59: protocol.CMsgClientToGCShowcaseAdminReset.showcase_type:type_name -> protocol.EShowcaseType
	12, // 60: protocol.CMsgClientToGCShowcaseAdminResetResponse.response:type_name -> protocol.CMsgClientToGCShowcaseAdminResetResponse.EResponse
	13, // 61: protocol.CMsgClientToGCShowcaseAdminLockAccountResponse.response:type_name -> protocol.CMsgClientToGCShowcaseAdminLockAccountResponse.EResponse
	0,  // 62: protocol.CMsgClientToGCShowcaseAdminConvict.showcase_type:type_name -> protocol.EShowcaseType
	14, // 63: protocol.CMsgClientToGCShowcaseAdminConvictResponse.response:type_name -> protocol.CMsgClientToGCShowcaseAdminConvictResponse.EResponse
	0,  // 64: protocol.CMsgClientToGCShowcaseAdminExonerate.showcase_type:type_name -> protocol.EShowcaseType
	15, // 65: protocol.CMsgClientToGCShowcaseAdminExonerateResponse.response:type_name -> protocol.CMsgClientToGCShowcaseAdminExonerateResponse.EResponse
	71, // 66: protocol.CMsgShowcaseItem_EconItem.Data.econ_item:type_name -> protocol.CSOEconItem
	71, // 67: protocol.CMsgShowcaseItem_Hero.Data.econ_items:type_name -> protocol.CSOEconItem
	72, // 68: protocol.CMsgShowcaseItem_PlayerMatch.Data.game_mode:type_name -> protocol.DOTA_GameMode
	5,  // 69: protocol.CMsgShowcaseItem_PlayerMatch.Data.outcome:type_name -> protocol.CMsgShowcaseItem_PlayerMatch.EPlayerOutcome
	71, // 70: protocol.CMsgShowcaseBackground.Data.loading_screen:type_name -> protocol.CSOEconItem
...
func file_dota_gcmessages_client_showcase_proto_init() {
	...
	file_dota_gcmessages_client_showcase_proto_msgTypes[12].OneofWrappers = []any{
