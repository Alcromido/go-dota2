...
const file_dota_gcmessages_client_fantasy_proto_rawDesc = "" +
	"\n" +
	"$dota_gcmessages_client_fantasy.proto\x12\bprotocol\x1a\x17dota_shared_enums.proto\"\xb4\a\n" +
	"\x12CMsgDOTAPlayerInfo\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12!\n" +
	"\fcountry_code\x18\x03 \x01(\tR\vcountryCode\x12R\n" +
	"\ffantasy_role\x18\x04 \x01(\x0e2\x17.protocol.Fantasy_Roles:\x16FANTASY_ROLE_UNDEFINEDR\vfantasyRole\x12\x17\n" +
	...
	"\tis_locked\x18\t \x01(\bR\bisLocked\x12\x15\n" +
	"\x06is_pro\x18\n" +
	" \x01(\bR\x05isPro\x12\x1b\n" +
	"\treal_name\x18\v \x01(\tR\brealName\x12%\n" +
	"\x0etotal_earnings\x18\r \x01(\rR\rtotalEarnings\x12>\n" +
	"\aresults\x18\x0e \x03(\v2$.protocol.CMsgDOTAPlayerInfo.ResultsR\aresults\x12\"\n" +
	"\rteam_url_logo\x18\x0f \x01(\tR\vteamUrlLogo\x12L\n" +
	"\raudit_entries\x18\x10 \x03(\v2'.protocol.CMsgDOTAPlayerInfo.AuditEntryR\fauditEntries\x12+\n" +
	"\x11team_abbreviation\x18\x11 \x01(\tR\x10teamAbbreviation\x1a`\n" +
	"\aResults\x12\x1b\n" +
	...
	"\rteam_url_logo\x18\x06 \x01(\tR\vteamUrlLogo\"Y\n" +
	...
	"\x10coach_account_id\x18\x04 \x01(\rR\x0ecoachAccountId\"\xbb\x04\n" +
	"\x16CMsgDOTADPCProfileInfo\x12=\n" +
	"\vplayer_info\x18\x01 \x01(\v2\x1c.protocol.CMsgDOTAPlayerInfoR\n" +
	"playerInfo\x12X\n" +
	"\x0fprediction_info\x18\x02 \x01(\v2/.protocol.CMsgDOTADPCProfileInfo.PredictionInfoR\x0epredictionInfo\x12O\n" +
	"\ffantasy_info\x18\x03 \x01(\v2,.protocol.CMsgDOTADPCProfileInfo.FantasyInfoR\vfantasyInfo\x125\n" +
	...
	"\x0eshard_winnings\x18\x04 \x01(\rR\rshardWinnings\"\xbe\x01\n" +
	"\x14CMsgDOTALeaderboards\x12T\n" +
	"\fleaderboards\x18\x02 \x03(\v20.protocol.CMsgDOTALeaderboards.RegionLeaderboardR\fleaderboards\x1aP\n" +
	...
	"runnerupId\"\xb5\x01\n" +
	"$CMsgDOTAPassportVoteGenericSelection\x12o\n" +
	"\x0fselection_index\x18\x01 \x01(\x0e2+.protocol.DOTA_2013PassportSelectionIndices:\x19PP13_SEL_ALLSTAR_PLAYER_0R\x0eselectionIndex\x12\x1c\n" +
	...
	"\fchallenge_id\x18\x01 \x01(\rR\vchallengeId\"\xf4\x02\n" +
	"\x14CMsgDOTAPassportVote\x12F\n" +
	"\n" +
	"team_votes\x18\x01 \x03(\v2'.protocol.CMsgDOTAPassportVoteTeamGuessR\tteamVotes\x12]\n" +
	"\x12generic_selections\x18\x02 \x03(\v2..protocol.CMsgDOTAPassportVoteGenericSelectionR\x11genericSelections\x12P\n" +
	"\x0fstamped_players\x18\x03 \x03(\v2'.protocol.CMsgDOTAPassportStampedPlayerR\x0estampedPlayers\x12c\n" +
	"\x16player_card_challenges\x18\x04 \x03(\v2-.protocol.CMsgDOTAPassportPlayerCardChallengeR\x14playerCardChallenges\"z\n" +
	"(CMsgClientToGCGetPlayerCardRosterRequest\x12\x1b\n" +
	"\tleague_id\x18\x01 \x01(\rR\bleagueId\x121\n" +
	"\x0efantasy_period\x18\x03 \x01(\r:\n" +
	"4294967295R\rfantasyPeriod\"\xf3\x02\n" +
	")CMsgClientToGCGetPlayerCardRosterResponse\x12[\n" +
	"\x06result\x18\x01 \x01(\x0e2:.protocol.CMsgClientToGCGetPlayerCardRosterResponse.Result:\aSUCCESSR\x06result\x12-\n" +
	...
	"\x17ERROR_INVALID_TIMESTAMP\x10\x03\"\x88\x02\n" +
	"-CMsgClientToGCBatchGetPlayerCardRosterRequest\x12t\n" +
	"\x11league_timestamps\x18\x01 \x03(\v2G.protocol.CMsgClientToGCBatchGetPlayerCardRosterRequest.LeagueTimestampR\x10leagueTimestamps\x1aa\n" +
	"\x0fLeagueTimestamp\x12\x1b\n" +
	"\tleague_id\x18\x01 \x01(\rR\bleagueId\x121\n" +
	"\x0efantasy_period\x18\x03 \x01(\r:\n" +
	"4294967295R\rfantasyPeriod\"\xfa\x04\n" +
	".CMsgClientToGCBatchGetPlayerCardRosterResponse\x12e\n" +
	"\tresponses\x18\x01 \x03(\v2G.protocol.CMsgClientToGCBatchGetPlayerCardRosterResponse.RosterResponseR\tresponses\x1a\xf8\x02\n" +
	"\x0eRosterResponse\x12\x1b\n" +
	"\tleague_id\x18\x01 \x01(\rR\bleagueId\x121\n" +
	"\x14deprecated_timestamp\x18\x02 \x01(\rR\x13deprecatedTimestamp\x12`\n" +
	"\x06result\x18\x03 \x01(\x0e2?.protocol.CMsgClientToGCBatchGetPlayerCardRosterResponse.Result:\aSUCCESSR\x06result\x12-\n" +
	...
	"percentile\x121\n" +
	"\x0efantasy_period\x18\b \x01(\r:\n" +
	"4294967295R\rfantasyPeriod\"f\n" +
	"\x06Result\x12\v\n" +
	"\aSUCCESS\x10\x00\x12\x15\n" +
	"\x11ERROR_UNSPECIFIED\x10\x01\x12\x1b\n" +
	"\x17ERROR_INVALID_LEAGUE_ID\x10\x02\x12\x1b\n" +
	"\x17ERROR_INVALID_TIMESTAMP\x10\x03\"\x8b\x02\n" +
	...
	"\bevent_id\x18\x05 \x01(\rR\aeventId\x121\n" +
	"\x0efantasy_period\x18\x06 \x01(\r:\n" +
	"4294967295R\rfantasyPeriod\"\xbd\x03\n" +
	")CMsgClientToGCSetPlayerCardRosterResponse\x12[\n" +
	"\x06result\x18\x01 \x01(\x0e2:.protocol.CMsgClientToGCSetPlayerCardRosterResponse.Result:\aSUCCESSR\x06result\"\xb2\x02\n" +
	"\x06Result\x12\v\n" +
	"\aSUCCESS\x10\x00\x12\x15\n" +
	"\x11ERROR_UNSPECIFIED\x10\x01\x12\x1b\n" +
	"\x17ERROR_INVALID_LEAGUE_ID\x10\x02\x12\x1b\n" +
	...
	"\"\xd3\x03\n" +
	"\x1eCMsgDOTAFantasyDPCLeagueStatus\x12V\n" +
	"\fleague_infos\x18\x01 \x03(\v23.protocol.CMsgDOTAFantasyDPCLeagueStatus.LeagueInfoR\vleagueInfos\x1a\x96\x02\n" +
	"\n" +
	"LeagueInfo\x12\x1b\n" +
	...
	"\x0eday_timestamps\x18\x05 \x03(\rR\rdayTimestamps\x12U\n" +
	"\x06status\x18\b \x01(\x0e26.protocol.CMsgDOTAFantasyDPCLeagueStatus.ERosterStatus:\x05UNSETR\x06status\"@\n" +
	"\rERosterStatus\x12\t\n" +
	"\x05UNSET\x10\x00\x12\v\n" +
	"\aPARTIAL\x10\x01\x12\b\n" +
	"\x04FULL\x10\x02\x12\r\n" +
	"\tCONCLUDED\x10\x03\"\xc2\x04\n" +
	"\x18CMsgDOTADPCSearchResults\x12C\n" +
	"\aplayers\x18\x01 \x03(\v2).protocol.CMsgDOTADPCSearchResults.PlayerR\aplayers\x12=\n" +
	"\x05teams\x18\x02 \x03(\v2'.protocol.CMsgDOTADPCSearchResults.TeamR\x05teams\x12C\n" +
	"\aleagues\x18\x03 \x03(\v2).protocol.CMsgDOTADPCSearchResults.LeagueR\aleagues\x1aI\n" +
	"\x06Player\x12\x0e\n" +
	...
	"\x1bk_ESearchResultsDesired_All\x10\a\"\xa6\x01\n" +
	"\x1fCMsgDOTADPCTeamFavoriteRankings\x12D\n" +
	...
	"\atablets\x18\x02 \x03(\v28.protocol.CMsgDotaFantasyCraftingTabletPeriodData.TabletR\atablets\x1a\xd6\x01\n" +
	"\x03Gem\x12E\n" +
	"\x04type\x18\x01 \x01(\x0e2\x1a.protocol.Fantasy_Gem_Type:\x15FANTASY_GEM_TYPE_RUBYR\x04type\x12\x12\n" +
	...
	"\ffantasy_role\x18\x03 \x01(\x0e2\x17.protocol.Fantasy_Roles:\x16FANTASY_ROLE_UNDEFINEDR\vfantasyRole\x12\x1d\n" +
	"\n" +
	...
	"bestSeries\"\x88\x02\n" +
	"!CMsgDotaFantasyCraftingTabletData\x12o\n" +
	"\x12tablet_period_data\x18\x01 \x03(\v2A.protocol.CMsgDotaFantasyCraftingTabletData.TabletPeriodDataEntryR\x10tabletPeriodData\x1ar\n" +
	"\x15TabletPeriodDataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\rR\x03key\x12G\n" +
	"\x05value\x18\x02 \x01(\v21.protocol.CMsgDotaFantasyCraftingTabletPeriodDataR\x05value\"\xa0\x04\n" +
	"\x1fCMsgDotaFantasyCraftingUserData\x12'\n" +
	"\x0favailable_rolls\x18\x01 \x03(\rR\x0eavailableRolls\x12m\n" +
	"\x12period_roll_tokens\x18\x02 \x03(\v2?.protocol.CMsgDotaFantasyCraftingUserData.PeriodRollTokensEntryR\x10periodRollTokens\x12`\n" +
	"\rperiod_scores\x18\x03 \x03(\v2;.protocol.CMsgDotaFantasyCraftingUserData.PeriodScoresEntryR\fperiodScores\x1aN\n" +
	...
	"\x05value\x18\x02 \x01(\rR\x05value\x1ar\n" +
	"\x11PeriodScoresEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\rR\x03key\x12K\n" +
	"\x05value\x18\x02 \x01(\v25.protocol.CMsgDotaFantasyCraftingUserData.PeriodScoreR\x05value\"\xa6\x02\n" +
	" CMsgDotaFantasyCraftingDataCache\x12Z\n" +
	"\rcache_entries\x18\x01 \x03(\v25.protocol.CMsgDotaFantasyCraftingDataCache.CacheEntryR\fcacheEntries\x1a\xa5\x01\n" +
	"\n" +
	"CacheEntry\x12\x1d\n" +
	"\n" +
	"account_id\x18\x01 \x01(\rR\taccountId\x12%\n" +
	"\x0efantasy_league\x18\x02 \x01(\rR\rfantasyLeague\x12Q\n" +
	"\n" +
	"cache_data\x18\x03 \x01(\v22.protocol.CMsgGCToClientFantasyCraftingDataUpdatedR\tcacheData\"l\n" +
	"$CMsgClientToGCFantasyCraftingGetData\x12%\n" +
	"\x0efantasy_league\x18\x01 \x01(\rR\rfantasyLeague\x12\x1d\n" +
	"\n" +
	"account_id\x18\x02 \x01(\rR\taccountId\"\xae\x03\n" +
	",CMsgClientToGCFantasyCraftingGetDataResponse\x12n\n" +
	"\bresponse\x18\x01 \x01(\x0e2@.protocol.CMsgClientToGCFantasyCraftingGetDataResponse.EResponse:\x10k_eInternalErrorR\bresponse\x12F\n" +
	"\tuser_data\x18\x02 \x01(\v2).protocol.CMsgDotaFantasyCraftingUserDataR\buserData\x12L\n" +
	"\vtablet_data\x18\x04 \x01(\v2+.protocol.CMsgDotaFantasyCraftingTabletDataR\n" +
	"tabletData\"x\n" +
	"\tEResponse\x12\x14\n" +
	...
	"\n" +
	"extra_data\x18\x04 \x01(\x04R\textraData\"\xe3\x06\n" +
	"5CMsgClientToGCFantasyCraftingPerformOperationResponse\x12w\n" +
	"\bresponse\x18\x01 \x01(\x0e2I.protocol.CMsgClientToGCFantasyCraftingPerformOperationResponse.EResponse:\x10k_eInternalErrorR\bresponse\x12!\n" +
	"\foperation_id\x18\x02 \x01(\rR\voperationId\x12\x1b\n" +
	"\ttablet_id\x18\a \x01(\rR\btabletId\x12F\n" +
	"\tuser_data\x18\b \x01(\v2).protocol.CMsgDotaFantasyCraftingUserDataR\buserData\x12L\n" +
	"\vtablet_data\x18\t \x01(\v2+.protocol.CMsgDotaFantasyCraftingTabletDataR\n" +
	"tabletData\x12%\n" +
	"\x0eplayer_choices\x18\x03 \x03(\rR\rplayerChoices\x12%\n" +
	"\x0eprefix_choices\x18\x04 \x03(\rR\rprefixChoices\x12%\n" +
	"\x0esuffix_choices\x18\x05 \x03(\rR\rsuffixChoices\x12p\n" +
	"\rtitle_choices\x18\x06 \x03(\v2K.protocol.CMsgClientToGCFantasyCraftingPerformOperationResponse.TitleChoiceR\ftitleChoices\x1aW\n" +
	"\vTitleChoice\x12#\n" +
	...
	"\vk_eMoreInfo\x10\a\"\xe7\x01\n" +
	"(CMsgGCToClientFantasyCraftingDataUpdated\x12%\n" +
	"\x0efantasy_league\x18\x01 \x01(\rR\rfantasyLeague\x12F\n" +
	"\tuser_data\x18\x02 \x01(\v2).protocol.CMsgDotaFantasyCraftingUserDataR\buserData\x12L\n" +
	"\vtablet_data\x18\x04 \x01(\v2+.protocol.CMsgDotaFantasyCraftingTabletDataR\n" +
	"tabletData\"\xf9\x01\n" +
	...
	"\x0fupgrade_tablets\x18\x06 \x01(\bR\x0eupgradeTablets\x121\n" +
	"\x0efantasy_period\x18\x05 \x01(\r:\n" +
	"4294967295R\rfantasyPeriod\"\xbe\x03\n" +
	"4CMsgClientToGCFantasyCraftingDevModifyTabletResponse\x12v\n" +
	"\bresponse\x18\x01 \x01(\x0e2H.protocol.CMsgClientToGCFantasyCraftingDevModifyTabletResponse.EResponse:\x10k_eInternalErrorR\bresponse\x12F\n" +
	"\tuser_data\x18\x02 \x01(\v2).protocol.CMsgDotaFantasyCraftingUserDataR\buserData\x12L\n" +
	...
	"\x0efantasy_league\x18\x01 \x01(\rR\rfantasyLeague\x12\x1d\n" +
	"\n" +
	"account_id\x18\x02 \x01(\rR\taccountId\"\x87\x03\n" +
	"1CMsgClientToGCFantasyCraftingSelectPlayerResponse\x12s\n" +
	"\bresponse\x18\x01 \x01(\x0e2E.protocol.CMsgClientToGCFantasyCraftingSelectPlayerResponse.EResponse:\x10k_eInternalErrorR\bresponse\x12L\n" +
	...
	"\bresponse\x18\x01 \x01(\x0e2G.protocol.CMsgClientToGcFantasyCraftingUpgradeTabletsResponse.EResponse:\x10k_eInternalErrorR\bresponse\x12L\n" +
	"\vtablet_data\x18\x03 \x01(\v2+.protocol.CMsgDotaFantasyCraftingTabletDataR\n" +
	"tabletData\"x\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	...
	"\x0efantasy_league\x18\x01 \x01(\rR\rfantasyLeague\"\x88\x03\n" +
	"2CMsgClientToGCFantasyCraftingRerollOptionsResponse\x12t\n" +
	"\bresponse\x18\x01 \x01(\x0e2F.protocol.CMsgClientToGCFantasyCraftingRerollOptionsResponse.EResponse:\x10k_eInternalErrorR\bresponse\x12F\n" +
	"\tuser_data\x18\x02 \x01(\v2).protocol.CMsgDotaFantasyCraftingUserDataR\buserData\"\x93\x01\n" +
	"\tEResponse\x12\x14\n" +
	"\x10k_eInternalError\x10\x00\x12\x0e\n" +
	"\n" +
	"k_eSuccess\x10\x01\x12\x0e\n" +
	...
	"\x0fPP13_SEL_SOLO_7\x10_B\rZ\v./;protocol"
