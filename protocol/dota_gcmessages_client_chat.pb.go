...
func (x *CMsgDOTAChatMessage) GetEventPoints() uint32 {
...
func (x *CMsgDOTAChatMessage) GetSuggestPickHeroId() uint32 {
...
func (x *CMsgDOTAChatMessage) GetSuggestBanHeroId() uint32 {
...
const file_dota_gcmessages_client_chat_proto_rawDesc = "" +
	"\n" +
	"!dota_gcmessages_client_chat.proto\x12\bprotocol\x1a\x17dota_shared_enums.proto\"\x8a\x01\n" +
	...
	"\x19private_chat_channel_name\x18\x01 \x01(\tR\x16privateChatChannelName\x12*\n" +
	"\x11demote_account_id\x18\x02 \x01(\rR\x0fdemoteAccountId\"\xf0\x04\n" +
	"!CMsgGCToClientPrivateChatResponse\x129\n" +
	"\x19private_chat_channel_name\x18\x01 \x01(\tR\x16privateChatChannelName\x12S\n" +
	"\x06result\x18\x02 \x01(\x0e22.protocol.CMsgGCToClientPrivateChatResponse.Result:\aSUCCESSR\x06result\x12\x1a\n" +
	...
	"\x15FAILURE_ALREADY_ADMIN\x10\x0f\"\xc5\x01\n" +
	"\x17CMsgDOTAJoinChatChannel\x12!\n" +
	"\fchannel_name\x18\x02 \x01(\tR\vchannelName\x12\\\n" +
	"\fchannel_type\x18\x04 \x01(\x0e2\x1f.protocol.DOTAChatChannelType_t:\x18DOTAChannelType_RegionalR\vchannelType\x12)\n" +
	...
	"\bduration\x18\x03 \x01(\rR\bduration\"\xb1\x13\n" +
	...
	"\x17suggest_invite_to_lobby\x18\v \x01(\bR\x14suggestInviteToLobby\x12!\n" +
	"\fevent_points\x18\f \x01(\rR\veventPoints\x12\x1b\n" +
	"\tcoin_flip\x18\r \x01(\bR\bcoinFlip\x12\x1f\n" +
	"\tplayer_id\x18\x0e \x01(\x05:\x02-1R\bplayerId\x127\n" +
	"\x18share_profile_account_id\x18\x0f \x01(\rR\x15shareProfileAccountId\x12&\n" +
	"\x0fchannel_user_id\x18\x10 \x01(\rR\rchannelUserId\x12C\n" +
	"\tdice_roll\x18\x11 \x01(\v2&.protocol.CMsgDOTAChatMessage.DiceRollR\bdiceRoll\x12$\n" +
	...
	"badgeLevel\x12/\n" +
	"\x14suggest_pick_hero_id\x18\x1a \x01(\rR\x11suggestPickHeroId\x123\n" +
	"\x16suggest_pick_hero_role\x18\x1b \x01(\tR\x13suggestPickHeroRole\x12-\n" +
	"\x13suggest_ban_hero_id\x18\x1e \x01(\rR\x10suggestBanHeroId\x12Q\n" +
	"\rtrivia_answer\x18  \x01(\v2,.protocol.CMsgDOTAChatMessage.TriviaAnsweredR\ftriviaAnswer\x124\n" +
	"\x14requested_ability_id\x18! \x01(\x05:\x02-1R\x12requestedAbilityId\x12\x1d\n" +
	"\n" +
	...
	"\x15favorite_team_quality\x18& \x01(\rR\x13favoriteTeamQuality\x12=\n" +
	"\x19suggest_player_draft_pick\x18' \x01(\x05:\x02-1R\x16suggestPlayerDraftPick\x12Y\n" +
	"\x11player_draft_pick\x18( \x01(\v2-.protocol.CMsgDOTAChatMessage.PlayerDraftPickR\x0fplayerDraftPick\x12\\\n" +
	"\x12chat_wheel_message\x18) \x01(\v2..protocol.CMsgDOTAChatMessage.ChatWheelMessageR\x10chatWheelMessage\x1aX\n" +
	"\bDiceRoll\x12\x19\n" +
	...
	"\x13party_trivia_points\x18\x05 \x01(\rR\x11partyTriviaPoints\x1aF\n" +
	"\x0fPlayerDraftPick\x12\x1f\n" +
	"\tplayer_id\x18\x01 \x01(\x05:\x02-1R\bplayerId\x12\x12\n" +
	"\x04team\x18\x02 \x01(\x05R\x04team\x1a\xa9\x01\n" +
	"\x10ChatWheelMessage\x12)\n" +
	"\n" +
	"message_id\x18\x01 \x01(\r:\n" +
	"4294967295R\tmessageId\x12\x1f\n" +
	...
	"\x06status\x18\x04 \x01(\rR\x06status\"\xfd\b\n" +
	...
	"maxMembers\x126\n" +
	"\amembers\x18\x05 \x03(\v2\x1c.protocol.CMsgDOTAChatMemberR\amembers\x12\\\n" +
	"\fchannel_type\x18\x06 \x01(\x0e2\x1f.protocol.DOTAChatChannelType_t:\x18DOTAChannelType_RegionalR\vchannelType\x12V\n" +
	"\x06result\x18\a \x01(\x0e20.protocol.CMsgDOTAJoinChatChannelResponse.Result:\fJOIN_SUCCESSR\x06result\x12*\n" +
	...
	" \x01(\tR\x0ewelcomeMessage\x12n\n" +
	"\x12special_privileges\x18\v \x01(\x0e2 .protocol.EChatSpecialPrivileges:\x1dk_EChatSpecialPrivileges_NoneR\x11specialPrivileges\"\xff\x03\n" +
	"\x06Result\x12\x10\n" +
	...
	"\x1eCMsgDOTARequestChatChannelList\"\xb4\x02\n" +
	"&CMsgDOTARequestChatChannelListResponse\x12X\n" +
	"\bchannels\x18\x01 \x03(\v2<.protocol.CMsgDOTARequestChatChannelListResponse.ChatChannelR\bchannels\x1a\xaf\x01\n" +
	"\vChatChannel\x12!\n" +
	"\fchannel_name\x18\x01 \x01(\tR\vchannelName\x12\x1f\n" +
	"\vnum_members\x18\x02 \x01(\rR\n" +
	"numMembers\x12\\\n" +
	"\fchannel_type\x18\x03 \x01(\x0e2\x1f.protocol.DOTAChatChannelType_t:\x18DOTAChannelType_RegionalR\vchannelType\"\x95\x02\n" +
	"\x1fCMsgDOTAChatGetUserListResponse\x12\x1d\n" +
	"\n" +
	"channel_id\x18\x01 \x01(\x06R\tchannelId\x12J\n" +
	"\amembers\x18\x02 \x03(\v20.protocol.CMsgDOTAChatGetUserListResponse.MemberR\amembers\x1a\x86\x01\n" +
	"\x06Member\x12\x19\n" +
	"\bsteam_id\x18\x01 \x01(\x06R\asteamId\x12!\n" +
	"\fpersona_name\x18\x02 \x01(\tR\vpersonaName\x12&\n" +
	"\x0fchannel_user_id\x18\x03 \x01(\rR\rchannelUserId\x12\x16\n" +
	"\x06status\x18\x04 \x01(\rR\x06status\"\x9d\x01\n" +
	"\x1aCMsgDOTAChatGetMemberCount\x12!\n" +
	"\fchannel_name\x18\x01 \x01(\tR\vchannelName\x12\\\n" +
	"\fchannel_type\x18\x02 \x01(\x0e2\x1f.protocol.DOTAChatChannelType_t:\x18DOTAChannelType_RegionalR\vchannelType\"\xc8\x01\n" +
	"\"CMsgDOTAChatGetMemberCountResponse\x12!\n" +
	"\fchannel_name\x18\x01 \x01(\tR\vchannelName\x12\\\n" +
	"\fchannel_type\x18\x02 \x01(\x0e2\x1f.protocol.DOTAChatChannelType_t:\x18DOTAChannelType_RegionalR\vchannelType\x12!\n" +
	"\fmember_count\x18\x03 \x01(\rR\vmemberCount\"\xbb\x02\n" +
	"\x1aCMsgDOTAChatRegionsEnabled\x12,\n" +
	"\x12enable_all_regions\x18\x01 \x01(\bR\x10enableAllRegions\x12T\n" +
	"\x0fenabled_regions\x18\x02 \x03(\v2+.protocol.CMsgDOTAChatRegionsEnabled.RegionR\x0eenabledRegions\x1a\x98\x01\n" +
	"\x06Region\x12!\n" +
	...
	"\rmax_longitude\x18\x04 \x01(\x02R\fmaxLongitudeB\rZ\v./;protocol"
