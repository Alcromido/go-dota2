...
const file_dota_gcmessages_common_match_management_proto_rawDesc = "" +
	"\n" +
	"-dota_gcmessages_common_match_management.proto\x12\bprotocol\x1a\x13steammessages.proto\x1a\x16gcsdk_gcmessages.proto\x1a\x17dota_shared_enums.proto\"\x95\x05\n" +
	...
	"\x0eis_steam_china\x18\x10 \x01(\bR\fisSteamChina\"\xf7\x16\n" +
	...
	"!restricted_from_ranked_account_id\x18K \x01(\rR\x1drestrictedFromRankedAccountId\"0\n" +
	"\x05State\x12\x06\n" +
	...
	"\x17behavior_score_variance\x18\x03 \x01(\x0e2%.protocol.EMatchBehaviorScoreVariance:%k_EMatchBehaviorScoreVariance_InvalidR\x15behaviorScoreVariance\"\xb2k\n" +
	"\bCMvpData\x12/\n" +
	"\x04mvps\x18\x01 \x03(\v2\x1b.protocol.CMvpData.MvpDatumR\x04mvps\x1a\xf4j\n" +
	"\bMvpDatum\x12\x1f\n" +
	"\vplayer_slot\x18\x01 \x01(\rR\n" +
	"playerSlot\x12E\n" +
	"\taccolades\x18\x02 \x03(\v2'.protocol.CMvpData.MvpDatum.MvpAccoladeR\taccolades\x1a\xffi\n" +
	"\vMvpAccolade\x12R\n" +
	"\x04type\x18\x01 \x01(\x0e27.protocol.CMvpData.MvpDatum.MvpAccolade.MvpAccoladeType:\x05killsR\x04type\x12!\n" +
	"\fdetail_value\x18\x02 \x01(\x02R\vdetailValue\"\xf8h\n" +
	...
	"2kKillEaterEventType_Muerta_DeadShotsIntoTheCalling\x10\x96\x02*\xab\x01\n" +
	...
	"\"k_EMatchBehaviorScoreVariance_High\x10\x03B\rZ\v./;protocol"
...
var file_dota_gcmessages_common_match_management_proto_depIdxs = []int32{
	...
	4,  // 15: protocol.CMsgReadyCheckStatus.ReadyMember.ready_status:type_name -> protocol.EReadyCheckStatus
	23, // 16: protocol.CMvpData.MvpDatum.accolades:type_name -> protocol.CMvpData.MvpDatum.MvpAccolade
	8,  // 17: protocol.CMvpData.MvpDatum.MvpAccolade.type:type_name -> protocol.CMvpData.MvpDatum.MvpAccolade.MvpAccoladeType
