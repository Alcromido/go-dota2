...
const file_econ_shared_enums_proto_rawDesc = "" +
	"\n" +
	"\x17econ_shared_enums.proto\x12\bprotocol\"U\n" +
	...
	"+k_EGCMsgUseItemResponse_ItemUsed_Compendium\x10\rB\rZ\v./;protocol"
...
var file_econ_shared_enums_proto_goTypes = []any{
	(EGCEconBaseMsg)(0),        // 0: protocol.EGCEconBaseMsg
	(EGCMsgResponse)(0),        // 1: protocol.EGCMsgResponse
	(EGCMsgUseItemResponse)(0), // 2: protocol.EGCMsgUseItemResponse
	(*CMsgGenericResult)(nil),  // 3: protocol.CMsgGenericResult
}
